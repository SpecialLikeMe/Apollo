...
namespace __apollo_inline_inline_3449_5_15 {
        void* sys__native_mutex_new() { return __apo_stdlib::mutex_new(); }
        int sys__native_mutex_lock(void* value) { return __apo_stdlib::mutex_lock(value); }
        int sys__native_mutex_try_lock(void* value) { return __apo_stdlib::mutex_try_lock(value); }
        int sys__native_mutex_unlock(void* value) { return __apo_stdlib::mutex_unlock(value); }

        void* sys__native_condvar_new() { return __apo_stdlib::condvar_new(); }
        int sys__native_condvar_wait_ms(void* value, int timeout_ms) { return __apo_stdlib::condvar_wait_ms(value, timeout_ms); }
        void sys__native_condvar_notify_one(void* value) { __apo_stdlib::condvar_notify_one(value); }
        void sys__native_condvar_notify_all(void* value) { __apo_stdlib::condvar_notify_all(value); }

        void* sys__native_channel_bounded(int capacity) { return __apo_stdlib::channel_bounded(capacity); }
        void* sys__native_channel_unbounded() { return __apo_stdlib::channel_unbounded(); }
        int sys__native_channel_send_i32(void* value, int item) { return __apo_stdlib::channel_send_i32(value, item); }
        int sys__native_channel_send_str(void* value, const char* item) { return __apo_stdlib::channel_send_str(value, __apo_stdlib::text_or_empty(item)); }
        int sys__native_channel_send_bool(void* value, int item) { return __apo_stdlib::channel_send_bool(value, item); }
        int sys__native_channel_send_f64(void* value, double item) { return __apo_stdlib::channel_send_f64(value, item); }
        int sys__native_channel_try_send_i32(void* value, int item) { return __apo_stdlib::channel_try_send_i32(value, item); }
        int sys__native_channel_try_send_str(void* value, const char* item) { return __apo_stdlib::channel_try_send_str(value, __apo_stdlib::text_or_empty(item)); }
        int sys__native_channel_try_send_bool(void* value, int item) { return __apo_stdlib::channel_try_send_bool(value, item); }
        int sys__native_channel_try_send_f64(void* value, double item) { return __apo_stdlib::channel_try_send_f64(value, item); }
        int sys__native_channel_recv_i32(void* value) { return __apo_stdlib::channel_recv_i32(value); }
        const char* sys__native_channel_recv_str(void* value) { return __apo_stdlib::channel_recv_str(value); }
        int sys__native_channel_recv_bool(void* value) { return __apo_stdlib::channel_recv_bool(value); }
        double sys__native_channel_recv_f64(void* value) { return __apo_stdlib::channel_recv_f64(value); }
        int sys__native_channel_try_recv_i32(void* value, int fallback) { return __apo_stdlib::channel_try_recv_i32(value, fallback); }
        const char* sys__native_channel_try_recv_str(void* value) { return __apo_stdlib::channel_try_recv_str(value); }
        int sys__native_channel_try_recv_bool(void* value, int fallback) { return __apo_stdlib::channel_try_recv_bool(value, fallback); }
        double sys__native_channel_try_recv_f64(void* value, double fallback) { return __apo_stdlib::channel_try_recv_f64(value, fallback); }
        int sys__native_channel_len(void* value) { return __apo_stdlib::channel_len(value); }
        int sys__native_channel_close(void* value) { return __apo_stdlib::channel_close(value); }
        int sys__native_channel_is_closed(void* value) { return __apo_stdlib::channel_is_closed(value); }
    
}
extern "C" void* sys__native_mutex_new() { return __apollo_inline_inline_3449_5_15::sys__native_mutex_new(); }
extern "C" int sys__native_mutex_lock(void* value) { return __apollo_inline_inline_3449_5_15::sys__native_mutex_lock(value); }
extern "C" int sys__native_mutex_try_lock(void* value) { return __apollo_inline_inline_3449_5_15::sys__native_mutex_try_lock(value); }
extern "C" int sys__native_mutex_unlock(void* value) { return __apollo_inline_inline_3449_5_15::sys__native_mutex_unlock(value); }
extern "C" void* sys__native_condvar_new() { return __apollo_inline_inline_3449_5_15::sys__native_condvar_new(); }
extern "C" int sys__native_condvar_wait_ms(void* value, int timeout_ms) { return __apollo_inline_inline_3449_5_15::sys__native_condvar_wait_ms(value, timeout_ms); }
extern "C" void sys__native_condvar_notify_one(void* value) { __apollo_inline_inline_3449_5_15::sys__native_condvar_notify_one(value); }
extern "C" void sys__native_condvar_notify_all(void* value) { __apollo_inline_inline_3449_5_15::sys__native_condvar_notify_all(value); }
extern "C" void* sys__native_channel_bounded(int capacity) { return __apollo_inline_inline_3449_5_15::sys__native_channel_bounded(capacity); }
extern "C" void* sys__native_channel_unbounded() { return __apollo_inline_inline_3449_5_15::sys__native_channel_unbounded(); }
extern "C" int sys__native_channel_send_i32(void* value, int item) { return __apollo_inline_inline_3449_5_15::sys__native_channel_send_i32(value, item); }
extern "C" int sys__native_channel_send_str(void* value, const char* item) { return __apollo_inline_inline_3449_5_15::sys__native_channel_send_str(value, item); }
extern "C" int sys__native_channel_send_bool(void* value, int item) { return __apollo_inline_inline_3449_5_15::sys__native_channel_send_bool(value, item); }
extern "C" int sys__native_channel_send_f64(void* value, double item) { return __apollo_inline_inline_3449_5_15::sys__native_channel_send_f64(value, item); }
extern "C" int sys__native_channel_try_send_i32(void* value, int item) { return __apollo_inline_inline_3449_5_15::sys__native_channel_try_send_i32(value, item); }
extern "C" int sys__native_channel_try_send_str(void* value, const char* item) { return __apollo_inline_inline_3449_5_15::sys__native_channel_try_send_str(value, item); }
extern "C" int sys__native_channel_try_send_bool(void* value, int item) { return __apollo_inline_inline_3449_5_15::sys__native_channel_try_send_bool(value, item); }
extern "C" int sys__native_channel_try_send_f64(void* value, double item) { return __apollo_inline_inline_3449_5_15::sys__native_channel_try_send_f64(value, item); }
extern "C" int sys__native_channel_recv_i32(void* value) { return __apollo_inline_inline_3449_5_15::sys__native_channel_recv_i32(value); }
extern "C" const char* sys__native_channel_recv_str(void* value) { return __apollo_inline_inline_3449_5_15::sys__native_channel_recv_str(value); }
extern "C" int sys__native_channel_recv_bool(void* value) { return __apollo_inline_inline_3449_5_15::sys__native_channel_recv_bool(value); }
extern "C" double sys__native_channel_recv_f64(void* value) { return __apollo_inline_inline_3449_5_15::sys__native_channel_recv_f64(value); }
extern "C" int sys__native_channel_try_recv_i32(void* value, int fallback) { return __apollo_inline_inline_3449_5_15::sys__native_channel_try_recv_i32(value, fallback); }
extern "C" const char* sys__native_channel_try_recv_str(void* value) { return __apollo_inline_inline_3449_5_15::sys__native_channel_try_recv_str(value); }
extern "C" int sys__native_channel_try_recv_bool(void* value, int fallback) { return __apollo_inline_inline_3449_5_15::sys__native_channel_try_recv_bool(value, fallback); }
extern "C" double sys__native_channel_try_recv_f64(void* value, double fallback) { return __apollo_inline_inline_3449_5_15::sys__native_channel_try_recv_f64(value, fallback); }
extern "C" int sys__native_channel_len(void* value) { return __apollo_inline_inline_3449_5_15::sys__native_channel_len(value); }
extern "C" int sys__native_channel_close(void* value) { return __apollo_inline_inline_3449_5_15::sys__native_channel_close(value); }
extern "C" int sys__native_channel_is_closed(void* value) { return __apollo_inline_inline_3449_5_15::sys__native_channel_is_closed(value); }
