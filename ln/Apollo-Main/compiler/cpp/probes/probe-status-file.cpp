...
__apo_isc write_log() {
    const __apo_file handle = __apo_file::open("output/status_file.txt", "w");
    handle.write("hello");
    handle.close();
...
__apo_isc read_log() {
    const __apo_file handle = __apo_file::open("output/status_file.txt");
