...
namespace __apollo_inline_inline_1847_5_5 {
...
extern "C" void* sys__native_vec_new() { return __apollo_inline_inline_1847_5_5::sys__native_vec_new(); }
extern "C" void* sys__native_vec_with_capacity(int capacity) { return __apollo_inline_inline_1847_5_5::sys__native_vec_with_capacity(capacity); }
extern "C" int sys__native_vec_len(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_vec_len(value); }
extern "C" void sys__native_vec_push(void* value, const char* item) { __apollo_inline_inline_1847_5_5::sys__native_vec_push(value, item); }
extern "C" const char* sys__native_vec_pop(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_vec_pop(value); }
extern "C" const char* sys__native_vec_get(void* value, int index) { return __apollo_inline_inline_1847_5_5::sys__native_vec_get(value, index); }
extern "C" void sys__native_vec_set(void* value, int index, const char* item) { __apollo_inline_inline_1847_5_5::sys__native_vec_set(value, index, item); }
extern "C" void sys__native_vec_insert(void* value, int index, const char* item) { __apollo_inline_inline_1847_5_5::sys__native_vec_insert(value, index, item); }
extern "C" const char* sys__native_vec_remove(void* value, int index) { return __apollo_inline_inline_1847_5_5::sys__native_vec_remove(value, index); }
extern "C" const char* sys__native_vec_swap_remove(void* value, int index) { return __apollo_inline_inline_1847_5_5::sys__native_vec_swap_remove(value, index); }
extern "C" void sys__native_vec_clear(void* value) { __apollo_inline_inline_1847_5_5::sys__native_vec_clear(value); }
extern "C" void sys__native_vec_truncate(void* value, int length) { __apollo_inline_inline_1847_5_5::sys__native_vec_truncate(value, length); }
extern "C" void sys__native_vec_reserve(void* value, int additional) { __apollo_inline_inline_1847_5_5::sys__native_vec_reserve(value, additional); }
extern "C" void sys__native_vec_shrink_to_fit(void* value) { __apollo_inline_inline_1847_5_5::sys__native_vec_shrink_to_fit(value); }
extern "C" void sys__native_vec_resize(void* value, int new_length, const char* item) { __apollo_inline_inline_1847_5_5::sys__native_vec_resize(value, new_length, item); }
extern "C" void sys__native_vec_dedup(void* value) { __apollo_inline_inline_1847_5_5::sys__native_vec_dedup(value); }
extern "C" const char* sys__native_vec_join(void* value, const char* delimiter) { return __apollo_inline_inline_1847_5_5::sys__native_vec_join(value, delimiter); }
extern "C" int sys__native_vec_contains(void* value, const char* item) { return __apollo_inline_inline_1847_5_5::sys__native_vec_contains(value, item); }
extern "C" void* sys__native_map_new() { return __apollo_inline_inline_1847_5_5::sys__native_map_new(); }
extern "C" void* sys__native_map_with_capacity(int capacity) { return __apollo_inline_inline_1847_5_5::sys__native_map_with_capacity(capacity); }
extern "C" int sys__native_map_len(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_map_len(value); }
extern "C" void sys__native_map_insert(void* value, const char* key, const char* item) { __apollo_inline_inline_1847_5_5::sys__native_map_insert(value, key, item); }
extern "C" const char* sys__native_map_get(void* value, const char* key) { return __apollo_inline_inline_1847_5_5::sys__native_map_get(value, key); }
extern "C" const char* sys__native_map_get_mut(void* value, const char* key) { return __apollo_inline_inline_1847_5_5::sys__native_map_get_mut(value, key); }
extern "C" const char* sys__native_map_remove(void* value, const char* key) { return __apollo_inline_inline_1847_5_5::sys__native_map_remove(value, key); }
extern "C" int sys__native_map_contains_key(void* value, const char* key) { return __apollo_inline_inline_1847_5_5::sys__native_map_contains_key(value, key); }
extern "C" void sys__native_map_clear(void* value) { __apollo_inline_inline_1847_5_5::sys__native_map_clear(value); }
extern "C" void sys__native_map_reserve(void* value, int capacity) { __apollo_inline_inline_1847_5_5::sys__native_map_reserve(value, capacity); }
extern "C" const char* sys__native_map_entry_or_insert(void* value, const char* key, const char* default_value) { return __apollo_inline_inline_1847_5_5::sys__native_map_entry_or_insert(value, key, default_value); }
extern "C" void sys__native_map_rehash(void* value) { __apollo_inline_inline_1847_5_5::sys__native_map_rehash(value); }
extern "C" const char* sys__native_map_keys(void* value, const char* delimiter) { return __apollo_inline_inline_1847_5_5::sys__native_map_keys(value, delimiter); }
extern "C" const char* sys__native_map_values(void* value, const char* delimiter) { return __apollo_inline_inline_1847_5_5::sys__native_map_values(value, delimiter); }
extern "C" const char* sys__native_map_entries(void* value, const char* delimiter) { return __apollo_inline_inline_1847_5_5::sys__native_map_entries(value, delimiter); }
extern "C" void* sys__native_tmap_new() { return __apollo_inline_inline_1847_5_5::sys__native_tmap_new(); }
extern "C" int sys__native_tmap_len(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_tmap_len(value); }
extern "C" void sys__native_tmap_insert(void* value, const char* key, const char* item) { __apollo_inline_inline_1847_5_5::sys__native_tmap_insert(value, key, item); }
extern "C" const char* sys__native_tmap_get(void* value, const char* key) { return __apollo_inline_inline_1847_5_5::sys__native_tmap_get(value, key); }
extern "C" int sys__native_tmap_contains_key(void* value, const char* key) { return __apollo_inline_inline_1847_5_5::sys__native_tmap_contains_key(value, key); }
extern "C" const char* sys__native_tmap_remove(void* value, const char* key) { return __apollo_inline_inline_1847_5_5::sys__native_tmap_remove(value, key); }
extern "C" const char* sys__native_tmap_first_key(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_tmap_first_key(value); }
extern "C" const char* sys__native_tmap_last_key(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_tmap_last_key(value); }
extern "C" const char* sys__native_tmap_floor_key(void* value, const char* key) { return __apollo_inline_inline_1847_5_5::sys__native_tmap_floor_key(value, key); }
extern "C" const char* sys__native_tmap_ceiling_key(void* value, const char* key) { return __apollo_inline_inline_1847_5_5::sys__native_tmap_ceiling_key(value, key); }
extern "C" void* sys__native_tmap_pop_first(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_tmap_pop_first(value); }
extern "C" void* sys__native_tmap_pop_last(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_tmap_pop_last(value); }
extern "C" void* sys__native_tmap_iter(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_tmap_iter(value); }
extern "C" void* sys__native_tmap_range_iter(void* value, const char* start_key, const char* end_key) { return __apollo_inline_inline_1847_5_5::sys__native_tmap_range_iter(value, start_key, end_key); }
extern "C" const char* sys__native_entry_key(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_entry_key(value); }
extern "C" const char* sys__native_entry_value(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_entry_value(value); }
extern "C" int sys__native_entry_iter_has_next(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_entry_iter_has_next(value); }
extern "C" void* sys__native_entry_iter_next(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_entry_iter_next(value); }
extern "C" void* sys__native_set_new() { return __apollo_inline_inline_1847_5_5::sys__native_set_new(); }
extern "C" int sys__native_set_insert(void* value, const char* item) { return __apollo_inline_inline_1847_5_5::sys__native_set_insert(value, item); }
extern "C" int sys__native_set_remove(void* value, const char* item) { return __apollo_inline_inline_1847_5_5::sys__native_set_remove(value, item); }
extern "C" int sys__native_set_contains(void* value, const char* item) { return __apollo_inline_inline_1847_5_5::sys__native_set_contains(value, item); }
extern "C" int sys__native_set_len(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_set_len(value); }
extern "C" void sys__native_set_clear(void* value) { __apollo_inline_inline_1847_5_5::sys__native_set_clear(value); }
extern "C" const char* sys__native_set_values(void* value, const char* delimiter) { return __apollo_inline_inline_1847_5_5::sys__native_set_values(value, delimiter); }
extern "C" void* sys__native_set_union(void* left, void* right) { return __apollo_inline_inline_1847_5_5::sys__native_set_union(left, right); }
extern "C" void* sys__native_set_intersection(void* left, void* right) { return __apollo_inline_inline_1847_5_5::sys__native_set_intersection(left, right); }
extern "C" void* sys__native_set_difference(void* left, void* right) { return __apollo_inline_inline_1847_5_5::sys__native_set_difference(left, right); }
extern "C" void* sys__native_set_symmetric_difference(void* left, void* right) { return __apollo_inline_inline_1847_5_5::sys__native_set_symmetric_difference(left, right); }
extern "C" int sys__native_set_is_subset(void* left, void* right) { return __apollo_inline_inline_1847_5_5::sys__native_set_is_subset(left, right); }
extern "C" int sys__native_set_is_superset(void* left, void* right) { return __apollo_inline_inline_1847_5_5::sys__native_set_is_superset(left, right); }
extern "C" void* sys__native_queue_new() { return __apollo_inline_inline_1847_5_5::sys__native_queue_new(); }
extern "C" void sys__native_queue_enqueue(void* value, const char* item) { __apollo_inline_inline_1847_5_5::sys__native_queue_enqueue(value, item); }
extern "C" const char* sys__native_queue_dequeue(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_queue_dequeue(value); }
extern "C" int sys__native_queue_len(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_queue_len(value); }
extern "C" void* sys__native_deque_new() { return __apollo_inline_inline_1847_5_5::sys__native_deque_new(); }
extern "C" void sys__native_deque_push_front(void* value, const char* item) { __apollo_inline_inline_1847_5_5::sys__native_deque_push_front(value, item); }
extern "C" void sys__native_deque_push_back(void* value, const char* item) { __apollo_inline_inline_1847_5_5::sys__native_deque_push_back(value, item); }
extern "C" const char* sys__native_deque_pop_front(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_deque_pop_front(value); }
extern "C" const char* sys__native_deque_pop_back(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_deque_pop_back(value); }
extern "C" int sys__native_deque_len(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_deque_len(value); }
extern "C" void* sys__native_heap_new_max() { return __apollo_inline_inline_1847_5_5::sys__native_heap_new_max(); }
extern "C" void* sys__native_heap_new_min() { return __apollo_inline_inline_1847_5_5::sys__native_heap_new_min(); }
extern "C" void sys__native_heap_push(void* value, int item) { __apollo_inline_inline_1847_5_5::sys__native_heap_push(value, item); }
extern "C" int sys__native_heap_pop(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_heap_pop(value); }
extern "C" int sys__native_heap_peek(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_heap_peek(value); }
extern "C" int sys__native_heap_len(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_heap_len(value); }
extern "C" void* sys__native_list_new() { return __apollo_inline_inline_1847_5_5::sys__native_list_new(); }
extern "C" void sys__native_list_push_front(void* value, const char* item) { __apollo_inline_inline_1847_5_5::sys__native_list_push_front(value, item); }
extern "C" void sys__native_list_push_back(void* value, const char* item) { __apollo_inline_inline_1847_5_5::sys__native_list_push_back(value, item); }
extern "C" const char* sys__native_list_pop_front(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_list_pop_front(value); }
extern "C" const char* sys__native_list_pop_back(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_list_pop_back(value); }
extern "C" const char* sys__native_list_front(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_list_front(value); }
extern "C" const char* sys__native_list_back(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_list_back(value); }
extern "C" int sys__native_list_len(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_list_len(value); }
extern "C" void sys__native_list_clear(void* value) { __apollo_inline_inline_1847_5_5::sys__native_list_clear(value); }
extern "C" const char* sys__native_list_values(void* value, const char* delimiter) { return __apollo_inline_inline_1847_5_5::sys__native_list_values(value, delimiter); }
extern "C" void* sys__native_ring_buffer_new(int capacity) { return __apollo_inline_inline_1847_5_5::sys__native_ring_buffer_new(capacity); }
extern "C" void sys__native_ring_buffer_push_back(void* value, const char* item) { __apollo_inline_inline_1847_5_5::sys__native_ring_buffer_push_back(value, item); }
extern "C" void sys__native_ring_buffer_push_front(void* value, const char* item) { __apollo_inline_inline_1847_5_5::sys__native_ring_buffer_push_front(value, item); }
extern "C" const char* sys__native_ring_buffer_pop_front(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_ring_buffer_pop_front(value); }
extern "C" const char* sys__native_ring_buffer_pop_back(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_ring_buffer_pop_back(value); }
extern "C" const char* sys__native_ring_buffer_front(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_ring_buffer_front(value); }
extern "C" const char* sys__native_ring_buffer_back(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_ring_buffer_back(value); }
extern "C" int sys__native_ring_buffer_len(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_ring_buffer_len(value); }
extern "C" int sys__native_ring_buffer_capacity(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_ring_buffer_capacity(value); }
extern "C" void sys__native_ring_buffer_clear(void* value) { __apollo_inline_inline_1847_5_5::sys__native_ring_buffer_clear(value); }
extern "C" const char* sys__native_ring_buffer_values(void* value, const char* delimiter) { return __apollo_inline_inline_1847_5_5::sys__native_ring_buffer_values(value, delimiter); }
extern "C" void* sys__native_bitvec_new() { return __apollo_inline_inline_1847_5_5::sys__native_bitvec_new(); }
extern "C" void sys__native_bitvec_push(void* value, int bit) { __apollo_inline_inline_1847_5_5::sys__native_bitvec_push(value, bit); }
extern "C" int sys__native_bitvec_get(void* value, int index) { return __apollo_inline_inline_1847_5_5::sys__native_bitvec_get(value, index); }
extern "C" void sys__native_bitvec_set(void* value, int index, int bit) { __apollo_inline_inline_1847_5_5::sys__native_bitvec_set(value, index, bit); }
extern "C" int sys__native_bitvec_len(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_bitvec_len(value); }
extern "C" int sys__native_bitvec_count_ones(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_bitvec_count_ones(value); }
extern "C" void sys__native_bitvec_clear(void* value) { __apollo_inline_inline_1847_5_5::sys__native_bitvec_clear(value); }
extern "C" const char* sys__native_bitvec_text(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_bitvec_text(value); }
extern "C" void* sys__native_multimap_new() { return __apollo_inline_inline_1847_5_5::sys__native_multimap_new(); }
extern "C" void sys__native_multimap_insert(void* value, const char* key, const char* item) { __apollo_inline_inline_1847_5_5::sys__native_multimap_insert(value, key, item); }
extern "C" void* sys__native_multimap_get_all(void* value, const char* key) { return __apollo_inline_inline_1847_5_5::sys__native_multimap_get_all(value, key); }
extern "C" int sys__native_multimap_remove_all(void* value, const char* key) { return __apollo_inline_inline_1847_5_5::sys__native_multimap_remove_all(value, key); }
extern "C" int sys__native_multimap_contains_key(void* value, const char* key) { return __apollo_inline_inline_1847_5_5::sys__native_multimap_contains_key(value, key); }
extern "C" int sys__native_multimap_len(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_multimap_len(value); }
extern "C" void sys__native_multimap_clear(void* value) { __apollo_inline_inline_1847_5_5::sys__native_multimap_clear(value); }
extern "C" const char* sys__native_multimap_entries(void* value, const char* delimiter) { return __apollo_inline_inline_1847_5_5::sys__native_multimap_entries(value, delimiter); }
extern "C" void* sys__native_weak_map_new() { return __apollo_inline_inline_1847_5_5::sys__native_weak_map_new(); }
extern "C" void sys__native_weak_map_insert(void* value, const char* key, const char* item) { __apollo_inline_inline_1847_5_5::sys__native_weak_map_insert(value, key, item); }
extern "C" const char* sys__native_weak_map_get(void* value, const char* key) { return __apollo_inline_inline_1847_5_5::sys__native_weak_map_get(value, key); }
extern "C" const char* sys__native_weak_map_remove(void* value, const char* key) { return __apollo_inline_inline_1847_5_5::sys__native_weak_map_remove(value, key); }
extern "C" int sys__native_weak_map_contains_key(void* value, const char* key) { return __apollo_inline_inline_1847_5_5::sys__native_weak_map_contains_key(value, key); }
extern "C" int sys__native_weak_map_len(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_weak_map_len(value); }
extern "C" void sys__native_weak_map_clear(void* value) { __apollo_inline_inline_1847_5_5::sys__native_weak_map_clear(value); }
extern "C" void* sys__native_lru_cache_new(int capacity) { return __apollo_inline_inline_1847_5_5::sys__native_lru_cache_new(capacity); }
extern "C" void sys__native_lru_cache_put(void* value, const char* key, const char* item) { __apollo_inline_inline_1847_5_5::sys__native_lru_cache_put(value, key, item); }
extern "C" const char* sys__native_lru_cache_get(void* value, const char* key) { return __apollo_inline_inline_1847_5_5::sys__native_lru_cache_get(value, key); }
extern "C" int sys__native_lru_cache_contains_key(void* value, const char* key) { return __apollo_inline_inline_1847_5_5::sys__native_lru_cache_contains_key(value, key); }
extern "C" int sys__native_lru_cache_len(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_lru_cache_len(value); }
extern "C" void sys__native_lru_cache_clear(void* value) { __apollo_inline_inline_1847_5_5::sys__native_lru_cache_clear(value); }
extern "C" const char* sys__native_lru_cache_keys(void* value, const char* delimiter) { return __apollo_inline_inline_1847_5_5::sys__native_lru_cache_keys(value, delimiter); }
extern "C" void* sys__native_enum_set_new() { return __apollo_inline_inline_1847_5_5::sys__native_enum_set_new(); }
extern "C" int sys__native_enum_set_insert(void* value, const char* item) { return __apollo_inline_inline_1847_5_5::sys__native_enum_set_insert(value, item); }
extern "C" int sys__native_enum_set_remove(void* value, const char* item) { return __apollo_inline_inline_1847_5_5::sys__native_enum_set_remove(value, item); }
extern "C" int sys__native_enum_set_contains(void* value, const char* item) { return __apollo_inline_inline_1847_5_5::sys__native_enum_set_contains(value, item); }
extern "C" int sys__native_enum_set_len(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_enum_set_len(value); }
extern "C" void sys__native_enum_set_clear(void* value) { __apollo_inline_inline_1847_5_5::sys__native_enum_set_clear(value); }
extern "C" const char* sys__native_enum_set_values(void* value, const char* delimiter) { return __apollo_inline_inline_1847_5_5::sys__native_enum_set_values(value, delimiter); }
extern "C" void* sys__native_grid2d_new(int rows, int cols, const char* fill_value) { return __apollo_inline_inline_1847_5_5::sys__native_grid2d_new(rows, cols, fill_value); }
extern "C" int sys__native_grid2d_rows(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_grid2d_rows(value); }
extern "C" int sys__native_grid2d_cols(void* value) { return __apollo_inline_inline_1847_5_5::sys__native_grid2d_cols(value); }
extern "C" const char* sys__native_grid2d_get(void* value, int row, int col) { return __apollo_inline_inline_1847_5_5::sys__native_grid2d_get(value, row, col); }
extern "C" void sys__native_grid2d_set(void* value, int row, int col, const char* item) { __apollo_inline_inline_1847_5_5::sys__native_grid2d_set(value, row, col, item); }
extern "C" void sys__native_grid2d_fill(void* value, const char* item) { __apollo_inline_inline_1847_5_5::sys__native_grid2d_fill(value, item); }
extern "C" const char* sys__native_grid2d_row_text(void* value, int row, const char* delimiter) { return __apollo_inline_inline_1847_5_5::sys__native_grid2d_row_text(value, row, delimiter); }
