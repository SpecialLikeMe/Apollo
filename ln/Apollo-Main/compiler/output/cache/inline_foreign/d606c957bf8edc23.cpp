...
namespace __apollo_inline_inline_327_5_1 {
...
extern "C" int sys__native_str_len(const char* value) { return __apollo_inline_inline_327_5_1::sys__native_str_len(value); }
extern "C" const char* sys__native_str_concat(const char* left, const char* right) { return __apollo_inline_inline_327_5_1::sys__native_str_concat(left, right); }
extern "C" const char* sys__native_str_trim(const char* value) { return __apollo_inline_inline_327_5_1::sys__native_str_trim(value); }
extern "C" const char* sys__native_str_trim_start(const char* value) { return __apollo_inline_inline_327_5_1::sys__native_str_trim_start(value); }
extern "C" const char* sys__native_str_trim_end(const char* value) { return __apollo_inline_inline_327_5_1::sys__native_str_trim_end(value); }
extern "C" const char* sys__native_str_lowercase(const char* value) { return __apollo_inline_inline_327_5_1::sys__native_str_lowercase(value); }
extern "C" const char* sys__native_str_uppercase(const char* value) { return __apollo_inline_inline_327_5_1::sys__native_str_uppercase(value); }
extern "C" const char* sys__native_str_titlecase(const char* value) { return __apollo_inline_inline_327_5_1::sys__native_str_titlecase(value); }
extern "C" int sys__native_str_contains(const char* value, const char* sub) { return __apollo_inline_inline_327_5_1::sys__native_str_contains(value, sub); }
extern "C" int sys__native_str_starts_with(const char* value, const char* prefix) { return __apollo_inline_inline_327_5_1::sys__native_str_starts_with(value, prefix); }
extern "C" int sys__native_str_ends_with(const char* value, const char* suffix) { return __apollo_inline_inline_327_5_1::sys__native_str_ends_with(value, suffix); }
extern "C" int sys__native_str_find(const char* value, const char* sub) { return __apollo_inline_inline_327_5_1::sys__native_str_find(value, sub); }
extern "C" int sys__native_str_rfind(const char* value, const char* sub) { return __apollo_inline_inline_327_5_1::sys__native_str_rfind(value, sub); }
extern "C" const char* sys__native_str_replace(const char* value, const char* old_text, const char* new_text) { return __apollo_inline_inline_327_5_1::sys__native_str_replace(value, old_text, new_text); }
extern "C" const char* sys__native_str_replace_n(const char* value, const char* old_text, const char* new_text, int count) { return __apollo_inline_inline_327_5_1::sys__native_str_replace_n(value, old_text, new_text, count); }
extern "C" const char* sys__native_str_reverse(const char* value) { return __apollo_inline_inline_327_5_1::sys__native_str_reverse(value); }
extern "C" const char* sys__native_str_repeat(const char* value, int count) { return __apollo_inline_inline_327_5_1::sys__native_str_repeat(value, count); }
extern "C" const char* sys__native_str_pad_left(const char* value, int target_len, const char* fill) { return __apollo_inline_inline_327_5_1::sys__native_str_pad_left(value, target_len, fill); }
extern "C" const char* sys__native_str_pad_right(const char* value, int target_len, const char* fill) { return __apollo_inline_inline_327_5_1::sys__native_str_pad_right(value, target_len, fill); }
extern "C" const char* sys__native_str_substring(const char* value, int start, int len) { return __apollo_inline_inline_327_5_1::sys__native_str_substring(value, start, len); }
extern "C" int sys__native_str_cmp(const char* left, const char* right) { return __apollo_inline_inline_327_5_1::sys__native_str_cmp(left, right); }
extern "C" int sys__native_str_casecmp(const char* left, const char* right) { return __apollo_inline_inline_327_5_1::sys__native_str_casecmp(left, right); }
extern "C" void* sys__native_str_split(const char* value, const char* delimiter) { return __apollo_inline_inline_327_5_1::sys__native_str_split(value, delimiter); }
extern "C" void* sys__native_str_split_n(const char* value, const char* delimiter, int max_parts) { return __apollo_inline_inline_327_5_1::sys__native_str_split_n(value, delimiter, max_parts); }
extern "C" void* sys__native_str_split_lines(const char* value) { return __apollo_inline_inline_327_5_1::sys__native_str_split_lines(value); }
extern "C" long sys__native_parse_int(const char* value, int base) { return __apollo_inline_inline_327_5_1::sys__native_parse_int(value, base); }
extern "C" int sys__native_parse_bool(const char* value) { return __apollo_inline_inline_327_5_1::sys__native_parse_bool(value); }
extern "C" double sys__native_parse_float(const char* value) { return __apollo_inline_inline_327_5_1::sys__native_parse_float(value); }
extern "C" int sys__native_is_alpha(const char* value) { return __apollo_inline_inline_327_5_1::sys__native_is_alpha(value); }
extern "C" int sys__native_is_digit(const char* value) { return __apollo_inline_inline_327_5_1::sys__native_is_digit(value); }
extern "C" int sys__native_is_alnum(const char* value) { return __apollo_inline_inline_327_5_1::sys__native_is_alnum(value); }
extern "C" int sys__native_is_whitespace(const char* value) { return __apollo_inline_inline_327_5_1::sys__native_is_whitespace(value); }
extern "C" int sys__native_is_control(const char* value) { return __apollo_inline_inline_327_5_1::sys__native_is_control(value); }
extern "C" int sys__native_is_punctuation(const char* value) { return __apollo_inline_inline_327_5_1::sys__native_is_punctuation(value); }
extern "C" int sys__native_is_graph(const char* value) { return __apollo_inline_inline_327_5_1::sys__native_is_graph(value); }
extern "C" int sys__native_is_print(const char* value) { return __apollo_inline_inline_327_5_1::sys__native_is_print(value); }
extern "C" int sys__native_is_hex_digit(const char* value) { return __apollo_inline_inline_327_5_1::sys__native_is_hex_digit(value); }
extern "C" int sys__native_is_ascii(const char* value) { return __apollo_inline_inline_327_5_1::sys__native_is_ascii(value); }
