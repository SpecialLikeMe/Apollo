...
# RUN: llvm-objdump --no-print-imm-hex -d --no-show-raw-insn %t2.exe | FileCheck --check-prefix=ORPH1 %s
...
# RUN: llvm-objdump --no-print-imm-hex -d --no-show-raw-insn %t3.exe | FileCheck --check-prefix=ORPH2 %s
