...
///
/// \file
/// This file contains the conformance test of the tanhf function.
///
//===----------------------------------------------------------------------===//
...
template <> struct FunctionConfig<tanhf> {
  static constexpr llvm::StringRef Name = "tanhf";
  static constexpr llvm::StringRef KernelName = "tanhfKernel";
...
int main(int argc, const char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv,
                                    "Conformance test of the tanhf function");
  ...
  bool Passed = runTests<tanhf>(Generator, Configs, DeviceBinaryDir, IsVerbose);
