...
// NOT-GFX942: :[[@LINE+2]]:{{[0-9]+}}: error: invalid operand for instruction
// GFX942: global_load_dword v2, v[2:3], off       ; encoding: [0x00,0x80,0x50,0xdc,0x02,0x00,0x7f,0x02]
...
// NOT-GFX942: :[[@LINE+2]]:{{[0-9]+}}: error: instruction not supported on this GPU
...
// NOT-GFX942: :[[@LINE+2]]:{{[0-9]+}}: error: invalid hardware register: not supported on this GPU
...
// GFX942: s_getreg_b32 s1, hwreg(HW_REG_TMA_HI)   ; encoding: [0x13,0xf8,0x81,0xb8]
...
// GFX942: s_getreg_b32 s1, hwreg(25)              ; encoding: [0x19,0xf8,0x81,0xb8]
