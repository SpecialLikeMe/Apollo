...
// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx90a %s -filetype=null 2>&1 | FileCheck --check-prefixes=GFX90A --implicit-check-not=error: %s

global_load_dwordx2 a[1:2], v[0:1], off
// GFX90A: :[[@LINE-1]]:21: error: invalid operand for instruction
...
// GFX90A: :[[@LINE-1]]:1: error: operands are not valid for this GPU or mode
...
// GFX90A: :[[@LINE-1]]:22: error: invalid operand for instruction
...
// GFX90A: :[[@LINE-1]]:19: error: invalid operand for instruction

image_load a[1:2], v2, s[0:7] dmask:0x3 unorm
// GFX90A: :[[@LINE-1]]:12: error: invalid operand for instruction
...
// GFX90A: :[[@LINE-1]]:13: error: invalid operand for instruction
...
// GFX90A: :[[@LINE-1]]:32: error: invalid operand for instruction
