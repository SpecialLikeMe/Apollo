...
; RUN: opt < %s -passes="print<cost-model>" 2>&1 -disable-output -mcpu=tremont | FileCheck %s --check-prefixes=CHECK,GLM
...
; CHECK-NEXT:  Cost Model: Found an estimated cost of 3 for instruction: %res = mul nsw i8 %a, %b
