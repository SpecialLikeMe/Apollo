...
; bf16
define <vscale x 1 x bfloat> @test_vpairo_bf16mf4(<vscale x 1 x bfloat> %passthru, <vscale x 1 x bfloat> %a1, <vscale x 1 x bfloat> %a2, iXLen %vl) nounwind {
; CHECK-LABEL: test_vpairo_bf16mf4:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, mf4, tu, ma
; CHECK-NEXT:    vpairo.vv v8, v9, v10
; CHECK-NEXT:    ret
  %r = call <vscale x 1 x bfloat> @llvm.riscv.vpairo(
...
define <vscale x 1 x bfloat> @test_vpairo_mask_bf16mf4(<vscale x 1 x bfloat> %passthru, <vscale x 1 x bfloat> %a1, <vscale x 1 x bfloat> %a2, <vscale x 1 x i1> %m, iXLen %vl) nounwind {
; CHECK-LABEL: test_vpairo_mask_bf16mf4:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, mf4, ta, mu
; CHECK-NEXT:    vpairo.vv v8, v9, v10, v0.t
; CHECK-NEXT:    ret
  %r = call <vscale x 1 x bfloat> @llvm.riscv.vpairo.mask(
    <vscale x 1 x bfloat> %passthru,
    <vscale x 1 x bfloat> %a1,
    <vscale x 1 x bfloat> %a2,
    <vscale x 1 x i1> %m,
...
define <vscale x 2 x bfloat> @test_vpairo_bf16mf2(<vscale x 2 x bfloat> %passthru, <vscale x 2 x bfloat> %a1, <vscale x 2 x bfloat> %a2, iXLen %vl) nounwind {
; CHECK-LABEL: test_vpairo_bf16mf2:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, mf2, tu, ma
; CHECK-NEXT:    vpairo.vv v8, v9, v10
; CHECK-NEXT:    ret
  %r = call <vscale x 2 x bfloat> @llvm.riscv.vpairo(
...
define <vscale x 2 x bfloat> @test_vpairo_mask_bf16mf2(<vscale x 2 x bfloat> %passthru, <vscale x 2 x bfloat> %a1, <vscale x 2 x bfloat> %a2, <vscale x 2 x i1> %m, iXLen %vl) nounwind {
; CHECK-LABEL: test_vpairo_mask_bf16mf2:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, mf2, ta, mu
; CHECK-NEXT:    vpairo.vv v8, v9, v10, v0.t
; CHECK-NEXT:    ret
  %r = call <vscale x 2 x bfloat> @llvm.riscv.vpairo.mask(
    <vscale x 2 x bfloat> %passthru,
    <vscale x 2 x bfloat> %a1,
    <vscale x 2 x bfloat> %a2,
    <vscale x 2 x i1> %m,
...
define <vscale x 4 x bfloat> @test_vpairo_bf16m1(<vscale x 4 x bfloat> %passthru, <vscale x 4 x bfloat> %a1, <vscale x 4 x bfloat> %a2, iXLen %vl) nounwind {
; CHECK-LABEL: test_vpairo_bf16m1:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, m1, tu, ma
; CHECK-NEXT:    vpairo.vv v8, v9, v10
; CHECK-NEXT:    ret
  %r = call <vscale x 4 x bfloat> @llvm.riscv.vpairo(
...
define <vscale x 4 x bfloat> @test_vpairo_mask_bf16m1(<vscale x 4 x bfloat> %passthru, <vscale x 4 x bfloat> %a1, <vscale x 4 x bfloat> %a2, <vscale x 4 x i1> %m, iXLen %vl) nounwind {
; CHECK-LABEL: test_vpairo_mask_bf16m1:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, m1, ta, mu
; CHECK-NEXT:    vpairo.vv v8, v9, v10, v0.t
; CHECK-NEXT:    ret
  %r = call <vscale x 4 x bfloat> @llvm.riscv.vpairo.mask(
    <vscale x 4 x bfloat> %passthru,
    <vscale x 4 x bfloat> %a1,
    <vscale x 4 x bfloat> %a2,
    <vscale x 4 x i1> %m,
...
define <vscale x 8 x bfloat> @test_vpairo_bf16m2(<vscale x 8 x bfloat> %passthru, <vscale x 8 x bfloat> %a1, <vscale x 8 x bfloat> %a2, iXLen %vl) nounwind {
; CHECK-LABEL: test_vpairo_bf16m2:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, m2, tu, ma
; CHECK-NEXT:    vpairo.vv v8, v10, v12
; CHECK-NEXT:    ret
  %r = call <vscale x 8 x bfloat> @llvm.riscv.vpairo(
...
define <vscale x 8 x bfloat> @test_vpairo_mask_bf16m2(<vscale x 8 x bfloat> %passthru, <vscale x 8 x bfloat> %a1, <vscale x 8 x bfloat> %a2, <vscale x 8 x i1> %m, iXLen %vl) nounwind {
; CHECK-LABEL: test_vpairo_mask_bf16m2:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, m2, ta, mu
; CHECK-NEXT:    vpairo.vv v8, v10, v12, v0.t
; CHECK-NEXT:    ret
  %r = call <vscale x 8 x bfloat> @llvm.riscv.vpairo.mask(
    <vscale x 8 x bfloat> %passthru,
    <vscale x 8 x bfloat> %a1,
    <vscale x 8 x bfloat> %a2,
    <vscale x 8 x i1> %m,
...
define <vscale x 16 x bfloat> @test_vpairo_bf16m4(<vscale x 16 x bfloat> %passthru, <vscale x 16 x bfloat> %a1, <vscale x 16 x bfloat> %a2, iXLen %vl) nounwind {
; CHECK-LABEL: test_vpairo_bf16m4:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, m4, tu, ma
; CHECK-NEXT:    vpairo.vv v8, v12, v16
; CHECK-NEXT:    ret
  %r = call <vscale x 16 x bfloat> @llvm.riscv.vpairo(
...
define <vscale x 16 x bfloat> @test_vpairo_mask_bf16m4(<vscale x 16 x bfloat> %passthru, <vscale x 16 x bfloat> %a1, <vscale x 16 x bfloat> %a2, <vscale x 16 x i1> %m, iXLen %vl) nounwind {
; CHECK-LABEL: test_vpairo_mask_bf16m4:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli zero, a0, e16, m4, ta, mu
; CHECK-NEXT:    vpairo.vv v8, v12, v16, v0.t
; CHECK-NEXT:    ret
  %r = call <vscale x 16 x bfloat> @llvm.riscv.vpairo.mask(
    <vscale x 16 x bfloat> %passthru,
    <vscale x 16 x bfloat> %a1,
    <vscale x 16 x bfloat> %a2,
    <vscale x 16 x i1> %m,
...
define <vscale x 32 x bfloat> @test_vpairo_bf16m8(<vscale x 32 x bfloat> %passthru, <vscale x 32 x bfloat> %a1, <vscale x 32 x bfloat> %a2, iXLen %vl) nounwind {
; CHECK-LABEL: test_vpairo_bf16m8:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vl8re16.v v24, (a0)
; CHECK-NEXT:    vsetvli zero, a1, e16, m8, tu, ma
; CHECK-NEXT:    vpairo.vv v8, v16, v24
; CHECK-NEXT:    ret
  %r = call <vscale x 32 x bfloat> @llvm.riscv.vpairo(
...
define <vscale x 32 x bfloat> @test_vpairo_mask_bf16m8(<vscale x 32 x bfloat> %passthru, <vscale x 32 x bfloat> %a1, <vscale x 32 x bfloat> %a2, <vscale x 32 x i1> %m, iXLen %vl) nounwind {
; CHECK-LABEL: test_vpairo_mask_bf16m8:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vl8re16.v v24, (a0)
; CHECK-NEXT:    vsetvli zero, a1, e16, m8, ta, mu
; CHECK-NEXT:    vpairo.vv v8, v16, v24, v0.t
; CHECK-NEXT:    ret
  %r = call <vscale x 32 x bfloat> @llvm.riscv.vpairo.mask(
    <vscale x 32 x bfloat> %passthru,
    <vscale x 32 x bfloat> %a1,
    <vscale x 32 x bfloat> %a2,
    <vscale x 32 x i1> %m,
