...
; RUN:     --check-prefixes=CHECK,ZVFBFMIN,ZVFH,RV32
; RUN: llc -mtriple=riscv64 -mattr=+m,+d,+zfh,+zvfh,+zfbfmin,+zvfbfmin,+v \
; RUN:     -target-abi=lp64d -verify-machineinstrs < %s | FileCheck %s \
; RUN:     --check-prefixes=CHECK,ZVFBFMIN,ZVFH,RV64
; RUN: llc -mtriple=riscv32 -mattr=+m,+d,+zfh,+zvfhmin,+zfbfmin,+zvfbfmin,+v \
; RUN:     -target-abi=ilp32d -verify-machineinstrs < %s | FileCheck %s \
; RUN:     --check-prefixes=CHECK,ZVFBFMIN,ZVFHMIN,ZVFHMIN32
...
; ZVFBFMIN-LABEL: fcmp_oeq_vv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
...
; ZVFBFMIN-NEXT:    vmfeq.vv v0, v16, v12
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_oeq_vv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfeq.vv v0, v8, v10
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_oeq_vf_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmfeq.vf v0, v12, fa5
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_oeq_vf_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfeq.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_oeq_fv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_oeq_fv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfeq.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_oeq_vv_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfeq.vv v0, v8, v10
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_oeq_vf_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfeq.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_ogt_vv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v16, v10
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmflt.vv v0, v16, v12
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ogt_vv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmflt.vv v0, v10, v8
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_ogt_vf_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmfgt.vf v0, v12, fa5
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ogt_vf_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfgt.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
  %head = insertelement <vscale x 8 x bfloat> poison, bfloat %b, i32 0
  %splat = shufflevector <vscale x 8 x bfloat> %head, <vscale x 8 x bfloat> poison, <vscale x 8 x i32> zeroinitializer
...
; ZVFBFMIN-LABEL: fcmp_ogt_fv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmflt.vf v0, v12, fa5
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ogt_fv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmflt.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
  %head = insertelement <vscale x 8 x bfloat> poison, bfloat %b, i32 0
  %splat = shufflevector <vscale x 8 x bfloat> %head, <vscale x 8 x bfloat> poison, <vscale x 8 x i32> zeroinitializer
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ogt_vv_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmflt.vv v0, v10, v8
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ogt_vf_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfgt.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_oge_vv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v16, v10
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmfle.vv v0, v16, v12
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_oge_vv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfle.vv v0, v10, v8
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_oge_vf_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmfge.vf v0, v12, fa5
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_oge_vf_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfge.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
  %head = insertelement <vscale x 8 x bfloat> poison, bfloat %b, i32 0
  %splat = shufflevector <vscale x 8 x bfloat> %head, <vscale x 8 x bfloat> poison, <vscale x 8 x i32> zeroinitializer
...
; ZVFBFMIN-LABEL: fcmp_oge_fv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmfle.vf v0, v12, fa5
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_oge_fv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfle.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
  %head = insertelement <vscale x 8 x bfloat> poison, bfloat %b, i32 0
  %splat = shufflevector <vscale x 8 x bfloat> %head, <vscale x 8 x bfloat> poison, <vscale x 8 x i32> zeroinitializer
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_oge_vv_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfle.vv v0, v10, v8
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_oge_vf_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfge.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_olt_vv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v10
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v16, v8
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_olt_vv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmflt.vv v0, v8, v10
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_olt_vf_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_olt_vf_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmflt.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_olt_fv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_olt_fv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfgt.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_olt_vv_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmflt.vv v0, v8, v10
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_olt_vf_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmflt.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_ole_vv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v10
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v16, v8
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ole_vv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfle.vv v0, v8, v10
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_ole_vf_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ole_vf_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfle.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_ole_fv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ole_fv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfge.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ole_vv_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfle.vv v0, v8, v10
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ole_vf_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfle.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_one_vv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v10
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v16, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmflt.vv v8, v16, v12
; ZVFBFMIN-NEXT:    vmflt.vv v9, v12, v16
; ZVFBFMIN-NEXT:    vmor.mm v0, v9, v8
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_one_vv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmflt.vv v12, v8, v10
; ZVFBFA-NEXT:    vmflt.vv v13, v10, v8
; ZVFBFA-NEXT:    vmor.mm v0, v13, v12
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_one_vf_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmflt.vf v8, v12, fa5
; ZVFBFMIN-NEXT:    vmfgt.vf v9, v12, fa5
; ZVFBFMIN-NEXT:    vmor.mm v0, v9, v8
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_one_vf_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmflt.vf v10, v8, fa0
; ZVFBFA-NEXT:    vmfgt.vf v11, v8, fa0
; ZVFBFA-NEXT:    vmor.mm v0, v11, v10
; ZVFBFA-NEXT:    ret
  %head = insertelement <vscale x 8 x bfloat> poison, bfloat %b, i32 0
  %splat = shufflevector <vscale x 8 x bfloat> %head, <vscale x 8 x bfloat> poison, <vscale x 8 x i32> zeroinitializer
...
; ZVFBFMIN-LABEL: fcmp_one_fv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmfgt.vf v8, v12, fa5
; ZVFBFMIN-NEXT:    vmflt.vf v9, v12, fa5
; ZVFBFMIN-NEXT:    vmor.mm v0, v9, v8
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_one_fv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfgt.vf v10, v8, fa0
; ZVFBFA-NEXT:    vmflt.vf v11, v8, fa0
; ZVFBFA-NEXT:    vmor.mm v0, v11, v10
; ZVFBFA-NEXT:    ret
  %head = insertelement <vscale x 8 x bfloat> poison, bfloat %b, i32 0
  %splat = shufflevector <vscale x 8 x bfloat> %head, <vscale x 8 x bfloat> poison, <vscale x 8 x i32> zeroinitializer
...
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v16, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmfne.vv v0, v16, v12
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_one_vv_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfne.vv v0, v8, v10
; ZVFBFA-NEXT:    ret
  %vc = fcmp one <vscale x 8 x bfloat> %va, %vb
  ret <vscale x 8 x i1> %vc
}
...
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmfne.vf v0, v12, fa5
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_one_vf_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfne.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
  %head = insertelement <vscale x 8 x bfloat> poison, bfloat %b, i32 0
  %splat = shufflevector <vscale x 8 x bfloat> %head, <vscale x 8 x bfloat> poison, <vscale x 8 x i32> zeroinitializer
  %vc = fcmp one <vscale x 8 x bfloat> %va, %splat
...
; ZVFBFMIN-LABEL: fcmp_ord_vv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v10
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmfeq.vv v10, v12, v12
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmfeq.vv v8, v12, v12
; ZVFBFMIN-NEXT:    vmand.mm v0, v8, v10
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ord_vv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfeq.vv v12, v10, v10
; ZVFBFA-NEXT:    vmfeq.vv v10, v8, v8
; ZVFBFA-NEXT:    vmand.mm v0, v10, v12
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_ord_vf_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vfmv.v.f v12, fa5
; ZVFBFMIN-NEXT:    vmfeq.vf v10, v12, fa5
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmfeq.vv v8, v12, v12
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ord_vf_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vfmv.v.f v10, fa0
; ZVFBFA-NEXT:    vmfeq.vf v12, v10, fa0
; ZVFBFA-NEXT:    vmfeq.vv v10, v8, v8
; ZVFBFA-NEXT:    vmand.mm v0, v10, v12
; ZVFBFA-NEXT:    ret
  %head = insertelement <vscale x 8 x bfloat> poison, bfloat %b, i32 0
...
; ZVFBFMIN-LABEL: fcmp_ord_fv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vfmv.v.f v12, fa5
...
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmfeq.vv v8, v12, v12
; ZVFBFMIN-NEXT:    vmand.mm v0, v10, v8
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ord_fv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vfmv.v.f v10, fa0
; ZVFBFA-NEXT:    vmfeq.vf v12, v10, fa0
; ZVFBFA-NEXT:    vmfeq.vv v10, v8, v8
; ZVFBFA-NEXT:    vmand.mm v0, v12, v10
; ZVFBFA-NEXT:    ret
  %head = insertelement <vscale x 8 x bfloat> poison, bfloat %b, i32 0
  %splat = shufflevector <vscale x 8 x bfloat> %head, <vscale x 8 x bfloat> poison, <vscale x 8 x i32> zeroinitializer
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ord_vv_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfeq.vv v12, v10, v10
; ZVFBFA-NEXT:    vmfeq.vv v10, v8, v8
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ord_vf_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vfmv.v.f v10, fa0
; ZVFBFA-NEXT:    vmfeq.vf v12, v10, fa0
...
; ZVFBFMIN-LABEL: fcmp_ueq_vv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v10
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v16, v8
...
; ZVFBFMIN-NEXT:    vmflt.vv v8, v16, v12
; ZVFBFMIN-NEXT:    vmflt.vv v9, v12, v16
; ZVFBFMIN-NEXT:    vmnor.mm v0, v9, v8
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ueq_vv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmflt.vv v12, v8, v10
; ZVFBFA-NEXT:    vmflt.vv v13, v10, v8
; ZVFBFA-NEXT:    vmnor.mm v0, v13, v12
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_ueq_vf_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ueq_vf_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmflt.vf v10, v8, fa0
; ZVFBFA-NEXT:    vmfgt.vf v11, v8, fa0
; ZVFBFA-NEXT:    vmnor.mm v0, v11, v10
; ZVFBFA-NEXT:    ret
  %head = insertelement <vscale x 8 x bfloat> poison, bfloat %b, i32 0
  %splat = shufflevector <vscale x 8 x bfloat> %head, <vscale x 8 x bfloat> poison, <vscale x 8 x i32> zeroinitializer
...
; ZVFBFMIN-LABEL: fcmp_ueq_fv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ueq_fv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfgt.vf v10, v8, fa0
; ZVFBFA-NEXT:    vmflt.vf v11, v8, fa0
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ueq_vv_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfeq.vv v0, v8, v10
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ueq_vf_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfeq.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_ugt_vv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v10
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v16, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmfle.vv v8, v16, v12
; ZVFBFMIN-NEXT:    vmnot.m v0, v8
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ugt_vv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfle.vv v12, v8, v10
; ZVFBFA-NEXT:    vmnot.m v0, v12
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_ugt_vf_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmfle.vf v8, v12, fa5
; ZVFBFMIN-NEXT:    vmnot.m v0, v8
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ugt_vf_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfle.vf v10, v8, fa0
; ZVFBFA-NEXT:    vmnot.m v0, v10
; ZVFBFA-NEXT:    ret
  %head = insertelement <vscale x 8 x bfloat> poison, bfloat %b, i32 0
  %splat = shufflevector <vscale x 8 x bfloat> %head, <vscale x 8 x bfloat> poison, <vscale x 8 x i32> zeroinitializer
...
; ZVFBFMIN-LABEL: fcmp_ugt_fv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmfge.vf v8, v12, fa5
; ZVFBFMIN-NEXT:    vmnot.m v0, v8
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ugt_fv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfge.vf v10, v8, fa0
; ZVFBFA-NEXT:    vmnot.m v0, v10
; ZVFBFA-NEXT:    ret
  %head = insertelement <vscale x 8 x bfloat> poison, bfloat %b, i32 0
  %splat = shufflevector <vscale x 8 x bfloat> %head, <vscale x 8 x bfloat> poison, <vscale x 8 x i32> zeroinitializer
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ugt_vv_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmflt.vv v0, v10, v8
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ugt_vf_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfgt.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_uge_vv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v10
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v16, v8
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_uge_vv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmflt.vv v12, v8, v10
; ZVFBFA-NEXT:    vmnot.m v0, v12
...
; ZVFBFMIN-LABEL: fcmp_uge_vf_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_uge_vf_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmflt.vf v10, v8, fa0
; ZVFBFA-NEXT:    vmnot.m v0, v10
...
; ZVFBFMIN-LABEL: fcmp_uge_fv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_uge_fv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfgt.vf v10, v8, fa0
; ZVFBFA-NEXT:    vmnot.m v0, v10
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_uge_vv_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfle.vv v0, v10, v8
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_uge_vf_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfge.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_ult_vv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v16, v10
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ult_vv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfle.vv v12, v10, v8
; ZVFBFA-NEXT:    vmnot.m v0, v12
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_ult_vf_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ult_vf_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfge.vf v10, v8, fa0
; ZVFBFA-NEXT:    vmnot.m v0, v10
...
; ZVFBFMIN-LABEL: fcmp_ult_fv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ult_fv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfle.vf v10, v8, fa0
; ZVFBFA-NEXT:    vmnot.m v0, v10
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ult_vv_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmflt.vv v0, v8, v10
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ult_vf_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmflt.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_ule_vv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v16, v10
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ule_vv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmflt.vv v12, v10, v8
; ZVFBFA-NEXT:    vmnot.m v0, v12
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_ule_vf_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ule_vf_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfgt.vf v10, v8, fa0
; ZVFBFA-NEXT:    vmnot.m v0, v10
...
; ZVFBFMIN-LABEL: fcmp_ule_fv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ule_fv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmflt.vf v10, v8, fa0
; ZVFBFA-NEXT:    vmnot.m v0, v10
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ule_vv_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfle.vv v0, v8, v10
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_ule_vf_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfle.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_une_vv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v10
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v16, v8
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_une_vv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfne.vv v0, v8, v10
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_une_vf_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_une_vf_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfne.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_une_fv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_une_fv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfne.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_une_vv_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfne.vv v0, v8, v10
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_une_vf_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfne.vf v0, v8, fa0
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_uno_vv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v10
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmfne.vv v10, v12, v12
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmfne.vv v8, v12, v12
; ZVFBFMIN-NEXT:    vmor.mm v0, v8, v10
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_uno_vv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfne.vv v12, v10, v10
; ZVFBFA-NEXT:    vmfne.vv v10, v8, v8
; ZVFBFA-NEXT:    vmor.mm v0, v10, v12
; ZVFBFA-NEXT:    ret
...
; ZVFBFMIN-LABEL: fcmp_uno_vf_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vfmv.v.f v12, fa5
; ZVFBFMIN-NEXT:    vmfne.vf v10, v12, fa5
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfwcvtbf16.f.f.v v12, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmfne.vv v8, v12, v12
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_uno_vf_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vfmv.v.f v10, fa0
; ZVFBFA-NEXT:    vmfne.vf v12, v10, fa0
; ZVFBFA-NEXT:    vmfne.vv v10, v8, v8
; ZVFBFA-NEXT:    vmor.mm v0, v10, v12
; ZVFBFA-NEXT:    ret
  %head = insertelement <vscale x 8 x bfloat> poison, bfloat %b, i32 0
...
; ZVFBFMIN-LABEL: fcmp_uno_fv_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fcvt.s.bf16 fa5, fa0
; ZVFBFMIN-NEXT:    vsetvli a0, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vfmv.v.f v12, fa5
...
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vmfne.vv v8, v12, v12
; ZVFBFMIN-NEXT:    vmor.mm v0, v10, v8
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_uno_fv_nxv8bf16:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vfmv.v.f v10, fa0
; ZVFBFA-NEXT:    vmfne.vf v12, v10, fa0
; ZVFBFA-NEXT:    vmfne.vv v10, v8, v8
; ZVFBFA-NEXT:    vmor.mm v0, v12, v10
; ZVFBFA-NEXT:    ret
  %head = insertelement <vscale x 8 x bfloat> poison, bfloat %b, i32 0
  %splat = shufflevector <vscale x 8 x bfloat> %head, <vscale x 8 x bfloat> poison, <vscale x 8 x i32> zeroinitializer
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_uno_vv_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vmfne.vv v12, v10, v10
; ZVFBFA-NEXT:    vmfne.vv v10, v8, v8
...
; ZVFBFMIN-NEXT:    ret
;
; ZVFBFA-LABEL: fcmp_uno_vf_nxv8bf16_nonans:
; ZVFBFA:       # %bb.0:
; ZVFBFA-NEXT:    vsetvli a0, zero, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vfmv.v.f v10, fa0
; ZVFBFA-NEXT:    vmfne.vf v12, v10, fa0
