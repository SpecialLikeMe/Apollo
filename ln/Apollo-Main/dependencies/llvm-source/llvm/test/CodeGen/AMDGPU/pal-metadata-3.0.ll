...
; Set the fwd-progress attribute to false for PS - this should always be false
attributes #1 = { nounwind memory(readwrite) "InitialPSInputAddr"="36983" "amdgpu-no-fwd-progress" }
