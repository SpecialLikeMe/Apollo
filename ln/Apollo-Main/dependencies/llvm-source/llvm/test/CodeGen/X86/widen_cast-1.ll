...
forbody:
	...
	%arrayidx = getelementptr <2 x i32>, ptr %tmp2, i32 %tmp1
	%tmp3 = load i32, ptr %i
	%tmp4 = load ptr, ptr %src.addr
	%arrayidx5 = getelementptr <4 x i16>, ptr %tmp4, i32 %tmp3
	%tmp6 = load <4 x i16>, ptr %arrayidx5
	%add = add <4 x i16> %tmp6, < i16 1, i16 1, i16 1, i16 1 >
	%conv = bitcast <4 x i16> %add to <2 x i32>
	store <2 x i32> %conv, ptr %arrayidx
	br label %forinc
