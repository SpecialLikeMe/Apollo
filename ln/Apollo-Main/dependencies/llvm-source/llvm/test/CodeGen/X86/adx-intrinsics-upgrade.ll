...
define i8 @test_addcarryx_u32(i8 %c, i32 %a, i32 %b, ptr %ptr) {
...
; CHECK-NEXT:    retq ## encoding: [0xc3]
  %ret = tail call i8 @llvm.x86.addcarryx.u32(i8 %c, i32 %a, i32 %b, ptr %ptr)
  ret i8 %ret;
}

declare i8 @llvm.x86.addcarryx.u64(i8, i64, i64, ptr)

define i8 @test_addcarryx_u64(i8 %c, i64 %a, i64 %b, ptr %ptr) {
...
; CHECK-NEXT:    retq ## encoding: [0xc3]
  %ret = tail call i8 @llvm.x86.addcarryx.u64(i8 %c, i64 %a, i64 %b, ptr %ptr)
  ret i8 %ret;
}

declare i8 @llvm.x86.addcarry.u32(i8, i32, i32, ptr)

define i8 @test_addcarry_u32(i8 %c, i32 %a, i32 %b, ptr %ptr) {
...
; CHECK-NEXT:    movl %esi, (%rcx) ## encoding: [0x89,0x31]
; CHECK-NEXT:    retq ## encoding: [0xc3]
  %ret = tail call i8 @llvm.x86.addcarry.u32(i8 %c, i32 %a, i32 %b, ptr %ptr)
  ret i8 %ret;
}

declare i8 @llvm.x86.addcarry.u64(i8, i64, i64, ptr)

define i8 @test_addcarry_u64(i8 %c, i64 %a, i64 %b, ptr %ptr) {
...
; CHECK-NEXT:    movq %rsi, (%rcx) ## encoding: [0x48,0x89,0x31]
; CHECK-NEXT:    retq ## encoding: [0xc3]
  %ret = tail call i8 @llvm.x86.addcarry.u64(i8 %c, i64 %a, i64 %b, ptr %ptr)
  ret i8 %ret;
}

declare i8 @llvm.x86.subborrow.u32(i8, i32, i32, ptr)

define i8 @test_subborrow_u32(i8 %c, i32 %a, i32 %b, ptr %ptr) {
...
; CHECK-NEXT:    movl %esi, (%rcx) ## encoding: [0x89,0x31]
; CHECK-NEXT:    retq ## encoding: [0xc3]
  %ret = tail call i8 @llvm.x86.subborrow.u32(i8 %c, i32 %a, i32 %b, ptr %ptr)
  ret i8 %ret;
}

declare i8 @llvm.x86.subborrow.u64(i8, i64, i64, ptr)

define i8 @test_subborrow_u64(i8 %c, i64 %a, i64 %b, ptr %ptr) {
...
; CHECK-NEXT:    movq %rsi, (%rcx) ## encoding: [0x48,0x89,0x31]
; CHECK-NEXT:    retq ## encoding: [0xc3]
  %ret = tail call i8 @llvm.x86.subborrow.u64(i8 %c, i64 %a, i64 %b, ptr %ptr)
  ret i8 %ret;
}
...
; CHECK-NEXT:    retq ## encoding: [0xc3]
  ...
  %3 = tail call i8 @llvm.x86.addcarryx.u64(i8 0, i64 %1, i64 %2, ptr %res)
...
; CHECK-NEXT:    retq ## encoding: [0xc3]
entry:
  %0 = tail call i8 @llvm.x86.addcarryx.u64(i8 0, i64 0, i64 0, ptr null)
  ret void
}
