...
; CHECK-NOT: shl
define i32 @foo(ptr %a0, ptr %a2) nounwind {
entry:
  %tmp0 = alloca i8
  %tmp1 = alloca i32
  store i8 1, ptr %tmp0
  %tmp921.i7845 = load i8, ptr %a0, align 1
...
; CHECK-NOT: shl
; shl undef, x -> 0
define i32 @foo1_undef(ptr %a0) nounwind {
entry:
  %tmp1 = load i32, ptr %a0, align 1
