...
define i32 @func(ptr %s) nounwind ssp {
; CHECK-LABEL: func:
; CHECK:       ## %bb.0: ## %entry
...
; CHECK-NEXT:    retl
entry:
  %0 = tail call %asmtype asm "arg0 $0\0A\09arg1 $1\0A\09arg2 $2\0A\09arg3 $3\0A\09arg4 $4", "={ax},=r,=r,=r,1,~{dirflag},~{fpsr},~{flags}"(ptr %s) nounwind, !srcloc !0 ; <%0> [#uses=1]
