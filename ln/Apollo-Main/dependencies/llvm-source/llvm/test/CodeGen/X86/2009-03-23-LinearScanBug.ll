...
bb4:
        %a = load i32, ptr null             ; <i32> [#uses=1]
        %s = load i32, ptr getelementptr (i32, ptr null, i32 1)         ; <i32> [#uses=1]
        %z = load i32, ptr getelementptr (i32, ptr null, i32 2)         ; <i32> [#uses=1]
...
bb73:         ; preds = %bb72, %bb4
        ...
        store i32 %y, ptr getelementptr (i32, ptr null, i32 3)
        unreachable
}
