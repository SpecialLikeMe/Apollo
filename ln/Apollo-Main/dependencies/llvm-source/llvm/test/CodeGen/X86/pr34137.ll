...
entry:
  ...
  %0 = load i16, ptr @var_3, align 2
  %conv = zext i16 %0 to i32
  %1 = load i16, ptr @var_3, align 2
  %conv1 = zext i16 %1 to i32
  %2 = load i16, ptr @var_13, align 2
  %conv2 = zext i16 %2 to i32
  %and = and i32 %conv1, %conv2
  %and3 = and i32 %conv, %and
  store i32 %and3, ptr %a, align 4
  %3 = load i16, ptr @var_3, align 2
  %conv4 = zext i16 %3 to i32
  %4 = load i16, ptr @var_3, align 2
  %conv5 = zext i16 %4 to i32
  %5 = load i16, ptr @var_13, align 2
