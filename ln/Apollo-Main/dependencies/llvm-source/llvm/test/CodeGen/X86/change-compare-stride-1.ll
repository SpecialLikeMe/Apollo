...
define void @borf(ptr nocapture %in, ptr nocapture %out) nounwind {
; CHECK-LABEL: borf:
; CHECK-NOT: inc
; CHECK-NOT: leal 1(
; CHECK-NOT: leal -1(
...
bb2:		; preds = %bb2, %bb2.outer
	...
	%ctg2 = getelementptr i8, ptr %out, i64 %tmp21		; <ptr> [#uses=1]
	%tmp22 = ptrtoint ptr %ctg2 to i64		; <i64> [#uses=1]
	%tmp24 = sub i64 %tmp22, %indvar		; <i64> [#uses=1]
	%out_addr.0.reg2mem.0 = inttoptr i64 %tmp24 to ptr		; <ptr> [#uses=1]
	...
	%6 = getelementptr i8, ptr %in, i64 %5		; <ptr> [#uses=1]
	%7 = load i8, ptr %6, align 1		; <i8> [#uses=1]
	%8 = add i32 %3, -480		; <i32> [#uses=1]
	%9 = zext i32 %8 to i64		; <i64> [#uses=1]
	%10 = getelementptr i8, ptr %in, i64 %9		; <ptr> [#uses=1]
	%11 = load i8, ptr %10, align 1		; <i8> [#uses=1]
	%12 = add i32 %3, -479		; <i32> [#uses=1]
	%13 = zext i32 %12 to i64		; <i64> [#uses=1]
	%14 = getelementptr i8, ptr %in, i64 %13		; <ptr> [#uses=1]
	%15 = load i8, ptr %14, align 1		; <i8> [#uses=1]
	%16 = add i32 %3, -1		; <i32> [#uses=1]
	%17 = zext i32 %16 to i64		; <i64> [#uses=1]
	%18 = getelementptr i8, ptr %in, i64 %17		; <ptr> [#uses=1]
	%19 = load i8, ptr %18, align 1		; <i8> [#uses=1]
	%20 = zext i32 %3 to i64		; <i64> [#uses=1]
	%21 = getelementptr i8, ptr %in, i64 %20		; <ptr> [#uses=1]
	%22 = load i8, ptr %21, align 1		; <i8> [#uses=1]
	%23 = add i32 %3, 1		; <i32> [#uses=1]
	%24 = zext i32 %23 to i64		; <i64> [#uses=1]
	%25 = getelementptr i8, ptr %in, i64 %24		; <ptr> [#uses=1]
	%26 = load i8, ptr %25, align 1		; <i8> [#uses=1]
	%27 = add i32 %3, 481		; <i32> [#uses=1]
	%28 = zext i32 %27 to i64		; <i64> [#uses=1]
	%29 = getelementptr i8, ptr %in, i64 %28		; <ptr> [#uses=1]
	%30 = load i8, ptr %29, align 1		; <i8> [#uses=1]
	%31 = add i32 %3, 480		; <i32> [#uses=1]
	%32 = zext i32 %31 to i64		; <i64> [#uses=1]
	%33 = getelementptr i8, ptr %in, i64 %32		; <ptr> [#uses=1]
	%34 = load i8, ptr %33, align 1		; <i8> [#uses=1]
	%35 = add i32 %3, 479		; <i32> [#uses=1]
	%36 = zext i32 %35 to i64		; <i64> [#uses=1]
	%37 = getelementptr i8, ptr %in, i64 %36		; <ptr> [#uses=1]
	...
	store i8 %46, ptr %out_addr.0.reg2mem.0, align 1
