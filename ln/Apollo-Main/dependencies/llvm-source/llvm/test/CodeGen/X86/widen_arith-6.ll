...
entry:
	...
	store <3 x float> < float 1.000000e+00, float 2.000000e+00, float 3.000000e+00 >, ptr %v
	store i32 0, ptr %i
	br label %forcond
...
forbody:
	...
	%arrayidx = getelementptr <3 x float>, ptr %tmp3, i32 %tmp2
	%tmp4 = load i32, ptr %i
	%tmp5 = load ptr, ptr %src.addr
	%arrayidx6 = getelementptr <3 x float>, ptr %tmp5, i32 %tmp4
	%tmp7 = load <3 x float>, ptr %arrayidx6
	%tmp8 = load <3 x float>, ptr %v
	...
	store <3 x float> %add, ptr %arrayidx
	br label %forinc
