...
define dso_local <32 x half> @test1_safe(<32 x half> %acc, <32 x half> %a, <32 x half> %b) {
; CHECK-LABEL: test1_safe:
; CHECK:       # %bb.0: # %entry
...
define dso_local <32 x half> @test2_safe(<32 x half> %acc, <32 x half> %a, <32 x half> %b) {
; CHECK-LABEL: test2_safe:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vxorps %xmm3, %xmm3, %xmm3
...
define dso_local <16 x half> @test3_safe(<16 x half> %acc, <16 x half> %a, <16 x half> %b) {
; CHECK-LABEL: test3_safe:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vxorps %xmm3, %xmm3, %xmm3
...
define dso_local <16 x half> @test4_safe(<16 x half> %acc, <16 x half> %a, <16 x half> %b) {
; CHECK-LABEL: test4_safe:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vxorps %xmm3, %xmm3, %xmm3
...
define dso_local <8 x half> @test5_safe(<8 x half> %acc, <8 x half> %a, <8 x half> %b) {
; CHECK-LABEL: test5_safe:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vxorps %xmm3, %xmm3, %xmm3
...
define dso_local <8 x half> @test6_safe(<8 x half> %acc, <8 x half> %a, <8 x half> %b) {
; CHECK-LABEL: test6_safe:
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    vxorps %xmm3, %xmm3, %xmm3
