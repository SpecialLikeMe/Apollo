...
; RUN: llc < %s -mtriple=x86_64-- -mattr=+sse4.1 | FileCheck %s --check-prefixes=SSE41,SSE41-SLOW
; RUN: llc < %s -mtriple=x86_64-- -mattr=+sse4.1,+fast-hops | FileCheck %s --check-prefixes=SSE41,SSE41-FAST
; RUN: llc < %s -mtriple=x86_64-- -mattr=+avx2 | FileCheck %s --check-prefixes=AVX2,AVX2-SLOW
; RUN: llc < %s -mtriple=x86_64-- -mattr=+avx2,+fast-hops | FileCheck %s --check-prefixes=AVX2,AVX2-FAST
...
; SSE41-SLOW-LABEL: test_reduce_v16i16_with_add:
; SSE41-SLOW:       # %bb.0:
; SSE41-SLOW-NEXT:    movdqa %xmm0, %xmm4
; SSE41-SLOW-NEXT:    paddw %xmm1, %xmm4
; SSE41-SLOW-NEXT:    pshufd {{.*#+}} xmm5 = xmm4[2,3,2,3]
; SSE41-SLOW-NEXT:    paddw %xmm4, %xmm5
; SSE41-SLOW-NEXT:    pshufd {{.*#+}} xmm4 = xmm5[1,1,1,1]
; SSE41-SLOW-NEXT:    paddw %xmm5, %xmm4
; SSE41-SLOW-NEXT:    movdqa %xmm4, %xmm5
; SSE41-SLOW-NEXT:    psrld $16, %xmm5
; SSE41-SLOW-NEXT:    paddw %xmm4, %xmm5
; SSE41-SLOW-NEXT:    movd %xmm5, %eax
; SSE41-SLOW-NEXT:    pshuflw {{.*#+}} xmm4 = xmm5[0,0,0,0,4,5,6,7]
; SSE41-SLOW-NEXT:    pshufd {{.*#+}} xmm4 = xmm4[0,1,0,1]
; SSE41-SLOW-NEXT:    pcmpeqw %xmm4, %xmm1
; SSE41-SLOW-NEXT:    pcmpeqd %xmm5, %xmm5
; SSE41-SLOW-NEXT:    pxor %xmm5, %xmm1
; SSE41-SLOW-NEXT:    por %xmm3, %xmm1
