...
// Generated from C:/Users/devon/Apollo/compiler/native/compilerv1.g4 by ANTLR 4.13.2
...
public:
  enum {
    ...
    ASG = 94, LTO = 95, MNT = 96, INDEF = 97, ANNOT_OVERRIDE = 98, ASYNC = 99, 
    LANG = 100, DIRCPP_HDR = 101, OVERRIDE = 102, SYSCALL = 103, ALL = 104, 
    APND = 105, CONST = 106, NCONST = 107, THREADMODE = 108, JOIN = 109, 
    GLOBAL = 110, BRIDGE = 111, UNSAFE = 112, BYPASS = 113, AUTOFMTDECLARE = 114, 
    INDUCT = 115, RELEASE = 116, COMMUNAL = 117, CMGLOBAL = 118, STDEF = 119, 
    OPSTRUCT = 120, MEMSTRUCT = 121, SCHEDULE = 122, MANDATORY = 123, DETATCH = 124, 
    DETACH = 125, SCHVOID = 126, GC_NAME = 127, GCMODE_NAME = 128, BORROW_CHECKER_NAME = 129, 
    BORROW_CHECK_NAME = 130, ID = 131, NATIVE = 132, INCLUSIVE = 133, LBRACE = 134, 
    RBRACE = 135, STRING = 136, TEMPLATE_STRING = 137, INT = 138, WS = 139, 
    COMMENT = 140
  };

  enum {
    RuleProgram = 0, RuleDirective = 1, RuleGcDirective = 2, RuleBorrowCheckerDirective = 3, 
    RuleRuntimeDirective = 4, RuleSettingDirective = 5, RuleSettingValue = 6, 
    RuleImportStmt = 7, RuleInstance = 8, RuleInstancepush = 9, RuleMemberaccess = 10, 
    RuleAccessBase = 11, RuleInstanceValue = 12, RuleAllocatorUseSuffix = 13, 
    RuleImportPath = 14, RuleHeaderPath = 15, RuleHeaderPart = 16, RuleHeaderPartAtom = 17, 
    RuleFunction = 18, RuleMethod = 19, RuleField = 20, RuleParams = 21, 
    RuleParam = 22, RuleBorrowExpr = 23, RuleBlock = 24, RuleClassBody = 25, 
    RuleTemplateDecl = 26, RuleTemplateParams = 27, RuleDircpp = 28, RuleStructBody = 29, 
    RuleScheduleDecl = 30, RuleScheduleMember = 31, RuleMandatoryScheduleMember = 32, 
    RuleClassMember = 33, RuleStructMember = 34, RulePrint = 35, RuleNativemode = 36, 
    RuleAsyncCall = 37, RuleSyscallStmt = 38, RuleGlobalInit = 39, RuleMalloc = 40, 
    RuleMntDecl = 41, RuleDelalc = 42, RuleFree = 43, RulePlcnew = 44, RulePlcnewType = 45, 
    RulePointer = 46, RuleInclude = 47, RuleReturnType = 48, RuleTypeRef = 49, 
    RuleThread = 50, RuleTypeAtom = 51, RuleTypeModifier = 52, RuleGenericType = 53, 
    RuleFunctionType = 54, RuleFunctionTypeArgs = 55, RuleMacro = 56, RuleMacroQualifier = 57, 
    RuleStdinStmt = 58, RuleStdinValue = 59, RuleLambda = 60, RuleLambdaDefinition = 61, 
    RuleLambdaLiteral = 62, RuleSrcDecl = 63, RuleCscope = 64, RuleUnsafeBlock = 65, 
    RuleBypassBlock = 66, RuleAutofmtdeclareScope = 67, RuleBridgeInit = 68, 
    RuleInductStmt = 69, RuleReleaseStmt = 70, RuleAttributeBlock = 71, 
    RuleAttributeEntry = 72, RuleAttributeArgs = 73, RuleAttributeValue = 74, 
    RuleUnsafeLineStmt = 75, RuleUnsafeLinePayload = 76, RuleStatement = 77, 
    RuleTypedefOpstructSession = 78, RuleTypedefOpstructCreateStmt = 79, 
    RuleTypedefOpstructPhraseStmt = 80, RuleTypedefOpstructCommand = 81, 
    RuleTypedefOpstructCapture = 82, RuleTypedefOpstructWord = 83, RuleRdwindowStmt = 84, 
    RuleEventHandlerStmt = 85, RuleSchedulerStartStmt = 86, RuleSchedulerStartMode = 87, 
    RuleSchedulerInsertStmt = 88, RuleSchedulerVoidStmt = 89, RuleIfStatement = 90, 
    RuleWhileStatement = 91, RuleForStatement = 92, RuleForInStatement = 93, 
    RuleSwitchStatement = 94, RuleSwitchCase = 95, RuleSwitchDefault = 96, 
    RuleTryCatchStatement = 97, RuleAutocatchStatement = 98, RuleAssignment = 99, 
    RuleAssignmentCore = 100, RuleAssignTarget = 101, RuleAccessKey = 102, 
    RuleInit = 103, RuleLtoInit = 104, RuleLtoTypesetStmt = 105, RuleEasyInit = 106, 
    RuleInitCore = 107, RuleForInit = 108, RuleForUpdate = 109, RuleAssertStmt = 110, 
    RuleExpression = 111, RuleOrExpr = 112, RuleAndExpr = 113, RuleBitwiseOrExpr = 114, 
    RuleBitwiseXorExpr = 115, RuleBitwiseAndExpr = 116, RuleEqualityExpr = 117, 
    RuleShiftExpr = 118, RuleRightShiftOperator = 119, RuleRelationalExpr = 120, 
    RuleAddExpr = 121, RuleMultExpr = 122, RulePrimary = 123, RuleTemplateString = 124, 
    RuleCastExpr = 125, RuleCastType = 126, RulePlacementNewExpr = 127, 
    RuleIndexedAccess = 128, RuleCompositeLiteral = 129, RuleBraceInitializer = 130, 
    RuleBraceInitializerElement = 131, RuleFunctionCall = 132, RuleArgs = 133, 
    RuleReturnStmt = 134, RuleCommunalQualifier = 135, RuleClass = 136, 
    RuleStruct = 137, RuleMemstruct = 138, RuleTypedefStruct = 139, RuleOpstruct = 140, 
    RuleOpstructBody = 141, RuleTypedefOpstruct = 142, RuleTypedefOpstructDslBody = 143, 
    RuleTypedefOpstructDslEntry = 144, RuleTypedefOpstructAsgEntry = 145, 
    RuleTypedefOpstructSrcEntry = 146, RuleTypedefOpstructTemplateBody = 147, 
    RuleTypedefOpstructTemplateBodyItem = 148, RuleInterfaceDecl = 149, 
    RuleInheritanceClause = 150, RuleInheritedType = 151, RuleVirtualMethod = 152
  };
  ...
  public:
    ...
    std::vector<DircppContext *> dircpp();
    DircppContext* dircpp(size_t i);
  ...
  class  DircppContext : public antlr4::ParserRuleContext {
  public:
    DircppContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *DIRCPP_HDR();
