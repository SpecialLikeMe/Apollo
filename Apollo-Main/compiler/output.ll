; ModuleID = 'shared_reference'
source_filename = "C:/Users/devon/Apollo/Apollo-Main/compiler/tests/safety/pass/shared_reference.apollo"

@apollo.print.fmt = private unnamed_addr constant [4 x i8] c"%s\0A\00"
@apollo.str.literal = private unnamed_addr constant [3 x i8] c"ok\00"
@apollo.print.fmt.1 = private unnamed_addr constant [4 x i8] c"%s\0A\00"

define void @inspect(ptr %value) {
entry:
  %value1 = alloca ptr, align 8
  store ptr %value, ptr %value1, align 8
  %0 = load ptr, ptr %value1, align 8
  %1 = call i32 (ptr, ...) @printf(ptr @apollo.print.fmt, ptr %0)
  ret void
}
...
entry:
  ...
  store ptr @apollo.str.literal, ptr %message, align 8
  store ptr %message, ptr %alias, align 8
  %0 = load ptr, ptr %message, align 8
  call void @inspect(ptr %0)
  %1 = load ptr, ptr %message, align 8
  %2 = call i32 (ptr, ...) @printf(ptr @apollo.print.fmt.1, ptr %1)
  ret i32 0
}
...
!0 = !{!"direct-ir-prototype", !"llvm-cpp-api", !"shared_reference"}
