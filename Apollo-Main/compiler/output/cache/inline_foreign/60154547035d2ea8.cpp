...
extern "C" void* sys__native_vec_new() { return __apollo_inline_inline_878_5_5::sys__native_vec_new(); }
extern "C" void* sys__native_vec_with_capacity(int capacity) { return __apollo_inline_inline_878_5_5::sys__native_vec_with_capacity(capacity); }
extern "C" int sys__native_vec_len(void* value) { return __apollo_inline_inline_878_5_5::sys__native_vec_len(value); }
extern "C" const char* sys__native_vec_pop(void* value) { return __apollo_inline_inline_878_5_5::sys__native_vec_pop(value); }
extern "C" const char* sys__native_vec_get(void* value, int index) { return __apollo_inline_inline_878_5_5::sys__native_vec_get(value, index); }
extern "C" const char* sys__native_vec_remove(void* value, int index) { return __apollo_inline_inline_878_5_5::sys__native_vec_remove(value, index); }
extern "C" const char* sys__native_vec_join(void* value, const char* delimiter) { return __apollo_inline_inline_878_5_5::sys__native_vec_join(value, delimiter); }
extern "C" int sys__native_vec_contains(void* value, const char* item) { return __apollo_inline_inline_878_5_5::sys__native_vec_contains(value, item); }
extern "C" void* sys__native_map_new() { return __apollo_inline_inline_878_5_5::sys__native_map_new(); }
extern "C" void* sys__native_map_with_capacity(int capacity) { return __apollo_inline_inline_878_5_5::sys__native_map_with_capacity(capacity); }
extern "C" int sys__native_map_len(void* value) { return __apollo_inline_inline_878_5_5::sys__native_map_len(value); }
extern "C" const char* sys__native_map_get(void* value, const char* key) { return __apollo_inline_inline_878_5_5::sys__native_map_get(value, key); }
extern "C" const char* sys__native_map_remove(void* value, const char* key) { return __apollo_inline_inline_878_5_5::sys__native_map_remove(value, key); }
extern "C" int sys__native_map_contains_key(void* value, const char* key) { return __apollo_inline_inline_878_5_5::sys__native_map_contains_key(value, key); }
extern "C" const char* sys__native_map_keys(void* value, const char* delimiter) { return __apollo_inline_inline_878_5_5::sys__native_map_keys(value, delimiter); }
extern "C" const char* sys__native_map_values(void* value, const char* delimiter) { return __apollo_inline_inline_878_5_5::sys__native_map_values(value, delimiter); }
extern "C" const char* sys__native_map_entries(void* value, const char* delimiter) { return __apollo_inline_inline_878_5_5::sys__native_map_entries(value, delimiter); }
extern "C" void* sys__native_tmap_new() { return __apollo_inline_inline_878_5_5::sys__native_tmap_new(); }
extern "C" const char* sys__native_tmap_remove(void* value, const char* key) { return __apollo_inline_inline_878_5_5::sys__native_tmap_remove(value, key); }
extern "C" const char* sys__native_tmap_first_key(void* value) { return __apollo_inline_inline_878_5_5::sys__native_tmap_first_key(value); }
extern "C" const char* sys__native_tmap_last_key(void* value) { return __apollo_inline_inline_878_5_5::sys__native_tmap_last_key(value); }
extern "C" const char* sys__native_tmap_floor_key(void* value, const char* key) { return __apollo_inline_inline_878_5_5::sys__native_tmap_floor_key(value, key); }
extern "C" const char* sys__native_tmap_ceiling_key(void* value, const char* key) { return __apollo_inline_inline_878_5_5::sys__native_tmap_ceiling_key(value, key); }
extern "C" void* sys__native_set_new() { return __apollo_inline_inline_878_5_5::sys__native_set_new(); }
extern "C" int sys__native_set_insert(void* value, const char* item) { return __apollo_inline_inline_878_5_5::sys__native_set_insert(value, item); }
extern "C" int sys__native_set_remove(void* value, const char* item) { return __apollo_inline_inline_878_5_5::sys__native_set_remove(value, item); }
extern "C" int sys__native_set_contains(void* value, const char* item) { return __apollo_inline_inline_878_5_5::sys__native_set_contains(value, item); }
extern "C" int sys__native_set_len(void* value) { return __apollo_inline_inline_878_5_5::sys__native_set_len(value); }
extern "C" const char* sys__native_set_values(void* value, const char* delimiter) { return __apollo_inline_inline_878_5_5::sys__native_set_values(value, delimiter); }
extern "C" void* sys__native_set_union(void* left, void* right) { return __apollo_inline_inline_878_5_5::sys__native_set_union(left, right); }
extern "C" void* sys__native_set_intersection(void* left, void* right) { return __apollo_inline_inline_878_5_5::sys__native_set_intersection(left, right); }
extern "C" void* sys__native_set_difference(void* left, void* right) { return __apollo_inline_inline_878_5_5::sys__native_set_difference(left, right); }
extern "C" void* sys__native_set_symmetric_difference(void* left, void* right) { return __apollo_inline_inline_878_5_5::sys__native_set_symmetric_difference(left, right); }
extern "C" int sys__native_set_is_subset(void* left, void* right) { return __apollo_inline_inline_878_5_5::sys__native_set_is_subset(left, right); }
extern "C" int sys__native_set_is_superset(void* left, void* right) { return __apollo_inline_inline_878_5_5::sys__native_set_is_superset(left, right); }
extern "C" void* sys__native_queue_new() { return __apollo_inline_inline_878_5_5::sys__native_queue_new(); }
extern "C" const char* sys__native_queue_dequeue(void* value) { return __apollo_inline_inline_878_5_5::sys__native_queue_dequeue(value); }
extern "C" int sys__native_queue_len(void* value) { return __apollo_inline_inline_878_5_5::sys__native_queue_len(value); }
extern "C" void* sys__native_deque_new() { return __apollo_inline_inline_878_5_5::sys__native_deque_new(); }
extern "C" const char* sys__native_deque_pop_front(void* value) { return __apollo_inline_inline_878_5_5::sys__native_deque_pop_front(value); }
extern "C" const char* sys__native_deque_pop_back(void* value) { return __apollo_inline_inline_878_5_5::sys__native_deque_pop_back(value); }
extern "C" int sys__native_deque_len(void* value) { return __apollo_inline_inline_878_5_5::sys__native_deque_len(value); }
extern "C" void* sys__native_heap_new_max() { return __apollo_inline_inline_878_5_5::sys__native_heap_new_max(); }
extern "C" void* sys__native_heap_new_min() { return __apollo_inline_inline_878_5_5::sys__native_heap_new_min(); }
extern "C" int sys__native_heap_pop(void* value) { return __apollo_inline_inline_878_5_5::sys__native_heap_pop(value); }
extern "C" int sys__native_heap_peek(void* value) { return __apollo_inline_inline_878_5_5::sys__native_heap_peek(value); }
extern "C" int sys__native_heap_len(void* value) { return __apollo_inline_inline_878_5_5::sys__native_heap_len(value); }
