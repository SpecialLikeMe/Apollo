...
namespace __apollo_inline_inline_885_5_15 {
        void* sys__mutex_new() { return __apo_stdlib::mutex_new(); }
        int sys__mutex_lock(void* value) { return __apo_stdlib::mutex_lock(value); }
        int sys__mutex_try_lock(void* value) { return __apo_stdlib::mutex_try_lock(value); }
        int sys__mutex_unlock(void* value) { return __apo_stdlib::mutex_unlock(value); }

        void* sys__condvar_new() { return __apo_stdlib::condvar_new(); }
        int sys__condvar_wait_ms(void* value, int timeout_ms) { return __apo_stdlib::condvar_wait_ms(value, timeout_ms); }
        void sys__condvar_notify_one(void* value) { __apo_stdlib::condvar_notify_one(value); }
        void sys__condvar_notify_all(void* value) { __apo_stdlib::condvar_notify_all(value); }

        void* sys__channel_bounded(int capacity) { return __apo_stdlib::channel_bounded(capacity); }
        void* sys__channel_unbounded() { return __apo_stdlib::channel_unbounded(); }
        int sys__channel_send_i32(void* value, int item) { return __apo_stdlib::channel_send_i32(value, item); }
        int sys__channel_send_str(void* value, const char* item) { return __apo_stdlib::channel_send_str(value, __apo_stdlib::text_or_empty(item)); }
        int sys__channel_send_bool(void* value, int item) { return __apo_stdlib::channel_send_bool(value, item); }
        int sys__channel_send_f64(void* value, double item) { return __apo_stdlib::channel_send_f64(value, item); }
        int sys__channel_try_send_i32(void* value, int item) { return __apo_stdlib::channel_try_send_i32(value, item); }
        int sys__channel_try_send_str(void* value, const char* item) { return __apo_stdlib::channel_try_send_str(value, __apo_stdlib::text_or_empty(item)); }
        int sys__channel_try_send_bool(void* value, int item) { return __apo_stdlib::channel_try_send_bool(value, item); }
        int sys__channel_try_send_f64(void* value, double item) { return __apo_stdlib::channel_try_send_f64(value, item); }
        int sys__channel_recv_i32(void* value) { return __apo_stdlib::channel_recv_i32(value); }
        const char* sys__channel_recv_str(void* value) { return __apo_stdlib::channel_recv_str(value); }
        int sys__channel_recv_bool(void* value) { return __apo_stdlib::channel_recv_bool(value); }
        double sys__channel_recv_f64(void* value) { return __apo_stdlib::channel_recv_f64(value); }
        int sys__channel_try_recv_i32(void* value, int fallback) { return __apo_stdlib::channel_try_recv_i32(value, fallback); }
        const char* sys__channel_try_recv_str(void* value) { return __apo_stdlib::channel_try_recv_str(value); }
        int sys__channel_try_recv_bool(void* value, int fallback) { return __apo_stdlib::channel_try_recv_bool(value, fallback); }
        double sys__channel_try_recv_f64(void* value, double fallback) { return __apo_stdlib::channel_try_recv_f64(value, fallback); }
        int sys__channel_len(void* value) { return __apo_stdlib::channel_len(value); }
        int sys__channel_close(void* value) { return __apo_stdlib::channel_close(value); }
        int sys__channel_is_closed(void* value) { return __apo_stdlib::channel_is_closed(value); }
