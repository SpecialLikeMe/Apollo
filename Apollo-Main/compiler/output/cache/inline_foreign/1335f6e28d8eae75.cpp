...
extern long sys__hash_fnv1a_64(const char* value);
extern int sys__hash_adler32(const char* value);
extern int sys__hash_crc32(const char* value);
extern int sys__hash_murmur3_32(const char* value);
namespace __apollo_inline_inline_959_5_18 {
        int sys__json_parse_bool(const char* value) { return __apo_stdlib::json_parse_bool(__apo_stdlib::view_or_empty(value)); }
        long sys__json_parse_int(const char* value) { return static_cast<long>(__apo_stdlib::json_parse_int(__apo_stdlib::view_or_empty(value))); }
        double sys__json_parse_float(const char* value) { return __apo_stdlib::json_parse_float(__apo_stdlib::view_or_empty(value)); }
        const char* sys__json_parse_str(const char* value) { return __apo_stdlib::json_parse_str(__apo_stdlib::view_or_empty(value)); }
        const char* sys__json_write_bool(int value) { return __apo_stdlib::json_write_bool(value); }
        const char* sys__json_write_int(long value) { return __apo_stdlib::json_write_int(value); }
        const char* sys__json_write_float(double value) { return __apo_stdlib::json_write_float(value); }
        const char* sys__json_write_str(const char* value) { return __apo_stdlib::json_write_str(__apo_stdlib::view_or_empty(value)); }
        const char* sys__json_write_array_start() { return __apo_stdlib::json_write_array_start(); }
        const char* sys__json_write_array_end() { return __apo_stdlib::json_write_array_end(); }
        const char* sys__json_write_object_start() { return __apo_stdlib::json_write_object_start(); }
        const char* sys__json_write_object_end() { return __apo_stdlib::json_write_object_end(); }
    
}
extern "C" long sys__json_parse_int(const char* value) { return __apollo_inline_inline_959_5_18::sys__json_parse_int(value); }
extern "C" double sys__json_parse_float(const char* value) { return __apollo_inline_inline_959_5_18::sys__json_parse_float(value); }
