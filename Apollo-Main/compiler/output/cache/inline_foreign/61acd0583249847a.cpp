...
namespace __apollo_inline_inline_1583_5_7 {
...
extern "C" void* sys__native_file_open(const char* path, const char* mode) { return __apollo_inline_inline_1583_5_7::sys__native_file_open(path, mode); }
extern "C" void* sys__native_file_create(const char* path) { return __apollo_inline_inline_1583_5_7::sys__native_file_create(path); }
extern "C" int sys__native_file_write(void* value, const char* text) { return __apollo_inline_inline_1583_5_7::sys__native_file_write(value, text); }
extern "C" const char* sys__native_file_read_all(void* value) { return __apollo_inline_inline_1583_5_7::sys__native_file_read_all(value); }
extern "C" int sys__native_file_close(void* value) { return __apollo_inline_inline_1583_5_7::sys__native_file_close(value); }
extern "C" const char* sys__native_file_path(void* value) { return __apollo_inline_inline_1583_5_7::sys__native_file_path(value); }
extern "C" int sys__native_file_sync_all(void* value) { return __apollo_inline_inline_1583_5_7::sys__native_file_sync_all(value); }
extern "C" int sys__native_file_sync_data(void* value) { return __apollo_inline_inline_1583_5_7::sys__native_file_sync_data(value); }
extern "C" int sys__native_file_set_len(void* value, long size) { return __apollo_inline_inline_1583_5_7::sys__native_file_set_len(value, size); }
extern "C" void* sys__native_file_metadata(void* value) { return __apollo_inline_inline_1583_5_7::sys__native_file_metadata(value); }
extern "C" long sys__native_meta_size(void* value) { return __apollo_inline_inline_1583_5_7::sys__native_meta_size(value); }
extern "C" const char* sys__native_meta_modified(void* value) { return __apollo_inline_inline_1583_5_7::sys__native_meta_modified(value); }
extern "C" const char* sys__native_meta_accessed(void* value) { return __apollo_inline_inline_1583_5_7::sys__native_meta_accessed(value); }
extern "C" const char* sys__native_meta_created(void* value) { return __apollo_inline_inline_1583_5_7::sys__native_meta_created(value); }
extern "C" int sys__native_meta_is_dir(void* value) { return __apollo_inline_inline_1583_5_7::sys__native_meta_is_dir(value); }
extern "C" int sys__native_meta_is_file(void* value) { return __apollo_inline_inline_1583_5_7::sys__native_meta_is_file(value); }
extern "C" int sys__native_perm_readonly(void* value) { return __apollo_inline_inline_1583_5_7::sys__native_perm_readonly(value); }
extern "C" int sys__native_fs_create_dir(const char* path) { return __apollo_inline_inline_1583_5_7::sys__native_fs_create_dir(path); }
extern "C" int sys__native_fs_create_dir_all(const char* path) { return __apollo_inline_inline_1583_5_7::sys__native_fs_create_dir_all(path); }
extern "C" int sys__native_fs_remove_file(const char* path) { return __apollo_inline_inline_1583_5_7::sys__native_fs_remove_file(path); }
extern "C" int sys__native_fs_remove_dir(const char* path) { return __apollo_inline_inline_1583_5_7::sys__native_fs_remove_dir(path); }
extern "C" int sys__native_fs_remove_dir_all(const char* path) { return __apollo_inline_inline_1583_5_7::sys__native_fs_remove_dir_all(path); }
extern "C" int sys__native_fs_rename(const char* from, const char* to) { return __apollo_inline_inline_1583_5_7::sys__native_fs_rename(from, to); }
extern "C" int sys__native_fs_copy(const char* from, const char* to) { return __apollo_inline_inline_1583_5_7::sys__native_fs_copy(from, to); }
extern "C" const char* sys__native_fs_read_dir(const char* path, const char* delimiter) { return __apollo_inline_inline_1583_5_7::sys__native_fs_read_dir(path, delimiter); }
extern "C" int sys__native_fs_hard_link(const char* source, const char* destination) { return __apollo_inline_inline_1583_5_7::sys__native_fs_hard_link(source, destination); }
extern "C" int sys__native_fs_symlink(const char* source, const char* destination) { return __apollo_inline_inline_1583_5_7::sys__native_fs_symlink(source, destination); }
extern "C" const char* sys__native_fs_read_link(const char* path) { return __apollo_inline_inline_1583_5_7::sys__native_fs_read_link(path); }
extern "C" int sys__native_fs_exists(const char* path) { return __apollo_inline_inline_1583_5_7::sys__native_fs_exists(path); }
extern "C" const char* sys__native_path_parent(const char* path) { return __apollo_inline_inline_1583_5_7::sys__native_path_parent(path); }
extern "C" const char* sys__native_path_file_name(const char* path) { return __apollo_inline_inline_1583_5_7::sys__native_path_file_name(path); }
extern "C" const char* sys__native_path_extension(const char* path) { return __apollo_inline_inline_1583_5_7::sys__native_path_extension(path); }
extern "C" const char* sys__native_path_file_stem(const char* path) { return __apollo_inline_inline_1583_5_7::sys__native_path_file_stem(path); }
extern "C" int sys__native_path_is_absolute(const char* path) { return __apollo_inline_inline_1583_5_7::sys__native_path_is_absolute(path); }
extern "C" int sys__native_path_is_relative(const char* path) { return __apollo_inline_inline_1583_5_7::sys__native_path_is_relative(path); }
extern "C" const char* sys__native_path_to_absolute(const char* path) { return __apollo_inline_inline_1583_5_7::sys__native_path_to_absolute(path); }
extern "C" const char* sys__native_path_canonicalize(const char* path) { return __apollo_inline_inline_1583_5_7::sys__native_path_canonicalize(path); }
extern "C" const char* sys__native_path_components(const char* path, const char* delimiter) { return __apollo_inline_inline_1583_5_7::sys__native_path_components(path, delimiter); }
