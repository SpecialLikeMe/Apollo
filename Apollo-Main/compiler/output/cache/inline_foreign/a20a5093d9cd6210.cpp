...
namespace __apollo_inline_inline_1911_5_12 {
...
extern "C" void* sys__native_regex_compile(const char* pattern) { return __apollo_inline_inline_1911_5_12::sys__native_regex_compile(pattern); }
extern "C" int sys__native_regex_is_match(void* value, const char* text) { return __apollo_inline_inline_1911_5_12::sys__native_regex_is_match(value, text); }
extern "C" const char* sys__native_regex_find(void* value, const char* text) { return __apollo_inline_inline_1911_5_12::sys__native_regex_find(value, text); }
extern "C" const char* sys__native_regex_replace(void* value, const char* text, const char* replacement) { return __apollo_inline_inline_1911_5_12::sys__native_regex_replace(value, text, replacement); }
extern "C" const char* sys__native_regex_error(void* value) { return __apollo_inline_inline_1911_5_12::sys__native_regex_error(value); }
