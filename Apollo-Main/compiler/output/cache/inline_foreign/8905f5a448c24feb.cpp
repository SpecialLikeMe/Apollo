...
namespace __apollo_inline_inline_2137_5_8 {
...
extern "C" void* sys__native_process_spawn(const char* command) { return __apollo_inline_inline_2137_5_8::sys__native_process_spawn(command); }
extern "C" int sys__native_process_wait(void* value) { return __apollo_inline_inline_2137_5_8::sys__native_process_wait(value); }
extern "C" int sys__native_process_try_wait(void* value) { return __apollo_inline_inline_2137_5_8::sys__native_process_try_wait(value); }
extern "C" int sys__native_process_exit_code(void* value) { return __apollo_inline_inline_2137_5_8::sys__native_process_exit_code(value); }
extern "C" int sys__native_process_completed(void* value) { return __apollo_inline_inline_2137_5_8::sys__native_process_completed(value); }
extern "C" int sys__native_process_kill(void* value) { return __apollo_inline_inline_2137_5_8::sys__native_process_kill(value); }
extern "C" const char* sys__native_process_command(void* value) { return __apollo_inline_inline_2137_5_8::sys__native_process_command(value); }
