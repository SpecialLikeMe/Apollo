; ModuleID = 'semantic_redecl_bad'
source_filename = "semantic_redecl_bad.apollo"
...
entry:
  ...
  store i32 4, ptr %x1, align 4
  store ptr %x1, ptr %y, align 8
...
!0 = !{!"direct-ir-prototype", !"llvm-cpp-api", !"semantic_redecl_bad"}
