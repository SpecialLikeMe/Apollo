...
template <typename T>
inline void __apo_gc_trace_value(__apo_gc_tracer& tracer, const apo_Holder<T>& value) {
...
int main() {
{
        ...
        __apo_gc_handle<apo_Holder<apo_Box>> holder = __apo_total_gc_owner.make<apo_Holder<apo_Box>>(apo_Holder<apo_Box>{});
__apo_gc_root_slot<apo_Holder<apo_Box>> __apo_autofmt_root_holder_0(__apo_autofmt_owner_0, &holder);
        __apo_gc_handle<apo_Box> input = __apo_total_gc_owner.make<apo_Box>(apo_Box{});
__apo_gc_root_slot<apo_Box> __apo_autofmt_root_input_1(__apo_autofmt_owner_0, &input);
        holder->fetch(input);
        input->ping();
    }
    return 0;
