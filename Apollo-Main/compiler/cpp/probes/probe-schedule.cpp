...
static void __apo_schedule_schedule_surface_Pipeline_heartbeat();
...
__apo_scheduler_eevf_runtime::instance().register_schedule("Pipeline", {{"heartbeat", __apo_schedule_schedule_surface_Pipeline_heartbeat, true}});
static void __apo_schedule_schedule_surface_Pipeline_heartbeat() {
