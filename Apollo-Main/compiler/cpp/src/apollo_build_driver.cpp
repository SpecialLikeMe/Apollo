...
RuntimeRequirements directRuntimeRequirements(const std::filesystem::path& llvmIrPath) {
    RuntimeRequirements requirements;
...
void buildAot(const BuildEnvironment& env, const std::filesystem::path& linkOutput) {
    ...
    const RuntimeRequirements requirements = directRuntimeRequirements(env.llvmOutput);
