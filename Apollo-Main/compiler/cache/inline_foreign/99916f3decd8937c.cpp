...
namespace __apollo_inline_inline_831_5_13 {
        void* sys__rand_new() { return __apo_stdlib::rand_new(); }
        void sys__rand_seed(void* value, int seed) { __apo_stdlib::rand_seed(value, seed); }
        int sys__rand_i32(void* value) { return __apo_stdlib::rand_i32(value); }
        int sys__rand_range_i32(void* value, int low, int high) { return __apo_stdlib::rand_range_i32(value, low, high); }
        double sys__rand_f64(void* value) { return __apo_stdlib::rand_f64(value); }
        int sys__rand_bool(void* value) { return __apo_stdlib::rand_bool(value); }
