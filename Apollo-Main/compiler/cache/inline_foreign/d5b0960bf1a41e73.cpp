...
namespace __apollo_inline_inline_841_5_14 {
        const char* sys__datetime_now_utc() { return __apo_stdlib::datetime_now_utc(); }
        const char* sys__datetime_now_local() { return __apo_stdlib::datetime_now_local(); }
        int sys__datetime_year_local() { return __apo_stdlib::datetime_year_local(); }
        int sys__datetime_month_local() { return __apo_stdlib::datetime_month_local(); }
        int sys__datetime_day_local() { return __apo_stdlib::datetime_day_local(); }
        int sys__datetime_hour_local() { return __apo_stdlib::datetime_hour_local(); }
        int sys__datetime_minute_local() { return __apo_stdlib::datetime_minute_local(); }
        int sys__datetime_second_local() { return __apo_stdlib::datetime_second_local(); }
        int sys__monotonic_millis() { return __apo_stdlib::monotonic_millis(); }
    
}
extern "C" int sys__datetime_year_local() { return __apollo_inline_inline_841_5_14::sys__datetime_year_local(); }
extern "C" int sys__datetime_month_local() { return __apollo_inline_inline_841_5_14::sys__datetime_month_local(); }
extern "C" int sys__datetime_day_local() { return __apollo_inline_inline_841_5_14::sys__datetime_day_local(); }
extern "C" int sys__datetime_hour_local() { return __apollo_inline_inline_841_5_14::sys__datetime_hour_local(); }
extern "C" int sys__datetime_minute_local() { return __apollo_inline_inline_841_5_14::sys__datetime_minute_local(); }
extern "C" int sys__datetime_second_local() { return __apollo_inline_inline_841_5_14::sys__datetime_second_local(); }
extern "C" int sys__monotonic_millis() { return __apollo_inline_inline_841_5_14::sys__monotonic_millis(); }
