...
namespace __apollo_inline_inline_756_5_9 {
        ...
        void* sys__task_ready_bool(int value) { return __apo_stdlib::task_ready_bool(value); }
        void* sys__task_ready_f64(double value) { return __apo_stdlib::task_ready_f64(value); }
        ...
        int sys__task_await_bool(void* value) { return __apo_stdlib::task_await_bool(value); }
        double sys__task_await_f64(void* value) { return __apo_stdlib::task_await_f64(value); }
        int sys__task_is_i32(void* value) { return __apo_stdlib::task_is_i32(value); }
        int sys__task_is_str(void* value) { return __apo_stdlib::task_is_str(value); }
        int sys__task_is_bool(void* value) { return __apo_stdlib::task_is_bool(value); }
        int sys__task_is_f64(void* value) { return __apo_stdlib::task_is_f64(value); }
