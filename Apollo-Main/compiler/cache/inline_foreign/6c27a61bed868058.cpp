...
namespace __apollo_inline_inline_726_5_2 {
...
extern "C" int sys__native_clz(int value) { return __apollo_inline_inline_726_5_2::sys__native_clz(value); }
extern "C" int sys__native_ctz(int value) { return __apollo_inline_inline_726_5_2::sys__native_ctz(value); }
extern "C" int sys__native_popcount(int value) { return __apollo_inline_inline_726_5_2::sys__native_popcount(value); }
extern "C" int sys__native_ffs(int value) { return __apollo_inline_inline_726_5_2::sys__native_ffs(value); }
extern "C" int sys__native_rotate_left(int value, int amount) { return __apollo_inline_inline_726_5_2::sys__native_rotate_left(value, amount); }
extern "C" int sys__native_rotate_right(int value, int amount) { return __apollo_inline_inline_726_5_2::sys__native_rotate_right(value, amount); }
extern "C" int sys__native_bswap(int value) { return __apollo_inline_inline_726_5_2::sys__native_bswap(value); }
