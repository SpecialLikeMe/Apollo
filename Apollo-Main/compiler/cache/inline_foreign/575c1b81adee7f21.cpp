...
namespace __apollo_inline_inline_461_5_4 {
        void sys__term_print_raw(const char* value) { __apo_stdlib::term_print_raw(__apo_stdlib::view_or_empty(value)); }
        void sys__term_println_raw(const char* value) { __apo_stdlib::term_println_raw(__apo_stdlib::view_or_empty(value)); }
        const char* sys__term_read_line() { return __apo_stdlib::term_read_line(); }
        int sys__term_is_tty() { return __apo_stdlib::term_is_tty(); }
        void sys__term_clear() { __apo_stdlib::term_clear(); }
        void sys__term_set_cursor(int column, int row) { __apo_stdlib::term_set_cursor(column, row); }
        void sys__term_show_cursor() { __apo_stdlib::term_show_cursor(); }
        void sys__term_hide_cursor() { __apo_stdlib::term_hide_cursor(); }
        void sys__term_set_color_fg(int color) { __apo_stdlib::term_set_color_fg(color); }
        void sys__term_set_color_bg(int color) { __apo_stdlib::term_set_color_bg(color); }
        void sys__term_set_style(const char* style) { __apo_stdlib::term_set_style(__apo_stdlib::view_or_empty(style)); }
        void sys__term_reset() { __apo_stdlib::term_reset(); }
        void sys__log_info(const char* value) { __apo_stdlib::log_info(__apo_stdlib::view_or_empty(value)); }
        void sys__log_warn(const char* value) { __apo_stdlib::log_warn(__apo_stdlib::view_or_empty(value)); }
        void sys__log_error(const char* value) { __apo_stdlib::log_error(__apo_stdlib::view_or_empty(value)); }
        void sys__log_debug(const char* value) { __apo_stdlib::log_debug(__apo_stdlib::view_or_empty(value)); }
        void sys__log_trace(const char* value) { __apo_stdlib::log_trace(__apo_stdlib::view_or_empty(value)); }
    
}
extern "C" int sys__term_is_tty() { return __apollo_inline_inline_461_5_4::sys__term_is_tty(); }
