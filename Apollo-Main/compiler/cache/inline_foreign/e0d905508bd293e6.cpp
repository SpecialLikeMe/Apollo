...
namespace __apollo_inline_inline_2368_5_9 {
        void* sys__native_task_ready_i32(int value) { return __apo_stdlib::task_ready_i32(value); }
        void* sys__native_task_ready_str(const char* value) { return __apo_stdlib::task_ready_str(__apo_stdlib::text_or_empty(value)); }
        void* sys__native_task_ready_bool(int value) { return __apo_stdlib::task_ready_bool(value); }
        void* sys__native_task_ready_f64(double value) { return __apo_stdlib::task_ready_f64(value); }
        int sys__native_task_done(void* value) { return __apo_stdlib::task_done(value); }
        int sys__native_task_await_i32(void* value) { return __apo_stdlib::task_await_i32(value); }
        const char* sys__native_task_await_str(void* value) { return __apo_stdlib::task_await_str(value); }
        int sys__native_task_await_bool(void* value) { return __apo_stdlib::task_await_bool(value); }
        double sys__native_task_await_f64(void* value) { return __apo_stdlib::task_await_f64(value); }
        int sys__native_task_is_i32(void* value) { return __apo_stdlib::task_is_i32(value); }
        int sys__native_task_is_str(void* value) { return __apo_stdlib::task_is_str(value); }
        int sys__native_task_is_bool(void* value) { return __apo_stdlib::task_is_bool(value); }
        int sys__native_task_is_f64(void* value) { return __apo_stdlib::task_is_f64(value); }
    
}
extern "C" void* sys__native_task_ready_i32(int value) { return __apollo_inline_inline_2368_5_9::sys__native_task_ready_i32(value); }
extern "C" void* sys__native_task_ready_str(const char* value) { return __apollo_inline_inline_2368_5_9::sys__native_task_ready_str(value); }
extern "C" void* sys__native_task_ready_bool(int value) { return __apollo_inline_inline_2368_5_9::sys__native_task_ready_bool(value); }
extern "C" void* sys__native_task_ready_f64(double value) { return __apollo_inline_inline_2368_5_9::sys__native_task_ready_f64(value); }
extern "C" int sys__native_task_done(void* value) { return __apollo_inline_inline_2368_5_9::sys__native_task_done(value); }
extern "C" int sys__native_task_await_i32(void* value) { return __apollo_inline_inline_2368_5_9::sys__native_task_await_i32(value); }
extern "C" const char* sys__native_task_await_str(void* value) { return __apollo_inline_inline_2368_5_9::sys__native_task_await_str(value); }
extern "C" int sys__native_task_await_bool(void* value) { return __apollo_inline_inline_2368_5_9::sys__native_task_await_bool(value); }
extern "C" double sys__native_task_await_f64(void* value) { return __apollo_inline_inline_2368_5_9::sys__native_task_await_f64(value); }
extern "C" int sys__native_task_is_i32(void* value) { return __apollo_inline_inline_2368_5_9::sys__native_task_is_i32(value); }
extern "C" int sys__native_task_is_str(void* value) { return __apollo_inline_inline_2368_5_9::sys__native_task_is_str(value); }
extern "C" int sys__native_task_is_bool(void* value) { return __apollo_inline_inline_2368_5_9::sys__native_task_is_bool(value); }
extern "C" int sys__native_task_is_f64(void* value) { return __apollo_inline_inline_2368_5_9::sys__native_task_is_f64(value); }
