...
namespace __apollo_inline_inline_313_5_3 {
...
extern "C" int sys__str_contains(const char* value, const char* sub) { return __apollo_inline_inline_313_5_3::sys__str_contains(value, sub); }
extern "C" int sys__str_starts_with(const char* value, const char* prefix) { return __apollo_inline_inline_313_5_3::sys__str_starts_with(value, prefix); }
extern "C" int sys__str_ends_with(const char* value, const char* suffix) { return __apollo_inline_inline_313_5_3::sys__str_ends_with(value, suffix); }
extern "C" int sys__str_find(const char* value, const char* sub) { return __apollo_inline_inline_313_5_3::sys__str_find(value, sub); }
extern "C" int sys__str_rfind(const char* value, const char* sub) { return __apollo_inline_inline_313_5_3::sys__str_rfind(value, sub); }
extern "C" int sys__str_cmp(const char* left, const char* right) { return __apollo_inline_inline_313_5_3::sys__str_cmp(left, right); }
extern "C" int sys__str_casecmp(const char* left, const char* right) { return __apollo_inline_inline_313_5_3::sys__str_casecmp(left, right); }
extern "C" long sys__parse_int(const char* value, int base) { return __apollo_inline_inline_313_5_3::sys__parse_int(value, base); }
extern "C" double sys__parse_float(const char* value) { return __apollo_inline_inline_313_5_3::sys__parse_float(value); }
extern "C" int sys__is_alpha(const char* value) { return __apollo_inline_inline_313_5_3::sys__is_alpha(value); }
extern "C" int sys__is_digit(const char* value) { return __apollo_inline_inline_313_5_3::sys__is_digit(value); }
extern "C" int sys__is_alnum(const char* value) { return __apollo_inline_inline_313_5_3::sys__is_alnum(value); }
extern "C" int sys__is_whitespace(const char* value) { return __apollo_inline_inline_313_5_3::sys__is_whitespace(value); }
extern "C" int sys__is_control(const char* value) { return __apollo_inline_inline_313_5_3::sys__is_control(value); }
extern "C" int sys__is_punctuation(const char* value) { return __apollo_inline_inline_313_5_3::sys__is_punctuation(value); }
extern "C" int sys__is_graph(const char* value) { return __apollo_inline_inline_313_5_3::sys__is_graph(value); }
extern "C" int sys__is_print(const char* value) { return __apollo_inline_inline_313_5_3::sys__is_print(value); }
extern "C" int sys__is_hex_digit(const char* value) { return __apollo_inline_inline_313_5_3::sys__is_hex_digit(value); }
extern "C" int sys__is_ascii(const char* value) { return __apollo_inline_inline_313_5_3::sys__is_ascii(value); }
