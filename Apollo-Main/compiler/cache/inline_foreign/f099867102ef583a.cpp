...
namespace __apollo_inline_inline_913_5_16 {
        int sys__thread_get_raw_id() { return __apo_stdlib::thread_get_raw_id(); }
        void sys__thread_yield() { __apo_stdlib::thread_yield(); }
