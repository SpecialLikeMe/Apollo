...
namespace __apollo_inline_inline_814_5_12 {
        void* sys__regex_compile(const char* pattern) { return __apo_stdlib::regex_compile(__apo_stdlib::text_or_empty(pattern)); }
        int sys__regex_is_match(void* value, const char* text) { return __apo_stdlib::regex_is_match(value, __apo_stdlib::view_or_empty(text)); }
        const char* sys__regex_find(void* value, const char* text) { return __apo_stdlib::regex_find(value, __apo_stdlib::view_or_empty(text)); }
        const char* sys__regex_replace(void* value, const char* text, const char* replacement) { return __apo_stdlib::regex_replace(value, __apo_stdlib::view_or_empty(text), __apo_stdlib::view_or_empty(replacement)); }
        const char* sys__regex_error(void* value) { return __apo_stdlib::regex_error(value); }
