...
namespace __apollo_inline_inline_280_5_2 {
...
extern "C" int sys__ctz(int value) { return __apollo_inline_inline_280_5_2::sys__ctz(value); }
extern "C" int sys__popcount(int value) { return __apollo_inline_inline_280_5_2::sys__popcount(value); }
extern "C" int sys__ffs(int value) { return __apollo_inline_inline_280_5_2::sys__ffs(value); }
extern "C" int sys__rotate_left(int value, int amount) { return __apollo_inline_inline_280_5_2::sys__rotate_left(value, amount); }
extern "C" int sys__rotate_right(int value, int amount) { return __apollo_inline_inline_280_5_2::sys__rotate_right(value, amount); }
extern "C" int sys__bswap(int value) { return __apollo_inline_inline_280_5_2::sys__bswap(value); }
