...
namespace __apollo_inline_inline_793_5_11 {
        int sys__ascii_validate(const char* value) { return __apo_stdlib::ascii_validate(__apo_stdlib::view_or_empty(value)); }
        int sys__utf8_validate(const char* value) { return __apo_stdlib::utf8_validate(__apo_stdlib::view_or_empty(value)); }
        int sys__utf8_char_count(const char* value) { return __apo_stdlib::utf8_char_count(__apo_stdlib::view_or_empty(value)); }
        const char* sys__hex_encode(const char* value) { return __apo_stdlib::hex_encode(__apo_stdlib::view_or_empty(value)); }
        const char* sys__hex_decode(const char* value) { return __apo_stdlib::hex_decode(__apo_stdlib::view_or_empty(value)); }
        const char* sys__url_encode(const char* value) { return __apo_stdlib::url_encode(__apo_stdlib::view_or_empty(value)); }
        const char* sys__url_decode(const char* value) { return __apo_stdlib::url_decode(__apo_stdlib::view_or_empty(value)); }
        const char* sys__base64_encode(const char* value) { return __apo_stdlib::base64_encode(__apo_stdlib::view_or_empty(value)); }
        const char* sys__base64_decode(const char* value) { return __apo_stdlib::base64_decode(__apo_stdlib::view_or_empty(value)); }
    
}
extern "C" int sys__utf8_validate(const char* value) { return __apollo_inline_inline_793_5_11::sys__utf8_validate(value); }
extern "C" int sys__utf8_char_count(const char* value) { return __apollo_inline_inline_793_5_11::sys__utf8_char_count(value); }
