...
namespace __apollo_inline_inline_688_5_7 {
        ...
        void* sys__file_create(const char* path) { return __apo_stdlib::file_create(__apo_stdlib::text_or_empty(path)); }
        ...
        int sys__file_sync_all(void* value) { return __apo_stdlib::file_sync_all(value); }
        int sys__file_sync_data(void* value) { return __apo_stdlib::file_sync_data(value); }
        int sys__file_set_len(void* value, long size) { return __apo_stdlib::file_set_len(value, size); }
        void* sys__file_metadata(void* value) { return __apo_stdlib::file_metadata(value); }
        long sys__meta_size(void* value) { return __apo_stdlib::metadata_size(value); }
        const char* sys__meta_modified(void* value) { return __apo_stdlib::metadata_modified(value); }
        const char* sys__meta_accessed(void* value) { return __apo_stdlib::metadata_accessed(value); }
        const char* sys__meta_created(void* value) { return __apo_stdlib::metadata_created(value); }
        int sys__meta_is_dir(void* value) { return __apo_stdlib::metadata_is_dir(value); }
        int sys__meta_is_file(void* value) { return __apo_stdlib::metadata_is_file(value); }
        int sys__perm_readonly(void* value) { return __apo_stdlib::metadata_permissions_readonly(value); }
        ...
        int sys__fs_symlink(const char* source, const char* destination) { return __apo_stdlib::fs_symlink(__apo_stdlib::view_or_empty(source), __apo_stdlib::view_or_empty(destination)); }
        const char* sys__fs_read_link(const char* path) { return __apo_stdlib::fs_read_link(__apo_stdlib::view_or_empty(path)); }
        ...
        const char* sys__path_components(const char* path, const char* delimiter) { return __apo_stdlib::path_components(__apo_stdlib::view_or_empty(path), __apo_stdlib::view_or_empty(delimiter)); }
    
}
extern "C" int sys__fs_create_dir(const char* path) { return __apollo_inline_inline_688_5_7::sys__fs_create_dir(path); }
extern "C" int sys__fs_create_dir_all(const char* path) { return __apollo_inline_inline_688_5_7::sys__fs_create_dir_all(path); }
extern "C" int sys__fs_remove_file(const char* path) { return __apollo_inline_inline_688_5_7::sys__fs_remove_file(path); }
extern "C" int sys__fs_remove_dir(const char* path) { return __apollo_inline_inline_688_5_7::sys__fs_remove_dir(path); }
extern "C" int sys__fs_remove_dir_all(const char* path) { return __apollo_inline_inline_688_5_7::sys__fs_remove_dir_all(path); }
extern "C" int sys__fs_rename(const char* from, const char* to) { return __apollo_inline_inline_688_5_7::sys__fs_rename(from, to); }
extern "C" int sys__fs_copy(const char* from, const char* to) { return __apollo_inline_inline_688_5_7::sys__fs_copy(from, to); }
extern "C" int sys__fs_hard_link(const char* source, const char* destination) { return __apollo_inline_inline_688_5_7::sys__fs_hard_link(source, destination); }
extern "C" int sys__fs_symlink(const char* source, const char* destination) { return __apollo_inline_inline_688_5_7::sys__fs_symlink(source, destination); }
extern "C" int sys__fs_exists(const char* path) { return __apollo_inline_inline_688_5_7::sys__fs_exists(path); }
extern "C" int sys__path_is_absolute(const char* path) { return __apollo_inline_inline_688_5_7::sys__path_is_absolute(path); }
extern "C" int sys__path_is_relative(const char* path) { return __apollo_inline_inline_688_5_7::sys__path_is_relative(path); }
