...
! LLVMIR: %[[shf:.*]] = shufflevector <4 x i32> %[[bc]], <4 x i32> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
...
! LLVMIR: %[[src:.*]] = shufflevector <4 x i32> %[[arg1]], <4 x i32> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
...
! LLVMIR: %[[shf:.*]] = shufflevector <2 x i64> %[[src]], <2 x i64> poison, <2 x i32> <i32 1, i32 0>
...
! LLVMIR: %[[arg2:.*]] = load i16, ptr %1, align 2
! LLVMIR: %[[gep2:.*]] = getelementptr i8, ptr %[[gep1]], i16 %[[arg2]]
! LLVMIR: %[[src:.*]] = shufflevector <4 x float> %[[arg1]], <4 x float> poison, <4 x i32> <i32 3, i32 2, i32 1, i32 0>
