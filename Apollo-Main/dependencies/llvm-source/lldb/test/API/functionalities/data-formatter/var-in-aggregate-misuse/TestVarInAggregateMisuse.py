...
class VarInAggregateMisuseTestCase(TestBase):
    ...
    def test_with_run_command(self):
        ...
        self.expect(
            "frame variable mine_ptr", substrs=["SUMMARY SUCCESS summarize_ptr_t @ "]
        )

        self.expect(
            "frame variable *mine_ptr", substrs=["SUMMARY SUCCESS summarize_t @"]
        )
        ...
        self.expect(
            "frame variable",
            substrs=[
                "(TwoSummarizes) twos = TwoSummarizes @ ",
                "first = summarize_t @ ",
                "second = summarize_t @ ",
            ],
        )
