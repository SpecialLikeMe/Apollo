...
// RUN: llvm-objdump --no-print-imm-hex -d --triple=armv7a-none-linux-gnueabi --no-show-raw-insn %t2 | FileCheck %s
...
// RUN: llvm-objdump --no-print-imm-hex -d --no-show-raw-insn %t4 | FileCheck --check-prefix=CHECK-THUMB %s
