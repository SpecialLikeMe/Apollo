...
// CHECK-LABEL: define {{.*}}ptr addrspace(271) @_Z2f1PU10ptr32_sptri
// WIN-LABEL: define {{.*}}ptr addrspace(271) @"?f1@@YAPAXPAH@Z"
...
// CHECK-LABEL: define {{.*}}ptr @_Z2f3Pi
// WIN-LABEL: define {{.*}}ptr @"?f3@@YAPEAXPEAH@Z"
