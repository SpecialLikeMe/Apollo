...
// RUN: %clang_cc1 %s -triple hexagon -verify -target-cpu hexagonv62 -S -o - -DTEST_V60
// RUN: %clang_cc1 %s -triple hexagon -verify -target-cpu hexagonv62 -S -o - -DTEST_V62
// RUN: %clang_cc1 %s -triple hexagon -verify -target-cpu hexagonv62 -S -o - -DTEST_V65
