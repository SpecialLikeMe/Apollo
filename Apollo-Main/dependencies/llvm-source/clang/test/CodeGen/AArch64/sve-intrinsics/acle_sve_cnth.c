...
//
// CPP-CHECK-LABEL: @_Z17test_svcnth_pat_1v(
// CPP-CHECK-NEXT:  entry:
...
//
// CPP-CHECK-LABEL: @_Z17test_svcnth_pat_2v(
// CPP-CHECK-NEXT:  entry:
...
//
// CPP-CHECK-LABEL: @_Z17test_svcnth_pat_3v(
// CPP-CHECK-NEXT:  entry:
...
//
// CPP-CHECK-LABEL: @_Z17test_svcnth_pat_4v(
// CPP-CHECK-NEXT:  entry:
...
//
// CPP-CHECK-LABEL: @_Z17test_svcnth_pat_5v(
// CPP-CHECK-NEXT:  entry:
...
//
// CPP-CHECK-LABEL: @_Z17test_svcnth_pat_6v(
// CPP-CHECK-NEXT:  entry:
...
//
// CPP-CHECK-LABEL: @_Z17test_svcnth_pat_7v(
// CPP-CHECK-NEXT:  entry:
...
//
// CPP-CHECK-LABEL: @_Z17test_svcnth_pat_8v(
// CPP-CHECK-NEXT:  entry:
