...
// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx810 -filetype=null 2>&1 %s | FileCheck -check-prefix=PACKED-ERR --implicit-check-not=error: %s
// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx900 -filetype=null 2>&1 %s | FileCheck -check-prefix=PACKED-ERR --implicit-check-not=error: %s
