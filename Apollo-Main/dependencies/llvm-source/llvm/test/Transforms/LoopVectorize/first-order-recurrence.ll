...
; UNROLL-NO-IC-LABEL: define void @recurrence_1(
; UNROLL-NO-IC-SAME: ptr noalias readonly [[A:%.*]], ptr noalias [[B:%.*]], i32 [[N:%.*]]) {
; UNROLL-NO-IC-NEXT:  [[ENTRY:.*:]]
; UNROLL-NO-IC-NEXT:    br label %[[FOR_PREHEADER:.*]]
; UNROLL-NO-IC:       [[FOR_PREHEADER]]:
...
; UNROLL-NO-IC-NEXT:    [[TMP7:%.*]] = getelementptr inbounds i32, ptr [[TMP5]], i64 4
...
; UNROLL-NO-IC-NEXT:    [[TMP14:%.*]] = getelementptr inbounds i32, ptr [[TMP10]], i64 4
...
; UNROLL-NO-IC-NEXT:    [[VECTOR_RECUR_EXTRACT:%.*]] = extractelement <4 x i32> [[WIDE_LOAD1]], i64 3
...
; UNROLL-NO-IC:       [[FOR_EXIT]]:
; UNROLL-NO-IC-NEXT:    ret void
;
; UNROLL-NO-VF-LABEL: define void @recurrence_1(
; UNROLL-NO-VF-SAME: ptr noalias readonly [[A:%.*]], ptr noalias [[B:%.*]], i32 [[N:%.*]]) {
; UNROLL-NO-VF-NEXT:  [[ENTRY:.*:]]
; UNROLL-NO-VF-NEXT:    br label %[[FOR_PREHEADER:.*]]
; UNROLL-NO-VF:       [[FOR_PREHEADER]]:
...
; UNROLL-NO-VF:       [[FOR_EXIT]]:
; UNROLL-NO-VF-NEXT:    ret void
;
; SINK-AFTER-LABEL: define void @recurrence_1(
; SINK-AFTER-SAME: ptr noalias readonly [[A:%.*]], ptr noalias [[B:%.*]], i32 [[N:%.*]]) {
; SINK-AFTER-NEXT:  [[ENTRY:.*:]]
; SINK-AFTER-NEXT:    br label %[[FOR_PREHEADER:.*]]
; SINK-AFTER:       [[FOR_PREHEADER]]:
...
; SINK-AFTER-NEXT:    [[VECTOR_RECUR_EXTRACT:%.*]] = extractelement <4 x i32> [[WIDE_LOAD]], i64 3
...
; UNROLL-NO-IC-LABEL: define i32 @recurrence_2(
; UNROLL-NO-IC-SAME: ptr readonly captures(none) [[A:%.*]], i32 [[N:%.*]]) {
; UNROLL-NO-IC-NEXT:  [[ENTRY:.*]]:
...
; UNROLL-NO-IC-NEXT:    [[TMP4:%.*]] = getelementptr inbounds i32, ptr [[TMP2]], i64 4
...
; UNROLL-NO-IC-NEXT:    [[VECTOR_RECUR_EXTRACT:%.*]] = extractelement <4 x i32> [[WIDE_LOAD2]], i64 3
...
; UNROLL-NO-IC-NEXT:    br label %[[SCALAR_BODY:.*]]
; UNROLL-NO-IC:       [[FOR_COND_CLEANUP_LOOPEXIT]]:
...
;
; UNROLL-NO-VF-LABEL: define i32 @recurrence_2(
; UNROLL-NO-VF-SAME: ptr readonly captures(none) [[A:%.*]], i32 [[N:%.*]]) {
; UNROLL-NO-VF-NEXT:  [[ENTRY:.*]]:
...
; UNROLL-NO-VF-NEXT:    br label %[[SCALAR_BODY:.*]]
; UNROLL-NO-VF:       [[FOR_COND_CLEANUP_LOOPEXIT]]:
...
;
; SINK-AFTER-LABEL: define i32 @recurrence_2(
; SINK-AFTER-SAME: ptr readonly captures(none) [[A:%.*]], i32 [[N:%.*]]) {
; SINK-AFTER-NEXT:  [[ENTRY:.*]]:
...
; SINK-AFTER-NEXT:    br label %[[SCALAR_BODY:.*]]
; SINK-AFTER:       [[FOR_COND_CLEANUP_LOOPEXIT]]:
...
; UNROLL-NO-IC-LABEL: define void @recurrence_3(
; UNROLL-NO-IC-SAME: ptr noalias readonly [[A:%.*]], ptr noalias [[B:%.*]], i32 [[N:%.*]], float [[F:%.*]], i16 [[P:%.*]]) {
; UNROLL-NO-IC-NEXT:  [[ENTRY:.*:]]
...
; UNROLL-NO-IC-NEXT:    [[TMP6:%.*]] = getelementptr inbounds i16, ptr [[TMP4]], i64 4
...
; UNROLL-NO-IC-NEXT:    [[TMP19:%.*]] = getelementptr inbounds double, ptr [[TMP17]], i64 4
...
; UNROLL-NO-IC:       [[MIDDLE_BLOCK]]:
; UNROLL-NO-IC-NEXT:    [[VECTOR_RECUR_EXTRACT:%.*]] = extractelement <4 x i16> [[WIDE_LOAD1]], i64 3
; UNROLL-NO-IC-NEXT:    [[CMP_N:%.*]] = icmp eq i64 [[TMP2]], [[N_VEC]]
...
; UNROLL-NO-IC:       [[FOR_END_LOOPEXIT]]:
; UNROLL-NO-IC-NEXT:    br label %[[FOR_END]]
; UNROLL-NO-IC:       [[FOR_END]]:
; UNROLL-NO-IC-NEXT:    ret void
;
; UNROLL-NO-VF-LABEL: define void @recurrence_3(
; UNROLL-NO-VF-SAME: ptr noalias readonly [[A:%.*]], ptr noalias [[B:%.*]], i32 [[N:%.*]], float [[F:%.*]], i16 [[P:%.*]]) {
; UNROLL-NO-VF-NEXT:  [[ENTRY:.*:]]
...
; UNROLL-NO-VF:       [[FOR_END_LOOPEXIT]]:
; UNROLL-NO-VF-NEXT:    br label %[[FOR_END]]
; UNROLL-NO-VF:       [[FOR_END]]:
; UNROLL-NO-VF-NEXT:    ret void
;
; SINK-AFTER-LABEL: define void @recurrence_3(
; SINK-AFTER-SAME: ptr noalias readonly [[A:%.*]], ptr noalias [[B:%.*]], i32 [[N:%.*]], float [[F:%.*]], i16 [[P:%.*]]) {
; SINK-AFTER-NEXT:  [[ENTRY:.*:]]
...
; SINK-AFTER:       [[MIDDLE_BLOCK]]:
; SINK-AFTER-NEXT:    [[VECTOR_RECUR_EXTRACT:%.*]] = extractelement <4 x i16> [[WIDE_LOAD]], i64 3
; SINK-AFTER-NEXT:    [[CMP_N:%.*]] = icmp eq i64 [[TMP2]], [[N_VEC]]
...
;
define i32 @PR27246() {
; UNROLL-NO-IC-LABEL: define i32 @PR27246() {
; UNROLL-NO-IC-NEXT:  [[ENTRY:.*]]:
; UNROLL-NO-IC-NEXT:    br label %[[FOR_COND1_PREHEADER:.*]]
; UNROLL-NO-IC:       [[FOR_COND1_PREHEADER]]:
...
; UNROLL-NO-IC:       [[MIDDLE_BLOCK]]:
; UNROLL-NO-IC-NEXT:    [[VECTOR_RECUR_EXTRACT_FOR_PHI:%.*]] = extractelement <4 x i32> [[STEP_ADD]], i64 2
; UNROLL-NO-IC-NEXT:    [[VECTOR_RECUR_EXTRACT:%.*]] = extractelement <4 x i32> [[STEP_ADD]], i64 3
...
; UNROLL-NO-IC:       [[FOR_COND_CLEANUP3]]:
...
;
; UNROLL-NO-VF-LABEL: define i32 @PR27246() {
; UNROLL-NO-VF-NEXT:  [[ENTRY:.*]]:
; UNROLL-NO-VF-NEXT:    br label %[[FOR_COND1_PREHEADER:.*]]
; UNROLL-NO-VF:       [[FOR_COND1_PREHEADER]]:
...
; UNROLL-NO-VF:       [[MIDDLE_BLOCK]]:
; UNROLL-NO-VF-NEXT:    [[TMP4:%.*]] = sub i32 [[I_016]], [[INDEX]]
; UNROLL-NO-VF-NEXT:    [[TMP3:%.*]] = add i32 [[TMP4]], -1
...
; UNROLL-NO-VF:       [[FOR_COND_CLEANUP3]]:
; UNROLL-NO-VF-NEXT:    [[E_1_LCSSA]] = phi i32 [ [[E_1]], %[[FOR_COND1]] ], [ [[TMP4]], %[[MIDDLE_BLOCK]] ]
...
;
; SINK-AFTER-LABEL: define i32 @PR27246() {
; SINK-AFTER-NEXT:  [[ENTRY:.*]]:
; SINK-AFTER-NEXT:    br label %[[FOR_COND1_PREHEADER:.*]]
; SINK-AFTER:       [[FOR_COND1_PREHEADER]]:
...
; SINK-AFTER:       [[MIDDLE_BLOCK]]:
; SINK-AFTER-NEXT:    [[VECTOR_RECUR_EXTRACT_FOR_PHI:%.*]] = extractelement <4 x i32> [[VEC_IND]], i64 2
; SINK-AFTER-NEXT:    [[VECTOR_RECUR_EXTRACT:%.*]] = extractelement <4 x i32> [[VEC_IND]], i64 3
...
; UNROLL-NO-IC-LABEL: define i32 @PR30183(
; UNROLL-NO-IC-SAME: i32 [[PRE_LOAD:%.*]], ptr [[A:%.*]], ptr [[B:%.*]], i64 [[N:%.*]]) {
; UNROLL-NO-IC-NEXT:  [[ENTRY:.*]]:
...
;
; UNROLL-NO-VF-LABEL: define i32 @PR30183(
; UNROLL-NO-VF-SAME: i32 [[PRE_LOAD:%.*]], ptr [[A:%.*]], ptr [[B:%.*]], i64 [[N:%.*]]) {
; UNROLL-NO-VF-NEXT:  [[ENTRY:.*]]:
...
;
; SINK-AFTER-LABEL: define i32 @PR30183(
; SINK-AFTER-SAME: i32 [[PRE_LOAD:%.*]], ptr [[A:%.*]], ptr [[B:%.*]], i64 [[N:%.*]]) {
; SINK-AFTER-NEXT:  [[ENTRY:.*]]:
...
; UNROLL-NO-IC-LABEL: define i64 @constant_folded_previous_value() {
; UNROLL-NO-IC-NEXT:  [[ENTRY:.*:]]
...
;
; UNROLL-NO-VF-LABEL: define i64 @constant_folded_previous_value() {
; UNROLL-NO-VF-NEXT:  [[ENTRY:.*:]]
...
;
; SINK-AFTER-LABEL: define i64 @constant_folded_previous_value() {
; SINK-AFTER-NEXT:  [[ENTRY:.*:]]
...
; UNROLL-NO-IC-LABEL: define i32 @extract_second_last_iteration(
; UNROLL-NO-IC-SAME: ptr [[CVAL:%.*]], i32 [[X:%.*]], i32 [[N:%.*]]) {
; UNROLL-NO-IC-NEXT:  [[ENTRY:.*]]:
; UNROLL-NO-IC-NEXT:    [[TMP1:%.*]] = add i32 [[N]], 1
...
; UNROLL-NO-IC-NEXT:    [[VECTOR_RECUR_EXTRACT_FOR_PHI:%.*]] = extractelement <4 x i32> [[TMP0]], i64 2
; UNROLL-NO-IC-NEXT:    [[VECTOR_RECUR_EXTRACT:%.*]] = extractelement <4 x i32> [[TMP0]], i64 3
...
; UNROLL-NO-IC-NEXT:    br i1 [[CMP]], label %[[FOR_END]], label %[[FOR_BODY]], !llvm.loop [[LOOP14:![0-9]+]]
; UNROLL-NO-IC:       [[FOR_END]]:
...
;
; UNROLL-NO-VF-LABEL: define i32 @extract_second_last_iteration(
; UNROLL-NO-VF-SAME: ptr [[CVAL:%.*]], i32 [[X:%.*]], i32 [[N:%.*]]) {
; UNROLL-NO-VF-NEXT:  [[ENTRY:.*]]:
; UNROLL-NO-VF-NEXT:    [[TMP1:%.*]] = add i32 [[N]], 1
...
;
; SINK-AFTER-LABEL: define i32 @extract_second_last_iteration(
; SINK-AFTER-SAME: ptr [[CVAL:%.*]], i32 [[X:%.*]], i32 [[N:%.*]]) {
; SINK-AFTER-NEXT:  [[ENTRY:.*]]:
; SINK-AFTER-NEXT:    [[TMP1:%.*]] = add i32 [[N]], 1
...
; SINK-AFTER-NEXT:    [[VECTOR_RECUR_EXTRACT_FOR_PHI:%.*]] = extractelement <4 x i32> [[TMP0]], i64 2
; SINK-AFTER-NEXT:    [[VECTOR_RECUR_EXTRACT:%.*]] = extractelement <4 x i32> [[TMP0]], i64 3
...
; SINK-AFTER-NEXT:    br i1 [[CMP]], label %[[FOR_END]], label %[[FOR_BODY]], !llvm.loop [[LOOP14:![0-9]+]]
; SINK-AFTER:       [[FOR_END]]:
...
; UNROLL-NO-IC-LABEL: define i32 @PR33613(
; UNROLL-NO-IC-SAME: ptr [[B:%.*]], double [[J:%.*]], i32 [[D:%.*]], i32 [[N:%.*]]) {
; UNROLL-NO-IC-NEXT:  [[ENTRY:.*]]:
...
; UNROLL-NO-IC-NEXT:    br i1 [[TMP48]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP15:![0-9]+]]
; UNROLL-NO-IC:       [[MIDDLE_BLOCK]]:
...
; UNROLL-NO-IC-NEXT:    br i1 [[EXITCOND]], label %[[FOR_COND_CLEANUP]], label %[[FOR_BODY]], !llvm.loop [[LOOP16:![0-9]+]]
;
; UNROLL-NO-VF-LABEL: define i32 @PR33613(
; UNROLL-NO-VF-SAME: ptr [[B:%.*]], double [[J:%.*]], i32 [[D:%.*]], i32 [[N:%.*]]) {
; UNROLL-NO-VF-NEXT:  [[ENTRY:.*]]:
...
; UNROLL-NO-VF-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 2
; UNROLL-NO-VF-NEXT:    [[TMP19:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[N_VEC]]
; UNROLL-NO-VF-NEXT:    br i1 [[TMP19]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP15:![0-9]+]]
; UNROLL-NO-VF:       [[MIDDLE_BLOCK]]:
...
;
; SINK-AFTER-LABEL: define i32 @PR33613(
; SINK-AFTER-SAME: ptr [[B:%.*]], double [[J:%.*]], i32 [[D:%.*]], i32 [[N:%.*]]) {
; SINK-AFTER-NEXT:  [[ENTRY:.*]]:
...
; SINK-AFTER-NEXT:    br i1 [[TMP27]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP15:![0-9]+]]
; SINK-AFTER:       [[MIDDLE_BLOCK]]:
...
; SINK-AFTER-NEXT:    br i1 [[EXITCOND]], label %[[FOR_COND_CLEANUP]], label %[[FOR_BODY]], !llvm.loop [[LOOP16:![0-9]+]]
;
entry:
...
; UNROLL-NO-IC-LABEL: define void @sink_after(
; UNROLL-NO-IC-SAME: ptr noalias [[A:%.*]], ptr noalias [[B:%.*]], i64 [[N:%.*]]) {
; UNROLL-NO-IC-NEXT:  [[ENTRY:.*]]:
...
; UNROLL-NO-IC-NEXT:    [[TMP4:%.*]] = getelementptr inbounds i16, ptr [[TMP2]], i64 4
...
; UNROLL-NO-IC-NEXT:    [[TMP15:%.*]] = getelementptr inbounds i32, ptr [[TMP13]], i64 4
...
; UNROLL-NO-IC-NEXT:    br i1 [[TMP16]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP17:![0-9]+]]
; UNROLL-NO-IC:       [[MIDDLE_BLOCK]]:
; UNROLL-NO-IC-NEXT:    [[VECTOR_RECUR_EXTRACT:%.*]] = extractelement <4 x i16> [[WIDE_LOAD1]], i64 3
...
; UNROLL-NO-IC-NEXT:    br i1 [[EXITCOND]], label %[[FOR_END]], label %[[FOR_BODY]], !llvm.loop [[LOOP18:![0-9]+]]
; UNROLL-NO-IC:       [[FOR_END]]:
; UNROLL-NO-IC-NEXT:    ret void
;
; UNROLL-NO-VF-LABEL: define void @sink_after(
; UNROLL-NO-VF-SAME: ptr noalias [[A:%.*]], ptr noalias [[B:%.*]], i64 [[N:%.*]]) {
; UNROLL-NO-VF-NEXT:  [[ENTRY:.*]]:
...
; UNROLL-NO-VF-NEXT:    ret void
;
; SINK-AFTER-LABEL: define void @sink_after(
; SINK-AFTER-SAME: ptr noalias [[A:%.*]], ptr noalias [[B:%.*]], i64 [[N:%.*]]) {
; SINK-AFTER-NEXT:  [[ENTRY:.*]]:
...
; SINK-AFTER-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
; SINK-AFTER-NEXT:    [[TMP10:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[N_VEC]]
; SINK-AFTER-NEXT:    br i1 [[TMP10]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP17:![0-9]+]]
; SINK-AFTER:       [[MIDDLE_BLOCK]]:
; SINK-AFTER-NEXT:    [[VECTOR_RECUR_EXTRACT:%.*]] = extractelement <4 x i16> [[WIDE_LOAD]], i64 3
...
; SINK-AFTER-NEXT:    br i1 [[EXITCOND]], label %[[FOR_END]], label %[[FOR_BODY]], !llvm.loop [[LOOP18:![0-9]+]]
; SINK-AFTER:       [[FOR_END]]:
; SINK-AFTER-NEXT:    ret void
;
entry:
...
; UNROLL-NO-IC-LABEL: define void @PR34711(
; UNROLL-NO-IC-SAME: ptr noalias [[A:%.*]], ptr noalias [[B:%.*]], ptr noalias [[C:%.*]], i64 [[N:%.*]]) {
; UNROLL-NO-IC-NEXT:  [[ENTRY:.*]]:
; UNROLL-NO-IC-NEXT:    [[DOTPRE:%.*]] = load i16, ptr [[A]], align 2
; UNROLL-NO-IC-NEXT:    [[MIN_ITERS_CHECK:%.*]] = icmp ult i64 [[N]], 8
; UNROLL-NO-IC-NEXT:    br i1 [[MIN_ITERS_CHECK]], label %[[SCALAR_PH:.*]], label %[[VECTOR_PH:.*]]
...
; UNROLL-NO-IC-NEXT:    [[TMP18:%.*]] = getelementptr inbounds i32, ptr [[TMP8]], i64 4
...
; UNROLL-NO-IC-NEXT:    br i1 [[TMP46]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP19:![0-9]+]]
; UNROLL-NO-IC:       [[MIDDLE_BLOCK]]:
; UNROLL-NO-IC-NEXT:    [[CMP_N:%.*]] = icmp eq i64 [[N]], [[N_VEC]]
; UNROLL-NO-IC-NEXT:    br i1 [[CMP_N]], label %[[FOR_END:.*]], label %[[SCALAR_PH]]
; UNROLL-NO-IC:       [[SCALAR_PH]]:
...
; UNROLL-NO-IC-NEXT:    [[INDVARS_IV_NEXT]] = add nuw nsw i64 [[INDVARS_IV]], 1
; UNROLL-NO-IC-NEXT:    [[EXITCOND:%.*]] = icmp eq i64 [[INDVARS_IV_NEXT]], [[N]]
; UNROLL-NO-IC-NEXT:    br i1 [[EXITCOND]], label %[[FOR_END]], label %[[FOR_BODY]], !llvm.loop [[LOOP20:![0-9]+]]
; UNROLL-NO-IC:       [[FOR_END]]:
; UNROLL-NO-IC-NEXT:    ret void
;
; UNROLL-NO-VF-LABEL: define void @PR34711(
; UNROLL-NO-VF-SAME: ptr noalias [[A:%.*]], ptr noalias [[B:%.*]], ptr noalias [[C:%.*]], i64 [[N:%.*]]) {
; UNROLL-NO-VF-NEXT:  [[ENTRY:.*]]:
; UNROLL-NO-VF-NEXT:    [[DOTPRE:%.*]] = load i16, ptr [[A]], align 2
; UNROLL-NO-VF-NEXT:    [[MIN_ITERS_CHECK:%.*]] = icmp ult i64 [[N]], 2
; UNROLL-NO-VF-NEXT:    br i1 [[MIN_ITERS_CHECK]], label %[[SCALAR_PH:.*]], label %[[VECTOR_PH:.*]]
...
; UNROLL-NO-VF-NEXT:    ret void
;
; SINK-AFTER-LABEL: define void @PR34711(
; SINK-AFTER-SAME: ptr noalias [[A:%.*]], ptr noalias [[B:%.*]], ptr noalias [[C:%.*]], i64 [[N:%.*]]) {
; SINK-AFTER-NEXT:  [[ENTRY:.*]]:
; SINK-AFTER-NEXT:    [[DOTPRE:%.*]] = load i16, ptr [[A]], align 2
; SINK-AFTER-NEXT:    [[MIN_ITERS_CHECK:%.*]] = icmp ult i64 [[N]], 4
; SINK-AFTER-NEXT:    br i1 [[MIN_ITERS_CHECK]], label %[[SCALAR_PH:.*]], label %[[VECTOR_PH:.*]]
...
; SINK-AFTER-NEXT:    br i1 [[TMP24]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP19:![0-9]+]]
; SINK-AFTER:       [[MIDDLE_BLOCK]]:
; SINK-AFTER-NEXT:    [[CMP_N:%.*]] = icmp eq i64 [[N]], [[N_VEC]]
; SINK-AFTER-NEXT:    br i1 [[CMP_N]], label %[[FOR_END:.*]], label %[[SCALAR_PH]]
; SINK-AFTER:       [[SCALAR_PH]]:
...
; SINK-AFTER-NEXT:    [[INDVARS_IV_NEXT]] = add nuw nsw i64 [[INDVARS_IV]], 1
; SINK-AFTER-NEXT:    [[EXITCOND:%.*]] = icmp eq i64 [[INDVARS_IV_NEXT]], [[N]]
; SINK-AFTER-NEXT:    br i1 [[EXITCOND]], label %[[FOR_END]], label %[[FOR_BODY]], !llvm.loop [[LOOP20:![0-9]+]]
; SINK-AFTER:       [[FOR_END]]:
; SINK-AFTER-NEXT:    ret void
;
...
; UNROLL-NO-IC-LABEL: define void @sink_after_with_multiple_users(
; UNROLL-NO-IC-SAME: ptr noalias [[A:%.*]], ptr noalias [[B:%.*]], i64 [[N:%.*]]) {
; UNROLL-NO-IC-NEXT:  [[ENTRY:.*]]:
; UNROLL-NO-IC-NEXT:    [[DOTPRE:%.*]] = load i16, ptr [[A]], align 2
; UNROLL-NO-IC-NEXT:    [[MIN_ITERS_CHECK:%.*]] = icmp ult i64 [[N]], 8
...
; UNROLL-NO-IC-NEXT:    [[TMP17:%.*]] = getelementptr inbounds i32, ptr [[TMP15]], i64 4
...
; UNROLL-NO-IC-NEXT:    br i1 [[TMP18]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP21:![0-9]+]]
; UNROLL-NO-IC:       [[MIDDLE_BLOCK]]:
; UNROLL-NO-IC-NEXT:    [[VECTOR_RECUR_EXTRACT:%.*]] = extractelement <4 x i16> [[WIDE_LOAD1]], i64 3
; UNROLL-NO-IC-NEXT:    [[CMP_N:%.*]] = icmp eq i64 [[N]], [[N_VEC]]
; UNROLL-NO-IC-NEXT:    br i1 [[CMP_N]], label %[[FOR_END:.*]], label %[[SCALAR_PH]]
...
; UNROLL-NO-IC-NEXT:    store i32 [[MUL]], ptr [[ARRAYIDX5]], align 4
; UNROLL-NO-IC-NEXT:    [[EXITCOND:%.*]] = icmp eq i64 [[INDVARS_IV_NEXT]], [[N]]
; UNROLL-NO-IC-NEXT:    br i1 [[EXITCOND]], label %[[FOR_END]], label %[[FOR_BODY]], !llvm.loop [[LOOP22:![0-9]+]]
; UNROLL-NO-IC:       [[FOR_END]]:
; UNROLL-NO-IC-NEXT:    ret void
;
; UNROLL-NO-VF-LABEL: define void @sink_after_with_multiple_users(
; UNROLL-NO-VF-SAME: ptr noalias [[A:%.*]], ptr noalias [[B:%.*]], i64 [[N:%.*]]) {
; UNROLL-NO-VF-NEXT:  [[ENTRY:.*]]:
; UNROLL-NO-VF-NEXT:    [[DOTPRE:%.*]] = load i16, ptr [[A]], align 2
; UNROLL-NO-VF-NEXT:    [[MIN_ITERS_CHECK:%.*]] = icmp ult i64 [[N]], 2
...
; UNROLL-NO-VF-NEXT:    ret void
;
; SINK-AFTER-LABEL: define void @sink_after_with_multiple_users(
; SINK-AFTER-SAME: ptr noalias [[A:%.*]], ptr noalias [[B:%.*]], i64 [[N:%.*]]) {
; SINK-AFTER-NEXT:  [[ENTRY:.*]]:
; SINK-AFTER-NEXT:    [[DOTPRE:%.*]] = load i16, ptr [[A]], align 2
; SINK-AFTER-NEXT:    [[MIN_ITERS_CHECK:%.*]] = icmp ult i64 [[N]], 4
...
; SINK-AFTER-NEXT:    [[INDEX_NEXT]] = add nuw i64 [[INDEX]], 4
; SINK-AFTER-NEXT:    [[TMP11:%.*]] = icmp eq i64 [[INDEX_NEXT]], [[N_VEC]]
; SINK-AFTER-NEXT:    br i1 [[TMP11]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP21:![0-9]+]]
; SINK-AFTER:       [[MIDDLE_BLOCK]]:
; SINK-AFTER-NEXT:    [[VECTOR_RECUR_EXTRACT:%.*]] = extractelement <4 x i16> [[WIDE_LOAD]], i64 3
; SINK-AFTER-NEXT:    [[CMP_N:%.*]] = icmp eq i64 [[N]], [[N_VEC]]
; SINK-AFTER-NEXT:    br i1 [[CMP_N]], label %[[FOR_END:.*]], label %[[SCALAR_PH]]
...
; SINK-AFTER-NEXT:    store i32 [[MUL]], ptr [[ARRAYIDX5]], align 4
; SINK-AFTER-NEXT:    [[EXITCOND:%.*]] = icmp eq i64 [[INDVARS_IV_NEXT]], [[N]]
; SINK-AFTER-NEXT:    br i1 [[EXITCOND]], label %[[FOR_END]], label %[[FOR_BODY]], !llvm.loop [[LOOP22:![0-9]+]]
; SINK-AFTER:       [[FOR_END]]:
; SINK-AFTER-NEXT:    ret void
;
entry:
...
; UNROLL-NO-IC-LABEL: define void @do_not_sink_branch(
; UNROLL-NO-IC-SAME: i32 [[X:%.*]], ptr [[IN:%.*]], ptr [[OUT:%.*]], i32 [[TC:%.*]]) {
; UNROLL-NO-IC-NEXT:  [[ENTRY:.*]]:
; UNROLL-NO-IC-NEXT:    [[CMP530:%.*]] = icmp slt i32 0, [[TC]]
; UNROLL-NO-IC-NEXT:    br label %[[FOR_BODY4:.*]]
; UNROLL-NO-IC:       [[FOR_BODY4]]:
...
; UNROLL-NO-IC:       [[FOR_END12_LOOPEXIT]]:
; UNROLL-NO-IC-NEXT:    ret void
;
; UNROLL-NO-VF-LABEL: define void @do_not_sink_branch(
; UNROLL-NO-VF-SAME: i32 [[X:%.*]], ptr [[IN:%.*]], ptr [[OUT:%.*]], i32 [[TC:%.*]]) {
; UNROLL-NO-VF-NEXT:  [[ENTRY:.*]]:
; UNROLL-NO-VF-NEXT:    [[CMP530:%.*]] = icmp slt i32 0, [[TC]]
; UNROLL-NO-VF-NEXT:    br label %[[FOR_BODY4:.*]]
; UNROLL-NO-VF:       [[FOR_BODY4]]:
...
; UNROLL-NO-VF:       [[FOR_END12_LOOPEXIT]]:
; UNROLL-NO-VF-NEXT:    ret void
;
; SINK-AFTER-LABEL: define void @do_not_sink_branch(
; SINK-AFTER-SAME: i32 [[X:%.*]], ptr [[IN:%.*]], ptr [[OUT:%.*]], i32 [[TC:%.*]]) {
; SINK-AFTER-NEXT:  [[ENTRY:.*]]:
; SINK-AFTER-NEXT:    [[CMP530:%.*]] = icmp slt i32 0, [[TC]]
; SINK-AFTER-NEXT:    br label %[[FOR_BODY4:.*]]
; SINK-AFTER:       [[FOR_BODY4]]:
...
; UNROLL-NO-IC-LABEL: define void @sink_dead_inst(
; UNROLL-NO-IC-SAME: ptr [[A:%.*]]) {
; UNROLL-NO-IC-NEXT:  [[ENTRY:.*:]]
; UNROLL-NO-IC-NEXT:    br label %[[VECTOR_PH:.*]]
; UNROLL-NO-IC:       [[VECTOR_PH]]:
; UNROLL-NO-IC-NEXT:    br label %[[VECTOR_BODY:.*]]
...
; UNROLL-NO-IC-NEXT:    [[TMP12:%.*]] = getelementptr i16, ptr [[TMP10]], i64 4
...
; UNROLL-NO-IC-NEXT:    br i1 [[TMP13]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP23:![0-9]+]]
; UNROLL-NO-IC:       [[MIDDLE_BLOCK]]:
; UNROLL-NO-IC-NEXT:    [[TMP3:%.*]] = zext <4 x i16> [[TMP2]] to <4 x i32>
; UNROLL-NO-IC-NEXT:    [[VECTOR_RECUR_EXTRACT:%.*]] = extractelement <4 x i16> [[TMP5]], i64 3
; UNROLL-NO-IC-NEXT:    [[VECTOR_RECUR_EXTRACT2:%.*]] = extractelement <4 x i32> [[TMP3]], i64 3
; UNROLL-NO-IC-NEXT:    br label %[[SCALAR_PH:.*]]
; UNROLL-NO-IC:       [[SCALAR_PH]]:
; UNROLL-NO-IC-NEXT:    br label %[[FOR_COND:.*]]
; UNROLL-NO-IC:       [[FOR_COND]]:
; UNROLL-NO-IC-NEXT:    [[IV:%.*]] = phi i16 [ 13, %[[SCALAR_PH]] ], [ [[IV_NEXT:%.*]], %[[FOR_COND]] ]
; UNROLL-NO-IC-NEXT:    [[REC_1:%.*]] = phi i16 [ [[VECTOR_RECUR_EXTRACT]], %[[SCALAR_PH]] ], [ [[REC_1_PREV:%.*]], %[[FOR_COND]] ]
; UNROLL-NO-IC-NEXT:    [[REC_2:%.*]] = phi i32 [ [[VECTOR_RECUR_EXTRACT2]], %[[SCALAR_PH]] ], [ [[REC_2_PREV:%.*]], %[[FOR_COND]] ]
...
; UNROLL-NO-IC-NEXT:    br i1 [[CMP]], label %[[FOR_END:.*]], label %[[FOR_COND]], !llvm.loop [[LOOP24:![0-9]+]]
; UNROLL-NO-IC:       [[FOR_END]]:
; UNROLL-NO-IC-NEXT:    ret void
;
; UNROLL-NO-VF-LABEL: define void @sink_dead_inst(
; UNROLL-NO-VF-SAME: ptr [[A:%.*]]) {
; UNROLL-NO-VF-NEXT:  [[ENTRY:.*:]]
; UNROLL-NO-VF-NEXT:    br label %[[VECTOR_PH:.*]]
; UNROLL-NO-VF:       [[VECTOR_PH]]:
; UNROLL-NO-VF-NEXT:    br label %[[VECTOR_BODY:.*]]
...
; UNROLL-NO-VF-NEXT:    [[IV:%.*]] = phi i16 [ 15, %[[SCALAR_PH]] ], [ [[IV_NEXT:%.*]], %[[FOR_COND]] ]
; UNROLL-NO-VF-NEXT:    [[REC_1:%.*]] = phi i16 [ [[TMP6]], %[[SCALAR_PH]] ], [ [[REC_1_PREV:%.*]], %[[FOR_COND]] ]
; UNROLL-NO-VF-NEXT:    [[REC_2:%.*]] = phi i32 [ [[TMP4]], %[[SCALAR_PH]] ], [ [[REC_2_PREV:%.*]], %[[FOR_COND]] ]
...
; SINK-AFTER-NEXT:    br i1 [[TMP8]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP23:![0-9]+]]
; SINK-AFTER:       [[MIDDLE_BLOCK]]:
; SINK-AFTER-NEXT:    [[TMP2:%.*]] = zext <4 x i16> [[TMP1]] to <4 x i32>
; SINK-AFTER-NEXT:    [[VECTOR_RECUR_EXTRACT:%.*]] = extractelement <4 x i16> [[TMP3]], i64 3
; SINK-AFTER-NEXT:    [[VECTOR_RECUR_EXTRACT2:%.*]] = extractelement <4 x i32> [[TMP2]], i64 3
; SINK-AFTER-NEXT:    br label %[[SCALAR_PH:.*]]
; SINK-AFTER:       [[SCALAR_PH]]:
; SINK-AFTER-NEXT:    br label %[[FOR_COND:.*]]
; SINK-AFTER:       [[FOR_COND]]:
; SINK-AFTER-NEXT:    [[IV:%.*]] = phi i16 [ 13, %[[SCALAR_PH]] ], [ [[IV_NEXT:%.*]], %[[FOR_COND]] ]
; SINK-AFTER-NEXT:    [[REC_1:%.*]] = phi i16 [ [[VECTOR_RECUR_EXTRACT]], %[[SCALAR_PH]] ], [ [[REC_1_PREV:%.*]], %[[FOR_COND]] ]
; SINK-AFTER-NEXT:    [[REC_2:%.*]] = phi i32 [ [[VECTOR_RECUR_EXTRACT2]], %[[SCALAR_PH]] ], [ [[REC_2_PREV:%.*]], %[[FOR_COND]] ]
...
; SINK-AFTER-NEXT:    br i1 [[CMP]], label %[[FOR_END:.*]], label %[[FOR_COND]], !llvm.loop [[LOOP24:![0-9]+]]
; SINK-AFTER:       [[FOR_END]]:
; SINK-AFTER-NEXT:    ret void
;
entry:
...
; UNROLL-NO-IC-LABEL: define i32 @sink_into_replication_region(
; UNROLL-NO-IC-SAME: i32 [[Y:%.*]]) {
...
; UNROLL-NO-IC-NEXT:    [[VEC_IV:%.*]] = phi <4 x i32> [ <i32 0, i32 1, i32 2, i32 3>, %[[VECTOR_PH]] ], [ [[VEC_IND_NEXT:%.*]], %[[PRED_UDIV_CONTINUE20]] ]
; UNROLL-NO-IC-NEXT:    [[VEC_IV4:%.*]] = add nuw <4 x i32> [[VEC_IV]], splat (i32 4)
...
; UNROLL-NO-IC-NEXT:    [[INDEX_NEXT]] = add nuw i32 [[INDEX]], 8
; UNROLL-NO-IC-NEXT:    [[VEC_IND_NEXT]] = add nuw <4 x i32> [[VEC_IV4]], splat (i32 4)
; UNROLL-NO-IC-NEXT:    [[TMP50:%.*]] = icmp eq i32 [[INDEX_NEXT]], [[N_VEC]]
; UNROLL-NO-IC-NEXT:    br i1 [[TMP50]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !prof [[PROF25:![0-9]+]], !llvm.loop [[LOOP26:![0-9]+]]
; UNROLL-NO-IC:       [[MIDDLE_BLOCK]]:
...
;
; UNROLL-NO-VF-LABEL: define i32 @sink_into_replication_region(
; UNROLL-NO-VF-SAME: i32 [[Y:%.*]]) {
...
;
; SINK-AFTER-LABEL: define i32 @sink_into_replication_region(
; SINK-AFTER-SAME: i32 [[Y:%.*]]) {
; SINK-AFTER-NEXT:  [[BB:.*:]]
...
; SINK-AFTER-NEXT:    [[INDEX_NEXT]] = add nuw i32 [[INDEX]], 4
; SINK-AFTER-NEXT:    [[VEC_IND_NEXT]] = add nuw <4 x i32> [[VEC_IV]], splat (i32 4)
...
; UNROLL-NO-IC-LABEL: define i32 @sink_into_replication_region_multiple(
; UNROLL-NO-IC-SAME: ptr [[X:%.*]], i32 [[Y:%.*]]) {
; UNROLL-NO-IC-NEXT:  [[BB:.*:]]
; UNROLL-NO-IC-NEXT:    [[TMP0:%.*]] = add i32 [[Y]], 1
; UNROLL-NO-IC-NEXT:    [[SMIN:%.*]] = call i32 @llvm.smin.i32(i32 [[Y]], i32 1)
; UNROLL-NO-IC-NEXT:    [[TMP1:%.*]] = sub i32 [[TMP0]], [[SMIN]]
...
; UNROLL-NO-IC-NEXT:    [[TMP46]] = add <4 x i32> [[VEC_PHI]], [[TMP44]]
; UNROLL-NO-IC-NEXT:    [[TMP47]] = add <4 x i32> [[VEC_PHI1]], [[TMP45]]
; UNROLL-NO-IC-NEXT:    [[TMP48:%.*]] = extractelement <4 x i1> [[TMP10]], i64 0
; UNROLL-NO-IC-NEXT:    br i1 [[TMP48]], label %[[PRED_STORE_IF:.*]], label %[[PRED_STORE_CONTINUE:.*]]
; UNROLL-NO-IC:       [[PRED_STORE_IF]]:
...
; UNROLL-NO-IC:       [[PRED_STORE_CONTINUE]]:
; UNROLL-NO-IC-NEXT:    [[TMP51:%.*]] = extractelement <4 x i1> [[TMP10]], i64 1
; UNROLL-NO-IC-NEXT:    br i1 [[TMP51]], label %[[PRED_STORE_IF16:.*]], label %[[PRED_STORE_CONTINUE17:.*]]
; UNROLL-NO-IC:       [[PRED_STORE_IF16]]:
...
; UNROLL-NO-IC:       [[PRED_STORE_CONTINUE17]]:
; UNROLL-NO-IC-NEXT:    [[TMP54:%.*]] = extractelement <4 x i1> [[TMP10]], i64 2
; UNROLL-NO-IC-NEXT:    br i1 [[TMP54]], label %[[PRED_STORE_IF18:.*]], label %[[PRED_STORE_CONTINUE19:.*]]
; UNROLL-NO-IC:       [[PRED_STORE_IF18]]:
...
; UNROLL-NO-IC:       [[PRED_STORE_CONTINUE19]]:
; UNROLL-NO-IC-NEXT:    [[TMP57:%.*]] = extractelement <4 x i1> [[TMP10]], i64 3
; UNROLL-NO-IC-NEXT:    br i1 [[TMP57]], label %[[PRED_STORE_IF20:.*]], label %[[PRED_STORE_CONTINUE21:.*]]
; UNROLL-NO-IC:       [[PRED_STORE_IF20]]:
...
; UNROLL-NO-IC:       [[PRED_STORE_CONTINUE21]]:
; UNROLL-NO-IC-NEXT:    [[TMP60:%.*]] = extractelement <4 x i1> [[TMP11]], i64 0
; UNROLL-NO-IC-NEXT:    br i1 [[TMP60]], label %[[PRED_STORE_IF22:.*]], label %[[PRED_STORE_CONTINUE23:.*]]
; UNROLL-NO-IC:       [[PRED_STORE_IF22]]:
...
; UNROLL-NO-IC:       [[PRED_STORE_CONTINUE23]]:
...
; UNROLL-NO-IC:       [[PRED_STORE_CONTINUE25]]:
...
; UNROLL-NO-IC:       [[PRED_STORE_CONTINUE27]]:
...
;
; UNROLL-NO-VF-LABEL: define i32 @sink_into_replication_region_multiple(
; UNROLL-NO-VF-SAME: ptr [[X:%.*]], i32 [[Y:%.*]]) {
; UNROLL-NO-VF-NEXT:  [[BB:.*:]]
; UNROLL-NO-VF-NEXT:    [[TMP0:%.*]] = add i32 [[Y]], 1
; UNROLL-NO-VF-NEXT:    [[SMIN:%.*]] = call i32 @llvm.smin.i32(i32 [[Y]], i32 1)
; UNROLL-NO-VF-NEXT:    [[TMP1:%.*]] = sub i32 [[TMP0]], [[SMIN]]
...
; UNROLL-NO-VF-NEXT:    br i1 [[TMP5]], label %[[PRED_UDIV_IF3:.*]], label %[[PRED_UDIV_CONTINUE3:.*]]
; UNROLL-NO-VF:       [[PRED_UDIV_IF3]]:
...
; UNROLL-NO-VF-NEXT:    br i1 [[TMP5]], label %[[PRED_STORE_IF4:.*]], label %[[PRED_STORE_CONTINUE6]]
; UNROLL-NO-VF:       [[PRED_STORE_IF4]]:
...
; UNROLL-NO-VF:       [[PRED_STORE_CONTINUE6]]:
; UNROLL-NO-VF-NEXT:    [[INDEX_NEXT]] = add nuw i32 [[INDEX]], 2
...
; UNROLL-NO-VF-NEXT:    ret i32 [[BIN_RDX]]
;
; SINK-AFTER-LABEL: define i32 @sink_into_replication_region_multiple(
; SINK-AFTER-SAME: ptr [[X:%.*]], i32 [[Y:%.*]]) {
; SINK-AFTER-NEXT:  [[BB:.*:]]
; SINK-AFTER-NEXT:    [[TMP0:%.*]] = add i32 [[Y]], 1
; SINK-AFTER-NEXT:    [[SMIN:%.*]] = call i32 @llvm.smin.i32(i32 [[Y]], i32 1)
; SINK-AFTER-NEXT:    [[TMP1:%.*]] = sub i32 [[TMP0]], [[SMIN]]
...
; SINK-AFTER:       [[PRED_STORE_CONTINUE]]:
; SINK-AFTER-NEXT:    [[TMP28:%.*]] = extractelement <4 x i1> [[TMP6]], i64 1
; SINK-AFTER-NEXT:    br i1 [[TMP28]], label %[[PRED_STORE_IF7:.*]], label %[[PRED_STORE_CONTINUE8:.*]]
; SINK-AFTER:       [[PRED_STORE_IF7]]:
...
; SINK-AFTER:       [[PRED_STORE_CONTINUE8]]:
...
; SINK-AFTER:       [[PRED_STORE_CONTINUE10]]:
...
; UNROLL-NO-IC-LABEL: define i32 @sink_after_dead_inst(
; UNROLL-NO-IC-SAME: ptr [[A_PTR:%.*]], i32 [[N:%.*]]) {
; UNROLL-NO-IC-NEXT:  [[ENTRY:.*:]]
; UNROLL-NO-IC-NEXT:    br label %[[VECTOR_PH:.*]]
; UNROLL-NO-IC:       [[VECTOR_PH]]:
; UNROLL-NO-IC-NEXT:    br label %[[VECTOR_BODY:.*]]
...
; UNROLL-NO-IC-NEXT:    [[TMP6:%.*]] = getelementptr i32, ptr [[TMP4]], i64 4
...
;
; UNROLL-NO-VF-LABEL: define i32 @sink_after_dead_inst(
; UNROLL-NO-VF-SAME: ptr [[A_PTR:%.*]], i32 [[N:%.*]]) {
; UNROLL-NO-VF-NEXT:  [[ENTRY:.*:]]
; UNROLL-NO-VF-NEXT:    br label %[[VECTOR_PH:.*]]
; UNROLL-NO-VF:       [[VECTOR_PH]]:
; UNROLL-NO-VF-NEXT:    br label %[[VECTOR_BODY:.*]]
...
;
; SINK-AFTER-LABEL: define i32 @sink_after_dead_inst(
; SINK-AFTER-SAME: ptr [[A_PTR:%.*]], i32 [[N:%.*]]) {
; SINK-AFTER-NEXT:  [[ENTRY:.*:]]
; SINK-AFTER-NEXT:    br label %[[VECTOR_PH:.*]]
; SINK-AFTER:       [[VECTOR_PH]]:
; SINK-AFTER-NEXT:    br label %[[VECTOR_BODY:.*]]
...
; UNROLL-NO-IC-LABEL: define void @unused_recurrence(
; UNROLL-NO-IC-SAME: ptr [[A:%.*]], i16 [[N:%.*]]) {
; UNROLL-NO-IC-NEXT:  [[ENTRY:.*]]:
...
; UNROLL-NO-IC:       [[MIDDLE_BLOCK]]:
; UNROLL-NO-IC-NEXT:    [[TMP7:%.*]] = add <4 x i16> [[STEP_ADD]], splat (i16 1)
; UNROLL-NO-IC-NEXT:    [[TMP1:%.*]] = add <4 x i16> [[TMP7]], splat (i16 5)
; UNROLL-NO-IC-NEXT:    [[VECTOR_RECUR_EXTRACT:%.*]] = extractelement <4 x i16> [[TMP1]], i64 3
...
; UNROLL-NO-IC-NEXT:    br i1 [[CMP]], label %[[FOR_END]], label %[[FOR_COND]], !llvm.loop [[LOOP31:![0-9]+]]
; UNROLL-NO-IC:       [[FOR_END]]:
; UNROLL-NO-IC-NEXT:    ret void
;
; UNROLL-NO-VF-LABEL: define void @unused_recurrence(
; UNROLL-NO-VF-SAME: ptr [[A:%.*]], i16 [[N:%.*]]) {
; UNROLL-NO-VF-NEXT:  [[ENTRY:.*]]:
...
; UNROLL-NO-VF-NEXT:    br i1 [[CMP]], label %[[FOR_END]], label %[[FOR_COND]], !llvm.loop [[LOOP31:![0-9]+]]
; UNROLL-NO-VF:       [[FOR_END]]:
; UNROLL-NO-VF-NEXT:    ret void
;
; SINK-AFTER-LABEL: define void @unused_recurrence(
; SINK-AFTER-SAME: ptr [[A:%.*]], i16 [[N:%.*]]) {
; SINK-AFTER-NEXT:  [[ENTRY:.*]]:
...
; SINK-AFTER-NEXT:    br i1 [[TMP6]], label %[[MIDDLE_BLOCK:.*]], label %[[VECTOR_BODY]], !llvm.loop [[LOOP30:![0-9]+]]
; SINK-AFTER:       [[MIDDLE_BLOCK]]:
; SINK-AFTER-NEXT:    [[TMP7:%.*]] = add <4 x i16> [[VEC_IND]], splat (i16 1)
; SINK-AFTER-NEXT:    [[TMP1:%.*]] = add <4 x i16> [[TMP7]], splat (i16 5)
; SINK-AFTER-NEXT:    [[VECTOR_RECUR_EXTRACT:%.*]] = extractelement <4 x i16> [[TMP1]], i64 3
...
; SINK-AFTER-NEXT:    br i1 [[CMP]], label %[[FOR_END]], label %[[FOR_COND]], !llvm.loop [[LOOP31:![0-9]+]]
; SINK-AFTER:       [[FOR_END]]:
; SINK-AFTER-NEXT:    ret void
;
entry:
