...
; RUN: opt -p loop-vectorize -force-vector-width=4 -force-vector-interleave=1 -tail-folding-policy=must-fold-tail -S %s | FileCheck %s
...
; CHECK-NEXT:    [[TMP7:%.*]] = extractelement <4 x i1> [[TMP3]], i64 1
...
; CHECK-NEXT:    [[TMP13:%.*]] = extractelement <4 x i1> [[TMP3]], i64 3
