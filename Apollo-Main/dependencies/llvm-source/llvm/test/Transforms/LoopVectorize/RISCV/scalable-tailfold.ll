...
; RUN: opt < %s -passes=loop-vectorize -scalable-vectorization=on -tail-folding-policy=prefer-fold-tail -mtriple riscv64-linux-gnu -mattr=+v,+f -S 2>%t | FileCheck %s -check-prefix=CHECK
