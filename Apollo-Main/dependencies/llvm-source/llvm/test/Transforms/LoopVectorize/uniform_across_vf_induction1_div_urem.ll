...
; CHECK-NEXT:    [[TMP3:%.*]] = extractelement <8 x i64> [[TMP1]], i64 1
; CHECK-NEXT:    [[TMP4:%.*]] = extractelement <8 x i64> [[TMP1]], i64 2
; CHECK-NEXT:    [[TMP5:%.*]] = extractelement <8 x i64> [[TMP1]], i64 3
; CHECK-NEXT:    [[TMP6:%.*]] = extractelement <8 x i64> [[TMP1]], i64 4
; CHECK-NEXT:    [[TMP7:%.*]] = extractelement <8 x i64> [[TMP1]], i64 5
; CHECK-NEXT:    [[TMP8:%.*]] = extractelement <8 x i64> [[TMP1]], i64 6
; CHECK-NEXT:    [[TMP9:%.*]] = extractelement <8 x i64> [[TMP1]], i64 7
...
; CHECK-NEXT:    [[TMP4:%.*]] = extractelement <8 x i64> [[TMP2]], i64 1
; CHECK-NEXT:    [[TMP5:%.*]] = extractelement <8 x i64> [[TMP2]], i64 2
; CHECK-NEXT:    [[TMP6:%.*]] = extractelement <8 x i64> [[TMP2]], i64 3
; CHECK-NEXT:    [[TMP7:%.*]] = extractelement <8 x i64> [[TMP2]], i64 4
; CHECK-NEXT:    [[TMP8:%.*]] = extractelement <8 x i64> [[TMP2]], i64 5
; CHECK-NEXT:    [[TMP9:%.*]] = extractelement <8 x i64> [[TMP2]], i64 6
; CHECK-NEXT:    [[TMP10:%.*]] = extractelement <8 x i64> [[TMP2]], i64 7
; CHECK-NEXT:    [[TMP11:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP3]]
; CHECK-NEXT:    [[TMP12:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP4]]
; CHECK-NEXT:    [[TMP13:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP5]]
; CHECK-NEXT:    [[TMP14:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP6]]
...
; CHECK-NEXT:    [[TMP34:%.*]] = extractelement <8 x i64> [[TMP31]], i64 1
; CHECK-NEXT:    [[TMP35:%.*]] = getelementptr i32, ptr [[SRC_B]], i64 [[TMP34]]
; CHECK-NEXT:    [[TMP36:%.*]] = extractelement <8 x i64> [[TMP31]], i64 2
; CHECK-NEXT:    [[TMP37:%.*]] = getelementptr i32, ptr [[SRC_B]], i64 [[TMP36]]
; CHECK-NEXT:    [[TMP38:%.*]] = extractelement <8 x i64> [[TMP31]], i64 3
; CHECK-NEXT:    [[TMP39:%.*]] = getelementptr i32, ptr [[SRC_B]], i64 [[TMP38]]
; CHECK-NEXT:    [[TMP40:%.*]] = extractelement <8 x i64> [[TMP31]], i64 4
; CHECK-NEXT:    [[TMP41:%.*]] = getelementptr i32, ptr [[SRC_B]], i64 [[TMP40]]
; CHECK-NEXT:    [[TMP42:%.*]] = extractelement <8 x i64> [[TMP31]], i64 5
; CHECK-NEXT:    [[TMP43:%.*]] = getelementptr i32, ptr [[SRC_B]], i64 [[TMP42]]
; CHECK-NEXT:    [[TMP44:%.*]] = extractelement <8 x i64> [[TMP31]], i64 6
; CHECK-NEXT:    [[TMP45:%.*]] = getelementptr i32, ptr [[SRC_B]], i64 [[TMP44]]
; CHECK-NEXT:    [[TMP46:%.*]] = extractelement <8 x i64> [[TMP31]], i64 7
