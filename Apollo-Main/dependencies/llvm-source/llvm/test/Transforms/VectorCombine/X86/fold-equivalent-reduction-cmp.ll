...
; RUN: opt -S -passes=vector-combine -mtriple=x86_64 -mattr=+avx2 < %s | FileCheck %s
...
define i1 @umax_slt_1(<4 x i32> %x) {
; CHECK-LABEL: define i1 @umax_slt_1(
; CHECK-SAME: <4 x i32> [[X:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:    [[TMP1:%.*]] = call i32 @llvm.vector.reduce.umax.v4i32(<4 x i32> [[X]])
...
define i1 @umin_sgt_m2(<4 x i32> %x) {
; CHECK-LABEL: define i1 @umin_sgt_m2(
; CHECK-SAME: <4 x i32> [[X:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:    [[TMP1:%.*]] = call i32 @llvm.vector.reduce.umin.v4i32(<4 x i32> [[X]])
...
; CHECK-NEXT:    ret i1 [[CMP]]
;
  %red = call i64 @llvm.vector.reduce.umin.v2i64(<2 x i64> %x)
  %cmp = icmp eq i64 %red, -1
  ret i1 %cmp
}

define i1 @umax_eq_1(<4 x i32> %x) {
; CHECK-LABEL: define i1 @umax_eq_1(
; CHECK-SAME: <4 x i32> [[X:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:    [[TMP1:%.*]] = call i32 @llvm.vector.reduce.umax.v4i32(<4 x i32> [[X]])
; CHECK-NEXT:    [[CMP:%.*]] = icmp eq i32 [[TMP1]], 1
; CHECK-NEXT:    ret i1 [[CMP]]
...
define i1 @umin_eq_minus2(<4 x i32> %x) {
; CHECK-LABEL: define i1 @umin_eq_minus2(
; CHECK-SAME: <4 x i32> [[X:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:    [[TMP1:%.*]] = call i32 @llvm.vector.reduce.umin.v4i32(<4 x i32> [[X]])
...
define i1 @umax_slt_2(<4 x i32> %x) {
; CHECK-LABEL: define i1 @umax_slt_2(
; CHECK-SAME: <4 x i32> [[X:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:    [[TMP1:%.*]] = call i32 @llvm.vector.reduce.umax.v4i32(<4 x i32> [[X]])
...
define i1 @umin_sgt_m3(<4 x i32> %x) {
; CHECK-LABEL: define i1 @umin_sgt_m3(
; CHECK-SAME: <4 x i32> [[X:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:    [[TMP1:%.*]] = call i32 @llvm.vector.reduce.umin.v4i32(<4 x i32> [[X]])
...
define i1 @umin_eq_0_negative(<4 x i32> %x) {
; CHECK-LABEL: define i1 @umin_eq_0_negative(
; CHECK-SAME: <4 x i32> [[X:%.*]]) #[[ATTR0]] {
...
define i1 @umax_ult_0_negative(<4 x i32> %x) {
; CHECK-LABEL: define i1 @umax_ult_0_negative(
; CHECK-SAME: <4 x i32> [[X:%.*]]) #[[ATTR0]] {
...
define i1 @umax_eq_0_multiuse_negative(<4 x i32> %x) {
; CHECK-LABEL: define i1 @umax_eq_0_multiuse_negative(
; CHECK-SAME: <4 x i32> [[X:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:    [[RED:%.*]] = call i32 @llvm.vector.reduce.umax.v4i32(<4 x i32> [[X]])
...
define i1 @umax_eq_0_scalable_negative(<vscale x 4 x i32> %x) {
; CHECK-LABEL: define i1 @umax_eq_0_scalable_negative(
; CHECK-SAME: <vscale x 4 x i32> [[X:%.*]]) #[[ATTR0]] {
; CHECK-NEXT:    [[RED:%.*]] = call i32 @llvm.vector.reduce.umax.nxv4i32(<vscale x 4 x i32> [[X]])
; CHECK-NEXT:    [[CMP:%.*]] = icmp eq i32 [[RED]], 0
; CHECK-NEXT:    ret i1 [[CMP]]
;
  %red = call i32 @llvm.vector.reduce.umax.nxv4i32(<vscale x 4 x i32> %x)
  %cmp = icmp eq i32 %red, 0
  ret i1 %cmp
}
