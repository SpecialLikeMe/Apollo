...
; X86-NEXT:    [[TMP6:%.*]] = shufflevector <4 x ptr> [[TMP0]], <4 x ptr> poison, <4 x i32> <i32 1, i32 3, i32 0, i32 2>
; X86-NEXT:    [[TMP2:%.*]] = insertelement <8 x ptr> <ptr null, ptr null, ptr poison, ptr poison, ptr null, ptr null, ptr null, ptr null>, ptr [[I242]], i32 2
; X86-NEXT:    [[TMP3:%.*]] = insertelement <8 x ptr> [[TMP2]], ptr [[I250]], i32 3
; X86-NEXT:    [[TMP1:%.*]] = shufflevector <4 x ptr> [[TMP0]], <4 x ptr> poison, <8 x i32> <i32 1, i32 3, i32 0, i32 2, i32 0, i32 2, i32 1, i32 3>
; X86-NEXT:    [[TMP5:%.*]] = shufflevector <4 x ptr> [[TMP6]], <4 x ptr> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
; X86-NEXT:    [[TMP4:%.*]] = icmp ult <8 x ptr> [[TMP3]], [[TMP1]]
; X86-NEXT:    [[TMP7:%.*]] = insertelement <8 x ptr> poison, ptr [[I242]], i32 0
; X86-NEXT:    [[TMP8:%.*]] = insertelement <8 x ptr> [[TMP7]], ptr [[I248]], i32 1
; X86-NEXT:    [[TMP14:%.*]] = insertelement <8 x ptr> [[TMP8]], ptr [[I250]], i32 2
; X86-NEXT:    [[TMP15:%.*]] = insertelement <8 x ptr> [[TMP14]], ptr [[I245]], i32 3
; X86-NEXT:    [[TMP9:%.*]] = shufflevector <8 x ptr> [[TMP15]], <8 x ptr> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 2, i32 3, i32 0, i32 1>
; X86-NEXT:    [[TMP16:%.*]] = shufflevector <4 x ptr> [[TMP6]], <4 x ptr> poison, <8 x i32> <i32 0, i32 poison, i32 2, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; X86-NEXT:    [[TMP17:%.*]] = shufflevector <4 x ptr> [[TMP0]], <4 x ptr> poison, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison>
; X86-NEXT:    [[TMP10:%.*]] = shufflevector <8 x ptr> <ptr null, ptr null, ptr poison, ptr poison, ptr null, ptr null, ptr null, ptr null>, <8 x ptr> [[TMP17]], <8 x i32> <i32 0, i32 1, i32 9, i32 8, i32 4, i32 5, i32 6, i32 7>
