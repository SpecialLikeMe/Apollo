...
; CHECK-NEXT:    [[TMP15:%.*]] = extractelement <16 x i32> [[TMP5]], i32 10
...
; CHECK-NEXT:    [[TMP41:%.*]] = fadd <16 x float> [[TMP30]], zeroinitializer
; CHECK-NEXT:    [[TMP42:%.*]] = insertelement <16 x i1> <i1 poison, i1 false, i1 poison, i1 poison, i1 false, i1 poison, i1 false, i1 false, i1 false, i1 false, i1 false, i1 false, i1 poison, i1 false, i1 false, i1 poison>, i1 false, i32 0
; CHECK-NEXT:    [[TMP33:%.*]] = insertelement <16 x i1> [[TMP42]], i1 false, i32 5
; CHECK-NEXT:    [[TMP34:%.*]] = shufflevector <16 x i1> [[TMP33]], <16 x i1> poison, <16 x i32> <i32 0, i32 1, i32 0, i32 0, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 0, i32 13, i32 14, i32 0>
; CHECK-NEXT:    [[TMP35:%.*]] = select <16 x i1> [[TMP34]], <16 x float> zeroinitializer, <16 x float> [[TMP41]]
...
; CHECK-NEXT:    [[TMP43:%.*]] = extractelement <16 x float> [[TMP29]], i32 0
; CHECK-NEXT:    [[TMP44:%.*]] = fcmp olt float [[TMP43]], 0.000000e+00
; CHECK-NEXT:    [[TMP45:%.*]] = extractelement <16 x float> [[TMP29]], i32 14
; CHECK-NEXT:    [[TMP49:%.*]] = fcmp ogt float [[TMP45]], 0.000000e+00
; CHECK-NEXT:    [[TMP46:%.*]] = fcmp olt float [[TMP45]], 0.000000e+00
; CHECK-NEXT:    [[TMP47:%.*]] = extractelement <16 x float> [[TMP29]], i32 13
; CHECK-NEXT:    [[TMP50:%.*]] = fcmp ogt float [[TMP47]], 0.000000e+00
; CHECK-NEXT:    [[TMP48:%.*]] = fcmp olt float [[TMP47]], 0.000000e+00
; CHECK-NEXT:    [[TMP54:%.*]] = fcmp olt float [[TMP43]], 0.000000e+00
; CHECK-NEXT:    [[TMP51:%.*]] = extractelement <16 x float> [[TMP29]], i32 1
; CHECK-NEXT:    [[TMP55:%.*]] = fcmp ogt float [[TMP51]], 0.000000e+00
