...
; CHECK-NEXT:    [[PTR:%.*]] = getelementptr inbounds i8, ptr @sx, i64 [[I:%.*]]
...
; CHECK-NEXT:    [[PTR:%.*]] = getelementptr inbounds i8, ptr @a3, i64 [[I:%.*]]
...
; CHECK-NEXT:    [[PTR:%.*]] = getelementptr inbounds i8, ptr @s5_3, i64 [[I:%.*]]
; CHECK-NEXT:    [[LEN:%.*]] = call i64 @strnlen(ptr nonnull [[PTR]], i64 [[N:%.*]])
; CHECK-NEXT:    ret i64 [[LEN]]
;
