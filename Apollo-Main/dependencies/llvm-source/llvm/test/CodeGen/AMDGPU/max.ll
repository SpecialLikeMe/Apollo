...
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_max_u32 s6, s10, s14
; SI-NEXT:    s_max_u32 s4, s9, s13
; SI-NEXT:    s_max_u32 s5, s8, s12
...
; SI-NEXT:    s_cselect_b32 s1, s2, s8
