...
; CHECK: @llvm.amdgcn.expect_align1.dynlds = external addrspace(3) global [0 x i8], align 1, !absolute_symbol [[META0]]
; CHECK: @llvm.amdgcn.expect_align2.dynlds = external addrspace(3) global [0 x i8], align 2, !absolute_symbol [[META0]]
...
; CHECK-SAME: ) !llvm.amdgcn.lds.kernel.id [[META5:![0-9]+]] {
