...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck -check-prefixes=GFX9-32BANK %s
; RUN: llc -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx900 < %s | FileCheck -check-prefixes=GFX9-32BANK %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=fiji < %s | FileCheck -check-prefixes=GFX8-32BANK %s
; RUN: llc -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=fiji < %s | FileCheck -check-prefixes=GFX8-32BANK %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx810 < %s | FileCheck -check-prefixes=GFX8-16BANK-SDAG %s
; RUN: llc -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx810 < %s | FileCheck -check-prefixes=GFX8-16BANK-GISEL %s
...
;
; GFX8-16BANK-SDAG-LABEL: interp_f16:
; GFX8-16BANK-SDAG:       ; %bb.0: ; %main_body
; GFX8-16BANK-SDAG-NEXT:    s_mov_b32 m0, s2
; GFX8-16BANK-SDAG-NEXT:    v_interp_mov_f32_e32 v0, p0, attr2.y
; GFX8-16BANK-SDAG-NEXT:    v_mov_b32_e32 v1, s0
; GFX8-16BANK-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 2, 2), 3
; GFX8-16BANK-SDAG-NEXT:    v_interp_p1lv_f16 v2, v1, attr2.y, v0
; GFX8-16BANK-SDAG-NEXT:    v_mov_b32_e32 v3, s1
; GFX8-16BANK-SDAG-NEXT:    v_interp_p1lv_f16 v0, v1, attr2.y, v0 high
; GFX8-16BANK-SDAG-NEXT:    v_interp_p2_f16 v2, v3, attr2.y, v2
; GFX8-16BANK-SDAG-NEXT:    v_interp_p2_f16 v0, v3, attr2.y, v0 high
; GFX8-16BANK-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 2, 2), 0
; GFX8-16BANK-SDAG-NEXT:    v_add_f16_e32 v0, v2, v0
; GFX8-16BANK-SDAG-NEXT:    ; return to shader part epilog
;
; GFX8-16BANK-GISEL-LABEL: interp_f16:
...
; GFX8-16BANK-GISEL-NEXT:    v_interp_p1lv_f16 v2, v0, attr2.y, v1
; GFX8-16BANK-GISEL-NEXT:    v_mov_b32_e32 v3, s1
; GFX8-16BANK-GISEL-NEXT:    v_interp_p1lv_f16 v0, v0, attr2.y, v1 high
; GFX8-16BANK-GISEL-NEXT:    v_interp_p2_f16 v2, v3, attr2.y, v2
; GFX8-16BANK-GISEL-NEXT:    v_interp_p2_f16 v0, v3, attr2.y, v0 high
; GFX8-16BANK-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 2, 2), 0
; GFX8-16BANK-GISEL-NEXT:    v_add_f16_e32 v0, v2, v0
; GFX8-16BANK-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GFX8-32BANK-NEXT:    ; return to shader part epilog
;
; GFX8-16BANK-SDAG-LABEL: interp_p1_m0_setup:
; GFX8-16BANK-SDAG:       ; %bb.0: ; %main_body
; GFX8-16BANK-SDAG-NEXT:    ;;#ASMSTART
; GFX8-16BANK-SDAG-NEXT:    s_mov_b32 m0, 0
; GFX8-16BANK-SDAG-NEXT:    ;;#ASMEND
; GFX8-16BANK-SDAG-NEXT:    s_mov_b32 s3, m0
; GFX8-16BANK-SDAG-NEXT:    s_mov_b32 m0, s2
; GFX8-16BANK-SDAG-NEXT:    v_interp_mov_f32_e32 v0, p0, attr2.y
; GFX8-16BANK-SDAG-NEXT:    v_mov_b32_e32 v1, s0
; GFX8-16BANK-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 2, 2), 3
; GFX8-16BANK-SDAG-NEXT:    v_interp_p1lv_f16 v0, v1, attr2.y, v0
; GFX8-16BANK-SDAG-NEXT:    v_mov_b32_e32 v1, s1
; GFX8-16BANK-SDAG-NEXT:    v_interp_p2_f16 v0, v1, attr2.y, v0
; GFX8-16BANK-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 2, 2), 0
; GFX8-16BANK-SDAG-NEXT:    v_add_f16_e32 v0, s3, v0
; GFX8-16BANK-SDAG-NEXT:    ; return to shader part epilog
;
; GFX8-16BANK-GISEL-LABEL: interp_p1_m0_setup:
; GFX8-16BANK-GISEL:       ; %bb.0: ; %main_body
...
; GFX8-16BANK-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 2, 2), 0
; GFX8-16BANK-GISEL-NEXT:    v_add_f16_e32 v0, s3, v0
; GFX8-16BANK-GISEL-NEXT:    ; return to shader part epilog
main_body:
...
; GFX8-32BANK-NEXT:    ; return to shader part epilog
;
; GFX8-16BANK-SDAG-LABEL: interp_p2_m0_setup:
; GFX8-16BANK-SDAG:       ; %bb.0: ; %main_body
; GFX8-16BANK-SDAG-NEXT:    s_mov_b32 m0, s2
; GFX8-16BANK-SDAG-NEXT:    v_interp_mov_f32_e32 v0, p0, attr2.y
; GFX8-16BANK-SDAG-NEXT:    v_mov_b32_e32 v1, s0
...
; GFX8-16BANK-SDAG-NEXT:    s_mov_b32 m0, 0
; GFX8-16BANK-SDAG-NEXT:    ;;#ASMEND
; GFX8-16BANK-SDAG-NEXT:    s_mov_b32 s0, m0
; GFX8-16BANK-SDAG-NEXT:    v_mov_b32_e32 v1, s1
; GFX8-16BANK-SDAG-NEXT:    s_mov_b32 m0, s2
; GFX8-16BANK-SDAG-NEXT:    v_interp_p2_f16 v0, v1, attr2.y, v0
; GFX8-16BANK-SDAG-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 2, 2), 0
; GFX8-16BANK-SDAG-NEXT:    v_add_f16_e32 v0, s0, v0
; GFX8-16BANK-SDAG-NEXT:    ; return to shader part epilog
;
...
; GFX8-16BANK-GISEL-NEXT:    s_mov_b32 m0, 0
; GFX8-16BANK-GISEL-NEXT:    ;;#ASMEND
; GFX8-16BANK-GISEL-NEXT:    s_mov_b32 s0, m0
; GFX8-16BANK-GISEL-NEXT:    v_mov_b32_e32 v1, s1
; GFX8-16BANK-GISEL-NEXT:    s_mov_b32 m0, s2
; GFX8-16BANK-GISEL-NEXT:    v_interp_p2_f16 v0, v1, attr2.y, v0
; GFX8-16BANK-GISEL-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_MODE, 2, 2), 0
; GFX8-16BANK-GISEL-NEXT:    v_add_f16_e32 v0, s0, v0
; GFX8-16BANK-GISEL-NEXT:    ; return to shader part epilog
main_body:
  %p1_0 = call float @llvm.amdgcn.interp.p1.f16(float %i, i32 1, i32 2, i1 0, i32 %m0)
  %mx = call i32 asm sideeffect "s_mov_b32 m0, 0", "={m0}"() #0
