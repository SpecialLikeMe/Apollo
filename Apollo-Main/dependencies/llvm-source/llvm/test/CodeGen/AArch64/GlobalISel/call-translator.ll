...
; CHECK: [[DBL:%[0-9]+]]:_(f64) = COPY $d0
; CHECK: [[I64:%[0-9]+]]:_(i64) = COPY $x0
; CHECK: [[I8_C:%[0-9]+]]:_(i32) = COPY $w1
; CHECK: [[I8:%[0-9]+]]:_(i8) = G_TRUNC [[I8_C]]
; CHECK: [[ADDR:%[0-9]+]]:_(p0) = COPY $x2

; CHECK: G_STORE [[DBL]](f64), [[ADDR]](p0) :: (store (f64) into %ir.addr)
; CHECK: [[CST1:%[0-9]+]]:_(i64) = G_CONSTANT i64 8
; CHECK: [[GEP1:%[0-9]+]]:_(p0) = nuw inbounds G_PTR_ADD [[ADDR]], [[CST1]](i64)
; CHECK: G_STORE [[I64]](i64), [[GEP1]](p0) :: (store (i64) into %ir.addr + 8)
; CHECK: [[CST2:%[0-9]+]]:_(i64) = G_CONSTANT i64 16
; CHECK: [[GEP2:%[0-9]+]]:_(p0) = nuw inbounds G_PTR_ADD [[ADDR]], [[CST2]](i64)
; CHECK: G_STORE [[I8]](i8), [[GEP2]](p0) :: (store (i8) into %ir.addr + 16, align 8)
; CHECK: RET_ReallyLR
...
; CHECK: [[LD1:%[0-9]+]]:_(f64) = G_LOAD [[ADDR]](p0) :: (load (f64) from %ir.addr)
; CHECK: [[CST1:%[0-9]+]]:_(i64) = G_CONSTANT i64 8
; CHECK: [[GEP1:%[0-9]+]]:_(p0) = nuw inbounds G_PTR_ADD [[ADDR]], [[CST1]](i64)
; CHECK: [[LD2:%[0-9]+]]:_(i64) = G_LOAD [[GEP1]](p0) :: (load (i64) from %ir.addr + 8)
; CHECK: [[CST2:%[0-9]+]]:_(i64) = G_CONSTANT i64 16
; CHECK: [[GEP2:%[0-9]+]]:_(p0) = nuw inbounds G_PTR_ADD [[ADDR]], [[CST2]](i64)
; CHECK: [[LD3:%[0-9]+]]:_(i32) = G_LOAD [[GEP2]](p0) :: (load (i32) from %ir.addr + 16, align 8)

; CHECK: $d0 = COPY [[LD1]](f64)
; CHECK: $x0 = COPY [[LD2]](i64)
; CHECK: $w1 = COPY [[LD3]](i32)
...
; CHECK: [[LD1:%[0-9]+]]:_(i64) = G_LOAD %0(p0) :: (load (i64) from %ir.addr)
; CHECK: [[CST1:%[0-9]+]]:_(i64) = G_CONSTANT i64 8
; CHECK: [[GEP1:%[0-9]+]]:_(p0) = nuw inbounds G_PTR_ADD %0, [[CST1]](i64)
; CHECK: [[LD2:%[0-9]+]]:_(i64) = G_LOAD [[GEP1]](p0) :: (load (i64) from %ir.addr + 8)
; CHECK: [[CST2:%[0-9]+]]:_(i64) = G_CONSTANT i64 16
; CHECK: [[GEP2:%[0-9]+]]:_(p0) = nuw inbounds G_PTR_ADD %0, [[CST2]](i64)
; CHECK: [[LD3:%[0-9]+]]:_(i64) = G_LOAD [[GEP2]](p0) :: (load (i64) from %ir.addr + 16)
; CHECK: [[CST3:%[0-9]+]]:_(i64) = G_CONSTANT i64 24
; CHECK: [[GEP3:%[0-9]+]]:_(p0) = nuw inbounds G_PTR_ADD %0, [[CST3]](i64)
; CHECK: [[LD4:%[0-9]+]]:_(i64) = G_LOAD [[GEP3]](p0) :: (load (i64) from %ir.addr + 24)

; CHECK: $x0 = COPY [[LD1]](i64)
...
; CHECK: [[VAL:%[0-9]+]]:_(i8) = G_LOAD
; CHECK: [[SVAL:%[0-9]+]]:_(i32) = G_ZEXT [[VAL]](i8)
; CHECK: $w0 = COPY [[SVAL]](i32)
; CHECK: RET_ReallyLR implicit $w0
...
; CHECK: [[LHS:%[0-9]+]]:_(i64) = G_LOAD [[LHS_ADDR]](p0) :: (invariant load (i64) from %fixed-stack.[[STACK0]], align 16)
; CHECK: [[RHS_ADDR:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.[[STACK8]]
; CHECK: [[RHS:%[0-9]+]]:_(i64) = G_LOAD [[RHS_ADDR]](p0) :: (invariant load (i64) from %fixed-stack.[[STACK8]])
...
; CHECK: [[SUM:%[0-9]+]]:_(i64) = G_ADD [[LHS]], [[RHS]]
; CHECK: G_STORE [[SUM]](i64), [[ADDR]](p0)
...
; CHECK: [[C42:%[0-9]+]]:_(i64) = G_CONSTANT i64 42
; CHECK: [[C12:%[0-9]+]]:_(i64) = G_CONSTANT i64 12
; CHECK: [[PTR:%[0-9]+]]:_(p0) = G_CONSTANT i64 0
; CHECK: ADJCALLSTACKDOWN 24, 0, implicit-def $sp, implicit $sp
; CHECK: [[SP:%[0-9]+]]:_(p0) = COPY $sp
; CHECK: [[C42_OFFS:%[0-9]+]]:_(i64) = G_CONSTANT i64 0
; CHECK: [[C42_LOC:%[0-9]+]]:_(p0) = G_PTR_ADD [[SP]], [[C42_OFFS]](i64)
; CHECK: G_STORE [[C42]](i64), [[C42_LOC]](p0) :: (store (i64) into stack, align 1)
; CHECK: [[C12_OFFS:%[0-9]+]]:_(i64) = G_CONSTANT i64 8
; CHECK: [[C12_LOC:%[0-9]+]]:_(p0) = G_PTR_ADD [[SP]], [[C12_OFFS]](i64)
; CHECK: G_STORE [[C12]](i64), [[C12_LOC]](p0) :: (store (i64) into stack + 8, align 1)
; CHECK: [[PTR_OFFS:%[0-9]+]]:_(i64) = G_CONSTANT i64 16
; CHECK: [[PTR_LOC:%[0-9]+]]:_(p0) = G_PTR_ADD [[SP]], [[PTR_OFFS]](i64)
...
; CHECK: [[LOAD:%[0-9]+]]:_(i32) = G_LOAD [[ADDR]](p0) :: (invariant load (i8) from %fixed-stack.[[SLOT]], align 16)
; CHECK: [[TRUNC8:%[0-9]+]]:_(i8) = G_TRUNC [[LOAD]]
; CHECK: [[TRUNCASSERT:%[0-9]+]]:_(i8) = G_ASSERT_ZEXT [[TRUNC8]], 1
; CHECK: {{%[0-9]+}}:_(i1) = G_TRUNC [[TRUNCASSERT]]
...
; CHECK: [[LO:%[0-9]+]]:_(i64) = G_LOAD [[LOPTR]](p0) :: (invariant load (i64) from %fixed-stack.[[LO_FRAME]], align 16)

; CHECK: [[HIPTR:%[0-9]+]]:_(p0) = G_FRAME_INDEX %fixed-stack.[[HI_FRAME]]
; CHECK: [[HI:%[0-9]+]]:_(i64) = G_LOAD [[HIPTR]](p0) :: (invariant load (i64) from %fixed-stack.[[HI_FRAME]])
