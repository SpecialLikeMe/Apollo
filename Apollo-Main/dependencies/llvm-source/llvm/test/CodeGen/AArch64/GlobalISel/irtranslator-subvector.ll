...
define i32 @extract_v4i32_vector_insert_const(<4 x i32> %a, <2 x i32> %b, i32 %c) {
  ...
  ; CHECK-NEXT:   [[INSERT_SUBVECTOR:%[0-9]+]]:_(<4 x i32>) = G_INSERT_SUBVECTOR [[COPY]], [[COPY1]](<2 x i32>), 0
  ; CHECK-NEXT:   [[EVEC:%[0-9]+]]:_(i32) = G_EXTRACT_VECTOR_ELT [[INSERT_SUBVECTOR]](<4 x i32>), [[C]](i64)
  ; CHECK-NEXT:   $w0 = COPY [[EVEC]](i32)
...
define double @extract_v4double_vector_insert_const(<4 x double> %a, <2 x double> %b, i32 %c) {
  ...
  ; CHECK-NEXT:   [[COPY3:%[0-9]+]]:_(i32) = COPY $w0
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i64) = G_CONSTANT i64 1
  ; CHECK-NEXT:   [[INSERT_SUBVECTOR:%[0-9]+]]:_(<4 x f64>) = G_INSERT_SUBVECTOR [[CONCAT_VECTORS]], [[BITCAST2]](<2 x f64>), 0
  ; CHECK-NEXT:   [[EVEC:%[0-9]+]]:_(f64) = G_EXTRACT_VECTOR_ELT [[INSERT_SUBVECTOR]](<4 x f64>), [[C]](i64)
  ; CHECK-NEXT:   $d0 = COPY [[EVEC]](f64)
...
define float @extract_v4float_vector_insert_const(<4 x float> %a, <2 x float> %b, i32 %c) {
  ...
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:_(i32) = COPY $w0
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i64) = G_CONSTANT i64 1
  ; CHECK-NEXT:   [[INSERT_SUBVECTOR:%[0-9]+]]:_(<4 x f32>) = G_INSERT_SUBVECTOR [[BITCAST]], [[BITCAST1]](<2 x f32>), 0
  ; CHECK-NEXT:   [[EVEC:%[0-9]+]]:_(f32) = G_EXTRACT_VECTOR_ELT [[INSERT_SUBVECTOR]](<4 x f32>), [[C]](i64)
...
define i32 @extract_v4i32_vector_insert(<4 x i32> %a, <2 x i32> %b, i32 %c) {
  ...
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:_(i32) = COPY $w0
  ; CHECK-NEXT:   [[INSERT_SUBVECTOR:%[0-9]+]]:_(<4 x i32>) = G_INSERT_SUBVECTOR [[COPY]], [[COPY1]](<2 x i32>), 0
  ; CHECK-NEXT:   [[ZEXT:%[0-9]+]]:_(i64) = G_ZEXT [[COPY2]](i32)
  ; CHECK-NEXT:   [[EVEC:%[0-9]+]]:_(i32) = G_EXTRACT_VECTOR_ELT [[INSERT_SUBVECTOR]](<4 x i32>), [[ZEXT]](i64)
  ; CHECK-NEXT:   $w0 = COPY [[EVEC]](i32)
  ; CHECK-NEXT:   RET_ReallyLR implicit $w0
entry:
  %vector = call <4 x i32> @llvm.vector.insert.v4i32.v2i32(<4 x i32> %a, <2 x i32> %b, i64 0)
...
define i32 @extract_v4i32_vector_extract(<4 x i32> %a, <2 x i32> %b, i32 %c) {
  ...
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(<2 x i32>) = COPY $d1
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:_(i32) = COPY $w0
  ; CHECK-NEXT:   [[EXTRACT_SUBVECTOR:%[0-9]+]]:_(<4 x i32>) = G_EXTRACT_SUBVECTOR [[COPY]](<4 x i32>), 0
  ; CHECK-NEXT:   [[ZEXT:%[0-9]+]]:_(i64) = G_ZEXT [[COPY2]](i32)
  ; CHECK-NEXT:   [[EVEC:%[0-9]+]]:_(i32) = G_EXTRACT_VECTOR_ELT [[EXTRACT_SUBVECTOR]](<4 x i32>), [[ZEXT]](i64)
  ; CHECK-NEXT:   $w0 = COPY [[EVEC]](i32)
  ; CHECK-NEXT:   RET_ReallyLR implicit $w0
entry:
...
define i32 @extract_v4i32_vector_extract_const(<vscale x 4 x i32> %a, i32 %c, ptr %p) {
  ...
  ; CHECK-NEXT:   [[EXTRACT_SUBVECTOR:%[0-9]+]]:_(<vscale x 4 x i32>) = G_EXTRACT_SUBVECTOR [[COPY]](<vscale x 4 x i32>), 0
  ; CHECK-NEXT:   G_STORE [[EXTRACT_SUBVECTOR]](<vscale x 4 x i32>), [[COPY2]](p0) :: (store (<vscale x 4 x i32>) into %ir.p)
...
define i32 @extract_v2double_vector_extract_const(<vscale x 2 x double> %a, i32 %c, ptr %p) {
  ...
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:_(p0) = COPY $x1
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 1
  ; CHECK-NEXT:   [[EXTRACT_SUBVECTOR:%[0-9]+]]:_(<vscale x 2 x f64>) = G_EXTRACT_SUBVECTOR [[COPY]](<vscale x 2 x f64>), 0
  ; CHECK-NEXT:   G_STORE [[EXTRACT_SUBVECTOR]](<vscale x 2 x f64>), [[COPY2]](p0) :: (store (<vscale x 2 x f64>) into %ir.p)
  ; CHECK-NEXT:   $w0 = COPY [[C]](i32)
  ; CHECK-NEXT:   RET_ReallyLR implicit $w0
entry:
...
define i32 @extract_v4i32_vector_insert_const_vscale(<vscale x 4 x i32> %a, <vscale x 4 x i32> %b, i32 %c, ptr %p) {
  ...
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 1
  ; CHECK-NEXT:   [[INSERT_SUBVECTOR:%[0-9]+]]:_(<vscale x 4 x i32>) = G_INSERT_SUBVECTOR [[COPY]], [[COPY1]](<vscale x 4 x i32>), 0
  ; CHECK-NEXT:   G_STORE [[INSERT_SUBVECTOR]](<vscale x 4 x i32>), [[COPY3]](p0) :: (store (<vscale x 4 x i32>) into %ir.p)
  ; CHECK-NEXT:   $w0 = COPY [[C]](i32)
  ; CHECK-NEXT:   RET_ReallyLR implicit $w0
entry:
...
define i32 @extract_v4i32_vector_extract_const_illegal_fixed(<4 x i32> %a, ptr %p) {
  ...
  ; CHECK-NEXT:   [[EVEC:%[0-9]+]]:_(i32) = G_EXTRACT_VECTOR_ELT [[COPY]](<4 x i32>), [[C]](i64)
...
define i32 @extract_v4i32_vector_insert_const_fixed(<4 x i32> %a, <1 x i32> %b, i32 %c, ptr %p) {
  ...
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i64) = G_CONSTANT i64 0
  ; CHECK-NEXT:   [[C1:%[0-9]+]]:_(i32) = G_CONSTANT i32 1
  ; CHECK-NEXT:   [[IVEC:%[0-9]+]]:_(<4 x i32>) = G_INSERT_VECTOR_ELT [[COPY]], [[UV]](i32), [[C]](i64)
  ; CHECK-NEXT:   G_STORE [[IVEC]](<4 x i32>), [[COPY3]](p0) :: (store (<4 x i32>) into %ir.p)
  ; CHECK-NEXT:   $w0 = COPY [[C1]](i32)
  ; CHECK-NEXT:   RET_ReallyLR implicit $w0
entry:
...
define i32 @extract_v4i32_vector_insert_const_fixed_illegal(<1 x i32> %a, <1 x i32> %b, i32 %c, ptr %p) {
  ...
  ; CHECK-NEXT:   [[COPY3:%[0-9]+]]:_(p0) = COPY $x1
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 1
  ; CHECK-NEXT:   [[COPY4:%[0-9]+]]:_(i32) = COPY [[UV]](i32)
  ; CHECK-NEXT:   G_STORE [[COPY4]](i32), [[COPY3]](p0) :: (store (i32) into %ir.p, align 16)
  ; CHECK-NEXT:   $w0 = COPY [[C]](i32)
  ; CHECK-NEXT:   RET_ReallyLR implicit $w0
entry:
...
define i32 @extract_v4ifloat_vector_insert_const_fixed_illegal(<1 x float> %a, <1 x float> %b, float %c, ptr %p) {
  ...
  ; CHECK-NEXT:   [[COPY1:%[0-9]+]]:_(<2 x i32>) = COPY $d1
  ; CHECK-NEXT:   [[BITCAST1:%[0-9]+]]:_(<2 x f32>) = G_BITCAST [[COPY1]](<2 x i32>)
  ; CHECK-NEXT:   [[UV2:%[0-9]+]]:_(f32), [[UV3:%[0-9]+]]:_(f32) = G_UNMERGE_VALUES [[BITCAST1]](<2 x f32>)
  ; CHECK-NEXT:   [[COPY2:%[0-9]+]]:_(f32) = COPY $s2
  ; CHECK-NEXT:   [[COPY3:%[0-9]+]]:_(p0) = COPY $x0
  ; CHECK-NEXT:   [[C:%[0-9]+]]:_(i32) = G_CONSTANT i32 1
  ; CHECK-NEXT:   [[COPY4:%[0-9]+]]:_(f32) = COPY [[UV]](f32)
  ; CHECK-NEXT:   G_STORE [[COPY4]](f32), [[COPY3]](p0) :: (store (f32) into %ir.p, align 16)
  ; CHECK-NEXT:   $w0 = COPY [[C]](i32)
  ; CHECK-NEXT:   RET_ReallyLR implicit $w0
entry:
...
define i32 @extract_v4iptr_vector_insert_const_fixed_legal(<4 x ptr> %a, <4 x ptr> %b, ptr %c, ptr %p) {
  ...
  ; CHECK-NEXT:   [[BITCAST2:%[0-9]+]]:_(<2 x p0>) = G_BITCAST [[COPY2]](<2 x i64>)
  ; CHECK-NEXT:   [[BITCAST3:%[0-9]+]]:_(<2 x p0>) = G_BITCAST [[COPY3]](<2 x i64>)
