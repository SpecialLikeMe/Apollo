...
; CHECK-NEXT:    addp v1.4s, v2.4s, v3.4s
; CHECK-NEXT:    sub v2.4s, v2.4s, v4.4s
; CHECK-NEXT:    ext v16.16b, v5.16b, v6.16b, #4
; CHECK-NEXT:    sub v3.4s, v3.4s, v7.4s
...
; CHECK-NEXT:    ext v3.16b, v16.16b, v5.16b, #4
; CHECK-NEXT:    rev64 v4.4s, v4.4s
; CHECK-NEXT:    rev64 v5.4s, v7.4s
; CHECK-NEXT:    mov v17.d[1], v6.d[1]
; CHECK-NEXT:    mov v2.d[1], v3.d[1]
; CHECK-NEXT:    uzp1 v3.4s, v1.4s, v0.4s
; CHECK-NEXT:    uzp2 v0.4s, v1.4s, v0.4s
; CHECK-NEXT:    add v1.4s, v4.4s, v5.4s
; CHECK-NEXT:    add v4.4s, v17.4s, v2.4s
; CHECK-NEXT:    sub v0.4s, v3.4s, v0.4s
; CHECK-NEXT:    sub v2.4s, v2.4s, v17.4s
; CHECK-NEXT:    zip1 v3.4s, v1.4s, v4.4s
; CHECK-NEXT:    uzp2 v5.4s, v1.4s, v4.4s
; CHECK-NEXT:    zip1 v6.4s, v0.4s, v2.4s
; CHECK-NEXT:    trn1 v7.4s, v0.4s, v2.4s
; CHECK-NEXT:    zip2 v16.4s, v1.4s, v4.4s
; CHECK-NEXT:    zip2 v2.4s, v0.4s, v2.4s
; CHECK-NEXT:    trn2 v3.4s, v1.4s, v3.4s
; CHECK-NEXT:    uzp2 v5.4s, v5.4s, v1.4s
; CHECK-NEXT:    ext v0.16b, v0.16b, v6.16b, #8
; CHECK-NEXT:    mov v1.s[1], v4.s[1]
; CHECK-NEXT:    mov v16.d[1], v7.d[1]
; CHECK-NEXT:    mov v3.d[1], v0.d[1]
; CHECK-NEXT:    mov v5.d[1], v2.d[1]
; CHECK-NEXT:    mov v1.d[1], v6.d[1]
; CHECK-NEXT:    add v0.4s, v5.4s, v16.4s
; CHECK-NEXT:    sub v4.4s, v16.4s, v5.4s
; CHECK-NEXT:    add v2.4s, v3.4s, v1.4s
