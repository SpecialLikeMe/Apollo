...
; CHECK-NOFP-SD-NEXT:    fmin s1, s2, s1
...
; CHECK-NOFP-SD-NEXT:    fcvt s1, h1
; CHECK-NOFP-SD-NEXT:    fmin s1, s1, s2
; CHECK-NOFP-SD-NEXT:    fcvt h1, s1
; CHECK-NOFP-SD-NEXT:    fcvt s1, h1
; CHECK-NOFP-SD-NEXT:    fmin s0, s1, s0
...
; CHECK-NOFP-GI-NEXT:    fminv s0, v0.4s
...
; CHECK-NOFP-GI-NEXT:    fmin v0.4s, v1.4s, v0.4s
; CHECK-NOFP-GI-NEXT:    fminv s0, v0.4s
; CHECK-NOFP-GI-NEXT:    fcvt h0, s0
; CHECK-NOFP-GI-NEXT:    ret
...
; CHECK-NOFP-SD-NEXT:    fmin s4, s5, s4
; CHECK-NOFP-SD-NEXT:    mov h5, v0.h[2]
; CHECK-NOFP-SD-NEXT:    fmin s2, s3, s2
...
; CHECK-NOFP-SD-NEXT:    fmin s2, s4, s2
...
; CHECK-NOFP-GI-NEXT:    fmin v0.4s, v2.4s, v0.4s
; CHECK-NOFP-GI-NEXT:    fmin v1.4s, v3.4s, v1.4s
; CHECK-NOFP-GI-NEXT:    fmin v0.4s, v0.4s, v1.4s
; CHECK-NOFP-GI-NEXT:    fminv s0, v0.4s
; CHECK-NOFP-GI-NEXT:    fcvt h0, s0
; CHECK-NOFP-GI-NEXT:    ret
...
; CHECK-NOFP-SD:       // %bb.0:
; CHECK-NOFP-SD-NEXT:    fmin v1.4s, v1.4s, v3.4s
; CHECK-NOFP-SD-NEXT:    fmin v0.4s, v0.4s, v2.4s
; CHECK-NOFP-SD-NEXT:    fmin v0.4s, v0.4s, v1.4s
; CHECK-NOFP-SD-NEXT:    fminv s0, v0.4s
; CHECK-NOFP-SD-NEXT:    ret
;
; CHECK-FP-SD-LABEL: test_v16f32:
; CHECK-FP-SD:       // %bb.0:
; CHECK-FP-SD-NEXT:    fmin v1.4s, v1.4s, v3.4s
; CHECK-FP-SD-NEXT:    fmin v0.4s, v0.4s, v2.4s
; CHECK-FP-SD-NEXT:    fmin v0.4s, v0.4s, v1.4s
...
; CHECK-NOFP-GI:       // %bb.0:
; CHECK-NOFP-GI-NEXT:    fmin v0.4s, v0.4s, v1.4s
; CHECK-NOFP-GI-NEXT:    fmin v1.4s, v2.4s, v3.4s
; CHECK-NOFP-GI-NEXT:    fmin v0.4s, v0.4s, v1.4s
; CHECK-NOFP-GI-NEXT:    fminv s0, v0.4s
; CHECK-NOFP-GI-NEXT:    ret
;
...
; CHECK-FP-GI:       // %bb.0:
; CHECK-FP-GI-NEXT:    fmin v0.4s, v0.4s, v1.4s
; CHECK-FP-GI-NEXT:    fmin v1.4s, v2.4s, v3.4s
; CHECK-FP-GI-NEXT:    fmin v0.4s, v0.4s, v1.4s
; CHECK-FP-GI-NEXT:    fminv s0, v0.4s
; CHECK-FP-GI-NEXT:    ret
