...
define fastcc void @_ZSt16__introsort_loopIPdl17less_than_functorEvT_S2_T0_T1_(ptr %__first, ptr %__last, i64 %__depth_limit) nounwind ssp {
entry:
...
bb1.i:                                            ; preds = %bb1.i, %bb2.outer.i
  ...
  %scevgep.i = getelementptr double, ptr undef, i64 %tmp ; <ptr> [#uses=0]
  br i1 undef, label %bb1.i, label %bb5.preheader.i
