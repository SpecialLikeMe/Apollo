...
define fastcc void @MinSize(ptr %x) nounwind {
entry:
	%tmp13 = load i8, ptr undef, align 4		; <i8> [#uses=3]
...
bb269:
	%tmp3424 = getelementptr %struct.rec, ptr %x, i32 0, i32 0, i32 0, i32 0, i32 1		; <ptr> [#uses=0]
	unreachable
...
bb1109:		; preds = %entry
	call fastcc void @Image(i32 %tmp14) nounwind		; <ptr> [#uses=0]
	unreachable
}
