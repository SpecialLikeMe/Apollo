...
; CHECK-NEXT:    retq
  %res = load <64 x i8>, ptr %addr, align 1
  ret <64 x i8>%res
}

define void @test2(ptr %addr, <64 x i8> %data) {
; CHECK-LABEL: test2:
; CHECK:       ## %bb.0:
; CHECK-NEXT:    vmovups %zmm0, (%rdi)
; CHECK-NEXT:    retq
  store <64 x i8>%data, ptr %addr, align 1
  ret void
}

define <64 x i8> @test3(ptr %addr, <64 x i8> %old, <64 x i8> %mask1) {
; CHECK-LABEL: test3:
; CHECK:       ## %bb.0:
...
define <64 x i8> @test4(ptr %addr, <64 x i8> %mask1) {
; CHECK-LABEL: test4:
; CHECK:       ## %bb.0:
...
define <32 x i16> @test5(ptr %addr) {
; CHECK-LABEL: test5:
; CHECK:       ## %bb.0:
; CHECK-NEXT:    vmovups (%rdi), %zmm0
; CHECK-NEXT:    retq
  %res = load <32 x i16>, ptr %addr, align 1
  ret <32 x i16>%res
}

define void @test6(ptr %addr, <32 x i16> %data) {
; CHECK-LABEL: test6:
; CHECK:       ## %bb.0:
; CHECK-NEXT:    vmovups %zmm0, (%rdi)
; CHECK-NEXT:    retq
  store <32 x i16>%data, ptr %addr, align 1
  ret void
}

define <32 x i16> @test7(ptr %addr, <32 x i16> %old, <32 x i16> %mask1) {
; CHECK-LABEL: test7:
; CHECK:       ## %bb.0:
...
define <32 x i16> @test8(ptr %addr, <32 x i16> %mask1) {
; CHECK-LABEL: test8:
; CHECK:       ## %bb.0:
...
; CHECK-NEXT:    retq
  %res = call <16 x i8> @llvm.masked.load.v16i8(ptr %addr, i32 4, <16 x i1>%mask, <16 x i8> undef)
  ret <16 x i8> %res
}
...
; CHECK-NEXT:    retq
  %res = call <32 x i8> @llvm.masked.load.v32i8(ptr %addr, i32 4, <32 x i1>%mask, <32 x i8> zeroinitializer)
  ret <32 x i8> %res
}
...
; CHECK-NEXT:    ## kill: def $xmm0 killed $xmm0 killed $zmm0
; CHECK-NEXT:    retq
  %res = call <8 x i16> @llvm.masked.load.v8i16(ptr %addr, i32 4, <8 x i1>%mask, <8 x i16> undef)
  ret <8 x i16> %res
}
...
; CHECK-NEXT:    ## kill: def $ymm0 killed $ymm0 killed $zmm0
; CHECK-NEXT:    retq
  %res = call <16 x i16> @llvm.masked.load.v16i16(ptr %addr, i32 4, <16 x i1>%mask, <16 x i16> zeroinitializer)
  ret <16 x i16> %res
}
...
; CHECK-NEXT:    retq
  call void @llvm.masked.store.v16i8(<16 x i8> %val, ptr %addr, i32 4, <16 x i1>%mask)
  ret void
}
...
; CHECK-NEXT:    vmovdqu8 %zmm1, (%rdi) {%k1}
; CHECK-NEXT:    retq
  call void @llvm.masked.store.v32i8(<32 x i8> %val, ptr %addr, i32 4, <32 x i1>%mask)
  ret void
}
...
; CHECK-NEXT:    retq
  call void @llvm.masked.store.v8i16(<8 x i16> %val, ptr %addr, i32 4, <8 x i1>%mask)
  ret void
}
...
; CHECK-NEXT:    vmovdqu16 %zmm1, (%rdi) {%k1}
; CHECK-NEXT:    retq
  call void @llvm.masked.store.v16i16(<16 x i16> %val, ptr %addr, i32 4, <16 x i1>%mask)
  ret void
}
