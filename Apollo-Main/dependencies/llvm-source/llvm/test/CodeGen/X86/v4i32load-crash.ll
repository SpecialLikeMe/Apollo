...
entry:
  %0 = load i32, ptr @e
  %1 = load i32, ptr getelementptr inbounds ([4 x i32], ptr @e, i32 0, i32 1)
  %2 = load i32, ptr getelementptr inbounds ([4 x i32], ptr @e, i32 0, i32 2)
  %3 = load i32, ptr getelementptr inbounds ([4 x i32], ptr @e, i32 0, i32 3)
