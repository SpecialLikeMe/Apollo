...
entry:
  ...
  %am = add <4 x i32> %a, %0
  store <4 x i32> %am, ptr %y, align 16
  %ip0 = shl nsw i32 %i, 2
  %ip1 = or i32 %ip0, 1
  %ip2 = or i32 %ip0, 2
  %ip3 = or i32 %ip0, 3
  %vecext = extractelement <4 x i32> %am, i32 %ip0
  %arrayidx = getelementptr inbounds i32, ptr %x, i32 %ip3
  store i32 %vecext, ptr %arrayidx, align 4
  %vecext5 = extractelement <4 x i32> %am, i32 %ip1
  %arrayidx8 = getelementptr inbounds i32, ptr %x, i32 %ip0
  store i32 %vecext5, ptr %arrayidx8, align 4
  %vecext11 = extractelement <4 x i32> %am, i32 %ip2
  %arrayidx14 = getelementptr inbounds i32, ptr %x, i32 %ip2
  store i32 %vecext11, ptr %arrayidx14, align 4
  %vecext17 = extractelement <4 x i32> %am, i32 %ip3
  %arrayidx20 = getelementptr inbounds i32, ptr %x, i32 %ip1
  store i32 %vecext17, ptr %arrayidx20, align 4
  ret void
}
