...
entry:
  call void asm "foo $1,$0", "=*m,*m,~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) @mout0, ptr elementtype(i32) @min1) nounwind
  ret void
}
...
entry:
  ...
  store i32 %2, ptr %out0, align 4
  %3 = call i32 asm "foo $1,$0", "=r,X,~{dirflag},~{fpsr},~{flags}"(ptr @marray) nounwind
...
entry:
  %out0 = alloca i32, align 4
  store i32 0, ptr %out0, align 4
  %0 = call i32 asm "foo $1,$0", "=r,im,~{dirflag},~{fpsr},~{flags}"(ptr @marray) nounwind
  store i32 %0, ptr %out0, align 4
  ret void
}
...
entry:
  ...
  call void asm "foo $1,$0", "=*m|r,m|r,~{dirflag},~{fpsr},~{flags}"(ptr elementtype(i32) @mout0, i32 %tmp) nounwind
  ret void
}
...
entry:
  ...
  store i32 %2, ptr %out0, align 4
  %3 = call i32 asm "foo $1,$0", "=r|r,r|X,~{dirflag},~{fpsr},~{flags}"(ptr @marray) nounwind
  store i32 %3, ptr %out0, align 4
...
entry:
  %out0 = alloca i32, align 4
  store i32 0, ptr %out0, align 4
  %0 = call i32 asm "foo $1,$0", "=r|r,r|im,~{dirflag},~{fpsr},~{flags}"(ptr @marray) nounwind
  store i32 %0, ptr %out0, align 4
  ret void
}
