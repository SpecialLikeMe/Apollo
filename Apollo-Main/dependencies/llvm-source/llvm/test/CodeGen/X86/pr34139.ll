...
; CHECK-NEXT:    vmovdqa %xmm0, (%rax)
  store <16 x i8> <i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1, i8 -1>, ptr undef
  %load_mask8.i.i.i = load <16 x i8>, ptr undef
  %v.i.i.i.i = load <16 x double>, ptr %ptr
  ...
  store <16 x double> %v1.i.i.i.i, ptr %ptr
  unreachable
}
