...
define <4 x float> @test_fsub_v4f32(<4 x float> %arg1, <4 x float> %arg2) {
; SSE-LABEL: test_fsub_v4f32:
; SSE:       # %bb.0:
; SSE-NEXT:    subps %xmm1, %xmm0
; SSE-NEXT:    retq
;
; AVX-LABEL: test_fsub_v4f32:
; AVX:       # %bb.0:
...
define <2 x double> @test_fsub_v2f64(<2 x double> %arg1, <2 x double> %arg2) {
; SSE-LABEL: test_fsub_v2f64:
; SSE:       # %bb.0:
; SSE-NEXT:    subpd %xmm1, %xmm0
; SSE-NEXT:    retq
;
; AVX-LABEL: test_fsub_v2f64:
; AVX:       # %bb.0:
...
define <8 x float> @test_fsub_v8f32(<8 x float> %arg1, <8 x float> %arg2) {
; SSE-LABEL: test_fsub_v8f32:
; SSE:       # %bb.0:
; SSE-NEXT:    subps %xmm2, %xmm0
; SSE-NEXT:    subps %xmm3, %xmm1
; SSE-NEXT:    retq
;
; AVX-LABEL: test_fsub_v8f32:
; AVX:       # %bb.0:
...
define <4 x double> @test_fsub_v4f64(<4 x double> %arg1, <4 x double> %arg2) {
; SSE-LABEL: test_fsub_v4f64:
; SSE:       # %bb.0:
; SSE-NEXT:    subpd %xmm2, %xmm0
; SSE-NEXT:    subpd %xmm3, %xmm1
; SSE-NEXT:    retq
;
; AVX-LABEL: test_fsub_v4f64:
; AVX:       # %bb.0:
...
define <16 x float> @test_fsub_v16f32(<16 x float> %arg1, <16 x float> %arg2) {
; SSE-LABEL: test_fsub_v16f32:
; SSE:       # %bb.0:
...
; SSE-NEXT:    retq
;
; AVX1-LABEL: test_fsub_v16f32:
; AVX1:       # %bb.0:
; AVX1-NEXT:    vsubps %ymm2, %ymm0, %ymm0
; AVX1-NEXT:    vsubps %ymm3, %ymm1, %ymm1
; AVX1-NEXT:    retq
;
; AVX512-LABEL: test_fsub_v16f32:
; AVX512:       # %bb.0:
...
define <8 x double> @test_fsub_v8f64(<8 x double> %arg1, <8 x double> %arg2) {
; SSE-LABEL: test_fsub_v8f64:
; SSE:       # %bb.0:
