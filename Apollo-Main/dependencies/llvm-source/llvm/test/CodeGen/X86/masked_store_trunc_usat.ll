...
; AVX512BW-NEXT:    vpmovusqd %zmm0, (%rdi) {%k1}
...
; AVX512FVL-NEXT:    vpmovusqw %zmm0, %xmm0
...
; AVX512BW-NEXT:    # kill: def $ymm1 killed $ymm1 def $zmm1
; AVX512BW-NEXT:    vptestmd %zmm1, %zmm1, %k1
; AVX512BW-NEXT:    vpmovusqw %zmm0, (%rdi) {%k1}
; AVX512BW-NEXT:    vzeroupper
; AVX512BW-NEXT:    retq
;
...
; AVX512FVL:       # %bb.0:
; AVX512FVL-NEXT:    vptestmd %ymm1, %ymm1, %k0
; AVX512FVL-NEXT:    vpmovusqb %zmm0, %xmm0
; AVX512FVL-NEXT:    kmovw %k0, %eax
; AVX512FVL-NEXT:    testb $1, %al
...
; AVX512BW-NEXT:    # kill: def $ymm1 killed $ymm1 def $zmm1
; AVX512BW-NEXT:    vptestmd %zmm1, %zmm1, %k1
; AVX512BW-NEXT:    vpmovusqb %zmm0, (%rdi) {%k1}
; AVX512BW-NEXT:    vzeroupper
; AVX512BW-NEXT:    retq
;
...
; AVX512FVL-NEXT:    vpmovusqw %ymm0, %xmm0
; AVX512FVL-NEXT:    kmovw %k0, %eax
; AVX512FVL-NEXT:    testb $1, %al
...
; AVX512FVL:       # %bb.0:
; AVX512FVL-NEXT:    vptestmd %xmm1, %xmm1, %k0
; AVX512FVL-NEXT:    vpmovusqb %ymm0, %xmm0
; AVX512FVL-NEXT:    kmovw %k0, %eax
; AVX512FVL-NEXT:    testb $1, %al
...
; AVX512FVL-NEXT:    vpmovusqw %xmm0, %xmm0
; AVX512FVL-NEXT:    kmovw %k0, %eax
; AVX512FVL-NEXT:    testb $1, %al
...
; AVX512FVL:       # %bb.0:
; AVX512FVL-NEXT:    vptestmq %xmm1, %xmm1, %k0
; AVX512FVL-NEXT:    vpmovusqb %xmm0, %xmm0
; AVX512FVL-NEXT:    kmovw %k0, %eax
; AVX512FVL-NEXT:    testb $1, %al
...
; AVX512FVL-NEXT:    vpmovusdw %zmm0, %ymm0
; AVX512FVL-NEXT:    kmovw %k0, %eax
; AVX512FVL-NEXT:    testb $1, %al
...
; AVX512BW:       # %bb.0:
; AVX512BW-NEXT:    vptestmd %zmm1, %zmm1, %k1
; AVX512BW-NEXT:    vpmovusdw %zmm0, (%rdi) {%k1}
; AVX512BW-NEXT:    vzeroupper
; AVX512BW-NEXT:    retq
;
...
; AVX512FVL:       # %bb.0:
; AVX512FVL-NEXT:    vptestmd %zmm1, %zmm1, %k0
; AVX512FVL-NEXT:    vpmovusdb %zmm0, %xmm0
; AVX512FVL-NEXT:    kmovw %k0, %eax
; AVX512FVL-NEXT:    testb $1, %al
...
; AVX512BW:       # %bb.0:
; AVX512BW-NEXT:    vptestmd %zmm1, %zmm1, %k1
; AVX512BW-NEXT:    vpmovusdb %zmm0, (%rdi) {%k1}
; AVX512BW-NEXT:    vzeroupper
; AVX512BW-NEXT:    retq
;
...
; AVX512FVL:       # %bb.0:
; AVX512FVL-NEXT:    vptestmd %ymm1, %ymm1, %k0
; AVX512FVL-NEXT:    vpmovusdw %ymm0, %xmm0
; AVX512FVL-NEXT:    kmovw %k0, %eax
; AVX512FVL-NEXT:    testb $1, %al
...
; AVX512FVL:       # %bb.0:
; AVX512FVL-NEXT:    vptestmd %ymm1, %ymm1, %k0
; AVX512FVL-NEXT:    vpmovusdb %ymm0, %xmm0
; AVX512FVL-NEXT:    kmovw %k0, %eax
; AVX512FVL-NEXT:    testb $1, %al
...
; AVX512FVL:       # %bb.0:
; AVX512FVL-NEXT:    vptestmd %xmm1, %xmm1, %k0
; AVX512FVL-NEXT:    vpmovusdw %xmm0, %xmm0
; AVX512FVL-NEXT:    kmovw %k0, %eax
; AVX512FVL-NEXT:    testb $1, %al
...
; AVX512FVL:       # %bb.0:
; AVX512FVL-NEXT:    vptestmd %xmm1, %xmm1, %k0
; AVX512FVL-NEXT:    vpmovusdb %xmm0, %xmm0
; AVX512FVL-NEXT:    kmovw %k0, %eax
; AVX512FVL-NEXT:    testb $1, %al
...
; AVX512FVL-NEXT:    vpbroadcastd {{.*#+}} ymm3 = [255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255]
; AVX512FVL-NEXT:    vpminuw %ymm3, %ymm2, %ymm2
; AVX512FVL-NEXT:    vpminuw %ymm3, %ymm0, %ymm0
; AVX512FVL-NEXT:    vpackuswb %ymm2, %ymm0, %ymm0
...
; AVX512FVL-NEXT:    vpminuw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %ymm0, %ymm0
; AVX512FVL-NEXT:    vpmovzxwd {{.*#+}} zmm0 = ymm0[0],zero,ymm0[1],zero,ymm0[2],zero,ymm0[3],zero,ymm0[4],zero,ymm0[5],zero,ymm0[6],zero,ymm0[7],zero,ymm0[8],zero,ymm0[9],zero,ymm0[10],zero,ymm0[11],zero,ymm0[12],zero,ymm0[13],zero,ymm0[14],zero,ymm0[15],zero
; AVX512FVL-NEXT:    vpmovdb %zmm0, %xmm0
...
; AVX512FVL-NEXT:    vptestmd %ymm1, %ymm1, %k0
; AVX512FVL-NEXT:    vpminuw {{\.?LCPI[0-9]+_[0-9]+}}(%rip), %xmm0, %xmm0
; AVX512FVL-NEXT:    vpackuswb %xmm0, %xmm0, %xmm0
; AVX512FVL-NEXT:    kmovw %k0, %eax
; AVX512FVL-NEXT:    testb $1, %al
