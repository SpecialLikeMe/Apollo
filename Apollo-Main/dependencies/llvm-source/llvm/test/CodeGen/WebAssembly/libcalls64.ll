...
; CHECK:         .functype fp128libcalls (i64, i64, i64, i64, i64, i32) -> ()
; CHECK-NEXT:    .local i64
; CHECK-NEXT:  # %bb.0:
; CHECK-NEXT:    global.get $push18=, __stack_pointer
; CHECK-NEXT:    i64.const $push19=, 144
; CHECK-NEXT:    i64.sub $push39=, $pop18, $pop19
; CHECK-NEXT:    local.tee $push38=, 6, $pop39
; CHECK-NEXT:    global.set __stack_pointer, $pop38
; CHECK-NEXT:    local.get $push40=, 6
; CHECK-NEXT:    i64.const $push36=, 128
; CHECK-NEXT:    i64.add $push37=, $pop40, $pop36
...
; CHECK-NEXT:    i64.const $push34=, 112
; CHECK-NEXT:    i64.add $push35=, $pop45, $pop34
...
; CHECK-NEXT:    i64.const $push32=, 96
; CHECK-NEXT:    i64.add $push33=, $pop50, $pop32
...
; CHECK-NEXT:    i64.const $push30=, 80
; CHECK-NEXT:    i64.add $push31=, $pop55, $pop30
...
; CHECK-NEXT:    i64.const $push28=, 64
; CHECK-NEXT:    i64.add $push29=, $pop58, $pop28
...
; CHECK-NEXT:    i64.const $push26=, 48
; CHECK-NEXT:    i64.add $push27=, $pop61, $pop26
...
; CHECK-NEXT:    i64.add $push25=, $pop66, $pop24
...
; CHECK-NEXT:    i64.const $push22=, 16
; CHECK-NEXT:    i64.add $push23=, $pop70, $pop22
...
; CHECK-NEXT:    i64.const $push20=, 144
; CHECK-NEXT:    i64.add $push21=, $pop80, $pop20
...
; CHECK:         .functype i128libcalls (i64, i64, i64, i64, i64) -> ()
; CHECK-NEXT:    .local i64, i64
; CHECK-NEXT:  # %bb.0:
; CHECK-NEXT:    global.get $push8=, __stack_pointer
; CHECK-NEXT:    i64.const $push9=, 32
; CHECK-NEXT:    i64.sub $push17=, $pop8, $pop9
; CHECK-NEXT:    local.tee $push16=, 5, $pop17
; CHECK-NEXT:    global.set __stack_pointer, $pop16
; CHECK-NEXT:    local.get $push18=, 5
; CHECK-NEXT:    i64.const $push12=, 16
; CHECK-NEXT:    i64.add $push13=, $pop18, $pop12
...
; CHECK-NEXT:    i64.add $push11=, $pop36, $pop10
...
; CHECK-NEXT:    i64.sub $push21=, $pop12, $pop13
...
; CHECK-NEXT:    local.get $push26=, 3
; CHECK-NEXT:    i64.const $push18=, 4
; CHECK-NEXT:    i64.add $push19=, $pop26, $pop18
...
; CHECK-NEXT:    i64.const $push16=, 8
; CHECK-NEXT:    i64.add $push17=, $pop29, $pop16
; CHECK-NEXT:    call $push30=, modf, $pop31, $pop17
; CHECK-NEXT:    local.set 0, $pop30
; CHECK-NEXT:    local.get $push32=, 3
; CHECK-NEXT:    i64.const $push14=, 16
; CHECK-NEXT:    i64.add $push15=, $pop32, $pop14
