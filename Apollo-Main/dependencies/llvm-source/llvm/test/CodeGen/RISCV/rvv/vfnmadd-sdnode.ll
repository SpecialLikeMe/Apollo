...
; RUN:     -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK,ZVFBFA
; RUN: llc -mtriple=riscv32 -mattr=+d,+zvfh,+zvfbfwma,+v \
; RUN:     -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK,ZVFBFWMA
; RUN: llc -mtriple=riscv64 -mattr=+d,+zvfh,+zvfbfwma,+v \
; RUN:     -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK,ZVFBFWMA
...
; ZVFBFWMA-NEXT:    ret
  ...
  %neg2 = fneg <vscale x 1 x bfloat> %vc
  %vd = call <vscale x 1 x bfloat> @llvm.fma.v1bf16(<vscale x 1 x bfloat> %neg, <vscale x 1 x bfloat> %vb, <vscale x 1 x bfloat> %neg2)
...
; ZVFBFWMA-NEXT:    ret
  ...
  %neg = fneg <vscale x 1 x bfloat> %va
  %neg2 = fneg <vscale x 1 x bfloat> %vb
  %vd = call <vscale x 1 x bfloat> @llvm.fma.v1bf16(<vscale x 1 x bfloat> %neg, <vscale x 1 x bfloat> %splat, <vscale x 1 x bfloat> %neg2)
  ret <vscale x 1 x bfloat> %vd
}
...
; ZVFBFWMA-NEXT:    ret
  ...
  %neg2 = fneg <vscale x 2 x bfloat> %vb
  %vd = call <vscale x 2 x bfloat> @llvm.fma.v2bf16(<vscale x 2 x bfloat> %neg, <vscale x 2 x bfloat> %vc, <vscale x 2 x bfloat> %neg2)
...
; ZVFBFWMA-NEXT:    ret
  ...
  %neg = fneg <vscale x 2 x bfloat> %va
  %neg2 = fneg <vscale x 2 x bfloat> %vb
  %vd = call <vscale x 2 x bfloat> @llvm.fma.v2bf16(<vscale x 2 x bfloat> %splat, <vscale x 2 x bfloat> %neg, <vscale x 2 x bfloat> %neg2)
  ret <vscale x 2 x bfloat> %vd
}
...
; ZVFBFMIN-NEXT:    vxor.vx v9, v9, a0
; ZVFBFMIN-NEXT:    vxor.vx v12, v10, a0
...
; ZVFBFWMA-NEXT:    ret
  ...
  %neg2 = fneg <vscale x 4 x bfloat> %vc
  %vd = call <vscale x 4 x bfloat> @llvm.fma.v4bf16(<vscale x 4 x bfloat> %neg, <vscale x 4 x bfloat> %va, <vscale x 4 x bfloat> %neg2)
...
; ZVFBFWMA-NEXT:    ret
  ...
  %neg2 = fneg <vscale x 4 x bfloat> %vb
  %vd = call <vscale x 4 x bfloat> @llvm.fma.v4bf16(<vscale x 4 x bfloat> %va, <vscale x 4 x bfloat> %neg, <vscale x 4 x bfloat> %neg2)
  ret <vscale x 4 x bfloat> %vd
}
...
; ZVFBFWMA-NEXT:    ret
  ...
  %neg2 = fneg <vscale x 8 x bfloat> %va
  %vd = call <vscale x 8 x bfloat> @llvm.fma.v8bf16(<vscale x 8 x bfloat> %neg, <vscale x 8 x bfloat> %vc, <vscale x 8 x bfloat> %neg2)
...
; ZVFBFMIN-NEXT:    lui a0, 8
; ZVFBFMIN-NEXT:    vxor.vx v8, v8, a0
; ZVFBFMIN-NEXT:    vxor.vx v20, v12, a0
...
; ZVFBFWMA-NEXT:    ret
  ...
  %neg2 = fneg <vscale x 8 x bfloat> %va
  %vd = call <vscale x 8 x bfloat> @llvm.fma.v8bf16(<vscale x 8 x bfloat> %vb, <vscale x 8 x bfloat> %neg, <vscale x 8 x bfloat> %neg2)
  ret <vscale x 8 x bfloat> %vd
}
...
; ZVFBFMIN-NEXT:    vxor.vx v4, v16, a0
...
; ZVFBFWMA-NEXT:    ret
  ...
  %neg2 = fneg <vscale x 16 x bfloat> %vb
  %vd = call <vscale x 16 x bfloat> @llvm.fma.v16bf16(<vscale x 16 x bfloat> %neg, <vscale x 16 x bfloat> %va, <vscale x 16 x bfloat> %neg2)
...
; ZVFBFMIN-NEXT:    vxor.vx v8, v0, a0
; ZVFBFMIN-NEXT:    csrr a1, vlenb
; ZVFBFMIN-NEXT:    slli a1, a1, 4
; ZVFBFMIN-NEXT:    add a1, sp, a1
; ZVFBFMIN-NEXT:    addi a1, a1, 16
; ZVFBFMIN-NEXT:    vs8r.v v8, (a1) # vscale x 64-byte Folded Spill
; ZVFBFMIN-NEXT:    vxor.vx v16, v16, a0
...
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFBFMIN-NEXT:    vfmadd.vv v24, v0, v8
; ZVFBFMIN-NEXT:    csrr a0, vlenb
; ZVFBFMIN-NEXT:    slli a0, a0, 3
...
; ZVFBFWMA-NEXT:    ret
  ...
  %neg2 = fneg <vscale x 32 x bfloat> %vb
  %vd = call <vscale x 32 x bfloat> @llvm.fma.v32bf16(<vscale x 32 x bfloat> %neg, <vscale x 32 x bfloat> %va, <vscale x 32 x bfloat> %neg2)
...
; ZVFBFWMA-NEXT:    ret
  ...
  %neg2 = fneg <vscale x 32 x bfloat> %va
  %vd = call <vscale x 32 x bfloat> @llvm.fma.v32bf16(<vscale x 32 x bfloat> %neg, <vscale x 32 x bfloat> %vb, <vscale x 32 x bfloat> %neg2)
  ret <vscale x 32 x bfloat> %vd
}
