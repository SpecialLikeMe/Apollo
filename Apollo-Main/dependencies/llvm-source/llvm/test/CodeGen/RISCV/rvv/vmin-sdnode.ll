...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 1 x i8> %va, splat (i8 -3)
...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 2 x i8> %va, splat (i8 -3)
...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 4 x i8> %va, splat (i8 -3)
...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 8 x i8> %va, splat (i8 -3)
...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 16 x i8> %va, splat (i8 -3)
...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 32 x i8> %va, splat (i8 -3)
...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 64 x i8> %va, splat (i8 -3)
...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 1 x i16> %va, splat (i16 -3)
...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 2 x i16> %va, splat (i16 -3)
...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 4 x i16> %va, splat (i16 -3)
...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 8 x i16> %va, splat (i16 -3)
...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 16 x i16> %va, splat (i16 -3)
...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 32 x i16> %va, splat (i16 -3)
...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 1 x i32> %va, splat (i32 -3)
...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 2 x i32> %va, splat (i32 -3)
...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 4 x i32> %va, splat (i32 -3)
...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 8 x i32> %va, splat (i32 -3)
...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 16 x i32> %va, splat (i32 -3)
...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 1 x i64> %va, splat (i64 -3)
...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 2 x i64> %va, splat (i64 -3)
...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 4 x i64> %va, splat (i64 -3)
...
; CHECK-NEXT:    vmin.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp slt <vscale x 8 x i64> %va, splat (i64 -3)
