...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 1 x i8> %va, splat (i8 -3)
...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 2 x i8> %va, splat (i8 -3)
...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 4 x i8> %va, splat (i8 -3)
...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 8 x i8> %va, splat (i8 -3)
...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 16 x i8> %va, splat (i8 -3)
...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 32 x i8> %va, splat (i8 -3)
...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 64 x i8> %va, splat (i8 -3)
...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 1 x i16> %va, splat (i16 -3)
...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 2 x i16> %va, splat (i16 -3)
...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 4 x i16> %va, splat (i16 -3)
...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 8 x i16> %va, splat (i16 -3)
...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 16 x i16> %va, splat (i16 -3)
...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 32 x i16> %va, splat (i16 -3)
...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 1 x i32> %va, splat (i32 -3)
...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 2 x i32> %va, splat (i32 -3)
...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 4 x i32> %va, splat (i32 -3)
...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 8 x i32> %va, splat (i32 -3)
...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 16 x i32> %va, splat (i32 -3)
...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 1 x i64> %va, splat (i64 -3)
...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 2 x i64> %va, splat (i64 -3)
...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 4 x i64> %va, splat (i64 -3)
...
; CHECK-NEXT:    vmaxu.vx v8, v8, a0
; CHECK-NEXT:    ret
  %cmp = icmp ugt <vscale x 8 x i64> %va, splat (i64 -3)
...
; CHECK-NEXT:    vmaxu.vv v8, v8, v12
; CHECK-NEXT:    ret
  %vs = select <vscale x 8 x i1> %mask, <vscale x 8 x i32> splat (i32 -3), <vscale x 8 x i32> zeroinitializer
  %cmp = icmp ugt <vscale x 8 x i32> %va, %vs
  %vc = select <vscale x 8 x i1> %cmp, <vscale x 8 x i32> %va, <vscale x 8 x i32> %vs
  ret <vscale x 8 x i32> %vc
}
