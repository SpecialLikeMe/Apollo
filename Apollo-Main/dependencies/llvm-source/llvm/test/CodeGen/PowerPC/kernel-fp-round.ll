...
; CHECK-NEXT:   %4:f8rc = LFIWAX $zero8, %3 :: (load (s32) from %stack.0)
...
; CHECK-P6-NEXT:   %4:f8rc = LFIWAX $zero, %3 :: (load (s32) from %stack.0)
...
; CHECK-P6-64-NEXT:   %4:f8rc = LFIWAX $zero8, %3 :: (load (s32) from %stack.0)
