...
///
/// \file
/// This file contains the conformance test of the log2f function.
///
//===----------------------------------------------------------------------===//
...
template <> struct FunctionConfig<log2f> {
  static constexpr llvm::StringRef Name = "log2f";
  static constexpr llvm::StringRef KernelName = "log2fKernel";
...
int main(int argc, const char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv,
                                    "Conformance test of the log2f function");
  ...
  bool Passed = runTests<log2f>(Generator, Configs, DeviceBinaryDir, IsVerbose);
