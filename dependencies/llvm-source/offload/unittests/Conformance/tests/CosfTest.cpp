...
///
/// \file
/// This file contains the conformance test of the cosf function.
///
//===----------------------------------------------------------------------===//
...
template <> struct FunctionConfig<cosf> {
  static constexpr llvm::StringRef Name = "cosf";
  static constexpr llvm::StringRef KernelName = "cosfKernel";
...
int main(int argc, const char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv,
                                    "Conformance test of the cosf function");
  ...
  bool Passed = runTests<cosf>(Generator, Configs, DeviceBinaryDir, IsVerbose);
