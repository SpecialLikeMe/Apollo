...
///
/// \file
/// This file contains the conformance test of the cospif function.
///
//===----------------------------------------------------------------------===//
...
template <> struct FunctionConfig<cospif> {
  static constexpr llvm::StringRef Name = "cospif";
  static constexpr llvm::StringRef KernelName = "cospifKernel";
...
int main(int argc, const char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv,
                                    "Conformance test of the cospif function");
  ...
  bool Passed =
      runTests<cospif>(Generator, Configs, DeviceBinaryDir, IsVerbose);
