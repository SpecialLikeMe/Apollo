...
_Z4foo2v:                               # @_Z4foo2v
.Lfunc_begin0:
	.file	1 "dwarf4-types-index-split-test" "helper2.cpp"
	.loc	1 11 0                          # helper2.cpp:11:0
	.cfi_startproc
# %bb.0:                                # %entry
	pushq	%rbp
...
.Ltmp0:
	.loc	1 14 3 prologue_end             # helper2.cpp:14:3
	xorl	%eax, %eax
	.loc	1 14 3 epilogue_begin is_stmt 0 # helper2.cpp:14:3
	popq	%rbp
	.cfi_def_cfa %rsp, 8
	retq
.Ltmp1:
.Lfunc_end0:
	...
	.cfi_endproc
                                        # -- End function
	.section	.debug_types,"G",@progbits,10328350931784810499,comdat
...
.Ldebug_info_start0:
	...
	.byte	0                               # End Of Children Mark
.Ldebug_info_end0:
	.section	.debug_types,"G",@progbits,16677756278370493230,comdat
...
.Ldebug_info_start2:
	...
	.long	107                             # DW_AT_type
	.byte	8                               # Abbrev [8] 0x55:0xe DW_TAG_variable
	.byte	2                               # DW_AT_location
	.byte	145
	.byte	88
...
.Linfo_string2:
	.asciz	"dwarf4-types-index-split-test" # string offset=117
.Linfo_string3:
	.asciz	"_Z4foo2v"                      # string offset=185
.Linfo_string4:
	.asciz	"foo2"                          # string offset=194
.Linfo_string5:
	.asciz	"int"                           # string offset=199
.Linfo_string6:
	.asciz	"f"                             # string offset=203
.Linfo_string7:
	.asciz	"c1"                            # string offset=205
.Linfo_string8:
	.asciz	"char"                          # string offset=208
.Linfo_string9:
	.asciz	"c2"                            # string offset=213
.Linfo_string10:
	.asciz	"c3"                            # string offset=216
.Linfo_string11:
	.asciz	"Foo2b"                         # string offset=219
.Linfo_string12:
	.asciz	"f2"                            # string offset=225
.Linfo_string13:
	.asciz	"Foo3b"                         # string offset=228
