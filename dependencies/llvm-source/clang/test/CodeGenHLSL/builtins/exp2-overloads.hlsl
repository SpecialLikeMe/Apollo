...
// CHECK:    ret float [[V2]]
// expected-warning@+1 {{'exp2' is deprecated: In 202x 64 bit API lowering for exp2 is deprecated. Explicitly cast parameters to 32 or 16 bit types.}}
...
// CHECK:    [[V2:%.*]] = call {{.*}} float @llvm.exp2.f32(float [[CONVI]])
// CHECK:    ret float [[V2]]
// expected-warning@+1 {{'exp2' is deprecated: In 202x int lowering for exp2 is deprecated. Explicitly cast parameters to float types.}}
