...
! CHECK-LABEL: func.func @_QPbgt_test1(
...
! CHECK-LABEL: func.func @_QPbgt_test2(
...
! CHECK-LABEL: func.func @_QPbgt_test3(
! CHECK-SAME: %[[A:.*]]: !fir.ref<i32> {{.*}}, %[[B:.*]]: !fir.ref<i32> {{.*}}, %[[C:.*]]: !fir.ref<!fir.logical<4>> {{.*}}) {
...
! CHECK-LABEL: func.func @_QPbgt_test4(
...
! CHECK-LABEL: func.func @_QPbgt_test5(
...
! CHECK-LABEL: func.func @_QPbgt_test6(
...
! CHECK-LABEL: func.func @_QPbgt_test7(
...
! CHECK-LABEL: func.func @_QPbgt_test8(
...
! CHECK-LABEL: func.func @_QPbgt_test9(
...
! CHECK-LABEL: func.func @_QPbgt_test11(
! CHECK-SAME: %[[C:.*]]: !fir.ref<!fir.logical<4>> {{.*}}) {
