...
class SyntheticFilterRecomputingTestCase(TestBase):
    ...
    def test_rdar12437442_with_run_command(self):
        ...
        self.assertEqual(
            id_x.GetSummary(), '@"5 elements"', "array does not get correct summary"
        )
        ...
        self.assertEqual(
            id_x.GetNumChildren(), 7, "dictionary does not have 7 children"
        )
        id_x.SetPreferSyntheticValue(False)
        self.assertNotEqual(
            id_x.GetNumChildren(), 7, "dictionary still looks synthetic"
        )
        id_x.SetPreferSyntheticValue(True)
        self.assertEqual(
            id_x.GetSummary(),
