...
; VF2-NEXT:    [[TMP3:%.*]] = extractelement <2 x i64> [[TMP2]], i64 0
; VF2-NEXT:    [[TMP4:%.*]] = extractelement <2 x i64> [[TMP2]], i64 1
...
; VF4-NEXT:    [[TMP3:%.*]] = extractelement <4 x i64> [[TMP2]], i64 0
; VF4-NEXT:    [[TMP4:%.*]] = extractelement <4 x i64> [[TMP2]], i64 1
; VF4-NEXT:    [[TMP5:%.*]] = extractelement <4 x i64> [[TMP2]], i64 2
; VF4-NEXT:    [[TMP6:%.*]] = extractelement <4 x i64> [[TMP2]], i64 3
...
; VF2-NEXT:    [[VEC_IND1:%.*]] = phi <2 x i64> [ <i64 0, i64 1>, [[VECTOR_PH]] ], [ [[VEC_IND_NEXT2:%.*]], [[VECTOR_BODY]] ]
; VF2-NEXT:    [[TMP0:%.*]] = shl i64 [[INDEX]], 1
; VF2-NEXT:    [[TMP1:%.*]] = add i64 [[TMP0]], 2
...
; VF2-NEXT:    [[TMP5:%.*]] = extractelement <2 x i64> [[TMP4]], i64 0
; VF2-NEXT:    [[TMP6:%.*]] = extractelement <2 x i64> [[TMP4]], i64 1
...
; VF2-NEXT:    [[TMP14:%.*]] = extractelement <2 x i64> [[TMP13]], i64 0
; VF2-NEXT:    [[TMP15:%.*]] = extractelement <2 x i64> [[TMP13]], i64 1
...
; VF4-NEXT:    [[VEC_IND1:%.*]] = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, [[VECTOR_PH]] ], [ [[VEC_IND_NEXT2:%.*]], [[VECTOR_BODY]] ]
; VF4-NEXT:    [[TMP0:%.*]] = shl i64 [[INDEX]], 1
; VF4-NEXT:    [[TMP1:%.*]] = add i64 [[TMP0]], 2
; VF4-NEXT:    [[TMP2:%.*]] = add i64 [[TMP0]], 4
; VF4-NEXT:    [[TMP3:%.*]] = add i64 [[TMP0]], 6
...
; VF4-NEXT:    [[TMP7:%.*]] = extractelement <4 x i64> [[TMP6]], i64 0
; VF4-NEXT:    [[TMP8:%.*]] = extractelement <4 x i64> [[TMP6]], i64 1
; VF4-NEXT:    [[TMP9:%.*]] = extractelement <4 x i64> [[TMP6]], i64 2
; VF4-NEXT:    [[TMP10:%.*]] = extractelement <4 x i64> [[TMP6]], i64 3
...
; VF4-NEXT:    [[TMP24:%.*]] = extractelement <4 x i64> [[TMP23]], i64 0
; VF4-NEXT:    [[TMP25:%.*]] = extractelement <4 x i64> [[TMP23]], i64 1
; VF4-NEXT:    [[TMP26:%.*]] = extractelement <4 x i64> [[TMP23]], i64 2
; VF4-NEXT:    [[TMP27:%.*]] = extractelement <4 x i64> [[TMP23]], i64 3
...
; VF4-NEXT:    [[TMP1:%.*]] = add i64 [[TMP0]], 3
; VF4-NEXT:    [[TMP2:%.*]] = add i64 [[TMP0]], 6
; VF4-NEXT:    [[TMP3:%.*]] = add i64 [[TMP0]], 9
; VF4-NEXT:    [[TMP4:%.*]] = lshr <4 x i64> [[VEC_IND]], zeroinitializer
; VF4-NEXT:    [[TMP5:%.*]] = lshr <4 x i64> [[VEC_IND1]], zeroinitializer
; VF4-NEXT:    [[TMP6:%.*]] = add <4 x i64> [[TMP4]], [[TMP5]]
; VF4-NEXT:    [[TMP7:%.*]] = extractelement <4 x i64> [[TMP6]], i64 0
...
; VF2-NEXT:    [[TMP4:%.*]] = extractelement <2 x i64> [[TMP3]], i64 0
; VF2-NEXT:    [[TMP5:%.*]] = extractelement <2 x i64> [[TMP3]], i64 1
; VF2-NEXT:    [[TMP6:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP4]]
; VF2-NEXT:    [[TMP7:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP5]]
; VF2-NEXT:    [[TMP8:%.*]] = load i64, ptr [[TMP6]], align 8
; VF2-NEXT:    [[TMP9:%.*]] = load i64, ptr [[TMP7]], align 8
...
; VF2-NEXT:    br i1 [[TMP14]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP14:![0-9]+]]
; VF2:       middle.block:
; VF2-NEXT:    br label [[SCALAR_PH:%.*]]
; VF2:       scalar.ph:
;
...
; VF4-NEXT:    [[VEC_IND1:%.*]] = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, [[VECTOR_PH]] ], [ [[VEC_IND_NEXT2:%.*]], [[VECTOR_BODY]] ]
; VF4-NEXT:    [[TMP0:%.*]] = add i64 1, [[INDEX]]
; VF4-NEXT:    [[TMP1:%.*]] = lshr <4 x i64> [[VEC_IND]], zeroinitializer
; VF4-NEXT:    [[TMP2:%.*]] = lshr <4 x i64> [[VEC_IND1]], zeroinitializer
; VF4-NEXT:    [[TMP3:%.*]] = add <4 x i64> [[TMP1]], [[TMP2]]
; VF4-NEXT:    [[TMP4:%.*]] = extractelement <4 x i64> [[TMP3]], i64 0
; VF4-NEXT:    [[TMP5:%.*]] = extractelement <4 x i64> [[TMP3]], i64 1
; VF4-NEXT:    [[TMP6:%.*]] = extractelement <4 x i64> [[TMP3]], i64 2
; VF4-NEXT:    [[TMP7:%.*]] = extractelement <4 x i64> [[TMP3]], i64 3
; VF4-NEXT:    [[TMP8:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP4]]
; VF4-NEXT:    [[TMP9:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP5]]
; VF4-NEXT:    [[TMP10:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP6]]
; VF4-NEXT:    [[TMP11:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP7]]
...
; VF4-NEXT:    br i1 [[TMP22]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP14:![0-9]+]]
; VF4:       middle.block:
; VF4-NEXT:    br label [[SCALAR_PH:%.*]]
; VF4:       scalar.ph:
;
...
; VF2-NEXT:    [[VEC_IND_NEXT2]] = add nsw <2 x i64> [[VEC_IND1]], splat (i64 2)
; VF2-NEXT:    [[TMP14:%.*]] = icmp eq i64 [[INDEX_NEXT]], 998
; VF2-NEXT:    br i1 [[TMP14]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP16:![0-9]+]]
; VF2:       middle.block:
; VF2-NEXT:    br label [[SCALAR_PH:%.*]]
; VF2:       scalar.ph:
;
...
; VF4-NEXT:    [[TMP2:%.*]] = lshr <4 x i64> [[VEC_IND1]], splat (i64 1)
; VF4-NEXT:    [[TMP3:%.*]] = add <4 x i64> [[TMP1]], [[TMP2]]
; VF4-NEXT:    [[TMP4:%.*]] = extractelement <4 x i64> [[TMP3]], i64 0
; VF4-NEXT:    [[TMP5:%.*]] = extractelement <4 x i64> [[TMP3]], i64 1
; VF4-NEXT:    [[TMP6:%.*]] = extractelement <4 x i64> [[TMP3]], i64 2
...
; VF4-NEXT:    [[VEC_IND_NEXT2]] = add nsw <4 x i64> [[VEC_IND1]], splat (i64 4)
; VF4-NEXT:    [[TMP22:%.*]] = icmp eq i64 [[INDEX_NEXT]], 996
; VF4-NEXT:    br i1 [[TMP22]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP16:![0-9]+]]
; VF4:       middle.block:
; VF4-NEXT:    br label [[SCALAR_PH:%.*]]
; VF4:       scalar.ph:
;
...
; VF2-NEXT:    [[VEC_IND_NEXT2]] = add nsw <2 x i64> [[VEC_IND1]], splat (i64 2)
; VF2-NEXT:    [[TMP14:%.*]] = icmp eq i64 [[INDEX_NEXT]], 998
; VF2-NEXT:    br i1 [[TMP14]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP18:![0-9]+]]
; VF2:       middle.block:
; VF2-NEXT:    br label [[SCALAR_PH:%.*]]
; VF2:       scalar.ph:
;
...
; VF4-NEXT:    [[TMP2:%.*]] = udiv <4 x i64> [[VEC_IND1]], splat (i64 3)
; VF4-NEXT:    [[TMP3:%.*]] = add <4 x i64> [[TMP1]], [[TMP2]]
; VF4-NEXT:    [[TMP4:%.*]] = extractelement <4 x i64> [[TMP3]], i64 0
; VF4-NEXT:    [[TMP5:%.*]] = extractelement <4 x i64> [[TMP3]], i64 1
; VF4-NEXT:    [[TMP6:%.*]] = extractelement <4 x i64> [[TMP3]], i64 2
...
; VF4-NEXT:    [[VEC_IND_NEXT2]] = add nsw <4 x i64> [[VEC_IND1]], splat (i64 4)
; VF4-NEXT:    [[TMP22:%.*]] = icmp eq i64 [[INDEX_NEXT]], 996
; VF4-NEXT:    br i1 [[TMP22]], label [[MIDDLE_BLOCK:%.*]], label [[VECTOR_BODY]], !llvm.loop [[LOOP18:![0-9]+]]
; VF4:       middle.block:
; VF4-NEXT:    br label [[SCALAR_PH:%.*]]
; VF4:       scalar.ph:
;
...
; VF2-NEXT:    [[VEC_IND1:%.*]] = phi <2 x i64> [ <i64 0, i64 1>, [[VECTOR_PH]] ], [ [[VEC_IND_NEXT2:%.*]], [[VECTOR_BODY]] ]
; VF2-NEXT:    [[TMP0:%.*]] = shl i64 [[INDEX]], 1
; VF2-NEXT:    [[TMP1:%.*]] = add i64 1, [[TMP0]]
; VF2-NEXT:    [[TMP2:%.*]] = add i64 [[TMP1]], 2
...
; VF2-NEXT:    [[TMP6:%.*]] = extractelement <2 x i64> [[TMP5]], i64 0
; VF2-NEXT:    [[TMP7:%.*]] = extractelement <2 x i64> [[TMP5]], i64 1
; VF2-NEXT:    [[TMP8:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP6]]
...
; VF2-NEXT:    [[TMP15:%.*]] = extractelement <2 x i64> [[TMP14]], i64 0
; VF2-NEXT:    [[TMP16:%.*]] = extractelement <2 x i64> [[TMP14]], i64 1
; VF2-NEXT:    [[TMP17:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP1]]
...
; VF4-NEXT:    [[VEC_IND1:%.*]] = phi <4 x i64> [ <i64 0, i64 1, i64 2, i64 3>, [[VECTOR_PH]] ], [ [[VEC_IND_NEXT2:%.*]], [[VECTOR_BODY]] ]
; VF4-NEXT:    [[TMP0:%.*]] = shl i64 [[INDEX]], 1
; VF4-NEXT:    [[TMP1:%.*]] = add i64 1, [[TMP0]]
; VF4-NEXT:    [[TMP2:%.*]] = add i64 [[TMP1]], 2
; VF4-NEXT:    [[TMP3:%.*]] = add i64 [[TMP1]], 4
; VF4-NEXT:    [[TMP4:%.*]] = add i64 [[TMP1]], 6
...
; VF4-NEXT:    [[TMP8:%.*]] = extractelement <4 x i64> [[TMP7]], i64 0
; VF4-NEXT:    [[TMP9:%.*]] = extractelement <4 x i64> [[TMP7]], i64 1
; VF4-NEXT:    [[TMP10:%.*]] = extractelement <4 x i64> [[TMP7]], i64 2
; VF4-NEXT:    [[TMP11:%.*]] = extractelement <4 x i64> [[TMP7]], i64 3
; VF4-NEXT:    [[TMP12:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP8]]
; VF4-NEXT:    [[TMP13:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP9]]
; VF4-NEXT:    [[TMP14:%.*]] = getelementptr inbounds i64, ptr [[A]], i64 [[TMP10]]
...
; VF4-NEXT:    [[TMP25:%.*]] = extractelement <4 x i64> [[TMP24]], i64 0
; VF4-NEXT:    [[TMP26:%.*]] = extractelement <4 x i64> [[TMP24]], i64 1
; VF4-NEXT:    [[TMP27:%.*]] = extractelement <4 x i64> [[TMP24]], i64 2
; VF4-NEXT:    [[TMP28:%.*]] = extractelement <4 x i64> [[TMP24]], i64 3
; VF4-NEXT:    [[TMP29:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP1]]
; VF4-NEXT:    [[TMP30:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP2]]
; VF4-NEXT:    [[TMP31:%.*]] = getelementptr inbounds i64, ptr [[B]], i64 [[TMP3]]
...
; VF4-NEXT:    [[TMP0:%.*]] = mul i64 [[INDEX]], 3
; VF4-NEXT:    [[TMP1:%.*]] = add i64 1, [[TMP0]]
; VF4-NEXT:    [[TMP2:%.*]] = add i64 [[TMP1]], 3
; VF4-NEXT:    [[TMP3:%.*]] = add i64 [[TMP1]], 6
; VF4-NEXT:    [[TMP4:%.*]] = add i64 [[TMP1]], 9
; VF4-NEXT:    [[TMP5:%.*]] = lshr <4 x i64> [[VEC_IND]], zeroinitializer
; VF4-NEXT:    [[TMP6:%.*]] = lshr <4 x i64> [[VEC_IND1]], zeroinitializer
; VF4-NEXT:    [[TMP7:%.*]] = add <4 x i64> [[TMP5]], [[TMP6]]
; VF4-NEXT:    [[TMP8:%.*]] = extractelement <4 x i64> [[TMP7]], i64 0
