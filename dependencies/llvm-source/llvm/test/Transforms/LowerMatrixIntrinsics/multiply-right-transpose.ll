...
; CHECK-NEXT:    [[TMP21:%.*]] = shufflevector <2 x double> poison, <2 x double> [[TMP20]], <2 x i32> <i32 2, i32 1>
...
; CHECK-NEXT:    [[TMP41:%.*]] = shufflevector <2 x double> poison, <2 x double> [[TMP40]], <2 x i32> <i32 2, i32 1>
