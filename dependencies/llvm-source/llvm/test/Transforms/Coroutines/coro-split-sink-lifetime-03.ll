...
entry:
  ...
  %id = call token @llvm.coro.id(i32 0, ptr null, ptr @a.gep, ptr null)
...
; CHECK-LABEL: define void @a.gep() {
; CHECK-NEXT:  [[ENTRY:.*:]]
; CHECK-NEXT:    [[REF_TMP7:%.*]] = alloca %"struct.lean_future<int>::Awaiter", align 8
; CHECK-NEXT:    [[TESTVAL:%.*]] = alloca [[I8_ARRAY:%.*]], align 8
; CHECK-NEXT:    [[ID:%.*]] = call token @llvm.coro.id(i32 0, ptr null, ptr @a.gep, ptr @a.gep.resumers)
; CHECK-NEXT:    [[ALLOC:%.*]] = call ptr @malloc(i64 16)
; CHECK-NEXT:    [[VFRAME:%.*]] = call noalias nonnull ptr @llvm.coro.begin(token [[ID]], ptr [[ALLOC]])
; CHECK-NEXT:    store ptr @a.gep.resume, ptr [[VFRAME]], align 8
