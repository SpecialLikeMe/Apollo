...
;
; CHECK-INLINE-LABEL: @test_load_unk(
...
; CHECK-INLINE-NEXT:    [[BAD_DESC:%.*]] = icmp ne ptr [[SHADOW_DESC]], null
; CHECK-INLINE-NEXT:    br i1 [[BAD_DESC]], label [[TMP0:%.*]], label [[TMP22:%.*]], !prof [[PROF0:![0-9]+]]
; CHECK-INLINE:       0:
; CHECK-INLINE-NEXT:    [[TMP1:%.*]] = icmp eq ptr [[SHADOW_DESC]], null
; CHECK-INLINE-NEXT:    br i1 [[TMP1]], label [[TMP2:%.*]], label [[TMP20:%.*]]
; CHECK-INLINE:       2:
...
; CHECK-INLINE-NEXT:    br i1 [[TMP17]], label [[TMP18:%.*]], label [[TMP19:%.*]], !prof [[PROF0]]
; CHECK-INLINE:       18:
; CHECK-INLINE-NEXT:    call void @__tysan_check(ptr [[A]], i32 4, ptr null, i32 1)
; CHECK-INLINE-NEXT:    br label [[TMP19]]
; CHECK-INLINE:       19:
...
; CHECK-INLINE-NEXT:    br label [[TMP21:%.*]]
; CHECK-INLINE:       20:
; CHECK-INLINE-NEXT:    call void @__tysan_check(ptr [[A]], i32 4, ptr null, i32 1)
; CHECK-INLINE-NEXT:    br label [[TMP21]]
; CHECK-INLINE:       21:
; CHECK-INLINE-NEXT:    br label [[TMP43:%.*]]
; CHECK-INLINE:       22:
...
; CHECK-INLINE-NEXT:    br i1 [[TMP40]], label [[TMP41:%.*]], label [[TMP42:%.*]], !prof [[PROF0]]
; CHECK-INLINE:       41:
; CHECK-INLINE-NEXT:    call void @__tysan_check(ptr [[A]], i32 4, ptr null, i32 1)
; CHECK-INLINE-NEXT:    br label [[TMP42]]
; CHECK-INLINE:       42:
; CHECK-INLINE-NEXT:    br label [[TMP43]]
; CHECK-INLINE:       43:
; CHECK-INLINE-NEXT:    [[TMP1:%.*]] = load i32, ptr [[A]], align 4
; CHECK-INLINE-NEXT:    ret i32 [[TMP1]]
;
; CHECK-OUTLINE-LABEL: @test_load_unk(
...
; CHECK-OUTLINE-NEXT:    call void @__tysan_instrument_with_shadow_update(ptr [[A:%.*]], ptr null, i1 true, i64 4, i32 1)
; CHECK-OUTLINE-NEXT:    [[TMP1:%.*]] = load i32, ptr [[A]], align 4
...
; CHECK-NEXT:    ret void
;
; CHECK-INLINE-LABEL: @test_store_unk(
; CHECK-INLINE-NEXT:  entry:
; CHECK-INLINE-NEXT:    [[APP_MEM_MASK:%.*]] = load i64, ptr @__tysan_app_memory_mask, align 8
; CHECK-INLINE-NEXT:    [[SHADOW_BASE:%.*]] = load i64, ptr @__tysan_shadow_memory_address, align 8
; CHECK-INLINE-NEXT:    [[APP_PTR_INT:%.*]] = ptrtoint ptr [[A:%.*]] to i64
...
; CHECK-INLINE-NEXT:    [[SHADOW_DESC:%.*]] = load ptr, ptr [[SHADOW_PTR]], align 8
; CHECK-INLINE-NEXT:    [[BAD_DESC:%.*]] = icmp ne ptr [[SHADOW_DESC]], null
; CHECK-INLINE-NEXT:    br i1 [[BAD_DESC]], label [[TMP0:%.*]], label [[TMP22:%.*]], !prof [[PROF0]]
; CHECK-INLINE:       0:
; CHECK-INLINE-NEXT:    [[TMP1:%.*]] = icmp eq ptr [[SHADOW_DESC]], null
; CHECK-INLINE-NEXT:    br i1 [[TMP1]], label [[TMP2:%.*]], label [[TMP20:%.*]]
; CHECK-INLINE:       2:
...
; CHECK-INLINE-NEXT:    br i1 [[TMP17]], label [[TMP18:%.*]], label [[TMP19:%.*]], !prof [[PROF0]]
; CHECK-INLINE:       18:
; CHECK-INLINE-NEXT:    call void @__tysan_check(ptr [[A]], i32 4, ptr null, i32 2)
; CHECK-INLINE-NEXT:    br label [[TMP19]]
; CHECK-INLINE:       19:
; CHECK-INLINE-NEXT:    store ptr null, ptr [[SHADOW_PTR]], align 8
; CHECK-INLINE-NEXT:    [[SHADOW_BYTE_1_OFFSET:%.*]] = add i64 [[SHADOW_PTR_INT]], 8
...
; CHECK-INLINE-NEXT:    br label [[TMP43]]
; CHECK-INLINE:       43:
; CHECK-INLINE-NEXT:    store i32 42, ptr [[A]], align 4
; CHECK-INLINE-NEXT:    ret void
;
; CHECK-OUTLINE-LABEL: @test_store_unk(
; CHECK-OUTLINE-NEXT:  entry:
; CHECK-OUTLINE-NEXT:    [[APP_MEM_MASK:%.*]] = load i64, ptr @__tysan_app_memory_mask, align 8
; CHECK-OUTLINE-NEXT:    [[SHADOW_BASE:%.*]] = load i64, ptr @__tysan_shadow_memory_address, align 8
; CHECK-OUTLINE-NEXT:    call void @__tysan_instrument_with_shadow_update(ptr [[A:%.*]], ptr null, i1 true, i64 4, i32 2)
; CHECK-OUTLINE-NEXT:    store i32 42, ptr [[A]], align 4
