...
# RUN:   llvm-objdump --no-print-imm-hex -d -r - | FileCheck %s --check-prefixes=ELF-O32
# RUN: llvm-mc %s -triple mips-unknown-linux-gnu -mattr=+xgot -filetype=obj | \
# RUN:   llvm-objdump --no-print-imm-hex -d -r - | FileCheck %s --check-prefixes=ELF-XO32
# RUN: llvm-mc %s -triple mips64-unknown-linux-gnuabin32 -filetype=obj | \
# RUN:   llvm-objdump --no-print-imm-hex -d -r - | FileCheck %s --check-prefixes=ELF-N32
# RUN: llvm-mc %s -triple mips64-unknown-linux-gnuabin32 -mattr=+xgot -filetype=obj | \
# RUN:   llvm-objdump --no-print-imm-hex -d -r - | FileCheck %s --check-prefixes=ELF-XN32
# RUN: llvm-mc %s -triple mips64-unknown-linux-gnu -filetype=obj | \
# RUN:   llvm-objdump --no-print-imm-hex -d -r - | FileCheck %s --check-prefixes=ELF-N64
# RUN: llvm-mc %s -triple mips64-unknown-linux-gnu -mattr=+xgot -filetype=obj | \
# RUN:   llvm-objdump --no-print-imm-hex -d -r - | FileCheck %s --check-prefixes=ELF-XN64
