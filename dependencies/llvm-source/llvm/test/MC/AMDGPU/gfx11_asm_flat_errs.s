...
// VI-GFX9_10-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: instruction not supported on this GPU
...
// GFX11-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: expected a 12-bit unsigned offset
// VI-GFX9_10-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU
...
// GFX11-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: instruction must not use glc
// VI-GFX9_10-ERR: :[[@LINE-2]]:{{[0-9]+}}: error: instruction not supported on this GPU
...
// GFX11-ERR: :[[@LINE-1]]:{{[0-9]+}}: error: invalid operand for instruction
// VI-GFX9_10-ERR: :[[@LINE-2]]:{{[0-9]+}}: error:
