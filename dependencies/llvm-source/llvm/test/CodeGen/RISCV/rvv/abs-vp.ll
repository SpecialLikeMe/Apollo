...
; ZVABD:       # %bb.0:
; ZVABD-NEXT:    vsetvli a0, zero, e8, mf8, ta, ma
...
; ZVABD:       # %bb.0:
; ZVABD-NEXT:    vsetvli a0, zero, e8, mf4, ta, ma
; ZVABD-NEXT:    vabs.v v8, v8
; ZVABD-NEXT:    ret
...
; ZVABD:       # %bb.0:
; ZVABD-NEXT:    vsetvli a0, zero, e8, mf2, ta, ma
; ZVABD-NEXT:    vabs.v v8, v8
; ZVABD-NEXT:    ret
...
; ZVABD:       # %bb.0:
; ZVABD-NEXT:    vsetvli a0, zero, e8, m4, ta, ma
; ZVABD-NEXT:    vabs.v v8, v8
; ZVABD-NEXT:    ret
...
; ZVABD:       # %bb.0:
; ZVABD-NEXT:    vsetvli a0, zero, e8, m8, ta, ma
; ZVABD-NEXT:    vabs.v v8, v8
; ZVABD-NEXT:    ret
