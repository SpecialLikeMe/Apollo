...
define <vscale x 1 x float> @rint_nxv1f32(<vscale x 1 x float> %x) {
; CHECK-LABEL: rint_nxv1f32:
; CHECK:       # %bb.0:
...
define <vscale x 2 x float> @rint_nxv2f32(<vscale x 2 x float> %x) {
...
; CHECK-NEXT:    vfsgnj.vv v8, v9, v8, v0.t
; CHECK-NEXT:    ret
  %a = call <vscale x 2 x float> @llvm.rint.nxv2f32(<vscale x 2 x float> %x)
  ret <vscale x 2 x float> %a
}

define <vscale x 4 x float> @rint_nxv4f32(<vscale x 4 x float> %x) {
...
define <vscale x 8 x float> @rint_nxv8f32(<vscale x 8 x float> %x) {
...
; CHECK-NEXT:    ret
  %a = call <vscale x 8 x float> @llvm.rint.nxv8f32(<vscale x 8 x float> %x)
  ret <vscale x 8 x float> %a
}

define <vscale x 16 x float> @rint_nxv16f32(<vscale x 16 x float> %x) {
...
; CHECK-NEXT:    ret
  %a = call <vscale x 16 x float> @llvm.rint.nxv16f32(<vscale x 16 x float> %x)
