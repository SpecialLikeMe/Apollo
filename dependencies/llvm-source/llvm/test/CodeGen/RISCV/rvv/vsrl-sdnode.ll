...
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 1 x i8> %va, splat (i8 6)
  ret <vscale x 1 x i8> %vc
}
...
; CHECK-NEXT:    vsrl.vi v8, v8, 6
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 2 x i8> %va, splat (i8 6)
  ret <vscale x 2 x i8> %vc
}
...
; CHECK-NEXT:    vsrl.vi v8, v8, 6
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 4 x i8> %va, splat (i8 6)
  ret <vscale x 4 x i8> %vc
}
...
; CHECK-NEXT:    vsrl.vi v8, v8, 6
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 8 x i8> %va, splat (i8 6)
  ret <vscale x 8 x i8> %vc
}
...
; CHECK-NEXT:    vsrl.vi v8, v8, 6
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 16 x i8> %va, splat (i8 6)
  ret <vscale x 16 x i8> %vc
}
...
; CHECK-NEXT:    vsrl.vi v8, v8, 6
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 32 x i8> %va, splat (i8 6)
  ret <vscale x 32 x i8> %vc
}
...
; CHECK-NEXT:    vsrl.vi v8, v8, 6
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 64 x i8> %va, splat (i8 6)
  ret <vscale x 64 x i8> %vc
}
...
; CHECK-NEXT:    vsrl.vi v8, v8, 6
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 1 x i16> %va, splat (i16 6)
  ret <vscale x 1 x i16> %vc
}
...
; CHECK-NEXT:    vsrl.vi v8, v8, 6
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 2 x i16> %va, splat (i16 6)
  ret <vscale x 2 x i16> %vc
}
...
; CHECK-NEXT:    vsrl.vi v8, v8, 6
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 4 x i16> %va, splat (i16 6)
  ret <vscale x 4 x i16> %vc
}
...
; CHECK-NEXT:    vsrl.vi v8, v8, 6
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 8 x i16> %va, splat (i16 6)
  ret <vscale x 8 x i16> %vc
}
...
; CHECK-NEXT:    vsrl.vi v8, v8, 6
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 16 x i16> %va, splat (i16 6)
  ret <vscale x 16 x i16> %vc
}
...
; CHECK-NEXT:    vsrl.vi v8, v8, 6
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 32 x i16> %va, splat (i16 6)
  ret <vscale x 32 x i16> %vc
}
...
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 1 x i32> %va, splat (i32 31)
  ret <vscale x 1 x i32> %vc
}
...
; CHECK-NEXT:    vsrl.vi v8, v8, 31
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 2 x i32> %va, splat (i32 31)
  ret <vscale x 2 x i32> %vc
}
...
; CHECK-NEXT:    vsrl.vi v8, v8, 31
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 4 x i32> %va, splat (i32 31)
  ret <vscale x 4 x i32> %vc
}
...
; CHECK-NEXT:    vsrl.vi v8, v8, 31
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 8 x i32> %va, splat (i32 31)
  ret <vscale x 8 x i32> %vc
}
...
; CHECK-NEXT:    vsrl.vi v8, v8, 31
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 16 x i32> %va, splat (i32 31)
  ret <vscale x 16 x i32> %vc
}
...
; CHECK-NEXT:    vsrl.vi v8, v8, 31
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 1 x i64> %va, splat (i64 31)
  ret <vscale x 1 x i64> %vc
}
...
; CHECK-NEXT:    vsrl.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 1 x i64> %va, splat (i64 32)
  ret <vscale x 1 x i64> %vc
}
...
; CHECK-NEXT:    vsrl.vi v8, v8, 31
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 2 x i64> %va, splat (i64 31)
  ret <vscale x 2 x i64> %vc
}
...
; CHECK-NEXT:    vsrl.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 2 x i64> %va, splat (i64 32)
  ret <vscale x 2 x i64> %vc
}
...
; CHECK-NEXT:    vsrl.vi v8, v8, 31
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 4 x i64> %va, splat (i64 31)
  ret <vscale x 4 x i64> %vc
}
...
; CHECK-NEXT:    vsrl.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 4 x i64> %va, splat (i64 32)
  ret <vscale x 4 x i64> %vc
}
...
; CHECK-NEXT:    vsrl.vi v8, v8, 31
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 8 x i64> %va, splat (i64 31)
  ret <vscale x 8 x i64> %vc
}
...
; CHECK-NEXT:    vsrl.vx v8, v8, a0
; CHECK-NEXT:    ret
  %vc = lshr <vscale x 8 x i64> %va, splat (i64 32)
  ret <vscale x 8 x i64> %vc
}
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vsetvli a0, zero, e32, m4, ta, mu
; CHECK-NEXT:    vsrl.vi v8, v8, 31, v0.t
; CHECK-NEXT:    ret
