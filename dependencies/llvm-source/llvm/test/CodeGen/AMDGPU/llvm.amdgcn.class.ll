...
; SI-SDAG-LABEL: test_class_f32:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dword s6, s[4:5], 0x1c
; SI-SDAG-NEXT:    s_load_dword s7, s[4:5], 0x13
...
; SI-SDAG-NEXT:    v_cmp_class_f32_e32 vcc, s7, v0
...
; SI-SDAG-LABEL: test_class_fabs_f32:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dword s6, s[4:5], 0x1c
; SI-SDAG-NEXT:    s_load_dword s7, s[4:5], 0x13
; SI-SDAG-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
...
; SI-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SI-SDAG-NEXT:    v_mov_b32_e32 v0, s6
; SI-SDAG-NEXT:    v_cmp_class_f32_e64 s[4:5], |s7|, v0
...
; SI-SDAG-LABEL: test_class_fneg_f32:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dword s6, s[4:5], 0x1c
; SI-SDAG-NEXT:    s_load_dword s7, s[4:5], 0x13
; SI-SDAG-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
...
; SI-SDAG-LABEL: test_class_fneg_fabs_f32:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dword s6, s[4:5], 0x1c
; SI-SDAG-NEXT:    s_load_dword s7, s[4:5], 0x13
; SI-SDAG-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
...
; SI-SDAG-LABEL: v_test_class_full_mask_f32:
; SI-SDAG:       ; %bb.0:
...
; SI-SDAG-LABEL: test_class_inline_imm_constant_dynamic_mask_f32:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-SDAG-NEXT:    s_mov_b32 s7, 0xf000
; SI-SDAG-NEXT:    s_mov_b32 s6, 0
...
; SI-SDAG-NEXT:    s_mov_b64 s[2:3], s[6:7]
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    v_cmp_class_f32_e32 vcc, 1.0, v2
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v2, 0, -1, vcc
; SI-SDAG-NEXT:    buffer_store_dword v2, v[0:1], s[0:3], 0 addr64
; SI-SDAG-NEXT:    s_endpgm
;
; SI-GISEL-LABEL: test_class_inline_imm_constant_dynamic_mask_f32:
; SI-GISEL:       ; %bb.0:
; SI-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-GISEL-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; SI-GISEL-NEXT:    v_mov_b32_e32 v1, 0
...
; SI-SDAG-LABEL: test_class_lit_constant_dynamic_mask_f32:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-SDAG-NEXT:    s_mov_b32 s7, 0xf000
; SI-SDAG-NEXT:    s_mov_b32 s6, 0
...
; SI-SDAG-NEXT:    s_mov_b64 s[4:5], s[2:3]
; SI-SDAG-NEXT:    buffer_load_dword v2, v[0:1], s[4:7], 0 addr64
; SI-SDAG-NEXT:    s_mov_b32 s4, 0x44800000
; SI-SDAG-NEXT:    s_mov_b64 s[2:3], s[6:7]
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    v_cmp_class_f32_e32 vcc, s4, v2
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v2, 0, -1, vcc
; SI-SDAG-NEXT:    buffer_store_dword v2, v[0:1], s[0:3], 0 addr64
; SI-SDAG-NEXT:    s_endpgm
;
; SI-GISEL-LABEL: test_class_lit_constant_dynamic_mask_f32:
; SI-GISEL:       ; %bb.0:
; SI-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-GISEL-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; SI-GISEL-NEXT:    v_mov_b32_e32 v1, 0
...
; SI-SDAG-LABEL: test_class_f64:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dword s8, s[4:5], 0x1d
...
; SI-SDAG-LABEL: test_class_fabs_f64:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dword s8, s[4:5], 0x1d
; SI-SDAG-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x13
; SI-SDAG-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
...
; SI-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SI-SDAG-NEXT:    v_mov_b32_e32 v0, s8
; SI-SDAG-NEXT:    v_cmp_class_f64_e64 s[4:5], |s[6:7]|, v0
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v0, 0, -1, s[4:5]
; SI-SDAG-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; SI-SDAG-NEXT:    s_endpgm
;
...
; SI-SDAG-LABEL: test_class_fneg_f64:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dword s8, s[4:5], 0x1d
; SI-SDAG-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x13
; SI-SDAG-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
...
; SI-SDAG-LABEL: test_class_fneg_fabs_f64:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dword s8, s[4:5], 0x1d
; SI-SDAG-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x13
; SI-SDAG-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
...
; SI-SDAG-LABEL: test_class_1_f64:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-SDAG-NEXT:    s_mov_b32 s7, 0xf000
...
; SI-SDAG-LABEL: test_class_64_f64:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-SDAG-NEXT:    s_mov_b32 s7, 0xf000
; SI-SDAG-NEXT:    s_mov_b32 s6, -1
...
; SI-SDAG-NEXT:    s_mov_b32 s4, s0
; SI-SDAG-NEXT:    s_mov_b32 s5, s1
; SI-SDAG-NEXT:    v_cmp_class_f64_e64 s[0:1], s[2:3], 64
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v0, 0, -1, s[0:1]
; SI-SDAG-NEXT:    buffer_store_dword v0, off, s[4:7], 0
; SI-SDAG-NEXT:    s_endpgm
;
; SI-GISEL-LABEL: test_class_64_f64:
; SI-GISEL:       ; %bb.0:
; SI-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; SI-SDAG-LABEL: v_test_class_full_mask_f64:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-SDAG-NEXT:    s_mov_b32 s7, 0xf000
; SI-SDAG-NEXT:    s_mov_b32 s6, -1
...
; SI-SDAG-LABEL: test_class_inline_imm_constant_dynamic_mask_f64:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-SDAG-NEXT:    s_mov_b32 s7, 0xf000
; SI-SDAG-NEXT:    s_mov_b32 s6, 0
...
; SI-SDAG-NEXT:    s_mov_b64 s[2:3], s[6:7]
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    v_cmp_class_f64_e32 vcc, 1.0, v2
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v2, 0, -1, vcc
; SI-SDAG-NEXT:    buffer_store_dword v2, v[0:1], s[0:3], 0 addr64
; SI-SDAG-NEXT:    s_endpgm
;
; SI-GISEL-LABEL: test_class_inline_imm_constant_dynamic_mask_f64:
; SI-GISEL:       ; %bb.0:
; SI-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-GISEL-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; SI-GISEL-NEXT:    v_mov_b32_e32 v1, 0
...
; SI-SDAG-LABEL: test_class_lit_constant_dynamic_mask_f64:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-SDAG-NEXT:    s_mov_b32 s7, 0xf000
; SI-SDAG-NEXT:    s_mov_b32 s6, 0
...
; SI-SDAG-NEXT:    s_mov_b64 s[2:3], s[6:7]
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0)
; SI-SDAG-NEXT:    v_cmp_class_f64_e32 vcc, s[4:5], v2
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v2, 0, -1, vcc
; SI-SDAG-NEXT:    buffer_store_dword v2, v[0:1], s[0:3], 0 addr64
; SI-SDAG-NEXT:    s_endpgm
;
; SI-GISEL-LABEL: test_class_lit_constant_dynamic_mask_f64:
; SI-GISEL:       ; %bb.0:
; SI-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-GISEL-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; SI-GISEL-NEXT:    v_mov_b32_e32 v1, 0
...
; SI-SDAG-LABEL: test_fold_or_class_f32_0:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-SDAG-NEXT:    s_mov_b32 s7, 0xf000
...
; SI-SDAG-NEXT:    s_endpgm
;
; SI-GISEL-LABEL: test_fold_or_class_f32_0:
; SI-GISEL:       ; %bb.0:
; SI-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-GISEL-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; SI-GISEL-NEXT:    v_mov_b32_e32 v1, 0
...
; SI-GISEL-NEXT:    s_waitcnt vmcnt(0)
; SI-GISEL-NEXT:    v_cmp_class_f32_e64 s[2:3], v0, 1
; SI-GISEL-NEXT:    v_cmp_class_f32_e64 s[4:5], v0, 3
...
; SI-SDAG-LABEL: test_fold_or3_class_f32_0:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-SDAG-NEXT:    s_mov_b32 s7, 0xf000
; SI-SDAG-NEXT:    s_mov_b32 s10, 0
...
; SI-SDAG-NEXT:    s_endpgm
;
; SI-GISEL-LABEL: test_fold_or3_class_f32_0:
; SI-GISEL:       ; %bb.0:
; SI-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-GISEL-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; SI-GISEL-NEXT:    v_mov_b32_e32 v1, 0
...
; SI-GISEL-NEXT:    s_waitcnt vmcnt(0)
; SI-GISEL-NEXT:    v_cmp_class_f32_e64 s[2:3], v0, 1
; SI-GISEL-NEXT:    v_cmp_class_f32_e64 s[4:5], v0, 2
; SI-GISEL-NEXT:    v_cmp_class_f32_e64 s[8:9], v0, 4
; SI-GISEL-NEXT:    s_or_b64 s[2:3], s[2:3], s[4:5]
; SI-GISEL-NEXT:    s_or_b64 s[2:3], s[2:3], s[8:9]
; SI-GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, -1, s[2:3]
; SI-GISEL-NEXT:    s_mov_b64 s[2:3], s[6:7]
; SI-GISEL-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; SI-GISEL-NEXT:    s_endpgm
...
; SI-SDAG-LABEL: test_fold_or_all_tests_class_f32_0:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-SDAG-NEXT:    s_mov_b32 s7, 0xf000
; SI-SDAG-NEXT:    s_mov_b32 s10, 0
...
; SI-SDAG-NEXT:    s_endpgm
;
; SI-GISEL-LABEL: test_fold_or_all_tests_class_f32_0:
; SI-GISEL:       ; %bb.0:
...
; SI-SDAG-LABEL: test_fold_or_class_f32_1:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-SDAG-NEXT:    s_mov_b32 s7, 0xf000
; SI-SDAG-NEXT:    s_mov_b32 s10, 0
...
; SI-SDAG-NEXT:    s_endpgm
;
; SI-GISEL-LABEL: test_fold_or_class_f32_1:
; SI-GISEL:       ; %bb.0:
; SI-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-GISEL-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; SI-GISEL-NEXT:    v_mov_b32_e32 v1, 0
...
; SI-GISEL-NEXT:    s_mov_b32 s6, -1
; SI-GISEL-NEXT:    s_waitcnt vmcnt(0)
; SI-GISEL-NEXT:    v_cmp_class_f32_e64 s[2:3], v0, 4
; SI-GISEL-NEXT:    v_cmp_class_f32_e64 s[4:5], v0, 8
; SI-GISEL-NEXT:    s_or_b64 s[2:3], s[2:3], s[4:5]
; SI-GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, -1, s[2:3]
; SI-GISEL-NEXT:    s_mov_b64 s[2:3], s[6:7]
; SI-GISEL-NEXT:    buffer_store_dword v0, off, s[0:3], 0
...
; SI-SDAG-LABEL: test_fold_or_class_f32_2:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-SDAG-NEXT:    s_mov_b32 s7, 0xf000
; SI-SDAG-NEXT:    s_mov_b32 s10, 0
...
; SI-SDAG-NEXT:    s_endpgm
;
; SI-GISEL-LABEL: test_fold_or_class_f32_2:
; SI-GISEL:       ; %bb.0:
; SI-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-GISEL-NEXT:    v_lshlrev_b32_e32 v0, 2, v0
; SI-GISEL-NEXT:    v_mov_b32_e32 v1, 0
...
; SI-GISEL-NEXT:    s_mov_b32 s6, -1
; SI-GISEL-NEXT:    s_waitcnt vmcnt(0)
; SI-GISEL-NEXT:    v_cmp_class_f32_e64 s[2:3], v0, 7
; SI-GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, -1, s[2:3]
; SI-GISEL-NEXT:    s_mov_b64 s[2:3], s[6:7]
; SI-GISEL-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; SI-GISEL-NEXT:    s_endpgm
...
; SI-SDAG-LABEL: test_no_fold_or_class_f32_0:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
...
; SI-SDAG-NEXT:    s_endpgm
;
; SI-GISEL-LABEL: test_no_fold_or_class_f32_0:
; SI-GISEL:       ; %bb.0:
; SI-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
...
; SI-SDAG-LABEL: test_class_0_f64:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-SDAG-NEXT:    s_waitcnt lgkmcnt(0)
; SI-SDAG-NEXT:    s_mov_b32 s3, 0xf000
...
; SI-SDAG-NEXT:    s_endpgm
;
; SI-GISEL-LABEL: test_class_0_f64:
; SI-GISEL:       ; %bb.0:
; SI-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; SI-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; SI-SDAG-LABEL: test_class_undef_f32:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; SI-SDAG-NEXT:    s_mov_b32 s3, 0xf000
; SI-SDAG-NEXT:    s_mov_b32 s2, -1
...
; SI-SDAG-LABEL: test_fold_and_ord:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SI-SDAG-NEXT:    v_cmp_class_f32_e64 s[4:5], v0, 32
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[4:5]
; SI-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; SI-GISEL-LABEL: test_fold_and_ord:
; SI-GISEL:       ; %bb.0:
...
; SI-SDAG-LABEL: test_fold_and_unord:
; SI-SDAG:       ; %bb.0:
; SI-SDAG-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SI-SDAG-NEXT:    v_cmp_class_f32_e64 s[4:5], v0, 3
; SI-SDAG-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[4:5]
; SI-SDAG-NEXT:    s_setpc_b64 s[30:31]
;
; SI-GISEL-LABEL: test_fold_and_unord:
; SI-GISEL:       ; %bb.0:
; SI-GISEL-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; SI-GISEL-NEXT:    v_cmp_class_f32_e64 s[4:5], v0, 35
; SI-GISEL-NEXT:    v_cmp_u_f32_e32 vcc, v0, v0
; SI-GISEL-NEXT:    s_and_b64 s[4:5], vcc, s[4:5]
; SI-GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, s[4:5]
; SI-GISEL-NEXT:    s_setpc_b64 s[30:31]
  %class = call i1 @llvm.amdgcn.class.f32(float %a, i32 35) #1
