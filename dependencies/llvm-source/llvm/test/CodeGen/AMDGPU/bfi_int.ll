...
; GFX8-GISEL-NEXT:    s_load_dword s4, s[4:5], 0x34
...
; GFX10-GISEL-NEXT:    s_load_dword s4, s[4:5], 0x34
...
; GFX8-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-GISEL-NEXT:    s_and_b64 s[2:3], s[0:1], s[2:3]
; GFX8-GISEL-NEXT:    s_andn2_b64 s[0:1], s[4:5], s[0:1]
...
; GFX10-GISEL-NEXT:    s_clause 0x1
; GFX10-GISEL-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX10-GISEL-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x34
; GFX10-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-GISEL-NEXT:    s_and_b64 s[2:3], s[0:1], s[2:3]
; GFX10-GISEL-NEXT:    s_andn2_b64 s[0:1], s[4:5], s[0:1]
...
; GFX8-GISEL-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x34
; GFX8-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-GISEL-NEXT:    s_xor_b64 s[0:1], s[0:1], s[4:5]
; GFX8-GISEL-NEXT:    s_and_b64 s[0:1], s[0:1], s[2:3]
; GFX8-GISEL-NEXT:    s_xor_b64 s[0:1], s[0:1], s[4:5]
; GFX8-GISEL-NEXT:    s_add_u32 s0, s0, 10
; GFX8-GISEL-NEXT:    s_addc_u32 s1, s1, 0
; GFX8-GISEL-NEXT:    v_mov_b32_e32 v0, s0
...
; GFX10-GISEL-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x34
; GFX10-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-GISEL-NEXT:    s_xor_b64 s[0:1], s[0:1], s[4:5]
...
; GFX7-NEXT:    s_mov_b32 s6, -1
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    s_and_b64 s[8:9], s[0:1], s[4:5]
...
; GFX8-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x34
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    s_and_b64 s[6:7], s[0:1], s[4:5]
...
; GFX10-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x34
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_or_b64 s[6:7], s[0:1], s[4:5]
; GFX10-NEXT:    s_and_b64 s[0:1], s[0:1], s[4:5]
...
; GFX8-GISEL-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x34
; GFX8-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-GISEL-NEXT:    s_and_b64 s[6:7], s[0:1], s[4:5]
; GFX8-GISEL-NEXT:    s_or_b64 s[0:1], s[0:1], s[4:5]
; GFX8-GISEL-NEXT:    s_and_b64 s[0:1], s[2:3], s[0:1]
; GFX8-GISEL-NEXT:    s_or_b64 s[0:1], s[6:7], s[0:1]
; GFX8-GISEL-NEXT:    s_add_u32 s0, s0, 10
; GFX8-GISEL-NEXT:    s_addc_u32 s1, s1, 0
; GFX8-GISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX8-GISEL-NEXT:    v_mov_b32_e32 v1, s1
...
; GFX10-GISEL-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x34
; GFX10-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-GISEL-NEXT:    s_or_b64 s[6:7], s[0:1], s[4:5]
; GFX10-GISEL-NEXT:    s_and_b64 s[0:1], s[0:1], s[4:5]
