...
define amdgpu_ps i32 @test_llvm_amdgcn_sudot8_uu_s_s_s(i32 inreg %a, i32 inreg %b, i32 inreg %c) {
; GFX11-LABEL: test_llvm_amdgcn_sudot8_uu_s_s_s:
; GFX11:       ; %bb.0: ; %entry
...
; GFX11-NEXT:    v_dot8_i32_iu4 v0, s0, s1, v0 ; encoding: [0x00,0x40,0x18,0xcc,0x00,0x02,0x00,0x1c]
