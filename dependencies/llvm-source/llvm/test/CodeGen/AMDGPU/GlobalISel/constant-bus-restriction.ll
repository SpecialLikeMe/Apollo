...
; RUN: llc -global-isel -new-reg-bank-select -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx900 < %s | FileCheck -enable-var-scope -check-prefix=GFX9 %s
; RUN: llc -global-isel -new-reg-bank-select -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1010 < %s | FileCheck -enable-var-scope -check-prefixes=GFX10PLUS,GFX10 %s
; RUN: llc -global-isel -new-reg-bank-select -mtriple=amdgcn-mesa-mesa3d -mcpu=gfx1100 -amdgpu-enable-delay-alu=0 < %s | FileCheck -enable-var-scope -check-prefixes=GFX10PLUS,GFX11 %s
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: fmul_ss:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    v_mul_f32_e64 v0, s2, s2
; GFX10PLUS-NEXT:    ; return to shader part epilog
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: fma_s_s_s:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    v_mov_b32_e32 v0, s4
; GFX10PLUS-NEXT:    v_fma_f32 v0, s3, s2, v0
; GFX10PLUS-NEXT:    ; return to shader part epilog
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: fma_sss:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    v_fma_f32 v0, s2, s2, s2
; GFX10PLUS-NEXT:    ; return to shader part epilog
...
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    v_fma_f32 v0, s2, s2, s3
; GFX10PLUS-NEXT:    ; return to shader part epilog
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: fma_s_ss:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    v_fma_f32 v0, s2, s3, s3
; GFX10PLUS-NEXT:    ; return to shader part epilog
...
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    v_fma_f32 v0, s2, s3, s2
; GFX10PLUS-NEXT:    ; return to shader part epilog
...
; GFX9-NEXT:    ; return to shader part epilog
;
; GFX10PLUS-LABEL: amdgcn_div_fmas_sss:
; GFX10PLUS:       ; %bb.0:
; GFX10PLUS-NEXT:    v_cmp_eq_f32_e32 vcc_lo, 0, v0
; GFX10PLUS-NEXT:    v_div_fmas_f32 v0, s2, s2, s2
; GFX10PLUS-NEXT:    ; return to shader part epilog
