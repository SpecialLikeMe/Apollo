...
define <4 x i16> @AMinusZeroMinusB_vector(<4 x i16> %a, <4 x i16> %b) {
; CHECK-LABEL: AMinusZeroMinusB_vector:
; CHECK:       // %bb.0: // %entry
...
entry:
; fold (A - (0 - B)) to (A + B)
  %sub1 = sub <4 x i16> <i16 0, i16 0, i16 0, i16 0>, %b
  %sub2 = sub <4 x i16> %a, %sub1
  ret  <4 x i16> %sub2
}
...
define <4 x i16> @AMinusBMinusA_vec(<4 x i16> %a, <4 x i16> %b) {
; CHECK-LABEL: AMinusBMinusA_vec:
; CHECK:       // %bb.0: // %entry
; CHECK-NEXT:    fmov d0, d1
; CHECK-NEXT:    ret
entry:
; fold A - (A - B) -> B
  %sub1 = sub <4 x i16> %a, %b
  %sub2 = sub <4 x i16> %a, %sub1
  ret <4 x i16> %sub2
}
