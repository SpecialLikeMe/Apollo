...
; RUN: llc -fast-isel=true -aarch64-streaming-hazard-size=0 -global-isel=false -fast-isel-abort=0 -mtriple=aarch64-linux-gnu < %s \
; RUN:     | FileCheck %s --check-prefixes=CHECK-COMMON,CHECK-FISEL
; RUN: llc -fast-isel=false -aarch64-streaming-hazard-size=0 -global-isel=true -global-isel-abort=0 -mtriple=aarch64-linux-gnu < %s \
...
define double @nonstreaming_caller_streaming_callee(double %x) nounwind noinline optnone #0 {
...
; CHECK-FISEL-NEXT:    str x30, [sp, #80] // 8-byte Spill
; CHECK-FISEL-NEXT:    str d0, [sp] // 8-byte Spill
; CHECK-FISEL-NEXT:    smstart sm
; CHECK-FISEL-NEXT:    ldr d0, [sp] // 8-byte Reload
; CHECK-FISEL-NEXT:    bl streaming_callee
; CHECK-FISEL-NEXT:    str d0, [sp, #8] // 8-byte Spill
; CHECK-FISEL-NEXT:    smstop sm
; CHECK-FISEL-NEXT:    ldr d1, [sp, #8] // 8-byte Reload
; CHECK-FISEL-NEXT:    adrp x8, .LCPI0_0
; CHECK-FISEL-NEXT:    ldr d0, [x8, :lo12:.LCPI0_0]
; CHECK-FISEL-NEXT:    fadd d0, d1, d0
; CHECK-FISEL-NEXT:    ldr x30, [sp, #80] // 8-byte Reload
...
; CHECK-GISEL-NEXT:    str x30, [sp, #80] // 8-byte Spill
; CHECK-GISEL-NEXT:    str d0, [sp] // 8-byte Spill
; CHECK-GISEL-NEXT:    smstart sm
; CHECK-GISEL-NEXT:    ldr d0, [sp] // 8-byte Reload
; CHECK-GISEL-NEXT:    bl streaming_callee
; CHECK-GISEL-NEXT:    str d0, [sp, #8] // 8-byte Spill
; CHECK-GISEL-NEXT:    smstop sm
; CHECK-GISEL-NEXT:    ldr d1, [sp, #8] // 8-byte Reload
; CHECK-GISEL-NEXT:    mov x8, #4631107791820423168 // =0x4045000000000000
; CHECK-GISEL-NEXT:    fmov d0, x8
; CHECK-GISEL-NEXT:    fadd d0, d1, d0
; CHECK-GISEL-NEXT:    ldr x30, [sp, #80] // 8-byte Reload
...
define double @streaming_caller_nonstreaming_callee(double %x) nounwind noinline optnone "aarch64_pstate_sm_enabled" #0 {
...
; CHECK-COMMON-NEXT:    str x30, [sp, #80] // 8-byte Spill
; CHECK-COMMON-NEXT:    str d0, [sp] // 8-byte Spill
; CHECK-COMMON-NEXT:    smstop sm
; CHECK-COMMON-NEXT:    ldr d0, [sp] // 8-byte Reload
; CHECK-COMMON-NEXT:    bl normal_callee
; CHECK-COMMON-NEXT:    str d0, [sp, #8] // 8-byte Spill
; CHECK-COMMON-NEXT:    smstart sm
; CHECK-COMMON-NEXT:    ldr d1, [sp, #8] // 8-byte Reload
...
; CHECK-COMMON-NEXT:    ldr x30, [sp, #80] // 8-byte Reload
...
define double @locally_streaming_caller_normal_callee(double %x) nounwind noinline optnone "aarch64_pstate_sm_body" #0 {
...
; CHECK-COMMON-NEXT:    str x30, [sp, #96] // 8-byte Spill
; CHECK-COMMON-NEXT:    str d0, [sp, #24] // 8-byte Spill
; CHECK-COMMON-NEXT:    smstart sm
; CHECK-COMMON-NEXT:    ldr d0, [sp, #24] // 8-byte Reload
; CHECK-COMMON-NEXT:    str d0, [sp, #24] // 8-byte Spill
; CHECK-COMMON-NEXT:    smstop sm
; CHECK-COMMON-NEXT:    ldr d0, [sp, #24] // 8-byte Reload
; CHECK-COMMON-NEXT:    bl normal_callee
; CHECK-COMMON-NEXT:    str d0, [sp, #16] // 8-byte Spill
; CHECK-COMMON-NEXT:    smstart sm
; CHECK-COMMON-NEXT:    ldr d1, [sp, #16] // 8-byte Reload
; CHECK-COMMON-NEXT:    mov x8, #4631107791820423168 // =0x4045000000000000
; CHECK-COMMON-NEXT:    fmov d0, x8
; CHECK-COMMON-NEXT:    fadd d0, d1, d0
; CHECK-COMMON-NEXT:    str d0, [sp, #8] // 8-byte Spill
; CHECK-COMMON-NEXT:    smstop sm
; CHECK-COMMON-NEXT:    ldr d0, [sp, #8] // 8-byte Reload
; CHECK-COMMON-NEXT:    ldr x30, [sp, #96] // 8-byte Reload
...
define double @normal_caller_to_locally_streaming_callee(double %x) nounwind noinline optnone #0 {
...
define void @locally_streaming_caller_streaming_callee_ptr(ptr %p) nounwind noinline optnone "aarch64_pstate_sm_body" #0 {
...
define void @normal_call_to_streaming_callee_ptr(ptr %p) nounwind noinline optnone #0 {
...
define double  @za_new_caller_to_za_shared_callee(double %x) nounwind noinline optnone "aarch64_new_za" #0 {
...
define double  @za_shared_caller_to_za_none_callee(double %x) nounwind noinline optnone "aarch64_inout_za" #0 {
...
define fp128 @f128_call_za(fp128 %a, fp128 %b) "aarch64_inout_za" nounwind #0 {
...
define fp128 @f128_call_sm(fp128 %a, fp128 %b) "aarch64_pstate_sm_enabled" nounwind #0 {
...
; CHECK-COMMON-NEXT:    bl __addtf3
; CHECK-COMMON-NEXT:    str q0, [sp, #16] // 16-byte Spill
; CHECK-COMMON-NEXT:    smstart sm
; CHECK-COMMON-NEXT:    ldp d9, d8, [sp, #80] // 16-byte Folded Reload
; CHECK-COMMON-NEXT:    ldr q0, [sp, #16] // 16-byte Reload
; CHECK-COMMON-NEXT:    ldp d11, d10, [sp, #64] // 16-byte Folded Reload
; CHECK-COMMON-NEXT:    ldr x30, [sp, #96] // 8-byte Reload
; CHECK-COMMON-NEXT:    ldp d13, d12, [sp, #48] // 16-byte Folded Reload
; CHECK-COMMON-NEXT:    ldp d15, d14, [sp, #32] // 16-byte Folded Reload
...
define double @frem_call_za(double %a, double %b) "aarch64_inout_za" nounwind #0 {
...
define float @frem_call_sm(float %a, float %b) "aarch64_pstate_sm_enabled" nounwind #0 {
...
; CHECK-COMMON-NEXT:    str s0, [sp, #12] // 4-byte Spill
; CHECK-COMMON-NEXT:    smstart sm
; CHECK-COMMON-NEXT:    ldp d9, d8, [sp, #64] // 16-byte Folded Reload
; CHECK-COMMON-NEXT:    ldr s0, [sp, #12] // 4-byte Reload
; CHECK-COMMON-NEXT:    ldp d11, d10, [sp, #48] // 16-byte Folded Reload
; CHECK-COMMON-NEXT:    ldr x30, [sp, #80] // 8-byte Reload
; CHECK-COMMON-NEXT:    ldp d13, d12, [sp, #32] // 16-byte Folded Reload
; CHECK-COMMON-NEXT:    ldp d15, d14, [sp, #16] // 16-byte Folded Reload
...
define double  @zt0_new_caller_to_zt0_shared_callee(double %x) nounwind noinline optnone "aarch64_new_zt0" #0 {
...
define double  @zt0_shared_caller_to_normal_callee(double %x) nounwind noinline optnone "aarch64_inout_zt0" #0 {
...
attributes #0 = { "target-features"="+sve,+sme2" }
