...
define void @use_memset(ptr inreg nocapture %dest, i8 inreg %c, i32 inreg %n) local_unnamed_addr #0 {
entry:
...
;FASTWIN-NEXT:     retl
  tail call void @llvm.memset.p0.i32(ptr %dest, i8 %c, i32 %n, i1 false)
  ret void
}
