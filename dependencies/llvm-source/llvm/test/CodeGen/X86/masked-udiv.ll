...
; SSE42-NEXT:    xorl %edx, %edx
; SSE42-NEXT:    divw %si
; SSE42-NEXT:    # kill: def $ax killed $ax def $eax
; SSE42-NEXT:    movd %eax, %xmm0
