...
bb:		; preds = %bb, %entry
	...
	%2 = getelementptr i16, ptr %A, i32 %1		; <ptr> [#uses=1]
	%3 = load i16, ptr %2, align 2		; <i16> [#uses=1]
	%4 = sext i16 %3 to i32		; <i32> [#uses=1]
	%5 = mul i32 %i.03, %Bs		; <i32> [#uses=1]
	%6 = getelementptr i16, ptr %B, i32 %5		; <ptr> [#uses=1]
	%7 = load i16, ptr %6, align 2		; <i16> [#uses=1]
...
bb2:		; preds = %entry, %bb1.bb2_crit_edge
	...
	store i16 %sum.0.lcssa, ptr %C, align 2
	ret void
}
