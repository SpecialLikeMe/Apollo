...
define noalias ptr @foo() nounwind ssp {
entry:
  br i1 undef, label %for.end, label %for.body

for.body:                                         ; preds = %if.end40, %entry
  %tmp6 = load i8, ptr undef, align 2                 ; <i8> [#uses=3]
...
if.end:                                           ; preds = %if.then, %for.body
  ...
  store i8 %index.0, ptr undef
  %tmp24 = load i8, ptr undef                         ; <i8> [#uses=2]
