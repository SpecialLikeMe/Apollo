...
@uint8 = external dso_local global i32                      ; <ptr> [#uses=3]
...
entry:
  ...
  %1 = tail call i32 @func_24(i16 zeroext %0, i8 signext ptrtoint (ptr @foo to i8)) nounwind; <i32> [#uses=1]
  ...
  %11 = tail call i32 @func_24(i16 zeroext ptrtoint (ptr @bar to i16), i8 signext %10) nounwind; <i32> [#uses=1]
...
bb4:                                              ; preds = %bb3
  %17 = load volatile i32, ptr @uint8, align 4        ; <i32> [#uses=0]
  br label %bb5

bb5:                                              ; preds = %bb4, %bb3
  %18 = load volatile i32, ptr @uint8, align 4        ; <i32> [#uses=0]
...
bb6.preheader:                                    ; preds = %bb5
  ...
  %22 = load volatile i32, ptr @uint8, align 4        ; <i32> [#uses=0]
