...
define <4 x i32> @test_llvm_x86_sse41_pmovsxbd(ptr %a) {
...
define <2 x i64> @test_llvm_x86_sse41_pmovsxbq(ptr %a) {
...
define <4 x i32> @test_llvm_x86_sse41_pmovsxwd(ptr %a) {
...
define <2 x i64> @test_llvm_x86_sse41_pmovsxwq(ptr %a) {
...
define <2 x i64> @test_llvm_x86_sse41_pmovsxdq(ptr %a) {
