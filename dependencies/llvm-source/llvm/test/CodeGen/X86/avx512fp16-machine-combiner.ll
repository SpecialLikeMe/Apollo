...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vdivsh %xmm1, %xmm0, %xmm0
; CHECK-NEXT:    vminsh %xmm0, %xmm2, %xmm0
; CHECK-NEXT:    vminsh %xmm0, %xmm3, %xmm0
; CHECK-NEXT:    retq
  %t0 = fdiv half %x0, %x1
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vdivsh %xmm1, %xmm0, %xmm0
; CHECK-NEXT:    vmaxsh %xmm0, %xmm2, %xmm0
; CHECK-NEXT:    vmaxsh %xmm0, %xmm3, %xmm0
; CHECK-NEXT:    retq
  %t0 = fdiv half %x0, %x1
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vaddph %xmm1, %xmm0, %xmm0
; CHECK-NEXT:    vminph %xmm0, %xmm2, %xmm0
; CHECK-NEXT:    vminph %xmm0, %xmm3, %xmm0
; CHECK-NEXT:    retq
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vaddph %xmm1, %xmm0, %xmm0
; CHECK-NEXT:    vmaxph %xmm0, %xmm2, %xmm0
; CHECK-NEXT:    vmaxph %xmm0, %xmm3, %xmm0
; CHECK-NEXT:    retq
  %t0 = fadd <8 x half> %x0, %x1
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vaddph %ymm1, %ymm0, %ymm0
; CHECK-NEXT:    vminph %ymm0, %ymm2, %ymm0
; CHECK-NEXT:    vminph %ymm0, %ymm3, %ymm0
; CHECK-NEXT:    retq
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vaddph %ymm1, %ymm0, %ymm0
; CHECK-NEXT:    vmaxph %ymm0, %ymm2, %ymm0
; CHECK-NEXT:    vmaxph %ymm0, %ymm3, %ymm0
; CHECK-NEXT:    retq
  %t0 = fadd <16 x half> %x0, %x1
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vaddph %zmm1, %zmm0, %zmm0
; CHECK-NEXT:    vminph %zmm0, %zmm2, %zmm0
; CHECK-NEXT:    vminph %zmm0, %zmm3, %zmm0
; CHECK-NEXT:    retq
...
; CHECK:       # %bb.0:
; CHECK-NEXT:    vaddph %zmm1, %zmm0, %zmm0
; CHECK-NEXT:    vmaxph %zmm0, %zmm2, %zmm0
; CHECK-NEXT:    vmaxph %zmm0, %zmm3, %zmm0
; CHECK-NEXT:    retq
  %t0 = fadd <32 x half> %x0, %x1
