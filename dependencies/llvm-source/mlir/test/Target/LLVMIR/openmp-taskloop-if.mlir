...
// CHECK:   call void @__kmpc_taskloop(ptr @1, i32 %[[omp_global_thread_num]], ptr %[[VAL_1]], i32 %[[IF_VAL]], ptr %[[VAL_3]], ptr %[[VAL_4]], i64 %[[VAL_6]], i32 1, i32 0, i64 0, ptr @omp_taskloop_dup)
