...
low:
 ...
 .thumb_func
_start:
// CHECK: error: {{.*}}.o:(.text.1+0x0): relocation R_ARM_THM_ALU_PREL_11_0 out of range: 4098 is not in [0, 4095]
/// adr.w r0, low - 4091
 .inst.w 0xf6af70ff
 .reloc 0, R_ARM_THM_ALU_PREL_11_0, low
// CHECK: error: {{.*}}.o:(.text.1+0x4): relocation R_ARM_THM_ALU_PREL_11_0 out of range: 4096 is not in [0, 4095]
/// adr.w r0, high + 4091
 .inst.w 0xf60f70f7
