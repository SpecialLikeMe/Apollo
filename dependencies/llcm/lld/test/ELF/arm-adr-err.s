...
_start:
// CHECK: error: {{.*}}.o:(.os1+0x0): unencodeable immediate 1031 for relocation R_ARM_ALU_PC_G0
/// adr r0, low
 .inst 0xe24f0008
 .reloc 0, R_ARM_ALU_PC_G0, low
 // CHECK: error: {{.*}}.o:(.os1+0x4): unencodeable immediate 1013 for relocation R_ARM_ALU_PC_G0
/// adr r1, unaligned
 .inst 0xe24f1008
 ...
 .balign 512
/// ldrd r0, r1, _start
// CHECK: error: {{.*}}.o:(.os1+0x200): relocation R_ARM_LDRS_PC_G0 out of range: 512 is not in [0, 255]; references '_start'
