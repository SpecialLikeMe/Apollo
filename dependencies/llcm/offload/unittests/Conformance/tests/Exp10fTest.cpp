...
///
/// \file
/// This file contains the conformance test of the exp10f function.
///
//===----------------------------------------------------------------------===//
...
template <> struct FunctionConfig<exp10f> {
  static constexpr llvm::StringRef Name = "exp10f";
  static constexpr llvm::StringRef KernelName = "exp10fKernel";
...
int main(int argc, const char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv,
                                    "Conformance test of the exp10f function");
  ...
  bool Passed =
      runTests<exp10f>(Generator, Configs, DeviceBinaryDir, IsVerbose);
