...
///
/// \file
/// This file contains the conformance test of the cbrtf function.
///
//===----------------------------------------------------------------------===//
...
template <> struct FunctionConfig<cbrtf> {
  static constexpr llvm::StringRef Name = "cbrtf";
  static constexpr llvm::StringRef KernelName = "cbrtfKernel";
...
int main(int argc, const char **argv) {
  llvm::cl::ParseCommandLineOptions(argc, argv,
                                    "Conformance test of the cbrtf function");
  ...
  bool Passed = runTests<cbrtf>(Generator, Configs, DeviceBinaryDir, IsVerbose);
