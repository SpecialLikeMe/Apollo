...
// CHECK:    ret float [[V2]]
// expected-warning@+1 {{'log10' is deprecated: In 202x 64 bit API lowering for log10 is deprecated. Explicitly cast parameters to 32 or 16 bit types.}}
...
// CHECK:    [[V2:%.*]] = call {{.*}} float @llvm.log10.f32(float [[CONVI]])
// CHECK:    ret float [[V2]]
// expected-warning@+1 {{'log10' is deprecated: In 202x int lowering for log10 is deprecated. Explicitly cast parameters to float types.}}
