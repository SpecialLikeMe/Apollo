...
// CHECK-NEXT:    [[TMP1:%.*]] = load i16, ptr @usa, align 2
// CHECK-NEXT:    [[TMP2:%.*]] = sub i16 [[TMP0]], [[TMP1]]
// CHECK-NEXT:    store i16 [[TMP2]], ptr @usa, align 2
// CHECK-NEXT:    ret void
//
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = load i16, ptr @usa, align 2
// CHECK-NEXT:    [[TMP1:%.*]] = load i32, ptr @ua, align 4
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[TMP0:%.*]] = load i16, ptr @usa, align 2
// CHECK-NEXT:    [[TMP1:%.*]] = load i8, ptr @usf, align 1
...
// CHECK-NEXT:    [[RESIZE2:%.*]] = trunc i24 [[DOWNSCALE]] to i16
// CHECK-NEXT:    store i16 [[RESIZE2]], ptr @usa, align 2
// CHECK-NEXT:    ret void
//
