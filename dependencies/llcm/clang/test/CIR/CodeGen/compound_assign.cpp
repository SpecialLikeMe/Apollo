...
// CIR:   %[[AND:.*]] = cir.and %{{.*}}, %{{.*}} : !s32i
// CIR:   cir.store{{.*}} %[[AND]], %{{.*}} : !s32i, !cir.ptr<!s32i>
// CIR:   %[[XOR:.*]] = cir.xor %{{.*}}, %{{.*}} : !s32i
