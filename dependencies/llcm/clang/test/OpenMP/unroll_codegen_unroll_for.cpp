...
// IR-NEXT:    store i32 %[[ADD22]], ptr %[[DOTUNROLLED_IV__UNROLLED_IV_I18]], align 4
// IR-NEXT:    %[[TMP23:.+]] = load i32, ptr %[[DOTUNROLLED_IV__UNROLLED_IV_I18]], align 4
// IR-NEXT:    store i32 %[[TMP23]], ptr %[[DOTUNROLL_INNER_IV__UNROLLED_IV_I]], align 4
// IR-NEXT:    br label %[[FOR_COND:.+]]
// IR-EMPTY:
// IR-NEXT:  [[FOR_COND]]:
// IR-NEXT:    %[[TMP24:.+]] = load i32, ptr %[[DOTUNROLL_INNER_IV__UNROLLED_IV_I]], align 4
// IR-NEXT:    %[[TMP25:.+]] = load i32, ptr %[[DOTUNROLLED_IV__UNROLLED_IV_I18]], align 4
// IR-NEXT:    %[[ADD23:.+]] = add i32 %[[TMP25]], 2
// IR-NEXT:    %[[CMP24:.+]] = icmp ult i32 %[[TMP24]], %[[ADD23]]
// IR-NEXT:    br i1 %[[CMP24]], label %[[LAND_RHS:.+]], label %[[LAND_END:.+]]
// IR-EMPTY:
// IR-NEXT:  [[LAND_RHS]]:
// IR-NEXT:    %[[TMP26:.+]] = load i32, ptr %[[DOTUNROLL_INNER_IV__UNROLLED_IV_I]], align 4
...
// IR-EMPTY:
// IR-NEXT:  [[FOR_BODY]]:
// IR-NEXT:    %[[TMP29:.+]] = load i32, ptr %[[DOTUNROLL_INNER_IV__UNROLLED_IV_I]], align 4
// IR-NEXT:    %[[MUL27:.+]] = mul i32 %[[TMP29]], 2
// IR-NEXT:    %[[ADD28:.+]] = add i32 0, %[[MUL27]]
// IR-NEXT:    store i32 %[[ADD28]], ptr %[[DOTUNROLLED_IV_I]], align 4
...
// IR-EMPTY:
// IR-NEXT:  [[FOR_INC39]]:
// IR-NEXT:    %[[TMP44:.+]] = load i32, ptr %[[DOTUNROLL_INNER_IV__UNROLLED_IV_I]], align 4
// IR-NEXT:    %[[INC40:.+]] = add i32 %[[TMP44]], 1
// IR-NEXT:    store i32 %[[INC40]], ptr %[[DOTUNROLL_INNER_IV__UNROLLED_IV_I]], align 4
