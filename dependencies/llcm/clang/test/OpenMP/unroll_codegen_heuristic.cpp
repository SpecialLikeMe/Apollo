...
// IR-EMPTY:
// IR-NEXT:  [[FOR_BODY]]:
// IR-NEXT:    %[[TMP3:.+]] = load i32, ptr %[[START_ADDR]], align 4
// IR-NEXT:    %[[TMP4:.+]] = load i32, ptr %[[END_ADDR]], align 4
// IR-NEXT:    %[[TMP5:.+]] = load i32, ptr %[[STEP_ADDR]], align 4
...
// IR-EMPTY:
// IR-NEXT:  [[FOR_INC]]:
// IR-NEXT:    %[[TMP7:.+]] = load i32, ptr %[[STEP_ADDR]], align 4
