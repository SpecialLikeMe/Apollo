...
class TestKernVerStrLCNOTE(TestBase):
    ...
    def test_lc_note(self):
        ...
        shell_cmds = [
            ...
            '  echo "<key>DBGDSYMPath</key><string>%s.dSYM/Contents/Resources/DWARF/%s</string>"'
            % (self.test_exe, os.path.basename(self.test_exe)),
        ...
        ### Create our corefile
        retcode = call(
            self.create_corefile + " " + self.corefile + " " + self.test_exe, shell=True
        )
