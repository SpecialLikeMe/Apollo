...
class LanguageCategoryUpdatesTestCase(TestBase):
    ...
    def test_with_run_command(self):
        ...
        self.expect(
            "frame variable", substrs=["(S)", "object", "123", "456"], matching=True
        )
        ...
        self.expect(
            "frame variable", substrs=["this is an object of type S"], matching=True
        )

        self.type_category.DeleteTypeSummary(self.type_specifier)
        self.expect(
            "frame variable", substrs=["this is an object of type S"], matching=False
        )
        self.expect(
            "frame variable", substrs=["(S)", "object", "123", "456"], matching=True
        )
