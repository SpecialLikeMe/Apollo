...
class TestCase(TestBase):
    def test(self):
        ...
        self.expect_expr(
            "myC",
            result_type="C<int, 16, 32>",
            result_children=[
                ValueCheck(
                    name="C<int, 16>", children=[ValueCheck(name="member", value="64")]
                )
            ],
        )
        ...
        self.expect_expr(
            "myD",
            result_type="D<int, int, bool>",
            result_children=[
                ValueCheck(
                    name="D<int, int>", children=[ValueCheck(name="member", value="64")]
                )
            ],
        )
