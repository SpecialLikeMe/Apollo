...
class TestCase(TestBase):
    ...
    def test(self):
        ...
        self.expect_expr(
            "base_ptr_to_derived->getOtherPtr()", result_type="OtherBase *"
        )
        ...
        self.expect_expr(
            "base_ptr_to_derived->getOtherPtr()->value()", result_summary='"derived"'
        )
        ...
        self.expect_expr(
            "base_ptr_to_derived->getOtherRef().value()", result_summary='"derived"'
        )
