...
; CHECK-NEXT:    [[VMAXV_I:%.*]] = zext i8 [[TMP7]] to i32
; CHECK-NEXT:    [[VMAXV_I1:%.*]] = tail call i32 @llvm.aarch64.neon.umaxv.i32.v8i8(<8 x i8> [[A]]) #[[ATTR3:[0-9]+]]
; CHECK-NEXT:    [[TMP:%.*]] = trunc i32 [[VMAXV_I]] to i8
; CHECK-NEXT:    [[TMP8:%.*]] = trunc i32 [[VMAXV_I1]] to i8
...
; CHECK-NEXT:    [[VMAXV_I:%.*]] = zext i16 [[TMP7]] to i32
; CHECK-NEXT:    [[VMAXV_I1:%.*]] = tail call i32 @llvm.aarch64.neon.umaxv.i32.v4i16(<4 x i16> [[A]]) #[[ATTR3]]
; CHECK-NEXT:    [[TMP:%.*]] = trunc i32 [[VMAXV_I]] to i16
; CHECK-NEXT:    [[TMP8:%.*]] = trunc i32 [[VMAXV_I1]] to i16
...
; CHECK-NEXT:    [[VMAXV_I:%.*]] = zext i16 [[TMP7]] to i32
; CHECK-NEXT:    [[VMAXV_I1:%.*]] = tail call i32 @llvm.aarch64.neon.umaxv.i32.v8i16(<8 x i16> [[A]]) #[[ATTR3]]
; CHECK-NEXT:    [[TMP:%.*]] = trunc i32 [[VMAXV_I]] to i16
; CHECK-NEXT:    [[TMP8:%.*]] = trunc i32 [[VMAXV_I1]] to i16
; CHECK-NEXT:    [[TMP9:%.*]] = xor i16 [[TMP8]], 0
; CHECK-NEXT:    [[TMP4:%.*]] = or i16 [[TMP]], 0
...
; CHECK-NEXT:    [[VMAXV_I:%.*]] = zext i8 [[TMP7]] to i32
; CHECK-NEXT:    [[VMAXV_I1:%.*]] = tail call i32 @llvm.aarch64.neon.umaxv.i32.v16i8(<16 x i8> [[A]]) #[[ATTR3]]
; CHECK-NEXT:    [[TMP:%.*]] = trunc i32 [[VMAXV_I]] to i8
; CHECK-NEXT:    [[TMP8:%.*]] = trunc i32 [[VMAXV_I1]] to i8
; CHECK-NEXT:    [[TMP9:%.*]] = xor i8 [[TMP8]], 0
; CHECK-NEXT:    [[TMP4:%.*]] = or i8 [[TMP]], 0
