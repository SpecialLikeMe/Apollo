...
; CHECK-INLINE: @llvm.used = appending global [5 x ptr] [ptr @tysan.module_ctor, ptr @__tysan_v1_Simple_20C_2b_2b_20TBAA, ptr @__tysan_v1_omnipotent_20char, ptr @__tysan_v1_int, ptr @__tysan_v1_int_o_0], section "llvm.metadata"
...
; CHECK-OUTLINE: @llvm.used = appending global [5 x ptr] [ptr @tysan.module_ctor, ptr @__tysan_v1_Simple_20C_2b_2b_20TBAA, ptr @__tysan_v1_omnipotent_20char, ptr @__tysan_v1_int, ptr @__tysan_v1_int_o_0], section "llvm.metadata"
; CHECK-OUTLINE: @__tysan_shadow_memory_address = external global i64
; CHECK-OUTLINE: @__tysan_app_memory_mask = external global i64
;.
; CHECK-INLINE-LABEL: define i32 @test_load_nsan(
; CHECK-INLINE-SAME: ptr [[A:%.*]]) {
...
;
;
; CHECK-INLINE-LABEL: define void @test_store_nsan(
; CHECK-INLINE-SAME: ptr [[A:%.*]]) {
; CHECK-INLINE-NEXT:  [[ENTRY:.*:]]
; CHECK-INLINE-NEXT:    [[APP_MEM_MASK:%.*]] = load i64, ptr @__tysan_app_memory_mask, align 8
; CHECK-INLINE-NEXT:    [[SHADOW_BASE:%.*]] = load i64, ptr @__tysan_shadow_memory_address, align 8
...
; CHECK-INLINE-NEXT:    [[SHADOW_DESC:%.*]] = load ptr, ptr [[SHADOW_PTR]], align 8
; CHECK-INLINE-NEXT:    [[DESC_SET:%.*]] = icmp eq ptr [[SHADOW_DESC]], null
; CHECK-INLINE-NEXT:    br i1 [[DESC_SET]], label %[[SET_TYPE:.*]], label %[[BB0:.*]], !prof [[PROF0]]
; CHECK-INLINE:       [[SET_TYPE]]:
; CHECK-INLINE-NEXT:    store ptr @__tysan_v1_int_o_0, ptr [[SHADOW_PTR]], align 8
; CHECK-INLINE-NEXT:    [[SHADOW_BYTE_1_OFFSET:%.*]] = add i64 [[SHADOW_PTR_INT]], 8
; CHECK-INLINE-NEXT:    [[SHADOW_BYTE_1_PTR:%.*]] = inttoptr i64 [[SHADOW_BYTE_1_OFFSET]] to ptr
...
; CHECK-INLINE-NEXT:    br label %[[BB0]]
; CHECK-INLINE:       [[BB0]]:
; CHECK-INLINE-NEXT:    store i32 42, ptr [[A]], align 4, !tbaa [[INT_TBAA1]]
; CHECK-INLINE-NEXT:    ret void
;
;
; CHECK-INLINE-LABEL: define internal void @tysan.module_ctor(
; CHECK-INLINE-SAME: ) #[[ATTR0:[0-9]+]] {
; CHECK-INLINE-NEXT:    call void @__tysan_init()
; CHECK-INLINE-NEXT:    ret void
;
;
; CHECK-OUTLINE-LABEL: define i32 @test_load_nsan(
; CHECK-OUTLINE-SAME: ptr [[A:%.*]]) {
...
; CHECK-OUTLINE-NEXT:    call void @__tysan_instrument_with_shadow_update(ptr [[A]], ptr @__tysan_v1_int_o_0, i1 false, i64 4, i32 1)
; CHECK-OUTLINE-NEXT:    [[TMP1:%.*]] = load i32, ptr [[A]], align 4, !tbaa [[INT_TBAA0:![0-9]+]]
; CHECK-OUTLINE-NEXT:    ret i32 [[TMP1]]
;
;
; CHECK-OUTLINE-LABEL: define void @test_store_nsan(
; CHECK-OUTLINE-SAME: ptr [[A:%.*]]) {
; CHECK-OUTLINE-NEXT:  [[ENTRY:.*:]]
; CHECK-OUTLINE-NEXT:    [[APP_MEM_MASK:%.*]] = load i64, ptr @__tysan_app_memory_mask, align 8
; CHECK-OUTLINE-NEXT:    [[SHADOW_BASE:%.*]] = load i64, ptr @__tysan_shadow_memory_address, align 8
; CHECK-OUTLINE-NEXT:    call void @__tysan_instrument_with_shadow_update(ptr [[A]], ptr @__tysan_v1_int_o_0, i1 false, i64 4, i32 2)
; CHECK-OUTLINE-NEXT:    store i32 42, ptr [[A]], align 4, !tbaa [[INT_TBAA0]]
; CHECK-OUTLINE-NEXT:    ret void
;
;
; CHECK-OUTLINE-LABEL: define internal void @tysan.module_ctor(
