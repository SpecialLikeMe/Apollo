...
@nodes = internal global i64 0                    ; <ptr> [#uses=4]
@.str = private constant [9 x i8] c"##-<=>+#\00", align 1 ; <ptr> [#uses=2]
@.str1 = private constant [6 x i8] c"%c%d\0A\00", align 1 ; <ptr> [#uses=1]
@.str2 = private constant [16 x i8] c"Fhourstones 2.0\00", align 1 ; <ptr> [#uses=1]
@.str3 = private constant [54 x i8] c"Using %d transposition table entries with %d probes.\0A\00", align 1 ; <ptr> [#uses=1]
@.str4 = private constant [31 x i8] c"Solving %d-ply position after \00", align 1 ; <ptr> [#uses=1]
@.str5 = private constant [7 x i8] c" . . .\00", align 1 ; <ptr> [#uses=1]
@.str6 = private constant [28 x i8] c"score = %d (%c)  work = %d\0A\00", align 1 ; <ptr> [#uses=1]
@.str7 = private constant [36 x i8] c"%lu pos / %lu msec = %.1f Kpos/sec\0A\00", align 1 ; <ptr> [#uses=1]
@plycnt = internal global i32 0                   ; <ptr> [#uses=21]
@dias = internal global [19 x i32] zeroinitializer ; <ptr> [#uses=43]
@columns = internal global [128 x i32] zeroinitializer ; <ptr> [#uses=18]
@height = internal global [128 x i32] zeroinitializer ; <ptr> [#uses=21]
@rows = internal global [8 x i32] zeroinitializer ; <ptr> [#uses=20]
...
@he = internal global ptr null                    ; <ptr> [#uses=9]
@hits = internal global i64 0                     ; <ptr> [#uses=8]
@posed = internal global i64 0                    ; <ptr> [#uses=7]
@ht = internal global ptr null                   ; <ptr> [#uses=5]
...
@.str319 = private constant [30 x i8] c"Failed to allocate %u bytes.\0A\00", align 1 ; <ptr> [#uses=1]
