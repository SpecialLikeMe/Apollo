...
; O1-MAD-EMPTY:
; O1-MAD-NEXT:  // %bb.0:
; O1-MAD-NEXT:    ld.param.b16 %rs1, [t33_param_0];
; O1-MAD-NEXT:    ld.param.b16 %rs2, [t33_param_1];
; O1-MAD-NEXT:    ld.param.b32 %r1, [t33_param_2];
; O1-MAD-NEXT:    mad.wide.s16 %r2, %rs1, %rs2, %r1;
; O1-MAD-NEXT:    st.param.b32 [func_retval0], %r2;
; O1-MAD-NEXT:    ret;
;
...
; O1-NO-MAD-EMPTY:
; O1-NO-MAD-NEXT:  // %bb.0:
; O1-NO-MAD-NEXT:    ld.param.b16 %rs1, [t34_param_0];
; O1-NO-MAD-NEXT:    ld.param.b16 %rs2, [t34_param_1];
; O1-NO-MAD-NEXT:    mul.wide.s16 %r1, %rs1, %rs2;
; O1-NO-MAD-NEXT:    add.s32 %r2, %r1, 1;
; O1-NO-MAD-NEXT:    st.param.b32 [func_retval0], %r2;
; O1-NO-MAD-NEXT:    ret;
;
; O1-MAD-LABEL: t34(
; O1-MAD:       {
...
; O1-MAD-EMPTY:
; O1-MAD-NEXT:  // %bb.0:
; O1-MAD-NEXT:    ld.param.b16 %rs1, [t34_param_0];
; O1-MAD-NEXT:    ld.param.b16 %rs2, [t34_param_1];
; O1-MAD-NEXT:    mad.wide.s16 %r1, %rs1, %rs2, 1;
; O1-MAD-NEXT:    st.param.b32 [func_retval0], %r1;
; O1-MAD-NEXT:    ret;
;
; O0-LABEL: t34(
; O0:       {
...
; O1-NO-MAD-LABEL: t35(
; O1-NO-MAD:       {
; O1-NO-MAD-NEXT:    .reg .b16 %rs<2>;
; O1-NO-MAD-NEXT:    .reg .b32 %r<4>;
; O1-NO-MAD-EMPTY:
; O1-NO-MAD-NEXT:  // %bb.0:
; O1-NO-MAD-NEXT:    ld.param.b16 %rs1, [t35_param_0];
; O1-NO-MAD-NEXT:    ld.param.b32 %r1, [t35_param_1];
; O1-NO-MAD-NEXT:    mul.wide.s16 %r2, %rs1, 3;
; O1-NO-MAD-NEXT:    add.s32 %r3, %r1, %r2;
; O1-NO-MAD-NEXT:    st.param.b32 [func_retval0], %r3;
; O1-NO-MAD-NEXT:    ret;
;
; O1-MAD-LABEL: t35(
; O1-MAD:       {
; O1-MAD-NEXT:    .reg .b16 %rs<2>;
; O1-MAD-NEXT:    .reg .b32 %r<3>;
; O1-MAD-EMPTY:
; O1-MAD-NEXT:  // %bb.0:
; O1-MAD-NEXT:    ld.param.b16 %rs1, [t35_param_0];
; O1-MAD-NEXT:    ld.param.b32 %r1, [t35_param_1];
; O1-MAD-NEXT:    mad.wide.s16 %r2, %rs1, 3, %r1;
; O1-MAD-NEXT:    st.param.b32 [func_retval0], %r2;
; O1-MAD-NEXT:    ret;
;
; O0-LABEL: t35(
...
; O1-NO-MAD-EMPTY:
; O1-NO-MAD-NEXT:  // %bb.0:
; O1-NO-MAD-NEXT:    ld.param.b16 %rs1, [t36_param_0];
; O1-NO-MAD-NEXT:    mul.wide.s16 %r1, %rs1, 3;
; O1-NO-MAD-NEXT:    add.s32 %r2, %r1, 5;
; O1-NO-MAD-NEXT:    st.param.b32 [func_retval0], %r2;
; O1-NO-MAD-NEXT:    ret;
;
; O1-MAD-LABEL: t36(
...
; O1-MAD-EMPTY:
; O1-MAD-NEXT:  // %bb.0:
; O1-MAD-NEXT:    ld.param.b16 %rs1, [t36_param_0];
; O1-MAD-NEXT:    mad.wide.s16 %r1, %rs1, 3, 5;
; O1-MAD-NEXT:    st.param.b32 [func_retval0], %r1;
; O1-MAD-NEXT:    ret;
;
; O0-LABEL: t36(
...
; O1-NO-MAD-EMPTY:
; O1-NO-MAD-NEXT:  // %bb.0:
; O1-NO-MAD-NEXT:    ld.param.b16 %rs1, [t37_param_0];
; O1-NO-MAD-NEXT:    ld.param.b16 %rs2, [t37_param_1];
; O1-NO-MAD-NEXT:    mul.wide.u16 %r1, %rs1, %rs2;
; O1-NO-MAD-NEXT:    ld.param.b32 %r2, [t37_param_2];
; O1-NO-MAD-NEXT:    add.s32 %r3, %r2, %r1;
; O1-NO-MAD-NEXT:    st.param.b32 [func_retval0], %r3;
; O1-NO-MAD-NEXT:    ret;
;
...
; O1-MAD-EMPTY:
; O1-MAD-NEXT:  // %bb.0:
; O1-MAD-NEXT:    ld.param.b16 %rs1, [t37_param_0];
; O1-MAD-NEXT:    ld.param.b16 %rs2, [t37_param_1];
; O1-MAD-NEXT:    ld.param.b32 %r1, [t37_param_2];
; O1-MAD-NEXT:    mad.wide.u16 %r2, %rs1, %rs2, %r1;
; O1-MAD-NEXT:    st.param.b32 [func_retval0], %r2;
; O1-MAD-NEXT:    ret;
;
; O0-LABEL: t37(
...
; O1-NO-MAD-EMPTY:
; O1-NO-MAD-NEXT:  // %bb.0:
; O1-NO-MAD-NEXT:    ld.param.b16 %rs1, [t38_param_0];
; O1-NO-MAD-NEXT:    ld.param.b16 %rs2, [t38_param_1];
; O1-NO-MAD-NEXT:    mul.wide.u16 %r1, %rs1, %rs2;
; O1-NO-MAD-NEXT:    ld.param.b32 %r2, [t38_param_2];
; O1-NO-MAD-NEXT:    add.s32 %r3, %r1, %r2;
; O1-NO-MAD-NEXT:    st.param.b32 [func_retval0], %r3;
; O1-NO-MAD-NEXT:    ret;
;
...
; O1-MAD-EMPTY:
; O1-MAD-NEXT:  // %bb.0:
; O1-MAD-NEXT:    ld.param.b16 %rs1, [t38_param_0];
; O1-MAD-NEXT:    ld.param.b16 %rs2, [t38_param_1];
; O1-MAD-NEXT:    ld.param.b32 %r1, [t38_param_2];
; O1-MAD-NEXT:    mad.wide.u16 %r2, %rs1, %rs2, %r1;
; O1-MAD-NEXT:    st.param.b32 [func_retval0], %r2;
; O1-MAD-NEXT:    ret;
;
