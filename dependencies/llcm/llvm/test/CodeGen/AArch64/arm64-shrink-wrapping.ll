...
; RUN: llc -debugify-and-strip-all-safe %s -o - -mtriple=arm64-apple-ios -enable-shrink-wrap=true -disable-post-ra -frame-pointer=non-leaf | FileCheck %s --check-prefixes=CHECK,ENABLE
; RUN: llc -debugify-and-strip-all-safe %s -o - -enable-shrink-wrap=false -disable-post-ra -frame-pointer=non-leaf | FileCheck %s --check-prefixes=CHECK,DISABLE
...
; CHECK-NEXT:    mov w20, #10 ; =0xa
; CHECK-NEXT:  LBB2_1: ; %for.body
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    bl _something
; CHECK-NEXT:    subs w20, w20, #1
; CHECK-NEXT:    add w19, w0, w19
...
; CHECK-NEXT:    .cfi_offset w19, -24
; CHECK-NEXT:    .cfi_offset w20, -32
; CHECK-NEXT:    sub x19, sp, #16
; CHECK-NEXT:    mov sp, x19
; CHECK-NEXT:    mov w20, wzr
; CHECK-NEXT:  LBB10_1: ; %for.body
; CHECK-NEXT:    ; =>This Inner Loop Header: Depth=1
; CHECK-NEXT:    bl _something
; CHECK-NEXT:    add w20, w0, w20
; CHECK-NEXT:    str w20, [x19]
...
; CHECK-NEXT:    lsl w8, w1, w0
; CHECK-NEXT:    lsr w9, w0, w1
; CHECK-NEXT:    lsl w14, w0, w1
; CHECK-NEXT:    lsr w11, w1, w0
; CHECK-NEXT:    add w15, w1, w0
; CHECK-NEXT:    sub w10, w8, w9
; CHECK-NEXT:    subs w17, w1, w0
; CHECK-NEXT:    add w16, w14, w8
; CHECK-NEXT:    add w12, w9, w11
; CHECK-NEXT:    add w13, w11, w15
...
; CHECK-NEXT:    str w14, [x2]
; CHECK-NEXT:    str w8, [x3]
; CHECK-NEXT:    str w9, [x4]
; CHECK-NEXT:    str w11, [x5]
; CHECK-NEXT:    str w15, [x6]
; CHECK-NEXT:    str w17, [x7]
; CHECK-NEXT:    stp w0, w1, [x2, #4]
; CHECK-NEXT:    stp w16, w10, [x2, #12]
; CHECK-NEXT:    stp w12, w13, [x2, #20]
...
define i1 @unreachableblock(i1 %arg) {
; CHECK-LABEL: unreachableblock:
; CHECK:       ; %bb.0: ; %bb
