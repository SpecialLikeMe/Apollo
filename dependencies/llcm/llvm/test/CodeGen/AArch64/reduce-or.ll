...
; CHECK-SD-LABEL: test_redor_v2i1:
; CHECK-SD:       // %bb.0:
...
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test_redor_v2i1:
; CHECK-GI:       // %bb.0:
...
; CHECK-SD-LABEL: test_redor_v4i1:
; CHECK-SD:       // %bb.0:
...
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test_redor_v4i1:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    // kill: def $d0 killed $d0 def $q0
...
; CHECK-SD-LABEL: test_redor_v8i1:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    shl v0.8b, v0.8b, #7
; CHECK-SD-NEXT:    cmlt v0.8b, v0.8b, #0
; CHECK-SD-NEXT:    umaxv b0, v0.8b
; CHECK-SD-NEXT:    fmov w8, s0
; CHECK-SD-NEXT:    and w0, w8, #0x1
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test_redor_v8i1:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    // kill: def $d0 killed $d0 def $q0
...
; CHECK-GI-NEXT:    orr w8, w8, w9
; CHECK-GI-NEXT:    orr w9, w10, w11
; CHECK-GI-NEXT:    orr w10, w12, w13
; CHECK-GI-NEXT:    orr w11, w14, w15
; CHECK-GI-NEXT:    orr w8, w8, w9
; CHECK-GI-NEXT:    orr w9, w10, w11
; CHECK-GI-NEXT:    orr w8, w8, w9
; CHECK-GI-NEXT:    and w0, w8, #0x1
...
; CHECK-SD-LABEL: test_redor_v16i1:
; CHECK-SD:       // %bb.0:
...
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test_redor_v16i1:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    umov w8, v0.b[0]
; CHECK-GI-NEXT:    umov w9, v0.b[1]
; CHECK-GI-NEXT:    umov w10, v0.b[2]
...
; CHECK-GI-NEXT:    orr w12, w16, w17
; CHECK-GI-NEXT:    orr w13, w18, w0
; CHECK-GI-NEXT:    orr w9, w10, w11
; CHECK-GI-NEXT:    orr w14, w1, w2
; CHECK-GI-NEXT:    orr w10, w12, w13
; CHECK-GI-NEXT:    orr w8, w8, w9
; CHECK-GI-NEXT:    orr w15, w3, w4
; CHECK-GI-NEXT:    orr w11, w14, w15
; CHECK-GI-NEXT:    orr w9, w10, w11
; CHECK-GI-NEXT:    orr w8, w8, w9
; CHECK-GI-NEXT:    and w0, w8, #0x1
...
; CHECK-SD-LABEL: test_redor_ins_v16i1:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    shl v0.16b, v0.16b, #7
; CHECK-SD-NEXT:    cmlt v0.16b, v0.16b, #0
; CHECK-SD-NEXT:    umaxv b0, v0.16b
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test_redor_ins_v16i1:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    umov w8, v0.b[0]
; CHECK-GI-NEXT:    umov w9, v0.b[1]
; CHECK-GI-NEXT:    umov w10, v0.b[2]
...
; CHECK-SD-LABEL: test_redor_v3i8:
; CHECK-SD:       // %bb.0:
...
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test_redor_v3i8:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    orr w8, w0, w1
; CHECK-GI-NEXT:    orr w0, w8, w2
; CHECK-GI-NEXT:    ret
...
; CHECK-SD-LABEL: test_redor_v4i8:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    fmov x8, d0
; CHECK-SD-NEXT:    orr x8, x8, x8, lsr #32
; CHECK-SD-NEXT:    lsr x9, x8, #16
; CHECK-SD-NEXT:    orr w0, w8, w9
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test_redor_v4i8:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    // kill: def $d0 killed $d0 def $q0
; CHECK-GI-NEXT:    umov w8, v0.h[0]
; CHECK-GI-NEXT:    umov w9, v0.h[1]
...
; CHECK-SD-LABEL: test_redor_v8i8:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    fmov x8, d0
; CHECK-SD-NEXT:    orr x8, x8, x8, lsr #32
; CHECK-SD-NEXT:    orr x8, x8, x8, lsr #16
; CHECK-SD-NEXT:    lsr x9, x8, #8
; CHECK-SD-NEXT:    orr w0, w8, w9
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test_redor_v8i8:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    // kill: def $d0 killed $d0 def $q0
; CHECK-GI-NEXT:    umov w8, v0.b[0]
; CHECK-GI-NEXT:    umov w9, v0.b[1]
...
; CHECK-SD-LABEL: test_redor_v16i8:
; CHECK-SD:       // %bb.0:
...
; CHECK-SD-LABEL: test_redor_v32i8:
; CHECK-SD:       // %bb.0:
...
; CHECK-SD-LABEL: test_redor_v4i16:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    fmov x8, d0
; CHECK-SD-NEXT:    orr x8, x8, x8, lsr #32
; CHECK-SD-NEXT:    lsr x9, x8, #16
...
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test_redor_v4i16:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    // kill: def $d0 killed $d0 def $q0
; CHECK-GI-NEXT:    umov w8, v0.h[0]
; CHECK-GI-NEXT:    umov w9, v0.h[1]
...
; CHECK-SD-LABEL: test_redor_v8i16:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    ext v1.16b, v0.16b, v0.16b, #8
; CHECK-SD-NEXT:    orr v0.8b, v0.8b, v1.8b
; CHECK-SD-NEXT:    fmov x8, d0
...
; CHECK-SD-LABEL: test_redor_v16i16:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    orr v0.16b, v0.16b, v1.16b
; CHECK-SD-NEXT:    ext v1.16b, v0.16b, v0.16b, #8
; CHECK-SD-NEXT:    orr v0.8b, v0.8b, v1.8b
...
; CHECK-SD-LABEL: test_redor_v2i32:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    fmov x8, d0
; CHECK-SD-NEXT:    lsr x9, x8, #32
; CHECK-SD-NEXT:    orr w0, w8, w9
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test_redor_v2i32:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    // kill: def $d0 killed $d0 def $q0
; CHECK-GI-NEXT:    mov w8, v0.s[1]
; CHECK-GI-NEXT:    fmov w9, s0
...
; CHECK-SD-LABEL: test_redor_v4i32:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    ext v1.16b, v0.16b, v0.16b, #8
; CHECK-SD-NEXT:    orr v0.8b, v0.8b, v1.8b
; CHECK-SD-NEXT:    fmov x8, d0
...
; CHECK-SD-LABEL: test_redor_v8i32:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    orr v0.16b, v0.16b, v1.16b
; CHECK-SD-NEXT:    ext v1.16b, v0.16b, v0.16b, #8
; CHECK-SD-NEXT:    orr v0.8b, v0.8b, v1.8b
...
; CHECK-SD-LABEL: test_redor_v2i64:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    ext v1.16b, v0.16b, v0.16b, #8
; CHECK-SD-NEXT:    orr v0.8b, v0.8b, v1.8b
...
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test_redor_v2i64:
; CHECK-GI:       // %bb.0:
...
; CHECK-SD-LABEL: test_redor_v4i64:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    orr v0.16b, v0.16b, v1.16b
; CHECK-SD-NEXT:    ext v1.16b, v0.16b, v0.16b, #8
; CHECK-SD-NEXT:    orr v0.8b, v0.8b, v1.8b
...
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: test_redor_v4i64:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    orr v0.16b, v0.16b, v1.16b
; CHECK-GI-NEXT:    mov x8, v0.d[1]
; CHECK-GI-NEXT:    fmov x9, d0
