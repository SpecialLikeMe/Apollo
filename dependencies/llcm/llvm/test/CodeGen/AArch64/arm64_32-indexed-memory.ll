...
; RUN: llc < %s -mtriple=arm64_32-apple-ios -aarch64-enable-sink-fold=true -aarch64-redzone | FileCheck %s
...
; CHECK-LABEL: postidx32_half:
; CHECK:       ; %bb.0:
; CHECK-NEXT:    ldr h1, [x0], #4
