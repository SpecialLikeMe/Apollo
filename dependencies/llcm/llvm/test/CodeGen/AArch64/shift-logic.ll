...
; CHECK-SD-LABEL: shl_and:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    lsl w8, w0, #5
; CHECK-SD-NEXT:    and w0, w8, w1, lsl #2
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: shl_and:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    lsl w8, w1, #2
; CHECK-GI-NEXT:    and w0, w8, w0, lsl #5
; CHECK-GI-NEXT:    ret
  %sh0 = shl i8 %x, 3
  %r = and i8 %sh0, %y
  %sh1 = shl i8 %r, 2
...
; CHECK-SD-LABEL: shl_or:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    lsl w8, w0, #12
; CHECK-SD-NEXT:    orr w0, w8, w1, lsl #7
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: shl_or:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    lsl w8, w1, #7
; CHECK-GI-NEXT:    orr w0, w8, w0, lsl #12
; CHECK-GI-NEXT:    ret
  %sh0 = shl i16 %x, 5
  %r = or i16 %y, %sh0
  %sh1 = shl i16 %r, 7
...
; CHECK-SD-LABEL: shl_xor:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    lsl w8, w0, #12
; CHECK-SD-NEXT:    eor w0, w8, w1, lsl #7
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: shl_xor:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    lsl w8, w1, #7
; CHECK-GI-NEXT:    eor w0, w8, w0, lsl #12
; CHECK-GI-NEXT:    ret
  %sh0 = shl i32 %x, 5
  %r = xor i32 %sh0, %y
  %sh1 = shl i32 %r, 7
...
; CHECK-SD-LABEL: lshr_and:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    lsr x8, x0, #12
; CHECK-SD-NEXT:    and x0, x8, x1, lsr #7
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: lshr_and:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    lsr x8, x1, #7
; CHECK-GI-NEXT:    and x0, x8, x0, lsr #12
; CHECK-GI-NEXT:    ret
  %sh0 = lshr i64 %x, 5
  %r = and i64 %y, %sh0
  %sh1 = lshr i64 %r, 7
...
; CHECK-SD-LABEL: lshr_or:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    ushr v1.4s, v1.4s, #7
; CHECK-SD-NEXT:    ushr v0.4s, v0.4s, #12
; CHECK-SD-NEXT:    orr v0.16b, v0.16b, v1.16b
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: lshr_or:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    ushr v0.4s, v0.4s, #5
; CHECK-GI-NEXT:    orr v0.16b, v0.16b, v1.16b
; CHECK-GI-NEXT:    ushr v0.4s, v0.4s, #7
; CHECK-GI-NEXT:    ret
...
; CHECK-SD-LABEL: lshr_xor:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    ushr v1.8h, v1.8h, #7
; CHECK-SD-NEXT:    ushr v0.8h, v0.8h, #12
; CHECK-SD-NEXT:    eor v0.16b, v0.16b, v1.16b
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: lshr_xor:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    ushr v0.8h, v0.8h, #5
...
; CHECK-SD-LABEL: ashr_and:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    sshr v1.16b, v1.16b, #2
; CHECK-SD-NEXT:    sshr v0.16b, v0.16b, #5
; CHECK-SD-NEXT:    and v0.16b, v0.16b, v1.16b
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: ashr_and:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    sshr v0.16b, v0.16b, #3
; CHECK-GI-NEXT:    and v0.16b, v1.16b, v0.16b
; CHECK-GI-NEXT:    sshr v0.16b, v0.16b, #2
; CHECK-GI-NEXT:    ret
...
; CHECK-SD-LABEL: ashr_or:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    sshr v1.2d, v1.2d, #7
; CHECK-SD-NEXT:    sshr v0.2d, v0.2d, #12
; CHECK-SD-NEXT:    orr v0.16b, v0.16b, v1.16b
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: ashr_or:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    sshr v0.2d, v0.2d, #5
; CHECK-GI-NEXT:    orr v0.16b, v0.16b, v1.16b
; CHECK-GI-NEXT:    sshr v0.2d, v0.2d, #7
; CHECK-GI-NEXT:    ret
...
; CHECK-SD-LABEL: ashr_xor:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    asr w8, w0, #12
; CHECK-SD-NEXT:    eor w0, w8, w1, asr #7
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: ashr_xor:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    asr w8, w1, #7
; CHECK-GI-NEXT:    eor w0, w8, w0, asr #12
; CHECK-GI-NEXT:    ret
  %sh0 = ashr i32 %x, 5
  %r = xor i32 %y, %sh0
  %sh1 = ashr i32 %r, 7
...
; CHECK-SD-LABEL: desirable_to_commute1:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    and x0, x0, #0x7fff8
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: desirable_to_commute1:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    ubfx x8, x0, #3, #16
; CHECK-GI-NEXT:    lsl x0, x8, #3
; CHECK-GI-NEXT:    ret
  %s1 = lshr i64 %x, 3
  %a = and i64 %s1, 65535
  %s2 = shl i64 %a, 3
...
; CHECK-SD-LABEL: desirable_to_commute2:
; CHECK-SD:       // %bb.0:
; CHECK-SD-NEXT:    and x8, x1, #0x1ff8
; CHECK-SD-NEXT:    ldr x0, [x0, x8]
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: desirable_to_commute2:
; CHECK-GI:       // %bb.0:
; CHECK-GI-NEXT:    ubfx x8, x1, #3, #10
; CHECK-GI-NEXT:    ldr x0, [x0, x8, lsl #3]
; CHECK-GI-NEXT:    ret
  %lshr = lshr i64 %i, 3
...
; CHECK-SD-LABEL: apint_type_mismatch:
; CHECK-SD:       // %bb.0: // %entry
; CHECK-SD-NEXT:    and w8, w0, #0x7f8
; CHECK-SD-NEXT:    str w8, [x1]
; CHECK-SD-NEXT:    ret
;
; CHECK-GI-LABEL: apint_type_mismatch:
; CHECK-GI:       // %bb.0: // %entry
