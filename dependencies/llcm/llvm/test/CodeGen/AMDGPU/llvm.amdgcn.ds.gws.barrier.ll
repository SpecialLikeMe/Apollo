...
; GFX6-SDAG-LABEL: gws_barrier_vgpr_offset_add:
; GFX6-SDAG:  ; %bb.0:
...
; GFX6-SDAG:    ds_gws_barrier v0 offset:3 gds
...
; GFX6-SDAG:    s_endpgm
;
; GFX6-GISEL-LABEL: gws_barrier_vgpr_offset_add:
; GFX6-GISEL:  ; %bb.0:
...
; GFX6-GISEL:    ds_gws_barrier v0 gds
...
; GFX6-GISEL:    s_endpgm
;
; GFX9-SDAG-LABEL: gws_barrier_vgpr_offset_add:
; GFX9-SDAG:  ; %bb.0:
; GFX9-SDAG:    v_readfirstlane_b32 s1, v0
; GFX9-SDAG:    s_lshl_b32 m0, s1, 16
; GFX9-SDAG:    s_waitcnt lgkmcnt(0)
; GFX9-SDAG:    v_mov_b32_e32 v0, s0
; GFX9-SDAG:    ds_gws_barrier v0 offset:3 gds
; GFX9-SDAG:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX9-SDAG:    s_endpgm
;
; GFX9-GISEL-LABEL: gws_barrier_vgpr_offset_add:
; GFX9-GISEL:  ; %bb.0:
