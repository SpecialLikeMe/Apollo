...
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX11,GFX11-TRUE16,GFX11-TRUE16-SDAG %s
; RUN: llc -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1100 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX11,GFX11-TRUE16,GFX11-TRUE16-GISEL %s
; RUN: llc -global-isel=0 -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX11,GFX11-FAKE16 %s
; RUN: llc -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1100 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX11,GFX11-FAKE16 %s
...
; RUN: llc -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1200 -mattr=+real-true16 < %s | FileCheck -check-prefixes=GFX12,GFX12-TRUE16,GFX12-TRUE16-GISEL %s
...
; RUN: llc -global-isel=1 -new-reg-bank-select -mtriple=amdgcn -mcpu=gfx1200 -mattr=-real-true16 < %s | FileCheck -check-prefixes=GFX12,GFX12-FAKE16,GFX12-FAKE16-GISEL %s
...
; GFX11-FAKE16-NEXT:    ; return to shader part epilog
;
; GFX12-TRUE16-SDAG-LABEL: v_interp_f16_imm_params:
; GFX12-TRUE16-SDAG:       ; %bb.0: ; %main_body
; GFX12-TRUE16-SDAG-NEXT:    v_dual_mov_b32 v1, 0 :: v_dual_mov_b32 v2, s0
; GFX12-TRUE16-SDAG-NEXT:    v_mov_b32_e32 v3, s1
; GFX12-TRUE16-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-TRUE16-SDAG-NEXT:    v_mov_b16_e32 v0.l, v1.l
; GFX12-TRUE16-SDAG-NEXT:    v_interp_p10_f16_f32 v2, v0.l, v2, v0.l wait_exp:7
; GFX12-TRUE16-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-TRUE16-SDAG-NEXT:    v_interp_p2_f16_f32 v0.l, v0.l, v3, v1 wait_exp:7
; GFX12-TRUE16-SDAG-NEXT:    v_cvt_f16_f32_e32 v0.h, v2
; GFX12-TRUE16-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX12-TRUE16-SDAG-NEXT:    v_add_f16_e32 v0.l, v0.h, v0.l
...
; GFX12-FAKE16-SDAG:       ; %bb.0: ; %main_body
; GFX12-FAKE16-SDAG-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s0
; GFX12-FAKE16-SDAG-NEXT:    v_mov_b32_e32 v2, s1
; GFX12-FAKE16-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-FAKE16-SDAG-NEXT:    v_interp_p10_f16_f32 v1, v0, v1, v0 wait_exp:7
; GFX12-FAKE16-SDAG-NEXT:    v_interp_p2_f16_f32 v0, v0, v2, v0 wait_exp:7
; GFX12-FAKE16-SDAG-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-FAKE16-SDAG-NEXT:    v_cvt_f16_f32_e32 v1, v1
; GFX12-FAKE16-SDAG-NEXT:    v_add_f16_e32 v0, v1, v0
; GFX12-FAKE16-SDAG-NEXT:    ; return to shader part epilog
;
; GFX12-FAKE16-GISEL-LABEL: v_interp_f16_imm_params:
; GFX12-FAKE16-GISEL:       ; %bb.0: ; %main_body
; GFX12-FAKE16-GISEL-NEXT:    v_dual_mov_b32 v0, 0 :: v_dual_mov_b32 v1, s0
; GFX12-FAKE16-GISEL-NEXT:    v_mov_b32_e32 v2, s1
; GFX12-FAKE16-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-FAKE16-GISEL-NEXT:    v_interp_p10_f16_f32 v1, v0, v1, v0 wait_exp:7
; GFX12-FAKE16-GISEL-NEXT:    v_interp_p2_f16_f32 v0, v0, v2, v0 wait_exp:7
; GFX12-FAKE16-GISEL-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX12-FAKE16-GISEL-NEXT:    v_readfirstlane_b32 s0, v1
; GFX12-FAKE16-GISEL-NEXT:    v_readfirstlane_b32 s1, v0
; GFX12-FAKE16-GISEL-NEXT:    s_cvt_f16_f32 s0, s0
; GFX12-FAKE16-GISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_2) | instskip(SKIP_1) | instid1(SALU_CYCLE_2)
; GFX12-FAKE16-GISEL-NEXT:    s_add_f16 s0, s0, s1
; GFX12-FAKE16-GISEL-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-FAKE16-GISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX12-FAKE16-GISEL-NEXT:    ; return to shader part epilog
main_body:
