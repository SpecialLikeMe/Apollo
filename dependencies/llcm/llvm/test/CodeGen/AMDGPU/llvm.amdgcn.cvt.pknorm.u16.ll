...
; SI:    s_mov_b32 s4, s0
; SI:    s_mov_b32 s5, s1
; SI:    v_cvt_pknorm_u16_f32_e32 v0, s2, v0
; SI:    s_endpgm
;
...
; GFX9-SDAG:    v_cvt_pknorm_u16_f32 v1, s2, v1
; GFX9-SDAG:    s_endpgm
;
; GFX9-GISEL-LABEL: s_cvt_pknorm_u16_f32:
; GFX9-GISEL:  ; %bb.0:
; GFX9-GISEL:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GFX9-GISEL:    v_mov_b32_e32 v1, 0
; GFX9-GISEL:    v_mov_b32_e32 v0, s3
; GFX9-GISEL:    v_cvt_pknorm_u16_f32 v0, s2, v0
; GFX9-GISEL:    s_endpgm
...
; GFX9-SDAG:    s_endpgm
;
; GFX9-GISEL-LABEL: s_cvt_pknorm_u16_samereg_f32:
; GFX9-GISEL:  ; %bb.0:
; GFX9-GISEL:    s_load_dword s2, s[4:5], 0x2c
; GFX9-GISEL:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX9-GISEL:    v_mov_b32_e32 v1, 0
; GFX9-GISEL:    v_cvt_pknorm_u16_f32 v0, s2, s2
; GFX9-GISEL:    s_endpgm
...
; VI:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI:    v_cvt_pknorm_u16_f32 v2, v5, v2
; VI:    s_endpgm
;
...
; SI:    buffer_load_dword v2, v[0:1], s[4:7], 0 addr64 glc
; SI:    s_mov_b64 s[2:3], s[6:7]
; SI:    v_cvt_pknorm_u16_f32_e64 v2, v2, 1.0
; SI:    s_endpgm
;
...
; VI:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI:    v_cvt_pknorm_u16_f32 v2, v3, 1.0
; VI:    s_endpgm
;
...
; GFX9:    v_lshlrev_b32_e32 v0, 2, v0
; GFX9:    global_load_dword v1, v0, s[2:3] glc
; GFX9:    v_cvt_pknorm_u16_f32 v1, v1, 1.0
; GFX9:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
  %tid.ext = sext i32 %tid to i64
  %a.gep = getelementptr inbounds float, ptr addrspace(1) %a.ptr, i64 %tid.ext
...
; SI:    buffer_load_dword v2, v[0:1], s[4:7], 0 addr64 glc
; SI:    s_mov_b64 s[2:3], s[6:7]
; SI:    v_cvt_pknorm_u16_f32_e32 v2, 1.0, v2
; SI:    s_endpgm
;
...
; VI:    v_add_u32_e32 v0, vcc, s0, v2
; VI:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; VI:    v_cvt_pknorm_u16_f32 v2, 1.0, v3
; VI:    s_endpgm
;
...
; GFX9:    v_lshlrev_b32_e32 v0, 2, v0
; GFX9:    global_load_dword v1, v0, s[2:3] glc
; GFX9:    v_cvt_pknorm_u16_f32 v1, 1.0, v1
; GFX9:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
  %tid.ext = sext i32 %tid to i64
  %a.gep = getelementptr inbounds float, ptr addrspace(1) %a.ptr, i64 %tid.ext
