...
;
; GFX942-BACKOFF-LABEL: back_off_barrier_no_fence:
; GFX942-BACKOFF:       ; %bb.0:
; GFX942-BACKOFF-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
...
; GFX9-BACKOFF-NEXT:    s_setpc_b64 s[30:31]
;
; GFX942-BACKOFF-LABEL: back_off_barrier_with_fence:
; GFX942-BACKOFF:       ; %bb.0:
; GFX942-BACKOFF-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX942-BACKOFF-NEXT:    flat_load_dword v0, v[0:1]
