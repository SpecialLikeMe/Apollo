...
; RUN: llc -global-isel -new-reg-bank-select -mtriple=amdgcn-mesa-mesa3d -mcpu=hawaii < %s | FileCheck -check-prefix=GFX6 %s
...
define amdgpu_ps float @s_test_fmin_legacy_f32(float inreg %a, float inreg %b) {
