...
; RUN: llc < %s -mtriple=r600 -mcpu=caicos --show-mc-encoding | FileCheck --check-prefix=EG %s
; RUN: llc < %s -mtriple=r600 -mcpu=cayman --show-mc-encoding | FileCheck --check-prefix=CM %s
