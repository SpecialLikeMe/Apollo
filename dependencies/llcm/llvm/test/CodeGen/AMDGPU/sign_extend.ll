...
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_bfe_i64 s[4:5], s[6:7], 0x100000
...
; VI-NEXT:    s_mov_b32 s2, -1
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_bfe_i64 s[4:5], s[6:7], 0x100000
...
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_ashr_i32 s4, s6, 24
; SI-NEXT:    s_bfe_i32 s5, s6, 0x80010
; SI-NEXT:    s_bfe_i32 s7, s6, 0x80008
...
; VI-NEXT:    s_mov_b32 s2, -1
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    s_ashr_i32 s4, s6, 24
; VI-NEXT:    s_bfe_i32 s5, s6, 0x80010
; VI-NEXT:    s_bfe_i32 s7, s6, 0x80008
; VI-NEXT:    s_sext_i32_i8 s6, s6
; VI-NEXT:    v_mov_b32_e32 v0, s6
; VI-NEXT:    buffer_store_dword v0, off, s[0:3], 0
; VI-NEXT:    s_waitcnt vmcnt(0)
