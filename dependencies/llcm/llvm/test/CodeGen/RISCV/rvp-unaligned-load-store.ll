...
; RUN: llc -mtriple=riscv32 -mattr=+experimental-p < %s \
; RUN:   | FileCheck --check-prefixes=CHECK,CHECK-RV32 %s
; RUN: llc -mtriple=riscv64 -mattr=+experimental-p < %s \
; RUN:   | FileCheck --check-prefixes=CHECK,CHECK-RV64 %s
; RUN: llc -mtriple=riscv32 -mattr=+experimental-p,+unaligned-scalar-mem < %s \
; RUN:   | FileCheck --check-prefixes=UNALIGNED,UNALIGNED-RV32 %s
; RUN: llc -mtriple=riscv64 -mattr=+experimental-p,+unaligned-scalar-mem < %s \
