...
; CHECK-NEXT:    ret
  %vc = sub <vscale x 1 x i8> splat (i8 -4), %va
  ret <vscale x 1 x i8> %vc
}
...
; CHECK-NEXT:    vrsub.vi v8, v8, -4
; CHECK-NEXT:    ret
  %vc = sub <vscale x 2 x i8> splat (i8 -4), %va
  ret <vscale x 2 x i8> %vc
}
...
; CHECK-NEXT:    vrsub.vi v8, v8, -4
; CHECK-NEXT:    ret
  %vc = sub <vscale x 4 x i8> splat (i8 -4), %va
  ret <vscale x 4 x i8> %vc
}
...
; CHECK-NEXT:    vrsub.vi v8, v8, -4
; CHECK-NEXT:    ret
  %vc = sub <vscale x 32 x i8> splat (i8 -4), %va
  ret <vscale x 32 x i8> %vc
}
...
; CHECK-NEXT:    vrsub.vi v8, v8, -4
; CHECK-NEXT:    ret
  %vc = sub <vscale x 64 x i8> splat (i8 -4), %va
  ret <vscale x 64 x i8> %vc
}
...
; CHECK-NEXT:    vrsub.vi v8, v8, -4
; CHECK-NEXT:    ret
  %vc = sub <vscale x 2 x i16> splat (i16 -4), %va
  ret <vscale x 2 x i16> %vc
}
...
; CHECK-NEXT:    vrsub.vi v8, v8, -4
; CHECK-NEXT:    ret
  %vc = sub <vscale x 4 x i16> splat (i16 -4), %va
  ret <vscale x 4 x i16> %vc
}
...
; CHECK-NEXT:    vrsub.vi v8, v8, -4
; CHECK-NEXT:    ret
  %vc = sub <vscale x 8 x i16> splat (i16 -4), %va
  ret <vscale x 8 x i16> %vc
}
...
; CHECK-NEXT:    vrsub.vi v8, v8, -4
; CHECK-NEXT:    ret
  %vc = sub <vscale x 16 x i16> splat (i16 -4), %va
  ret <vscale x 16 x i16> %vc
}
...
; CHECK-NEXT:    vrsub.vi v8, v8, -4
; CHECK-NEXT:    ret
  %vc = sub <vscale x 32 x i16> splat (i16 -4), %va
  ret <vscale x 32 x i16> %vc
}
...
; CHECK-NEXT:    vrsub.vi v8, v8, -4
; CHECK-NEXT:    ret
  %vc = sub <vscale x 1 x i32> splat (i32 -4), %va
  ret <vscale x 1 x i32> %vc
}
...
; CHECK-NEXT:    vrsub.vi v8, v8, -4
; CHECK-NEXT:    ret
  %vc = sub <vscale x 2 x i32> splat (i32 -4), %va
  ret <vscale x 2 x i32> %vc
}
...
; CHECK-NEXT:    vrsub.vi v8, v8, -4
; CHECK-NEXT:    ret
  %vc = sub <vscale x 4 x i32> splat (i32 -4), %va
  ret <vscale x 4 x i32> %vc
}
...
; CHECK-NEXT:    vrsub.vi v8, v8, -4
; CHECK-NEXT:    ret
  %vc = sub <vscale x 8 x i32> splat (i32 -4), %va
  ret <vscale x 8 x i32> %vc
}
...
; CHECK-NEXT:    vrsub.vi v8, v8, -4
; CHECK-NEXT:    ret
  %vc = sub <vscale x 1 x i64> splat (i64 -4), %va
  ret <vscale x 1 x i64> %vc
}
...
; CHECK-NEXT:    vrsub.vi v8, v8, -4
; CHECK-NEXT:    ret
  %vc = sub <vscale x 2 x i64> splat (i64 -4), %va
  ret <vscale x 2 x i64> %vc
}
...
; CHECK-NEXT:    vrsub.vi v8, v8, -4
; CHECK-NEXT:    ret
  %vc = sub <vscale x 4 x i64> splat (i64 -4), %va
  ret <vscale x 4 x i64> %vc
}
...
; CHECK-NEXT:    vrsub.vi v8, v8, -4
; CHECK-NEXT:    ret
  %vc = sub <vscale x 8 x i64> splat (i64 -4), %va
  ret <vscale x 8 x i64> %vc
}
