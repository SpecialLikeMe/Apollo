...
define <1 x bfloat> @vfmul_vv_v1bf16(<1 x bfloat> %va, <1 x bfloat> %vb) strictfp {
; ZVFH-LABEL: vfmul_vv_v1bf16:
; ZVFH:       # %bb.0: # %entry
...
; ZVFH-NEXT:    vfmul.vv v9, v9, v10
; ZVFH-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; ZVFH-NEXT:    vfncvtbf16.f.f.w v8, v9
; ZVFH-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vv_v1bf16:
; ZVFBFA:       # %bb.0: # %entry
; ZVFBFA-NEXT:    vsetivli zero, 1, e16alt, mf4, ta, ma
; ZVFBFA-NEXT:    vfmul.vv v8, v8, v9
; ZVFBFA-NEXT:    ret
entry:
  %vc = call <1 x bfloat> @llvm.experimental.constrained.fmul.v1bf16(<1 x bfloat> %va, <1 x bfloat> %vb, metadata !"round.dynamic", metadata !"fpexcept.ignore")
  ret <1 x bfloat> %vc
}

define <2 x bfloat> @vfmul_vv_v2bf16(<2 x bfloat> %va, <2 x bfloat> %vb) strictfp {
; ZVFH-LABEL: vfmul_vv_v2bf16:
; ZVFH:       # %bb.0: # %entry
...
; ZVFH-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vv_v2bf16:
; ZVFBFA:       # %bb.0: # %entry
; ZVFBFA-NEXT:    vsetivli zero, 2, e16alt, mf4, ta, ma
; ZVFBFA-NEXT:    vfmul.vv v8, v8, v9
; ZVFBFA-NEXT:    ret
entry:
  %vc = call <2 x bfloat> @llvm.experimental.constrained.fmul.v2bf16(<2 x bfloat> %va, <2 x bfloat> %vb, metadata !"round.dynamic", metadata !"fpexcept.ignore")
  ret <2 x bfloat> %vc
}

define <4 x bfloat> @vfmul_vv_v4bf16(<4 x bfloat> %va, <4 x bfloat> %vb) strictfp {
; ZVFH-LABEL: vfmul_vv_v4bf16:
; ZVFH:       # %bb.0: # %entry
...
; ZVFH-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vv_v4bf16:
; ZVFBFA:       # %bb.0: # %entry
; ZVFBFA-NEXT:    vsetivli zero, 4, e16alt, mf2, ta, ma
; ZVFBFA-NEXT:    vfmul.vv v8, v8, v9
; ZVFBFA-NEXT:    ret
entry:
  %vc = call <4 x bfloat> @llvm.experimental.constrained.fmul.v4bf16(<4 x bfloat> %va, <4 x bfloat> %vb, metadata !"round.dynamic", metadata !"fpexcept.ignore")
  ret <4 x bfloat> %vc
}

define <8 x bfloat> @vfmul_vv_v8bf16(<8 x bfloat> %va, <8 x bfloat> %vb) strictfp {
; ZVFH-LABEL: vfmul_vv_v8bf16:
; ZVFH:       # %bb.0: # %entry
; ZVFH-NEXT:    vsetivli zero, 8, e16, m1, ta, ma
; ZVFH-NEXT:    vfwcvtbf16.f.f.v v10, v9
; ZVFH-NEXT:    vfwcvtbf16.f.f.v v12, v8
; ZVFH-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; ZVFH-NEXT:    vfmul.vv v10, v12, v10
; ZVFH-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; ZVFH-NEXT:    vfncvtbf16.f.f.w v8, v10
; ZVFH-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vv_v8bf16:
; ZVFBFA:       # %bb.0: # %entry
; ZVFBFA-NEXT:    vsetivli zero, 8, e16alt, m1, ta, ma
; ZVFBFA-NEXT:    vfmul.vv v8, v8, v9
; ZVFBFA-NEXT:    ret
entry:
  %vc = call <8 x bfloat> @llvm.experimental.constrained.fmul.v8bf16(<8 x bfloat> %va, <8 x bfloat> %vb, metadata !"round.dynamic", metadata !"fpexcept.ignore")
  ret <8 x bfloat> %vc
}

define <16 x bfloat> @vfmul_vv_v16bf16(<16 x bfloat> %va, <16 x bfloat> %vb) strictfp {
; ZVFH-LABEL: vfmul_vv_v16bf16:
; ZVFH:       # %bb.0: # %entry
; ZVFH-NEXT:    vsetivli zero, 16, e16, m2, ta, ma
; ZVFH-NEXT:    vfwcvtbf16.f.f.v v12, v10
; ZVFH-NEXT:    vfwcvtbf16.f.f.v v16, v8
; ZVFH-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFH-NEXT:    vfmul.vv v12, v16, v12
; ZVFH-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; ZVFH-NEXT:    vfncvtbf16.f.f.w v8, v12
; ZVFH-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vv_v16bf16:
; ZVFBFA:       # %bb.0: # %entry
; ZVFBFA-NEXT:    vsetivli zero, 16, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vfmul.vv v8, v8, v10
; ZVFBFA-NEXT:    ret
entry:
  %vc = call <16 x bfloat> @llvm.experimental.constrained.fmul.v16bf16(<16 x bfloat> %va, <16 x bfloat> %vb, metadata !"round.dynamic", metadata !"fpexcept.ignore")
  ret <16 x bfloat> %vc
}

define <32 x bfloat> @vfmul_vv_v32bf16(<32 x bfloat> %va, <32 x bfloat> %vb) strictfp {
; ZVFH-LABEL: vfmul_vv_v32bf16:
; ZVFH:       # %bb.0: # %entry
; ZVFH-NEXT:    li a0, 32
...
; ZVFBFA-NEXT:    ret
entry:
  %vc = call <32 x bfloat> @llvm.experimental.constrained.fmul.v32bf16(<32 x bfloat> %va, <32 x bfloat> %vb, metadata !"round.dynamic", metadata !"fpexcept.ignore")
  ret <32 x bfloat> %vc
}

define <1 x half> @vfmul_vv_v1f16(<1 x half> %va, <1 x half> %vb) strictfp {
; ZVFH-LABEL: vfmul_vv_v1f16:
; ZVFH:       # %bb.0: # %entry
; ZVFH-NEXT:    vsetivli zero, 1, e16, mf4, ta, ma
; ZVFH-NEXT:    vfmul.vv v8, v8, v9
; ZVFH-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vv_v1f16:
; ZVFBFA:       # %bb.0: # %entry
...
; ZVFBFA-NEXT:    vfmul.vv v9, v9, v10
...
; ZVFH-LABEL: vfmul_vf_v1f16:
; ZVFH:       # %bb.0:
; ZVFH-NEXT:    vsetivli zero, 1, e16, mf4, ta, ma
; ZVFH-NEXT:    vfmul.vf v8, v8, fa0
; ZVFH-NEXT:    ret
;
; ZVFBFA-LABEL: vfmul_vf_v1f16:
; ZVFBFA:       # %bb.0:
...
; ZVFBFA-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; ZVFBFA-NEXT:    vfmul.vv v9, v10, v8
; ZVFBFA-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; ZVFBFA-NEXT:    vfncvt.f.f.w v8, v9
; ZVFBFA-NEXT:    ret
...
; ZVFBFA-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; ZVFBFA-NEXT:    vfmul.vv v10, v10, v8
; ZVFBFA-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; ZVFBFA-NEXT:    vfncvt.f.f.w v8, v10
; ZVFBFA-NEXT:    ret
...
; ZVFBFA-NEXT:    vfmul.vv v12, v16, v12
...
; ZVFBFA-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFA-NEXT:    vfmul.vv v12, v12, v8
; ZVFBFA-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; ZVFBFA-NEXT:    vfncvt.f.f.w v8, v12
; ZVFBFA-NEXT:    ret
...
; ZVFBFA-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFBFA-NEXT:    vfmul.vv v16, v16, v8
; ZVFBFA-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; ZVFBFA-NEXT:    vfncvt.f.f.w v8, v16
; ZVFBFA-NEXT:    ret
