...
; ZVFBFMIN-LABEL: vfadd_vv_nxv1bf16:
; ZVFBFMIN:       # %bb.0: # %entry
...
; ZVFBFMIN-NEXT:    vfadd.vv v9, v9, v10
...
; ZVFBFMIN-LABEL: vfadd_vf_nxv1bf16:
; ZVFBFMIN:       # %bb.0:
...
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, mf2, ta, ma
; ZVFBFMIN-NEXT:    vfadd.vv v9, v10, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e16, mf4, ta, ma
; ZVFBFMIN-NEXT:    vfncvtbf16.f.f.w v8, v9
; ZVFBFMIN-NEXT:    ret
;
...
; ZVFBFMIN-LABEL: vfadd_vv_nxv2bf16:
; ZVFBFMIN:       # %bb.0: # %entry
...
; ZVFBFMIN-LABEL: vfadd_vf_nxv2bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fmv.x.h a0, fa0
...
; ZVFBFMIN-LABEL: vfadd_vv_nxv4bf16:
; ZVFBFMIN:       # %bb.0: # %entry
...
; ZVFBFMIN-NEXT:    vfadd.vv v10, v12, v10
...
; ZVFBFMIN-LABEL: vfadd_vf_nxv4bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fmv.x.h a0, fa0
...
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m2, ta, ma
; ZVFBFMIN-NEXT:    vfadd.vv v10, v10, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e16, m1, ta, ma
; ZVFBFMIN-NEXT:    vfncvtbf16.f.f.w v8, v10
; ZVFBFMIN-NEXT:    ret
;
...
; ZVFBFMIN-LABEL: vfadd_vv_nxv8bf16:
; ZVFBFMIN:       # %bb.0: # %entry
...
; ZVFBFMIN-NEXT:    vfadd.vv v12, v16, v12
...
; ZVFBFMIN-LABEL: vfadd_vf_nxv8bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fmv.x.h a0, fa0
...
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m4, ta, ma
; ZVFBFMIN-NEXT:    vfadd.vv v12, v12, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e16, m2, ta, ma
; ZVFBFMIN-NEXT:    vfncvtbf16.f.f.w v8, v12
; ZVFBFMIN-NEXT:    ret
;
...
; ZVFBFMIN-LABEL: vfadd_vv_nxv16bf16:
; ZVFBFMIN:       # %bb.0: # %entry
...
; ZVFBFMIN-NEXT:    vfadd.vv v16, v24, v16
...
; ZVFBFMIN-LABEL: vfadd_vf_nxv16bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    fmv.x.h a0, fa0
...
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFBFMIN-NEXT:    vfadd.vv v16, v16, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; ZVFBFMIN-NEXT:    vfncvtbf16.f.f.w v8, v16
; ZVFBFMIN-NEXT:    ret
;
...
; ZVFBFMIN-LABEL: vfadd_vv_nxv32bf16:
; ZVFBFMIN:       # %bb.0: # %entry
...
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFBFMIN-NEXT:    vfadd.vv v0, v0, v8
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; ZVFBFMIN-NEXT:    vfncvtbf16.f.f.w v8, v0
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFBFMIN-NEXT:    vfadd.vv v16, v16, v24
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
...
; ZVFBFMIN-LABEL: vfadd_vf_nxv32bf16:
; ZVFBFMIN:       # %bb.0:
; ZVFBFMIN-NEXT:    addi sp, sp, -16
; ZVFBFMIN-NEXT:    .cfi_def_cfa_offset 16
; ZVFBFMIN-NEXT:    csrr a0, vlenb
...
; ZVFBFMIN-NEXT:    vl8r.v v8, (a0) # vscale x 64-byte Folded Reload
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFBFMIN-NEXT:    vfadd.vv v0, v8, v0
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e16, m4, ta, ma
; ZVFBFMIN-NEXT:    vfncvtbf16.f.f.w v8, v0
; ZVFBFMIN-NEXT:    vsetvli zero, zero, e32, m8, ta, ma
; ZVFBFMIN-NEXT:    vfadd.vv v16, v24, v16
