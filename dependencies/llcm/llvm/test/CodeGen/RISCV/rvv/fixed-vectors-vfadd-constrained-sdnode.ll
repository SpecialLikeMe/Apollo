...
define <1 x bfloat> @vfadd_vv_v1bf16(<1 x bfloat> %va, <1 x bfloat> %vb) strictfp {
; ZVFH-LABEL: vfadd_vv_v1bf16:
; ZVFH:       # %bb.0: # %entry
...
; ZVFH-NEXT:    ret
;
; ZVFBFA-LABEL: vfadd_vv_v1bf16:
; ZVFBFA:       # %bb.0: # %entry
; ZVFBFA-NEXT:    vsetivli zero, 1, e16alt, mf4, ta, ma
; ZVFBFA-NEXT:    vfadd.vv v8, v8, v9
; ZVFBFA-NEXT:    ret
entry:
  %vc = call <1 x bfloat> @llvm.experimental.constrained.fadd.v1bf16(<1 x bfloat> %va, <1 x bfloat> %vb, metadata !"round.dynamic", metadata !"fpexcept.ignore")
  ret <1 x bfloat> %vc
}

define <2 x bfloat> @vfadd_vv_v2bf16(<2 x bfloat> %va, <2 x bfloat> %vb) strictfp {
; ZVFH-LABEL: vfadd_vv_v2bf16:
; ZVFH:       # %bb.0: # %entry
...
; ZVFH-NEXT:    ret
;
; ZVFBFA-LABEL: vfadd_vv_v2bf16:
; ZVFBFA:       # %bb.0: # %entry
; ZVFBFA-NEXT:    vsetivli zero, 2, e16alt, mf4, ta, ma
; ZVFBFA-NEXT:    vfadd.vv v8, v8, v9
; ZVFBFA-NEXT:    ret
entry:
  %vc = call <2 x bfloat> @llvm.experimental.constrained.fadd.v2bf16(<2 x bfloat> %va, <2 x bfloat> %vb, metadata !"round.dynamic", metadata !"fpexcept.ignore")
  ret <2 x bfloat> %vc
}

define <4 x bfloat> @vfadd_vv_v4bf16(<4 x bfloat> %va, <4 x bfloat> %vb) strictfp {
; ZVFH-LABEL: vfadd_vv_v4bf16:
; ZVFH:       # %bb.0: # %entry
...
; ZVFH-NEXT:    ret
;
; ZVFBFA-LABEL: vfadd_vv_v4bf16:
; ZVFBFA:       # %bb.0: # %entry
; ZVFBFA-NEXT:    vsetivli zero, 4, e16alt, mf2, ta, ma
; ZVFBFA-NEXT:    vfadd.vv v8, v8, v9
; ZVFBFA-NEXT:    ret
entry:
  %vc = call <4 x bfloat> @llvm.experimental.constrained.fadd.v4bf16(<4 x bfloat> %va, <4 x bfloat> %vb, metadata !"round.dynamic", metadata !"fpexcept.ignore")
  ret <4 x bfloat> %vc
}

define <8 x bfloat> @vfadd_vv_v8bf16(<8 x bfloat> %va, <8 x bfloat> %vb) strictfp {
; ZVFH-LABEL: vfadd_vv_v8bf16:
; ZVFH:       # %bb.0: # %entry
...
; ZVFH-NEXT:    ret
;
; ZVFBFA-LABEL: vfadd_vv_v8bf16:
; ZVFBFA:       # %bb.0: # %entry
; ZVFBFA-NEXT:    vsetivli zero, 8, e16alt, m1, ta, ma
; ZVFBFA-NEXT:    vfadd.vv v8, v8, v9
; ZVFBFA-NEXT:    ret
entry:
  %vc = call <8 x bfloat> @llvm.experimental.constrained.fadd.v8bf16(<8 x bfloat> %va, <8 x bfloat> %vb, metadata !"round.dynamic", metadata !"fpexcept.ignore")
  ret <8 x bfloat> %vc
}

define <16 x bfloat> @vfadd_vv_v16bf16(<16 x bfloat> %va, <16 x bfloat> %vb) strictfp {
; ZVFH-LABEL: vfadd_vv_v16bf16:
; ZVFH:       # %bb.0: # %entry
...
; ZVFH-NEXT:    ret
;
; ZVFBFA-LABEL: vfadd_vv_v16bf16:
; ZVFBFA:       # %bb.0: # %entry
; ZVFBFA-NEXT:    vsetivli zero, 16, e16alt, m2, ta, ma
; ZVFBFA-NEXT:    vfadd.vv v8, v8, v10
; ZVFBFA-NEXT:    ret
entry:
  %vc = call <16 x bfloat> @llvm.experimental.constrained.fadd.v16bf16(<16 x bfloat> %va, <16 x bfloat> %vb, metadata !"round.dynamic", metadata !"fpexcept.ignore")
  ret <16 x bfloat> %vc
}

define <32 x bfloat> @vfadd_vv_v32bf16(<32 x bfloat> %va, <32 x bfloat> %vb) strictfp {
; ZVFH-LABEL: vfadd_vv_v32bf16:
; ZVFH:       # %bb.0: # %entry
; ZVFH-NEXT:    li a0, 32
...
; ZVFBFA-NEXT:    ret
entry:
  %vc = call <32 x bfloat> @llvm.experimental.constrained.fadd.v32bf16(<32 x bfloat> %va, <32 x bfloat> %vb, metadata !"round.dynamic", metadata !"fpexcept.ignore")
  ret <32 x bfloat> %vc
}
