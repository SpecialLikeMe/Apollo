...
entry:
	%c = alloca double, align 8		; <ptr> [#uses=2]
	%0 = add i32 %len, 2		; <i32> [#uses=1]
	%1 = add i32 %0, %lag		; <i32> [#uses=1]
	%2 = alloca double, i32 %1		; <ptr> [#uses=2]
	%3 = getelementptr double, ptr %2, i32 %lag		; <ptr> [#uses=2]
	%4 = ptrtoint ptr %3 to i32		; <i32> [#uses=1]
...
bb:		; preds = %entry
	...
	%7 = getelementptr double, ptr %2, i32 %.sum		; <ptr> [#uses=1]
	br label %bb19

bb19:		; preds = %bb, %entry
	%data15.0 = phi ptr [ %7, %bb ], [ %3, %entry ]		; <ptr> [#uses=5]
...
bb27:		; preds = %bb27, %bb28.preheader
	...
	%20 = getelementptr double, ptr %data15.0, i32 %19		; <ptr> [#uses=1]
...
bb29:		; preds = %bb27, %bb28.preheader
	%21 = getelementptr double, ptr %data15.0, i32 %len		; <ptr> [#uses=3]
