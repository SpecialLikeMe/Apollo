...
define i32 @test(ptr %pSA, ptr %A, i32 %B, i32 %C, i32 %D, ptr %E) {
; CHECK-LABEL: test:
; CHECK:       # %bb.0: # %entry
...
entry:
  ...
  %shl1 = shl i32 %C, %B
  %shl2 = shl i32 1, %D
  %v0 = load <1 x i64>, ptr %pSA, align 8
  %SA0 = getelementptr inbounds %SA, ptr %pSA, i64 0, i32 1
  %v1 = load i32, ptr %SA0, align 4
  %SA1 = getelementptr inbounds %SA, ptr %pSA, i64 0, i32 3
  %v2 = load ptr, ptr %SA1, align 8
