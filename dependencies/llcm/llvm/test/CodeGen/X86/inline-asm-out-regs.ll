...
@pcibios_last_bus = external dso_local global i32         ; <ptr> [#uses=2]
...
bb1.i:          ; preds = %bb6.i.i, %bb1.i, %entry
        %0 = load i32, ptr null, align 8            ; <i32> [#uses=1]
        %1 = icmp ugt i32 %0, 1048575           ; <i1> [#uses=1]
        br i1 %1, label %bb2.i, label %bb1.i

bb2.i:          ; preds = %bb1.i
        %asmtmp.i.i = tail call { i32, i32, i32, i32 } asm "lcall *(%edi); cld\0A\09jc 1f\0A\09xor %ah, %ah\0A1:", "={dx},={ax},={bx},={cx},1,{di},~{dirflag},~{fpsr},~{flags},~{memory}"(i32 45313, ptr @pci_indirect) nounwind             ; <{ i32, i32, i32, i32 }> [#uses=2]
        ...
        %4 = load i32, ptr @pcibios_last_bus, align 4               ; <i32> [#uses=1]
...
bb5.i.i:                ; preds = %bb2.i
        ...
        store i32 %6, ptr @pcibios_last_bus, align 4
        br label %bb6.i.i
