...
define <8 x half> @test_fminimum_v8f16(<8 x half> %x, <8 x half> %y) {
; CHECK-LABEL: test_fminimum_v8f16:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vminph %xmm1, %xmm0, %xmm0
; CHECK-NEXT:    retq
  %r = call nnan nsz <8 x half> @llvm.minimum.v8f16(<8 x half> %x, <8 x half> %y)
  ret <8 x half> %r
}
...
define <8 x half> @test_fmaximum_v8f16(<8 x half> %x, <8 x half> %y) {
; CHECK-LABEL: test_fmaximum_v8f16:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vmaxph %xmm1, %xmm0, %xmm0
; CHECK-NEXT:    retq
  %r = call nnan nsz <8 x half> @llvm.maximum.v8f16(<8 x half> %x, <8 x half> %y)
  ret <8 x half> %r
}
...
define <16 x half> @test_fminimum_v16f16(<16 x half> %x, <16 x half> %y) {
; CHECK-LABEL: test_fminimum_v16f16:
; CHECK:       # %bb.0:
; CHECK-NEXT:    vminph %ymm1, %ymm0, %ymm0
; CHECK-NEXT:    retq
  %r = call nnan nsz <16 x half> @llvm.minimum.v16f16(<16 x half> %x, <16 x half> %y)
  ret <16 x half> %r
}
