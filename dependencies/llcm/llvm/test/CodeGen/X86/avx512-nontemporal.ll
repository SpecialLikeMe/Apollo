...
; CHECK-NEXT:    retq
  ...
  store <16 x float> %A2, ptr %B, align 64, !nontemporal !0
  %v1 = load i32, ptr %loadptr, align 1
  %E2 = add <8 x i64> %E, %EE
  store <8 x i64> %E2, ptr %B, align 64, !nontemporal !0
  %v2 = load i32, ptr %loadptr, align 1
  %C2 = fadd <8 x double> %C, %CC
  store <8 x double> %C2, ptr %B, align 64, !nontemporal !0
  %v3 = load i32, ptr %loadptr, align 1
  %F2 = add <16 x i32> %F, %FF
  store <16 x i32> %F2, ptr %B, align 64, !nontemporal !0
  %v4 = load i32, ptr %loadptr, align 1
  %G2 = add <32 x i16> %G, %GG
  store <32 x i16> %G2, ptr %B, align 64, !nontemporal !0
  %v5 = load i32, ptr %loadptr, align 1
  %H2 = add <64 x i8> %H, %HH
  store <64 x i8> %H2, ptr %B, align 64, !nontemporal !0
