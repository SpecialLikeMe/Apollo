...
; SSE2-LABEL: trunc_ashr_v4i64_bitcast:
; SSE2:       # %bb.0:
; SSE2-NEXT:    pshufd {{.*#+}} xmm1 = xmm1[1,3,2,3]
; SSE2-NEXT:    movdqa %xmm1, %xmm2
; SSE2-NEXT:    psrad $31, %xmm2
; SSE2-NEXT:    psrad $17, %xmm1
...
; SSE2-NEXT:    ret{{[l|q]}}
;
; SSE4-LABEL: trunc_ashr_v4i64_bitcast:
; SSE4:       # %bb.0:
...
define <16 x i8> @_mm_packss_epi16_manual(<8 x i16> %a, <8 x i16> %b) nounwind {
...
define <32 x i8> @_mm256_packss_epi16_manual(<16 x i16> %a, <16 x i16> %b) nounwind {
...
define <64 x i8> @_mm512_packss_epi16_manual(<32 x i16> %a, <32 x i16> %b) nounwind {
...
; X86-SSE-NEXT:    retl
;
; X86-AVX1-LABEL: _mm512_packss_epi16_manual:
; X86-AVX1:       # %bb.0:
...
; X86-AVX1-NEXT:    retl
;
; X86-AVX2-LABEL: _mm512_packss_epi16_manual:
; X86-AVX2:       # %bb.0:
; X86-AVX2-NEXT:    pushl %ebp
; X86-AVX2-NEXT:    movl %esp, %ebp
; X86-AVX2-NEXT:    andl $-32, %esp
; X86-AVX2-NEXT:    subl $32, %esp
; X86-AVX2-NEXT:    vpacksswb %ymm2, %ymm0, %ymm0
; X86-AVX2-NEXT:    vpacksswb 8(%ebp), %ymm1, %ymm1
...
define <8 x i16> @_mm_packss_epi32_manual(<4 x i32> %a, <4 x i32> %b) nounwind {
...
define <16 x i16> @_mm256_packss_epi32_manual(<8 x i32> %a, <8 x i32> %b) nounwind {
...
define <32 x i16> @_mm512_packss_epi32_manual(<16 x i32> %a, <16 x i32> %b) nounwind {
...
; X86-SSE-NEXT:    retl
;
; X86-AVX1-LABEL: _mm512_packss_epi32_manual:
; X86-AVX1:       # %bb.0:
; X86-AVX1-NEXT:    pushl %ebp
; X86-AVX1-NEXT:    movl %esp, %ebp
; X86-AVX1-NEXT:    andl $-32, %esp
...
; X86-AVX1-NEXT:    retl
;
; X86-AVX2-LABEL: _mm512_packss_epi32_manual:
; X86-AVX2:       # %bb.0:
; X86-AVX2-NEXT:    pushl %ebp
; X86-AVX2-NEXT:    movl %esp, %ebp
; X86-AVX2-NEXT:    andl $-32, %esp
; X86-AVX2-NEXT:    subl $32, %esp
; X86-AVX2-NEXT:    vpackssdw %ymm2, %ymm0, %ymm0
; X86-AVX2-NEXT:    vpackssdw 8(%ebp), %ymm1, %ymm1
; X86-AVX2-NEXT:    movl %ebp, %esp
; X86-AVX2-NEXT:    popl %ebp
; X86-AVX2-NEXT:    retl
;
...
; X64-SSE-NEXT:    retq
;
; X64-AVX1-LABEL: _mm512_packss_epi32_manual:
; X64-AVX1:       # %bb.0:
; X64-AVX1-NEXT:    vextractf128 $1, %ymm1, %xmm4
; X64-AVX1-NEXT:    vextractf128 $1, %ymm0, %xmm5
; X64-AVX1-NEXT:    vextractf128 $1, %ymm2, %xmm6
; X64-AVX1-NEXT:    vpackssdw %xmm6, %xmm5, %xmm5
; X64-AVX1-NEXT:    vpackssdw %xmm2, %xmm0, %xmm0
; X64-AVX1-NEXT:    vinsertf128 $1, %xmm5, %ymm0, %ymm0
; X64-AVX1-NEXT:    vextractf128 $1, %ymm3, %xmm2
; X64-AVX1-NEXT:    vpackssdw %xmm2, %xmm4, %xmm2
; X64-AVX1-NEXT:    vpackssdw %xmm3, %xmm1, %xmm1
; X64-AVX1-NEXT:    vinsertf128 $1, %xmm2, %ymm1, %ymm1
; X64-AVX1-NEXT:    retq
;
; X64-AVX2-LABEL: _mm512_packss_epi32_manual:
; X64-AVX2:       # %bb.0:
; X64-AVX2-NEXT:    vpackssdw %ymm2, %ymm0, %ymm0
; X64-AVX2-NEXT:    vpackssdw %ymm3, %ymm1, %ymm1
; X64-AVX2-NEXT:    retq
