...
if.end.i:                                         ; preds = %_static_cpu_has.exit.thread.i, %entry
  ...
  %6 = load i32, ptr @ptrs_per_p4d, align 4
  %sub.i.i = add i32 %6, 33554431
  %7 = and i32 %sub.i.i, 33554431
  %and.i1.i = zext i32 %7 to i64
  %add.ptr.i = getelementptr %struct.p4d_t, ptr %5, i64 %and.i1.i
  br label %p4d_offset.exit

p4d_offset.exit:                                  ; preds = %if.end.i, %if.then.i
  %retval.0.i = phi ptr [ %add.ptr.i, %if.end.i ], [ %arrayidx, %if.then.i ]
  %8 = load i64, ptr %retval.0.i, align 8
  %and.i.i13 = and i64 %8, 4503599627366400
  %add.i.i14 = add i64 %and.i.i13, %1
  %9 = inttoptr i64 %add.i.i14 to ptr
  %coerce.dive.i16 = getelementptr %struct.pud_t, ptr %9, i64 511, i32 0
  %10 = load i64, ptr %coerce.dive.i16, align 8
  %tobool.i.i.i = icmp slt i64 %10, 0
