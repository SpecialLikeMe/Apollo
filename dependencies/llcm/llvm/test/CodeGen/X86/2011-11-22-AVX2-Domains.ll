...
for_loop156.lr.ph:                                ; preds = %if_else
  %val_6.i21244 = load i16, ptr undef, align 2
  %0 = insertelement <8 x i16> undef, i16 %val_6.i21244, i32 6
  %val_7.i21248 = load i16, ptr undef, align 2
  ...
  %val_4.i21290 = load i16, ptr undef, align 2
  %2 = insertelement <8 x i16> undef, i16 %val_4.i21290, i32 4
  %val_5.i21294 = load i16, ptr undef, align 2
  %3 = insertelement <8 x i16> %2, i16 %val_5.i21294, i32 5
  %val_6.i21298 = load i16, ptr undef, align 2
  %4 = insertelement <8 x i16> %3, i16 %val_6.i21298, i32 6
  %ptr_7.i21301 = inttoptr i64 undef to ptr
  %val_7.i21302 = load i16, ptr %ptr_7.i21301, align 2
  %5 = insertelement <8 x i16> %4, i16 %val_7.i21302, i32 7
  %uint2uint32.i20218 = zext <8 x i16> %5 to <8 x i32>
  %structelement561 = load ptr, ptr undef, align 8
  %ptr2int563 = ptrtoint ptr %structelement561 to i64
  ...
  %val_5.i21509 = load i8, ptr null, align 1
  ...
  %ptr_7.i21516 = inttoptr i64 %iptr_7.i21515 to ptr
  %val_7.i21517 = load i8, ptr %ptr_7.i21516, align 1
