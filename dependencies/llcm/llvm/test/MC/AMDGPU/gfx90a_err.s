...
// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx90a %s -filetype=null 2>&1 | FileCheck --check-prefix=GFX90A --implicit-check-not=error: %s
...
// GFX90A: :[[@LINE-1]]:13: error: vgpr must be even aligned
...
// GFX90A: :[[@LINE-1]]:19: error: lds_direct is not supported on this GPU

v_add_f32_sdwa v5, v1, lds_direct dst_sel:DWORD
// GFX90A: :[[@LINE-1]]:24: error: lds_direct is not supported on this GPU

v_ashrrev_i16 v0, lds_direct, v0
// GFX90A: :[[@LINE-1]]:19: error: lds_direct is not supported on this GPU

v_ceil_f64_dpp v[0:1], v[2:3] quad_perm:[1,1,1,1] row_mask:0xf bank_mask:0xf
// GFX90A: :[[@LINE-1]]:31: error: DP ALU dpp only supports row_newbcast
...
// GFX90A: :[[@LINE-1]]:26: error: DP ALU dpp only supports row_newbcast

v_dot4_i32_i8 v0, v1, v2, v3 op_sel:[0,0]
// GFX90A: :[[@LINE-1]]:30: error: not a valid operand.
...
// GFX90A: :[[@LINE-1]]:20: error: lds_direct is not supported on this GPU

v_mul_legacy_f32_dpp v5, v1, v2  quad_perm:[0,1,2,3] row_mask:0x0 bank_mask:0x0
// GFX90A: :[[@LINE-1]]:1: error: dpp variant of this instruction is not supported

v_mul_legacy_f32_e32 v5, v1, v2
// GFX90A: :[[@LINE-1]]:1: error: e32 variant of this instruction is not supported

v_mul_legacy_f32_sdwa v5, v1, v2 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:DWORD src1_sel:DWORD
// GFX90A: :[[@LINE-1]]:1: error: sdwa variant of this instruction is not supported
