...
// RUN: not llvm-mc -triple=amdgcn -mcpu=gfx942 %s -filetype=null 2>&1 | FileCheck --check-prefix=GFX942 --implicit-check-not=error: %s
...
// GFX942: :[[@LINE-1]]:27: error: invalid operand for instruction

s_getreg_b32 s1, hwreg(HW_REG_FLAT_SCR_HI)
// GFX942: :[[@LINE-1]]:24: error: invalid hardware register: not supported on this GPU
...
// GFX942: :[[@LINE-1]]:30: error: invalid operand for instruction

scratch_load_dword v2, off lds
// GFX942: :[[@LINE-1]]:28: error: invalid operand for instruction
...
// GFX942: :[[@LINE-1]]:26: error: not a valid operand.

v_cvt_pk_fp8_f32 v1, v2, v3 clamp
// GFX942: :[[@LINE-1]]:29: error: invalid operand for instruction

v_cvt_pk_fp8_f32 v1, v2, v3 mul:2
// GFX942: :[[@LINE-1]]:29: error: not a valid operand.
...
// GFX942: :[[@LINE-1]]:26: error: DP ALU dpp only supports row_newbcast

v_mov_b64 v[2:3], |v[4:5]|
// GFX942: :[[@LINE-1]]:19: error: not a valid operand.

v_mov_b64_sdwa v[2:3], v[4:5]
// GFX942: :[[@LINE-1]]:1: error: sdwa variant of this instruction is not supported
