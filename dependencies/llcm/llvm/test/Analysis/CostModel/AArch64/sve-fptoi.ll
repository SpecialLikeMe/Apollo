...
; CHECK-NEXT:  Cost Model: Found costs of Invalid for: %nv1f16_to_si8 = fptosi <vscale x 1 x half> poison to <vscale x 1 x i8>
; CHECK-NEXT:  Cost Model: Found costs of Invalid for: %nv1f16_to_ui8 = fptoui <vscale x 1 x half> poison to <vscale x 1 x i8>
; CHECK-NEXT:  Cost Model: Found costs of Invalid for: %nv1f16_to_si32 = fptosi <vscale x 1 x half> poison to <vscale x 1 x i32>
; CHECK-NEXT:  Cost Model: Found costs of Invalid for: %nv1f16_to_ui32 = fptoui <vscale x 1 x half> poison to <vscale x 1 x i32>
; CHECK-NEXT:  Cost Model: Found costs of Invalid for: %nv1f16_to_si64 = fptosi <vscale x 1 x half> poison to <vscale x 1 x i64>
; CHECK-NEXT:  Cost Model: Found costs of Invalid for: %nv1f16_to_ui64 = fptoui <vscale x 1 x half> poison to <vscale x 1 x i64>
; CHECK-NEXT:  Cost Model: Found costs of Invalid for: %nv1f32_to_si8 = fptosi <vscale x 1 x float> poison to <vscale x 1 x i8>
; CHECK-NEXT:  Cost Model: Found costs of Invalid for: %nv1f32_to_ui8 = fptoui <vscale x 1 x float> poison to <vscale x 1 x i8>
; CHECK-NEXT:  Cost Model: Found costs of Invalid for: %nv1f32_to_si16 = fptosi <vscale x 1 x float> poison to <vscale x 1 x i16>
...
; CHECK-NEXT:  Cost Model: Found costs of 4 for: %nv4f16_to_si64 = fptosi <vscale x 4 x half> poison to <vscale x 4 x i64>
; CHECK-NEXT:  Cost Model: Found costs of 4 for: %nv4f16_to_ui64 = fptoui <vscale x 4 x half> poison to <vscale x 4 x i64>
...
; CHECK-NEXT:  Cost Model: Found costs of 4 for: %nv4f32_to_si64 = fptosi <vscale x 4 x float> poison to <vscale x 4 x i64>
; CHECK-NEXT:  Cost Model: Found costs of 4 for: %nv4f32_to_ui64 = fptoui <vscale x 4 x float> poison to <vscale x 4 x i64>
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %nv4f64_to_si8 = fptosi <vscale x 4 x double> poison to <vscale x 4 x i8>
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %nv4f64_to_ui8 = fptoui <vscale x 4 x double> poison to <vscale x 4 x i8>
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %nv4f64_to_si16 = fptosi <vscale x 4 x double> poison to <vscale x 4 x i16>
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %nv4f64_to_ui16 = fptoui <vscale x 4 x double> poison to <vscale x 4 x i16>
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %nv4f64_to_si32 = fptosi <vscale x 4 x double> poison to <vscale x 4 x i32>
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %nv4f64_to_ui32 = fptoui <vscale x 4 x double> poison to <vscale x 4 x i32>
...
; CHECK-NEXT:  Cost Model: Found costs of 4 for: %nv8f16_to_si32 = fptosi <vscale x 8 x half> poison to <vscale x 8 x i32>
; CHECK-NEXT:  Cost Model: Found costs of 4 for: %nv8f16_to_ui32 = fptoui <vscale x 8 x half> poison to <vscale x 8 x i32>
; CHECK-NEXT:  Cost Model: Found costs of 10 for: %nv8f16_to_si64 = fptosi <vscale x 8 x half> poison to <vscale x 8 x i64>
; CHECK-NEXT:  Cost Model: Found costs of 10 for: %nv8f16_to_ui64 = fptoui <vscale x 8 x half> poison to <vscale x 8 x i64>
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %nv8f32_to_si8 = fptosi <vscale x 8 x float> poison to <vscale x 8 x i8>
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %nv8f32_to_ui8 = fptoui <vscale x 8 x float> poison to <vscale x 8 x i8>
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %nv8f32_to_si16 = fptosi <vscale x 8 x float> poison to <vscale x 8 x i16>
; CHECK-NEXT:  Cost Model: Found costs of 3 for: %nv8f32_to_ui16 = fptoui <vscale x 8 x float> poison to <vscale x 8 x i16>
; CHECK-NEXT:  Cost Model: Found costs of 8 for: %nv8f32_to_si64 = fptosi <vscale x 8 x float> poison to <vscale x 8 x i64>
; CHECK-NEXT:  Cost Model: Found costs of 8 for: %nv8f32_to_ui64 = fptoui <vscale x 8 x float> poison to <vscale x 8 x i64>
; CHECK-NEXT:  Cost Model: Found costs of 7 for: %nv8f64_to_si8 = fptosi <vscale x 8 x double> poison to <vscale x 8 x i8>
; CHECK-NEXT:  Cost Model: Found costs of 7 for: %nv8f64_to_ui8 = fptoui <vscale x 8 x double> poison to <vscale x 8 x i8>
; CHECK-NEXT:  Cost Model: Found costs of 7 for: %nv8f64_to_si16 = fptosi <vscale x 8 x double> poison to <vscale x 8 x i16>
; CHECK-NEXT:  Cost Model: Found costs of 7 for: %nv8f64_to_ui16 = fptoui <vscale x 8 x double> poison to <vscale x 8 x i16>
; CHECK-NEXT:  Cost Model: Found costs of 6 for: %nv8f64_to_si32 = fptosi <vscale x 8 x double> poison to <vscale x 8 x i32>
; CHECK-NEXT:  Cost Model: Found costs of 6 for: %nv8f64_to_ui32 = fptoui <vscale x 8 x double> poison to <vscale x 8 x i32>
