...
; RUN: opt %s -S -mtriple riscv64 -passes=loop-vectorize --tail-folding-policy=must-fold-tail -force-tail-folding-style=data-with-evl -riscv-v-min-trip-count=0 -force-target-instruction-cost=1 -mattr=+v | FileCheck %s
