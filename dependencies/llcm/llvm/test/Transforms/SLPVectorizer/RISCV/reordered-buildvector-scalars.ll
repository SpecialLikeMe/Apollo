...
; CHECK-NEXT:    [[TMP11:%.*]] = insertelement <8 x i32> [[TMP9]], i32 [[ADD111_I_I]], i32 6
; CHECK-NEXT:    [[TMP12:%.*]] = insertelement <8 x i32> [[TMP11]], i32 [[ADD2235_I17]], i32 1
; CHECK-NEXT:    [[TMP30:%.*]] = insertelement <8 x i32> [[TMP12]], i32 [[LOOPARRAY_SROA_24_0_I_I3]], i32 2
; CHECK-NEXT:    [[TMP13:%.*]] = insertelement <8 x i32> [[TMP30]], i32 [[MUL1445_I]], i32 5
...
; CHECK-NEXT:    [[TMP31:%.*]] = insertelement <4 x i32> poison, i32 [[TMP0]], i32 2
; CHECK-NEXT:    [[TMP20:%.*]] = insertelement <4 x i32> [[TMP31]], i32 [[LOOPARRAY_SROA_24_0_I_I3]], i32 0
; CHECK-NEXT:    [[TMP21:%.*]] = insertelement <4 x i32> [[TMP20]], i32 [[ADD1392_I]], i32 1
; CHECK-NEXT:    [[TMP32:%.*]] = insertelement <4 x i32> [[TMP21]], i32 [[SHR143_5_I_I9]], i32 3
