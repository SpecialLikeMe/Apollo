...
; CHECK-NEXT:    [[TMP3:%.*]] = fadd <2 x double> [[TMP2]], splat (double 1.000000e+01)
; CHECK-NEXT:    [[TMP4:%.*]] = fmul <2 x double> [[TMP3]], splat (double 4.000000e+00)
; CHECK-NEXT:    [[TMP5]] = fadd <2 x double> [[TMP4]], splat (double 4.000000e+00)
