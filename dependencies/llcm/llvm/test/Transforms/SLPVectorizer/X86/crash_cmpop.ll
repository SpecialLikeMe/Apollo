...
; CHECK-NEXT:    [[ADD13]] = fadd float [[TMP12]], [[TMP11]]
; CHECK-NEXT:    [[TMP16:%.*]] = shufflevector <2 x float> [[TMP10]], <2 x float> poison, <2 x i32> <i32 poison, i32 0>
; CHECK-NEXT:    [[TMP14:%.*]] = insertelement <2 x float> [[TMP16]], float [[ADD13]], i32 0
